...
public final class ItemStack
{
    ...
    {
        return this.getItem().getMaxItemUseDuration();
    }

    public EnumAction getItemUseAction()
    {
        return this.getItem().getItemUseAction();
    }
