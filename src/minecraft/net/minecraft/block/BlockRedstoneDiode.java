...
public abstract class BlockRedstoneDiode extends BlockDirectional
{
    ...
    {
        return !this.isPowered(state) ? 0 : (state.getValue(FACING) == side ? this.getActiveSignal(worldIn, pos) : 0);
    }
    ...
    protected int getActiveSignal(IBlockAccess worldIn, BlockPos pos)
    {
        return 15;
    }
