...
public class RenderChunk {
    ...
    public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
        ...
        try {
            ...
            regionrendercache = this.createRegionRenderCache(this.world, blockpos.add(-1, -1, -1), blockpos1.add(1, 1, 1));
        ...
        if (!regionrendercache.extendedLevelsInChunkCache()) {
            ...
            while (iterator.hasNext()) {
                ...
                for (int i = 0; i < aenumworldblocklayer.length; ++i) {
                    ...
                    if (flag2 && !Reflector.callBoolean(block, Reflector.ForgeBlock_canRenderInLayer, enumworldblocklayer))
                        continue;
