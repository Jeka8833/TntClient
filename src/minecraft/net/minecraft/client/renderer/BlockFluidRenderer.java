...
public class BlockFluidRenderer
{
    ...
    public boolean renderFluid(IBlockAccess blockAccess, IBlockState blockStateIn, BlockPos blockPosIn, WorldRenderer worldRendererIn)
    {
        ...
        RenderEnv renderenv = RenderEnv.getInstance(blockStateIn);
        ...
        else
        {
            ...
            if (flag)
            {
                ...
                float f26 = f4 * f1;
                float f18 = f4 * f2;
                worldRendererIn.pos(d0 + 0.0D, d1 + (double)f7, d2 + 0.0D).color(f25, f26, f18, 1.0F).tex(f13, f17).lightmap(l2, i3).endVertex();
                worldRendererIn.pos(d0 + 0.0D, d1 + (double)f8, d2 + 1.0D).color(f25, f26, f18, 1.0F).tex(f14, f19).lightmap(l2, i3).endVertex();
                worldRendererIn.pos(d0 + 1.0D, d1 + (double)f9, d2 + 1.0D).color(f25, f26, f18, 1.0F).tex(f15, f20).lightmap(l2, i3).endVertex();
                worldRendererIn.pos(d0 + 1.0D, d1 + (double)f10, d2 + 0.0D).color(f25, f26, f18, 1.0F).tex(f16, f21).lightmap(l2, i3).endVertex();
            ...
            for (int j1 = 0; j1 < 4; ++j1)
            {
                ...
                if (aboolean[j1])
                {
                    ...
                    float f33 = f4 * f31 * f1;
                    float f34 = f4 * f31 * f2;
                    worldRendererIn.pos(d5, d1 + (double)f39, d6).color(f32, f33, f34, 1.0F).tex(f41, f28).lightmap(k, l).endVertex();
                    worldRendererIn.pos(d3, d1 + (double)f40, d4).color(f32, f33, f34, 1.0F).tex(f27, f29).lightmap(k, l).endVertex();
