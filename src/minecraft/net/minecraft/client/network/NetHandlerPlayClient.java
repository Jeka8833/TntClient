...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleEntityVelocity(S12PacketEntityVelocity packetIn) {
        ...
        if (entity != null) {
            ...
            if (Config.config.tabDJCount.isActive() && entity instanceof EntityPlayer) {
                if(TabDJCount.jumpCount.containsKey(entity.getUniqueID()))
                    TabDJCount.jumpCount.put(entity.getUniqueID(), TabDJCount.jumpCount.get(entity.getUniqueID()) + 1);
                else
                    TabDJCount.jumpCount.put(entity.getUniqueID(), 1);
            }
        }
    }
