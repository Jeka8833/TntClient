        ...
        for (int k4 = 0; k4 < l3; ++k4) {
            ...
            if (k4 < list.size()) {
                ...
                if (networkplayerinfo1.getGameType() == WorldSettings.GameType.SPECTATOR) {
                    ...
                    this.mc.fontRendererObj.drawStringWithShadow(stat + s1, (float) j2, (float) k2, -1862270977);
                } else {
                    this.mc.fontRendererObj.drawStringWithShadow(stat + s1, (float) j2, (float) k2, -1);
                }
