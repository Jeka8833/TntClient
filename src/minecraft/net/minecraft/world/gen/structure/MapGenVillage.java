...
public class MapGenVillage extends MapGenStructure
{
    ...
    public static class Start extends StructureStart
    {
        ...
        public Start(World worldIn, Random rand, int x, int z, int p_i2092_5_)
        {
            ...
            StructureVillagePieces.Start structurevillagepieces$start = new StructureVillagePieces.Start(worldIn.getWorldChunkManager(), rand, (x << 4) + 2, (z << 4) + 2, list, p_i2092_5_);
