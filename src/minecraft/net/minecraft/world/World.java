...
public abstract class World implements IBlockAccess {
    ...
    private boolean isValid(BlockPos pos) {
        ...
        return posX >= -30000000 && posZ >= -30000000 && posX < 30000000 && posZ < 30000000 && posY >= 0 && posY < 256;
    }
    ...
    public IBlockState getBlockState(BlockPos pos) {
        return this.isValid(pos) ? getChunkFromBlockCoords(pos).getBlockState(pos) : Blocks.air.getDefaultState();
    }
