        ...
        if (!mc.gameSettings.showDebugInfo) {
            ...
            if (HypixelPlayers.isHypixel) {
                ...
                if(TntClient.isDebug){
                    final String line4 = "Api request: " + HypixelPlayers.sendPerSecond.size();
                    mc.fontRendererObj.drawString(line4, (int) (event.getWidth() - mc.fontRendererObj.getStringWidth(line4)), posX + 10, -2039584);
                }
            }
        }
    }
