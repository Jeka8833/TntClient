...
public class Lagometer
{
    ...
    public static final TimerNano timerTick = new TimerNano();
    public static final TimerNano timerScheduledExecutables = new TimerNano();
    public static final TimerNano timerChunkUpload = new TimerNano();
    public static final TimerNano timerChunkUpdate = new TimerNano();
    public static final TimerNano timerVisibility = new TimerNano();
    public static final TimerNano timerTerrain = new TimerNano();
    public static final TimerNano timerServer = new TimerNano();
    ...
    private static void renderTimeDivider(int p_renderTimeDivider_1_, long p_renderTimeDivider_2_, float p_renderTimeDivider_7_, WorldRenderer p_renderTimeDivider_8_)
    {
        ...
        {
            p_renderTimeDivider_8_.pos((float) 0 + 0.5F, p_renderTimeDivider_7_ - (float)i + 0.5F, 0.0D).color(196, 196, 196, 255).endVertex();
            p_renderTimeDivider_8_.pos((float)p_renderTimeDivider_1_ + 0.5F, p_renderTimeDivider_7_ - (float)i + 0.5F, 0.0D).color(196, 196, 196, 255).endVertex();
        }
    }
