...
public class Mipmaps
{
    ...
    {
        Dimension[] mipmapDimensions = makeMipmapDimensions(p_i66_2_, p_i66_3_, p_i66_1_);
        int[][] mipmapDatas = generateMipMapData(p_i66_4_, p_i66_2_, mipmapDimensions);

        if (p_i66_5_)
        {
            makeMipmapBuffers(mipmapDimensions, mipmapDatas);
        }
    }
    ...
    public static int[][] generateMipMapData(int[] p_generateMipMapData_0_, int p_generateMipMapData_1_, Dimension[] p_generateMipMapData_3_)
    {
    ...
    public static void makeMipmapBuffers(Dimension[] p_makeMipmapBuffers_0_, int[][] p_makeMipmapBuffers_1_)
    {
