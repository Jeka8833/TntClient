...
public class Config {
    ...
    public static IResourcePack getDefiningResourcePack(ResourceLocation p_getDefiningResourcePack_0_) {
        ...
        if (iresourcepack != null && iresourcepack.resourceExists(p_getDefiningResourcePack_0_)) {
            ...
            List<Entry> list = (List) Reflector.getFieldValue(resourcepackrepository, Reflector.ResourcePackRepository_repositoryEntries);
    ...
    public static void drawFps() {
        final NetworkPlayerInfo player = minecraft.getNetHandler().getPlayerInfo(minecraft.thePlayer.getUniqueID());
        if (player == null)
            return;
        minecraft.fontRendererObj.drawString(Minecraft.getDebugFPS() + " fps, C: "
                + minecraft.renderGlobal.getCountActiveRenderers() + ", E: " + minecraft.renderGlobal.getCountEntitiesRendered()
                + "+" + minecraft.renderGlobal.getCountTileEntitiesRendered() + ", U: " + getUpdates(minecraft.debug) +
                ", Ping: " + player.getResponseTime(), 2, 2, -2039584);
    }
