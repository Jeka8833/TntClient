...
public class Config
{
    ...
    public static void drawFps() {
        ...
        try {
            minecraft.fontRendererObj.drawString(i + " fps, C: " + j + ", E: " + k + "+" + l + ", U: " + s +
                    ", Ping: " + minecraft.getNetHandler().getPlayerInfo(minecraft.thePlayer.getUniqueID()).getResponseTime(), 2, 2, -2039584);
        } catch (Exception ignored) {
        }
    }
