...
public class DemoWorldManager extends ItemInWorldManager {
   ...
   public void func_73075_a() {
      super.func_73075_a();
      ++this.field_73102_f;
      long lvt_1_1_ = this.field_73092_a.func_82737_E();
      ...
      this.field_73103_d = lvt_1_1_ > 120500L;
      ...
      if (lvt_1_1_ % 24000L == 500L) {
         if (lvt_3_1_ <= 6L) {
            this.field_73090_b.func_145747_a(new ChatComponentTranslation("demo.day." + lvt_3_1_, new Object[0]));
         }
      } else if (lvt_3_1_ == 1L) {
         if (lvt_1_1_ == 100L) {
