...
public class WorldManager implements IWorldAccess {
   ...
   public void func_180441_b(int p_180441_1_, BlockPos p_180441_2_, int p_180441_3_) {
      Iterator lvt_4_1_ = this.field_72783_a.func_71203_ab().func_181057_v().iterator();

      while(lvt_4_1_.hasNext()) {
         EntityPlayerMP lvt_5_1_ = (EntityPlayerMP)lvt_4_1_.next();
         if (lvt_5_1_ != null && lvt_5_1_.field_70170_p == this.field_72782_b && lvt_5_1_.func_145782_y() != p_180441_1_) {
            double lvt_6_1_ = (double)p_180441_2_.func_177958_n() - lvt_5_1_.field_70165_t;
            double lvt_8_1_ = (double)p_180441_2_.func_177956_o() - lvt_5_1_.field_70163_u;
            double lvt_10_1_ = (double)p_180441_2_.func_177952_p() - lvt_5_1_.field_70161_v;
            if (lvt_6_1_ * lvt_6_1_ + lvt_8_1_ * lvt_8_1_ + lvt_10_1_ * lvt_10_1_ < 1024.0D) {
               lvt_5_1_.field_71135_a.func_147359_a(new S25PacketBlockBreakAnim(p_180441_1_, p_180441_2_, p_180441_3_));
            }
         }
      }
