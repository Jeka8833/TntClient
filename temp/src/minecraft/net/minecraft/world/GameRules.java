...
public class GameRules {
   ...
   public NBTTagCompound func_82770_a() {
      ...
      Iterator i$ = this.field_82771_a.keySet().iterator();
   ...
   public void func_82768_a(NBTTagCompound p_82768_1_) {
      Iterator i$ = p_82768_1_.func_150296_c().iterator();
   ...
   static class Value {
      ...
      public void func_82757_a(String p_82757_1_) {
         ...
         if (p_82757_1_ != null) {
            if (p_82757_1_.equals("false")) {
               this.field_82760_b = false;
               return;
            }

            if (p_82757_1_.equals("true")) {
               this.field_82760_b = true;
               return;
            }
         }
