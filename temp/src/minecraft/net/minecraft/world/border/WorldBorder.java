...
public class WorldBorder {
   ...
   public double func_177729_b(double p_177729_1_, double p_177729_3_) {
      double lvt_5_1_ = p_177729_3_ - this.func_177736_c();
      double lvt_7_1_ = this.func_177733_e() - p_177729_3_;
      double lvt_9_1_ = p_177729_1_ - this.func_177726_b();
      double lvt_11_1_ = this.func_177728_d() - p_177729_1_;
   ...
   public double func_177726_b() {
      double lvt_1_1_ = this.func_177731_f() - this.func_177741_h() / 2.0D;
      if (lvt_1_1_ < (double)(-this.field_177762_h)) {
         lvt_1_1_ = (double)(-this.field_177762_h);
      }
   ...
   public double func_177736_c() {
      double lvt_1_1_ = this.func_177721_g() - this.func_177741_h() / 2.0D;
      if (lvt_1_1_ < (double)(-this.field_177762_h)) {
         lvt_1_1_ = (double)(-this.field_177762_h);
      }
   ...
   public void func_177739_c(double p_177739_1_, double p_177739_3_) {
      ...
      Iterator lvt_5_1_ = this.func_177735_k().iterator();

      while(lvt_5_1_.hasNext()) {
         IBorderListener lvt_6_1_ = (IBorderListener)lvt_5_1_.next();
         lvt_6_1_.func_177693_a(this, p_177739_1_, p_177739_3_);
      }
   ...
   public double func_177741_h() {
      if (this.func_177734_a() != EnumBorderStatus.STATIONARY) {
         double lvt_1_1_ = (double)((float)(System.currentTimeMillis() - this.field_177753_g) / (float)(this.field_177752_f - this.field_177753_g));
         if (lvt_1_1_ < 1.0D) {
   ...
   public void func_177750_a(double p_177750_1_) {
      ...
      Iterator lvt_3_1_ = this.func_177735_k().iterator();

      while(lvt_3_1_.hasNext()) {
         IBorderListener lvt_4_1_ = (IBorderListener)lvt_3_1_.next();
         lvt_4_1_.func_177694_a(this, p_177750_1_);
      }
   ...
   public void func_177738_a(double p_177738_1_, double p_177738_3_, long p_177738_5_) {
      ...
      Iterator lvt_7_1_ = this.func_177735_k().iterator();

      while(lvt_7_1_.hasNext()) {
         IBorderListener lvt_8_1_ = (IBorderListener)lvt_7_1_.next();
         lvt_8_1_.func_177692_a(this, p_177738_1_, p_177738_3_, p_177738_5_);
      }

   }

   protected List<IBorderListener> func_177735_k() {
      return Lists.newArrayList((Iterable)this.field_177758_a);
   }
   ...
   public void func_177724_b(double p_177724_1_) {
      ...
      while(lvt_3_1_.hasNext()) {
         IBorderListener lvt_4_1_ = (IBorderListener)lvt_3_1_.next();
         lvt_4_1_.func_177695_c(this, p_177724_1_);
      }
   ...
   public void func_177744_c(double p_177744_1_) {
      ...
      while(lvt_3_1_.hasNext()) {
         IBorderListener lvt_4_1_ = (IBorderListener)lvt_3_1_.next();
         lvt_4_1_.func_177696_b(this, p_177744_1_);
      }
   ...
   public void func_177723_b(int p_177723_1_) {
      ...
      Iterator lvt_2_1_ = this.func_177735_k().iterator();

      while(lvt_2_1_.hasNext()) {
         IBorderListener lvt_3_1_ = (IBorderListener)lvt_2_1_.next();
         lvt_3_1_.func_177691_a(this, p_177723_1_);
      }
   ...
   public void func_177747_c(int p_177747_1_) {
      ...
      while(lvt_2_1_.hasNext()) {
         IBorderListener lvt_3_1_ = (IBorderListener)lvt_2_1_.next();
         lvt_3_1_.func_177690_b(this, p_177747_1_);
      }
