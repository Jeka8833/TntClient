...
public class WorldGenIcePath extends WorldGenerator {
   ...
   public boolean func_180709_b(World p_180709_1_, Random p_180709_2_, BlockPos p_180709_3_) {
      ...
      if (p_180709_1_.func_180495_p(p_180709_3_).func_177230_c() != Blocks.field_150433_aE) {
         ...
         int lvt_4_1_ = p_180709_2_.nextInt(this.field_150554_b - 2) + 2;
         int lvt_5_1_ = 1;
            ...
            for(int lvt_7_1_ = p_180709_3_.func_177952_p() - lvt_4_1_; lvt_7_1_ <= p_180709_3_.func_177952_p() + lvt_4_1_; ++lvt_7_1_) {
               ...
               if (lvt_8_1_ * lvt_8_1_ + lvt_9_1_ * lvt_9_1_ <= lvt_4_1_ * lvt_4_1_) {
                  for(int lvt_10_1_ = p_180709_3_.func_177956_o() - lvt_5_1_; lvt_10_1_ <= p_180709_3_.func_177956_o() + lvt_5_1_; ++lvt_10_1_) {
                     ...
                     if (lvt_12_1_ == Blocks.field_150346_d || lvt_12_1_ == Blocks.field_150433_aE || lvt_12_1_ == Blocks.field_150432_aD) {
                        p_180709_1_.func_180501_a(lvt_11_1_, this.field_150555_a.func_176223_P(), 2);
                     }
                  }
               }
            }
