...
public class StructureBoundingBox {
   ...
   public String toString() {
      return Objects.toStringHelper((Object)this).add("x0", this.field_78897_a).add("y0", this.field_78895_b).add("z0", this.field_78896_c).add("x1", this.field_78893_d).add("y1", this.field_78894_e).add("z1", this.field_78892_f).toString();
   }
