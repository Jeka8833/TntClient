...
public class StructureVillagePieces {
   ...
   public static List<StructureVillagePieces.PieceWeight> func_75084_a(Random p_75084_0_, int p_75084_1_) {
      ...
      lvt_2_1_.add(new StructureVillagePieces.PieceWeight(StructureVillagePieces.House4Garden.class, 4, MathHelper.func_76136_a(p_75084_0_, 2 + p_75084_1_, 4 + p_75084_1_ * 2)));
      lvt_2_1_.add(new StructureVillagePieces.PieceWeight(StructureVillagePieces.Church.class, 20, MathHelper.func_76136_a(p_75084_0_, 0 + p_75084_1_, 1 + p_75084_1_)));
      lvt_2_1_.add(new StructureVillagePieces.PieceWeight(StructureVillagePieces.House1.class, 20, MathHelper.func_76136_a(p_75084_0_, 0 + p_75084_1_, 2 + p_75084_1_)));
      lvt_2_1_.add(new StructureVillagePieces.PieceWeight(StructureVillagePieces.WoodHut.class, 3, MathHelper.func_76136_a(p_75084_0_, 2 + p_75084_1_, 5 + p_75084_1_ * 3)));
      lvt_2_1_.add(new StructureVillagePieces.PieceWeight(StructureVillagePieces.Hall.class, 15, MathHelper.func_76136_a(p_75084_0_, 0 + p_75084_1_, 2 + p_75084_1_)));
      lvt_2_1_.add(new StructureVillagePieces.PieceWeight(StructureVillagePieces.Field1.class, 3, MathHelper.func_76136_a(p_75084_0_, 1 + p_75084_1_, 4 + p_75084_1_)));
      lvt_2_1_.add(new StructureVillagePieces.PieceWeight(StructureVillagePieces.Field2.class, 3, MathHelper.func_76136_a(p_75084_0_, 2 + p_75084_1_, 4 + p_75084_1_ * 2)));
      lvt_2_1_.add(new StructureVillagePieces.PieceWeight(StructureVillagePieces.House2.class, 15, MathHelper.func_76136_a(p_75084_0_, 0, 1 + p_75084_1_)));
      lvt_2_1_.add(new StructureVillagePieces.PieceWeight(StructureVillagePieces.House3.class, 8, MathHelper.func_76136_a(p_75084_0_, 0 + p_75084_1_, 3 + p_75084_1_ * 2)));
      Iterator lvt_3_1_ = lvt_2_1_.iterator();

      while(lvt_3_1_.hasNext()) {
         if (((StructureVillagePieces.PieceWeight)lvt_3_1_.next()).field_75087_d == 0) {
            lvt_3_1_.remove();
         }
      }
   ...
   private static int func_75079_a(List<StructureVillagePieces.PieceWeight> p_75079_0_) {
      ...
      StructureVillagePieces.PieceWeight lvt_4_1_;
      for(Iterator lvt_3_1_ = p_75079_0_.iterator(); lvt_3_1_.hasNext(); lvt_2_1_ += lvt_4_1_.field_75088_b) {
         lvt_4_1_ = (StructureVillagePieces.PieceWeight)lvt_3_1_.next();
         if (lvt_4_1_.field_75087_d > 0 && lvt_4_1_.field_75089_c < lvt_4_1_.field_75087_d) {
            lvt_1_1_ = true;
         }
      }
   ...
   private static StructureVillagePieces.Village func_176065_a(StructureVillagePieces.Start p_176065_0_, StructureVillagePieces.PieceWeight p_176065_1_, List<StructureComponent> p_176065_2_, Random p_176065_3_, int p_176065_4_, int p_176065_5_, int p_176065_6_, EnumFacing p_176065_7_, int p_176065_8_) {
      Class<? extends StructureVillagePieces.Village> lvt_9_1_ = p_176065_1_.field_75090_a;
      StructureVillagePieces.Village lvt_10_1_ = null;
      if (lvt_9_1_ == StructureVillagePieces.House4Garden.class) {
         lvt_10_1_ = StructureVillagePieces.House4Garden.func_175858_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
      } else if (lvt_9_1_ == StructureVillagePieces.Church.class) {
         lvt_10_1_ = StructureVillagePieces.Church.func_175854_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
      } else if (lvt_9_1_ == StructureVillagePieces.House1.class) {
         lvt_10_1_ = StructureVillagePieces.House1.func_175850_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
      } else if (lvt_9_1_ == StructureVillagePieces.WoodHut.class) {
         lvt_10_1_ = StructureVillagePieces.WoodHut.func_175853_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
      } else if (lvt_9_1_ == StructureVillagePieces.Hall.class) {
         lvt_10_1_ = StructureVillagePieces.Hall.func_175857_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
      } else if (lvt_9_1_ == StructureVillagePieces.Field1.class) {
         lvt_10_1_ = StructureVillagePieces.Field1.func_175851_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
      } else if (lvt_9_1_ == StructureVillagePieces.Field2.class) {
         lvt_10_1_ = StructureVillagePieces.Field2.func_175852_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
      } else if (lvt_9_1_ == StructureVillagePieces.House2.class) {
         lvt_10_1_ = StructureVillagePieces.House2.func_175855_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
      } else if (lvt_9_1_ == StructureVillagePieces.House3.class) {
         lvt_10_1_ = StructureVillagePieces.House3.func_175849_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
      }

      return (StructureVillagePieces.Village)lvt_10_1_;
   }
   ...
   private static StructureVillagePieces.Village func_176067_c(StructureVillagePieces.Start p_176067_0_, List<StructureComponent> p_176067_1_, Random p_176067_2_, int p_176067_3_, int p_176067_4_, int p_176067_5_, EnumFacing p_176067_6_, int p_176067_7_) {
      int lvt_8_1_ = func_75079_a(p_176067_0_.field_74931_h);
      if (lvt_8_1_ <= 0) {
         return null;
      } else {
         int lvt_9_1_ = 0;
         ...
         while(lvt_9_1_ < 5) {
            ++lvt_9_1_;
            int lvt_10_1_ = p_176067_2_.nextInt(lvt_8_1_);
            Iterator lvt_11_1_ = p_176067_0_.field_74931_h.iterator();

            while(lvt_11_1_.hasNext()) {
               StructureVillagePieces.PieceWeight lvt_12_1_ = (StructureVillagePieces.PieceWeight)lvt_11_1_.next();
               lvt_10_1_ -= lvt_12_1_.field_75088_b;
               if (lvt_10_1_ < 0) {
                  if (!lvt_12_1_.func_75085_a(p_176067_7_) || lvt_12_1_ == p_176067_0_.field_74926_d && p_176067_0_.field_74931_h.size() > 1) {
                     break;
                  }

                  StructureVillagePieces.Village lvt_13_1_ = func_176065_a(p_176067_0_, lvt_12_1_, p_176067_1_, p_176067_2_, p_176067_3_, p_176067_4_, p_176067_5_, p_176067_6_, p_176067_7_);
                  if (lvt_13_1_ != null) {
                     ++lvt_12_1_.field_75089_c;
                     p_176067_0_.field_74926_d = lvt_12_1_;
                     if (!lvt_12_1_.func_75086_a()) {
                        p_176067_0_.field_74931_h.remove(lvt_12_1_);
                     }
         ...
         StructureBoundingBox lvt_10_2_ = StructureVillagePieces.Torch.func_175856_a(p_176067_0_, p_176067_1_, p_176067_2_, p_176067_3_, p_176067_4_, p_176067_5_, p_176067_6_);
         if (lvt_10_2_ != null) {
            return new StructureVillagePieces.Torch(p_176067_0_, p_176067_7_, p_176067_2_, lvt_10_2_, p_176067_6_);
         } else {
            return null;
         }
      }
   ...
   private static StructureComponent func_176066_d(StructureVillagePieces.Start p_176066_0_, List<StructureComponent> p_176066_1_, Random p_176066_2_, int p_176066_3_, int p_176066_4_, int p_176066_5_, EnumFacing p_176066_6_, int p_176066_7_) {
      if (p_176066_7_ > 50) {
         ...
         StructureComponent lvt_8_1_ = func_176067_c(p_176066_0_, p_176066_1_, p_176066_2_, p_176066_3_, p_176066_4_, p_176066_5_, p_176066_6_, p_176066_7_ + 1);
         if (lvt_8_1_ != null) {
            int lvt_9_1_ = (lvt_8_1_.field_74887_e.field_78897_a + lvt_8_1_.field_74887_e.field_78893_d) / 2;
            int lvt_10_1_ = (lvt_8_1_.field_74887_e.field_78896_c + lvt_8_1_.field_74887_e.field_78892_f) / 2;
            int lvt_11_1_ = lvt_8_1_.field_74887_e.field_78893_d - lvt_8_1_.field_74887_e.field_78897_a;
            int lvt_12_1_ = lvt_8_1_.field_74887_e.field_78892_f - lvt_8_1_.field_74887_e.field_78896_c;
            int lvt_13_1_ = lvt_11_1_ > lvt_12_1_ ? lvt_11_1_ : lvt_12_1_;
            if (p_176066_0_.func_74925_d().func_76940_a(lvt_9_1_, lvt_10_1_, lvt_13_1_ / 2 + 4, MapGenVillage.field_75055_e)) {
               p_176066_1_.add(lvt_8_1_);
               p_176066_0_.field_74932_i.add(lvt_8_1_);
               return lvt_8_1_;
            }
         }
   ...
   private static StructureComponent func_176069_e(StructureVillagePieces.Start p_176069_0_, List<StructureComponent> p_176069_1_, Random p_176069_2_, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing p_176069_6_, int p_176069_7_) {
      if (p_176069_7_ > 3 + p_176069_0_.field_74928_c) {
         ...
         StructureBoundingBox lvt_8_1_ = StructureVillagePieces.Path.func_175848_a(p_176069_0_, p_176069_1_, p_176069_2_, p_176069_3_, p_176069_4_, p_176069_5_, p_176069_6_);
         if (lvt_8_1_ != null && lvt_8_1_.field_78895_b > 10) {
            StructureComponent lvt_9_1_ = new StructureVillagePieces.Path(p_176069_0_, p_176069_7_, p_176069_2_, lvt_8_1_, p_176069_6_);
            int lvt_10_1_ = (lvt_9_1_.field_74887_e.field_78897_a + lvt_9_1_.field_74887_e.field_78893_d) / 2;
            int lvt_11_1_ = (lvt_9_1_.field_74887_e.field_78896_c + lvt_9_1_.field_74887_e.field_78892_f) / 2;
            int lvt_12_1_ = lvt_9_1_.field_74887_e.field_78893_d - lvt_9_1_.field_74887_e.field_78897_a;
            int lvt_13_1_ = lvt_9_1_.field_74887_e.field_78892_f - lvt_9_1_.field_74887_e.field_78896_c;
            int lvt_14_1_ = lvt_12_1_ > lvt_13_1_ ? lvt_12_1_ : lvt_13_1_;
            if (p_176069_0_.func_74925_d().func_76940_a(lvt_10_1_, lvt_11_1_, lvt_14_1_ / 2 + 4, MapGenVillage.field_75055_e)) {
               p_176069_1_.add(lvt_9_1_);
               p_176069_0_.field_74930_j.add(lvt_9_1_);
               return lvt_9_1_;
            }
         }
   ...
   public static class Torch extends StructureVillagePieces.Village {
      ...
      public static StructureBoundingBox func_175856_a(StructureVillagePieces.Start p_175856_0_, List<StructureComponent> p_175856_1_, Random p_175856_2_, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing p_175856_6_) {
         StructureBoundingBox lvt_7_1_ = StructureBoundingBox.func_175897_a(p_175856_3_, p_175856_4_, p_175856_5_, 0, 0, 0, 3, 4, 2, p_175856_6_);
         return StructureComponent.func_74883_a(p_175856_1_, lvt_7_1_) != null ? null : lvt_7_1_;
      }
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         boolean lvt_4_1_ = this.field_74885_f == EnumFacing.EAST || this.field_74885_f == EnumFacing.NORTH;
         this.func_175811_a(p_74875_1_, Blocks.field_150478_aa.func_176223_P().func_177226_a(BlockTorch.field_176596_a, this.field_74885_f.func_176746_e()), lvt_4_1_ ? 2 : 0, 3, 0, p_74875_3_);
         ...
         this.func_175811_a(p_74875_1_, Blocks.field_150478_aa.func_176223_P().func_177226_a(BlockTorch.field_176596_a, this.field_74885_f.func_176735_f()), lvt_4_1_ ? 0 : 2, 3, 0, p_74875_3_);
   ...
   public static class Field1 extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.Field1 func_175851_a(StructureVillagePieces.Start p_175851_0_, List<StructureComponent> p_175851_1_, Random p_175851_2_, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing p_175851_6_, int p_175851_7_) {
         StructureBoundingBox lvt_8_1_ = StructureBoundingBox.func_175897_a(p_175851_3_, p_175851_4_, p_175851_5_, 0, 0, 0, 13, 4, 9, p_175851_6_);
         return func_74895_a(lvt_8_1_) && StructureComponent.func_74883_a(p_175851_1_, lvt_8_1_) == null ? new StructureVillagePieces.Field1(p_175851_0_, p_175851_7_, p_175851_2_, lvt_8_1_, p_175851_6_) : null;
      }
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         int lvt_4_2_;
         for(lvt_4_2_ = 1; lvt_4_2_ <= 7; ++lvt_4_2_) {
            this.func_175811_a(p_74875_1_, this.field_82679_b.func_176203_a(MathHelper.func_76136_a(p_74875_2_, 2, 7)), 1, 1, lvt_4_2_, p_74875_3_);
            this.func_175811_a(p_74875_1_, this.field_82679_b.func_176203_a(MathHelper.func_76136_a(p_74875_2_, 2, 7)), 2, 1, lvt_4_2_, p_74875_3_);
            this.func_175811_a(p_74875_1_, this.field_82680_c.func_176203_a(MathHelper.func_76136_a(p_74875_2_, 2, 7)), 4, 1, lvt_4_2_, p_74875_3_);
            this.func_175811_a(p_74875_1_, this.field_82680_c.func_176203_a(MathHelper.func_76136_a(p_74875_2_, 2, 7)), 5, 1, lvt_4_2_, p_74875_3_);
            this.func_175811_a(p_74875_1_, this.field_82678_d.func_176203_a(MathHelper.func_76136_a(p_74875_2_, 2, 7)), 7, 1, lvt_4_2_, p_74875_3_);
            this.func_175811_a(p_74875_1_, this.field_82678_d.func_176203_a(MathHelper.func_76136_a(p_74875_2_, 2, 7)), 8, 1, lvt_4_2_, p_74875_3_);
            this.func_175811_a(p_74875_1_, this.field_82681_h.func_176203_a(MathHelper.func_76136_a(p_74875_2_, 2, 7)), 10, 1, lvt_4_2_, p_74875_3_);
            this.func_175811_a(p_74875_1_, this.field_82681_h.func_176203_a(MathHelper.func_76136_a(p_74875_2_, 2, 7)), 11, 1, lvt_4_2_, p_74875_3_);
         }

         for(lvt_4_2_ = 0; lvt_4_2_ < 9; ++lvt_4_2_) {
            for(int lvt_5_1_ = 0; lvt_5_1_ < 13; ++lvt_5_1_) {
               this.func_74871_b(p_74875_1_, lvt_5_1_, 4, lvt_4_2_, p_74875_3_);
               this.func_175808_b(p_74875_1_, Blocks.field_150346_d.func_176223_P(), lvt_5_1_, -1, lvt_4_2_, p_74875_3_);
            }
         }
   ...
   public static class Field2 extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.Field2 func_175852_a(StructureVillagePieces.Start p_175852_0_, List<StructureComponent> p_175852_1_, Random p_175852_2_, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing p_175852_6_, int p_175852_7_) {
         StructureBoundingBox lvt_8_1_ = StructureBoundingBox.func_175897_a(p_175852_3_, p_175852_4_, p_175852_5_, 0, 0, 0, 7, 4, 9, p_175852_6_);
         return func_74895_a(lvt_8_1_) && StructureComponent.func_74883_a(p_175852_1_, lvt_8_1_) == null ? new StructureVillagePieces.Field2(p_175852_0_, p_175852_7_, p_175852_2_, lvt_8_1_, p_175852_6_) : null;
      }
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         int lvt_4_2_;
         for(lvt_4_2_ = 1; lvt_4_2_ <= 7; ++lvt_4_2_) {
            this.func_175811_a(p_74875_1_, this.field_82675_b.func_176203_a(MathHelper.func_76136_a(p_74875_2_, 2, 7)), 1, 1, lvt_4_2_, p_74875_3_);
            this.func_175811_a(p_74875_1_, this.field_82675_b.func_176203_a(MathHelper.func_76136_a(p_74875_2_, 2, 7)), 2, 1, lvt_4_2_, p_74875_3_);
            this.func_175811_a(p_74875_1_, this.field_82676_c.func_176203_a(MathHelper.func_76136_a(p_74875_2_, 2, 7)), 4, 1, lvt_4_2_, p_74875_3_);
            this.func_175811_a(p_74875_1_, this.field_82676_c.func_176203_a(MathHelper.func_76136_a(p_74875_2_, 2, 7)), 5, 1, lvt_4_2_, p_74875_3_);
         }
   ...
   public static class House2 extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.House2 func_175855_a(StructureVillagePieces.Start p_175855_0_, List<StructureComponent> p_175855_1_, Random p_175855_2_, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing p_175855_6_, int p_175855_7_) {
         StructureBoundingBox lvt_8_1_ = StructureBoundingBox.func_175897_a(p_175855_3_, p_175855_4_, p_175855_5_, 0, 0, 0, 10, 6, 7, p_175855_6_);
         return func_74895_a(lvt_8_1_) && StructureComponent.func_74883_a(p_175855_1_, lvt_8_1_) == null ? new StructureVillagePieces.House2(p_175855_0_, p_175855_7_, p_175855_2_, lvt_8_1_, p_175855_6_) : null;
      }
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         int lvt_4_2_;
         for(lvt_4_2_ = 6; lvt_4_2_ <= 8; ++lvt_4_2_) {
            if (this.func_175807_a(p_74875_1_, lvt_4_2_, 0, -1, p_74875_3_).func_177230_c().func_149688_o() == Material.field_151579_a && this.func_175807_a(p_74875_1_, lvt_4_2_, -1, -1, p_74875_3_).func_177230_c().func_149688_o() != Material.field_151579_a) {
               this.func_175811_a(p_74875_1_, Blocks.field_150446_ar.func_176203_a(this.func_151555_a(Blocks.field_150446_ar, 3)), lvt_4_2_, 0, -1, p_74875_3_);
            }
         }

         for(lvt_4_2_ = 0; lvt_4_2_ < 7; ++lvt_4_2_) {
            for(int lvt_5_1_ = 0; lvt_5_1_ < 10; ++lvt_5_1_) {
               this.func_74871_b(p_74875_1_, lvt_5_1_, 6, lvt_4_2_, p_74875_3_);
               this.func_175808_b(p_74875_1_, Blocks.field_150347_e.func_176223_P(), lvt_5_1_, -1, lvt_4_2_, p_74875_3_);
            }
         }
   ...
   public static class House3 extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.House3 func_175849_a(StructureVillagePieces.Start p_175849_0_, List<StructureComponent> p_175849_1_, Random p_175849_2_, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing p_175849_6_, int p_175849_7_) {
         StructureBoundingBox lvt_8_1_ = StructureBoundingBox.func_175897_a(p_175849_3_, p_175849_4_, p_175849_5_, 0, 0, 0, 9, 7, 12, p_175849_6_);
         return func_74895_a(lvt_8_1_) && StructureComponent.func_74883_a(p_175849_1_, lvt_8_1_) == null ? new StructureVillagePieces.House3(p_175849_0_, p_175849_7_, p_175849_2_, lvt_8_1_, p_175849_6_) : null;
      }
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         int lvt_5_1_ = this.func_151555_a(Blocks.field_150476_ad, 2);

         int lvt_6_2_;
         int lvt_7_3_;
         for(lvt_6_2_ = -1; lvt_6_2_ <= 2; ++lvt_6_2_) {
            for(lvt_7_3_ = 0; lvt_7_3_ <= 8; ++lvt_7_3_) {
               this.func_175811_a(p_74875_1_, Blocks.field_150476_ad.func_176203_a(lvt_4_1_), lvt_7_3_, 4 + lvt_6_2_, lvt_6_2_, p_74875_3_);
               if ((lvt_6_2_ > -1 || lvt_7_3_ <= 1) && (lvt_6_2_ > 0 || lvt_7_3_ <= 3) && (lvt_6_2_ > 1 || lvt_7_3_ <= 4 || lvt_7_3_ >= 6)) {
                  this.func_175811_a(p_74875_1_, Blocks.field_150476_ad.func_176203_a(lvt_5_1_), lvt_7_3_, 4 + lvt_6_2_, 5 - lvt_6_2_, p_74875_3_);
               }
            }
         }
         ...
         lvt_6_2_ = this.func_151555_a(Blocks.field_150476_ad, 0);

         int lvt_8_4_;
         for(lvt_7_3_ = 4; lvt_7_3_ >= 1; --lvt_7_3_) {
            this.func_175811_a(p_74875_1_, Blocks.field_150344_f.func_176223_P(), lvt_7_3_, 2 + lvt_7_3_, 7 - lvt_7_3_, p_74875_3_);

            for(lvt_8_4_ = 8 - lvt_7_3_; lvt_8_4_ <= 10; ++lvt_8_4_) {
               this.func_175811_a(p_74875_1_, Blocks.field_150476_ad.func_176203_a(lvt_6_2_), lvt_7_3_, 2 + lvt_7_3_, lvt_8_4_, p_74875_3_);
            }
         }

         lvt_7_3_ = this.func_151555_a(Blocks.field_150476_ad, 1);
         ...
         this.func_175811_a(p_74875_1_, Blocks.field_150476_ad.func_176203_a(lvt_7_3_), 6, 6, 4, p_74875_3_);

         int lvt_9_3_;
         for(lvt_8_4_ = 6; lvt_8_4_ <= 8; ++lvt_8_4_) {
            for(lvt_9_3_ = 5; lvt_9_3_ <= 10; ++lvt_9_3_) {
               this.func_175811_a(p_74875_1_, Blocks.field_150476_ad.func_176203_a(lvt_7_3_), lvt_8_4_, 12 - lvt_8_4_, lvt_9_3_, p_74875_3_);
            }
         }
         ...
         for(lvt_8_4_ = 0; lvt_8_4_ < 5; ++lvt_8_4_) {
            for(lvt_9_3_ = 0; lvt_9_3_ < 9; ++lvt_9_3_) {
               this.func_74871_b(p_74875_1_, lvt_9_3_, 7, lvt_8_4_, p_74875_3_);
               this.func_175808_b(p_74875_1_, Blocks.field_150347_e.func_176223_P(), lvt_9_3_, -1, lvt_8_4_, p_74875_3_);
            }
         }

         for(lvt_8_4_ = 5; lvt_8_4_ < 11; ++lvt_8_4_) {
            for(lvt_9_3_ = 2; lvt_9_3_ < 9; ++lvt_9_3_) {
               this.func_74871_b(p_74875_1_, lvt_9_3_, 7, lvt_8_4_, p_74875_3_);
               this.func_175808_b(p_74875_1_, Blocks.field_150347_e.func_176223_P(), lvt_9_3_, -1, lvt_8_4_, p_74875_3_);
            }
         }
   ...
   public static class Hall extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.Hall func_175857_a(StructureVillagePieces.Start p_175857_0_, List<StructureComponent> p_175857_1_, Random p_175857_2_, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing p_175857_6_, int p_175857_7_) {
         StructureBoundingBox lvt_8_1_ = StructureBoundingBox.func_175897_a(p_175857_3_, p_175857_4_, p_175857_5_, 0, 0, 0, 9, 7, 11, p_175857_6_);
         return func_74895_a(lvt_8_1_) && StructureComponent.func_74883_a(p_175857_1_, lvt_8_1_) == null ? new StructureVillagePieces.Hall(p_175857_0_, p_175857_7_, p_175857_2_, lvt_8_1_, p_175857_6_) : null;
      }
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         int lvt_7_2_;
         for(lvt_6_2_ = -1; lvt_6_2_ <= 2; ++lvt_6_2_) {
            for(lvt_7_2_ = 0; lvt_7_2_ <= 8; ++lvt_7_2_) {
               this.func_175811_a(p_74875_1_, Blocks.field_150476_ad.func_176203_a(lvt_4_1_), lvt_7_2_, 4 + lvt_6_2_, lvt_6_2_, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150476_ad.func_176203_a(lvt_5_1_), lvt_7_2_, 4 + lvt_6_2_, 5 - lvt_6_2_, p_74875_3_);
            }
         }
         ...
         for(lvt_6_2_ = 0; lvt_6_2_ < 5; ++lvt_6_2_) {
            for(lvt_7_2_ = 0; lvt_7_2_ < 9; ++lvt_7_2_) {
               this.func_74871_b(p_74875_1_, lvt_7_2_, 7, lvt_6_2_, p_74875_3_);
               this.func_175808_b(p_74875_1_, Blocks.field_150347_e.func_176223_P(), lvt_7_2_, -1, lvt_6_2_, p_74875_3_);
            }
         }
   ...
   public static class WoodHut extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.WoodHut func_175853_a(StructureVillagePieces.Start p_175853_0_, List<StructureComponent> p_175853_1_, Random p_175853_2_, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing p_175853_6_, int p_175853_7_) {
         StructureBoundingBox lvt_8_1_ = StructureBoundingBox.func_175897_a(p_175853_3_, p_175853_4_, p_175853_5_, 0, 0, 0, 4, 6, 5, p_175853_6_);
         return func_74895_a(lvt_8_1_) && StructureComponent.func_74883_a(p_175853_1_, lvt_8_1_) == null ? new StructureVillagePieces.WoodHut(p_175853_0_, p_175853_7_, p_175853_2_, lvt_8_1_, p_175853_6_) : null;
      }
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         for(int lvt_4_1_ = 0; lvt_4_1_ < 5; ++lvt_4_1_) {
            for(int lvt_5_1_ = 0; lvt_5_1_ < 4; ++lvt_5_1_) {
               this.func_74871_b(p_74875_1_, lvt_5_1_, 6, lvt_4_1_, p_74875_3_);
               this.func_175808_b(p_74875_1_, Blocks.field_150347_e.func_176223_P(), lvt_5_1_, -1, lvt_4_1_, p_74875_3_);
            }
         }
   ...
   public static class House1 extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.House1 func_175850_a(StructureVillagePieces.Start p_175850_0_, List<StructureComponent> p_175850_1_, Random p_175850_2_, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing p_175850_6_, int p_175850_7_) {
         StructureBoundingBox lvt_8_1_ = StructureBoundingBox.func_175897_a(p_175850_3_, p_175850_4_, p_175850_5_, 0, 0, 0, 9, 9, 6, p_175850_6_);
         return func_74895_a(lvt_8_1_) && StructureComponent.func_74883_a(p_175850_1_, lvt_8_1_) == null ? new StructureVillagePieces.House1(p_175850_0_, p_175850_7_, p_175850_2_, lvt_8_1_, p_175850_6_) : null;
      }
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         int lvt_6_1_;
         int lvt_7_2_;
         for(lvt_6_1_ = -1; lvt_6_1_ <= 2; ++lvt_6_1_) {
            for(lvt_7_2_ = 0; lvt_7_2_ <= 8; ++lvt_7_2_) {
               this.func_175811_a(p_74875_1_, Blocks.field_150476_ad.func_176203_a(lvt_4_1_), lvt_7_2_, 6 + lvt_6_1_, lvt_6_1_, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150476_ad.func_176203_a(lvt_5_1_), lvt_7_2_, 6 + lvt_6_1_, 5 - lvt_6_1_, p_74875_3_);
            }
         }
         ...
         lvt_6_1_ = this.func_151555_a(Blocks.field_150476_ad, 3);
         this.func_175811_a(p_74875_1_, Blocks.field_150476_ad.func_176203_a(lvt_6_1_), 6, 1, 4, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150476_ad.func_176203_a(lvt_6_1_), 5, 1, 4, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150476_ad.func_176203_a(lvt_6_1_), 4, 1, 4, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150476_ad.func_176203_a(lvt_6_1_), 3, 1, 4, p_74875_3_);
         ...
         for(lvt_7_2_ = 0; lvt_7_2_ < 6; ++lvt_7_2_) {
            for(int lvt_8_1_ = 0; lvt_8_1_ < 9; ++lvt_8_1_) {
               this.func_74871_b(p_74875_1_, lvt_8_1_, 9, lvt_7_2_, p_74875_3_);
               this.func_175808_b(p_74875_1_, Blocks.field_150347_e.func_176223_P(), lvt_8_1_, -1, lvt_7_2_, p_74875_3_);
            }
         }
   ...
   public static class Church extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.Church func_175854_a(StructureVillagePieces.Start p_175854_0_, List<StructureComponent> p_175854_1_, Random p_175854_2_, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing p_175854_6_, int p_175854_7_) {
         StructureBoundingBox lvt_8_1_ = StructureBoundingBox.func_175897_a(p_175854_3_, p_175854_4_, p_175854_5_, 0, 0, 0, 5, 12, 9, p_175854_6_);
         return func_74895_a(lvt_8_1_) && StructureComponent.func_74883_a(p_175854_1_, lvt_8_1_) == null ? new StructureVillagePieces.Church(p_175854_0_, p_175854_7_, p_175854_2_, lvt_8_1_, p_175854_6_) : null;
      }
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         int lvt_4_1_ = this.func_151555_a(Blocks.field_150468_ap, 4);

         int lvt_5_2_;
         for(lvt_5_2_ = 1; lvt_5_2_ <= 9; ++lvt_5_2_) {
            this.func_175811_a(p_74875_1_, Blocks.field_150468_ap.func_176203_a(lvt_4_1_), 3, lvt_5_2_, 3, p_74875_3_);
         }
         ...
         for(lvt_5_2_ = 0; lvt_5_2_ < 9; ++lvt_5_2_) {
            for(int lvt_6_1_ = 0; lvt_6_1_ < 5; ++lvt_6_1_) {
               this.func_74871_b(p_74875_1_, lvt_6_1_, 12, lvt_5_2_, p_74875_3_);
               this.func_175808_b(p_74875_1_, Blocks.field_150347_e.func_176223_P(), lvt_6_1_, -1, lvt_5_2_, p_74875_3_);
            }
         }
   ...
   public static class House4Garden extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.House4Garden func_175858_a(StructureVillagePieces.Start p_175858_0_, List<StructureComponent> p_175858_1_, Random p_175858_2_, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing p_175858_6_, int p_175858_7_) {
         StructureBoundingBox lvt_8_1_ = StructureBoundingBox.func_175897_a(p_175858_3_, p_175858_4_, p_175858_5_, 0, 0, 0, 5, 6, 5, p_175858_6_);
         return StructureComponent.func_74883_a(p_175858_1_, lvt_8_1_) != null ? null : new StructureVillagePieces.House4Garden(p_175858_0_, p_175858_7_, p_175858_2_, lvt_8_1_, p_175858_6_);
      }
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         int lvt_4_2_;
         if (this.field_74913_b) {
            lvt_4_2_ = this.func_151555_a(Blocks.field_150468_ap, 3);
            this.func_175811_a(p_74875_1_, Blocks.field_150468_ap.func_176203_a(lvt_4_2_), 3, 1, 3, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150468_ap.func_176203_a(lvt_4_2_), 3, 2, 3, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150468_ap.func_176203_a(lvt_4_2_), 3, 3, 3, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150468_ap.func_176203_a(lvt_4_2_), 3, 4, 3, p_74875_3_);
         }

         this.func_175811_a(p_74875_1_, Blocks.field_150478_aa.func_176223_P().func_177226_a(BlockTorch.field_176596_a, this.field_74885_f), 2, 3, 1, p_74875_3_);

         for(lvt_4_2_ = 0; lvt_4_2_ < 5; ++lvt_4_2_) {
   ...
   public static class Path extends StructureVillagePieces.Road {
      ...
      public void func_74861_a(StructureComponent p_74861_1_, List<StructureComponent> p_74861_2_, Random p_74861_3_) {
         ...
         int lvt_5_1_;
         StructureComponent lvt_6_2_;
         for(lvt_5_1_ = p_74861_3_.nextInt(5); lvt_5_1_ < this.field_74934_a - 8; lvt_5_1_ += 2 + p_74861_3_.nextInt(5)) {
            lvt_6_2_ = this.func_74891_a((StructureVillagePieces.Start)p_74861_1_, p_74861_2_, p_74861_3_, 0, lvt_5_1_);
            if (lvt_6_2_ != null) {
               lvt_5_1_ += Math.max(lvt_6_2_.field_74887_e.func_78883_b(), lvt_6_2_.field_74887_e.func_78880_d());
               lvt_4_1_ = true;
            }
         }

         for(lvt_5_1_ = p_74861_3_.nextInt(5); lvt_5_1_ < this.field_74934_a - 8; lvt_5_1_ += 2 + p_74861_3_.nextInt(5)) {
            lvt_6_2_ = this.func_74894_b((StructureVillagePieces.Start)p_74861_1_, p_74861_2_, p_74861_3_, 0, lvt_5_1_);
            if (lvt_6_2_ != null) {
               lvt_5_1_ += Math.max(lvt_6_2_.field_74887_e.func_78883_b(), lvt_6_2_.field_74887_e.func_78880_d());
               lvt_4_1_ = true;
            }
         ...
         if (lvt_4_1_ && p_74861_3_.nextInt(3) > 0 && this.field_74885_f != null) {
      ...
      public static StructureBoundingBox func_175848_a(StructureVillagePieces.Start p_175848_0_, List<StructureComponent> p_175848_1_, Random p_175848_2_, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing p_175848_6_) {
         for(int lvt_7_1_ = 7 * MathHelper.func_76136_a(p_175848_2_, 3, 5); lvt_7_1_ >= 7; lvt_7_1_ -= 7) {
            StructureBoundingBox lvt_8_1_ = StructureBoundingBox.func_175897_a(p_175848_3_, p_175848_4_, p_175848_5_, 0, 0, 0, 3, 3, lvt_7_1_, p_175848_6_);
            if (StructureComponent.func_74883_a(p_175848_1_, lvt_8_1_) == null) {
               return lvt_8_1_;
            }
         }
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         IBlockState lvt_4_1_ = this.func_175847_a(Blocks.field_150351_n.func_176223_P());
         IBlockState lvt_5_1_ = this.func_175847_a(Blocks.field_150347_e.func_176223_P());

         for(int lvt_6_1_ = this.field_74887_e.field_78897_a; lvt_6_1_ <= this.field_74887_e.field_78893_d; ++lvt_6_1_) {
            for(int lvt_7_1_ = this.field_74887_e.field_78896_c; lvt_7_1_ <= this.field_74887_e.field_78892_f; ++lvt_7_1_) {
               ...
               if (p_74875_3_.func_175898_b(lvt_8_1_)) {
                  lvt_8_1_ = p_74875_1_.func_175672_r(lvt_8_1_).func_177977_b();
                  p_74875_1_.func_180501_a(lvt_8_1_, lvt_4_1_, 2);
                  p_74875_1_.func_180501_a(lvt_8_1_.func_177977_b(), lvt_5_1_, 2);
               }
            }
         }
   ...
   public static class Start extends StructureVillagePieces.Well {
      ...
      public Start(WorldChunkManager p_i2104_1_, int p_i2104_2_, Random p_i2104_3_, int p_i2104_4_, int p_i2104_5_, List<StructureVillagePieces.PieceWeight> p_i2104_6_, int p_i2104_7_) {
         ...
         BiomeGenBase lvt_8_1_ = p_i2104_1_.func_180300_a(new BlockPos(p_i2104_4_, 0, p_i2104_5_), BiomeGenBase.field_180279_ad);
         this.field_74927_b = lvt_8_1_ == BiomeGenBase.field_76769_d || lvt_8_1_ == BiomeGenBase.field_76786_s;
         ...
         for(int lvt_4_1_ = 0; lvt_4_1_ <= 5; ++lvt_4_1_) {
            for(int lvt_5_1_ = 0; lvt_5_1_ <= 5; ++lvt_5_1_) {
               if (lvt_5_1_ == 0 || lvt_5_1_ == 5 || lvt_4_1_ == 0 || lvt_4_1_ == 5) {
                  this.func_175811_a(p_74875_1_, Blocks.field_150351_n.func_176223_P(), lvt_5_1_, 11, lvt_4_1_, p_74875_3_);
                  this.func_74871_b(p_74875_1_, lvt_5_1_, 12, lvt_4_1_, p_74875_3_);
               }
            }
         }
   ...
   abstract static class Village extends StructureComponent {
      ...
      protected int func_74889_b(World p_74889_1_, StructureBoundingBox p_74889_2_) {
         ...
         for(int lvt_6_1_ = this.field_74887_e.field_78896_c; lvt_6_1_ <= this.field_74887_e.field_78892_f; ++lvt_6_1_) {
            for(int lvt_7_1_ = this.field_74887_e.field_78897_a; lvt_7_1_ <= this.field_74887_e.field_78893_d; ++lvt_7_1_) {
               lvt_5_1_.func_181079_c(lvt_7_1_, 64, lvt_6_1_);
               if (p_74889_2_.func_175898_b(lvt_5_1_)) {
                  lvt_3_1_ += Math.max(p_74889_1_.func_175672_r(lvt_5_1_).func_177956_o(), p_74889_1_.field_73011_w.func_76557_i());
                  ++lvt_4_1_;
               }
            }
         }
      ...
      protected void func_74893_a(World p_74893_1_, StructureBoundingBox p_74893_2_, int p_74893_3_, int p_74893_4_, int p_74893_5_, int p_74893_6_) {
         if (this.field_74896_a < p_74893_6_) {
            for(int lvt_7_1_ = this.field_74896_a; lvt_7_1_ < p_74893_6_; ++lvt_7_1_) {
               int lvt_8_1_ = this.func_74865_a(p_74893_3_ + lvt_7_1_, p_74893_5_);
               int lvt_9_1_ = this.func_74862_a(p_74893_4_);
               int lvt_10_1_ = this.func_74873_b(p_74893_3_ + lvt_7_1_, p_74893_5_);
               if (!p_74893_2_.func_175898_b(new BlockPos(lvt_8_1_, lvt_9_1_, lvt_10_1_))) {
                  break;
               }

               ++this.field_74896_a;
               EntityVillager lvt_11_1_ = new EntityVillager(p_74893_1_);
               lvt_11_1_.func_70012_b((double)lvt_8_1_ + 0.5D, (double)lvt_9_1_, (double)lvt_10_1_ + 0.5D, 0.0F, 0.0F);
               lvt_11_1_.func_180482_a(p_74893_1_.func_175649_E(new BlockPos(lvt_11_1_)), (IEntityLivingData)null);
               lvt_11_1_.func_70938_b(this.func_180779_c(lvt_7_1_, lvt_11_1_.func_70946_n()));
               p_74893_1_.func_72838_d(lvt_11_1_);
            }
      ...
      protected void func_175811_a(World p_175811_1_, IBlockState p_175811_2_, int p_175811_3_, int p_175811_4_, int p_175811_5_, StructureBoundingBox p_175811_6_) {
         IBlockState lvt_7_1_ = this.func_175847_a(p_175811_2_);
         super.func_175811_a(p_175811_1_, lvt_7_1_, p_175811_3_, p_175811_4_, p_175811_5_, p_175811_6_);
      }
      ...
      protected void func_175804_a(World p_175804_1_, StructureBoundingBox p_175804_2_, int p_175804_3_, int p_175804_4_, int p_175804_5_, int p_175804_6_, int p_175804_7_, int p_175804_8_, IBlockState p_175804_9_, IBlockState p_175804_10_, boolean p_175804_11_) {
         IBlockState lvt_12_1_ = this.func_175847_a(p_175804_9_);
         IBlockState lvt_13_1_ = this.func_175847_a(p_175804_10_);
         super.func_175804_a(p_175804_1_, p_175804_2_, p_175804_3_, p_175804_4_, p_175804_5_, p_175804_6_, p_175804_7_, p_175804_8_, lvt_12_1_, lvt_13_1_, p_175804_11_);
      }
      ...
      protected void func_175808_b(World p_175808_1_, IBlockState p_175808_2_, int p_175808_3_, int p_175808_4_, int p_175808_5_, StructureBoundingBox p_175808_6_) {
         IBlockState lvt_7_1_ = this.func_175847_a(p_175808_2_);
         super.func_175808_b(p_175808_1_, lvt_7_1_, p_175808_3_, p_175808_4_, p_175808_5_, p_175808_6_);
      }
