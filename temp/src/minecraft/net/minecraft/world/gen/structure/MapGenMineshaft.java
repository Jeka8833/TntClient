...
public class MapGenMineshaft extends MapGenStructure {
   ...
   public MapGenMineshaft(Map<String, String> p_i2034_1_) {
      Iterator lvt_2_1_ = p_i2034_1_.entrySet().iterator();

      while(lvt_2_1_.hasNext()) {
         Entry<String, String> lvt_3_1_ = (Entry)lvt_2_1_.next();
         if (((String)lvt_3_1_.getKey()).equals("chance")) {
            this.field_82673_e = MathHelper.func_82712_a((String)lvt_3_1_.getValue(), this.field_82673_e);
         }
      }
