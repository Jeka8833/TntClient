...
public class ComponentScatteredFeaturePieces {
   ...
   public static class SwampHut extends ComponentScatteredFeaturePieces.Feature {
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         if (!this.func_74935_a(p_74875_1_, p_74875_3_, 0)) {
            ...
            int lvt_8_2_;
            int lvt_9_2_;
            for(lvt_8_2_ = 2; lvt_8_2_ <= 7; lvt_8_2_ += 5) {
               for(lvt_9_2_ = 1; lvt_9_2_ <= 5; lvt_9_2_ += 4) {
                  this.func_175808_b(p_74875_1_, Blocks.field_150364_r.func_176223_P(), lvt_9_2_, -1, lvt_8_2_, p_74875_3_);
               }
            }

            if (!this.field_82682_h) {
               lvt_8_2_ = this.func_74865_a(2, 5);
               lvt_9_2_ = this.func_74862_a(2);
   ...
   public static class JunglePyramid extends ComponentScatteredFeaturePieces.Feature {
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         if (!this.func_74935_a(p_74875_1_, p_74875_3_, 0)) {
            ...
            int lvt_8_5_;
            for(lvt_8_5_ = 0; lvt_8_5_ <= 14; lvt_8_5_ += 14) {
               this.func_74882_a(p_74875_1_, p_74875_3_, 2, 4, lvt_8_5_, 2, 5, lvt_8_5_, false, p_74875_2_, field_74942_n);
               this.func_74882_a(p_74875_1_, p_74875_3_, 4, 4, lvt_8_5_, 4, 5, lvt_8_5_, false, p_74875_2_, field_74942_n);
               this.func_74882_a(p_74875_1_, p_74875_3_, 7, 4, lvt_8_5_, 7, 5, lvt_8_5_, false, p_74875_2_, field_74942_n);
               this.func_74882_a(p_74875_1_, p_74875_3_, 9, 4, lvt_8_5_, 9, 5, lvt_8_5_, false, p_74875_2_, field_74942_n);
            }

            this.func_74882_a(p_74875_1_, p_74875_3_, 5, 6, 0, 6, 6, 0, false, p_74875_2_, field_74942_n);

            for(lvt_8_5_ = 0; lvt_8_5_ <= 11; lvt_8_5_ += 11) {
               for(int lvt_9_1_ = 2; lvt_9_1_ <= 12; lvt_9_1_ += 2) {
                  this.func_74882_a(p_74875_1_, p_74875_3_, lvt_8_5_, 4, lvt_9_1_, lvt_8_5_, 5, lvt_9_1_, false, p_74875_2_, field_74942_n);
               }

               this.func_74882_a(p_74875_1_, p_74875_3_, lvt_8_5_, 6, 5, lvt_8_5_, 6, 5, false, p_74875_2_, field_74942_n);
               this.func_74882_a(p_74875_1_, p_74875_3_, lvt_8_5_, 6, 9, lvt_8_5_, 6, 9, false, p_74875_2_, field_74942_n);
            }
            ...
            for(lvt_8_5_ = 0; lvt_8_5_ < 4; ++lvt_8_5_) {
               this.func_175811_a(p_74875_1_, Blocks.field_150446_ar.func_176203_a(lvt_5_1_), 5, 0 - lvt_8_5_, 6 + lvt_8_5_, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150446_ar.func_176203_a(lvt_5_1_), 6, 0 - lvt_8_5_, 6 + lvt_8_5_, p_74875_3_);
               this.func_74878_a(p_74875_1_, p_74875_3_, 5, 0 - lvt_8_5_, 7 + lvt_8_5_, 6, 0 - lvt_8_5_, 9 + lvt_8_5_);
            }
            ...
            for(lvt_8_5_ = 1; lvt_8_5_ <= 13; lvt_8_5_ += 2) {
               this.func_74882_a(p_74875_1_, p_74875_3_, 1, -3, lvt_8_5_, 1, -2, lvt_8_5_, false, p_74875_2_, field_74942_n);
            }

            for(lvt_8_5_ = 2; lvt_8_5_ <= 12; lvt_8_5_ += 2) {
            ...
            this.func_175811_a(p_74875_1_, Blocks.field_150479_bC.func_176203_a(this.func_151555_a(Blocks.field_150479_bC, EnumFacing.EAST.func_176736_b())).func_177226_a(BlockTripWireHook.field_176265_M, true), 1, -3, 8, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150479_bC.func_176203_a(this.func_151555_a(Blocks.field_150479_bC, EnumFacing.WEST.func_176736_b())).func_177226_a(BlockTripWireHook.field_176265_M, true), 4, -3, 8, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150473_bD.func_176223_P().func_177226_a(BlockTripWire.field_176294_M, true), 2, -3, 8, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150473_bD.func_176223_P().func_177226_a(BlockTripWire.field_176294_M, true), 3, -3, 8, p_74875_3_);
            ...
            this.func_175811_a(p_74875_1_, Blocks.field_150479_bC.func_176203_a(this.func_151555_a(Blocks.field_150479_bC, EnumFacing.NORTH.func_176736_b())).func_177226_a(BlockTripWireHook.field_176265_M, true), 7, -3, 1, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150479_bC.func_176203_a(this.func_151555_a(Blocks.field_150479_bC, EnumFacing.SOUTH.func_176736_b())).func_177226_a(BlockTripWireHook.field_176265_M, true), 7, -3, 5, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150473_bD.func_176223_P().func_177226_a(BlockTripWire.field_176294_M, true), 7, -3, 2, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150473_bD.func_176223_P().func_177226_a(BlockTripWire.field_176294_M, true), 7, -3, 3, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150473_bD.func_176223_P().func_177226_a(BlockTripWire.field_176294_M, true), 7, -3, 4, p_74875_3_);
      ...
      static {
         ...
         field_175815_j = Lists.newArrayList((Object[])(new WeightedRandomChestContent(Items.field_151032_g, 0, 2, 7, 30)));
   ...
   public static class DesertPyramid extends ComponentScatteredFeaturePieces.Feature {
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         int lvt_4_2_;
         for(lvt_4_2_ = 1; lvt_4_2_ <= 9; ++lvt_4_2_) {
            this.func_175804_a(p_74875_1_, p_74875_3_, lvt_4_2_, lvt_4_2_, lvt_4_2_, this.field_74939_a - 1 - lvt_4_2_, lvt_4_2_, this.field_74938_c - 1 - lvt_4_2_, Blocks.field_150322_A.func_176223_P(), Blocks.field_150322_A.func_176223_P(), false);
            this.func_175804_a(p_74875_1_, p_74875_3_, lvt_4_2_ + 1, lvt_4_2_, lvt_4_2_ + 1, this.field_74939_a - 2 - lvt_4_2_, lvt_4_2_, this.field_74938_c - 2 - lvt_4_2_, Blocks.field_150350_a.func_176223_P(), Blocks.field_150350_a.func_176223_P(), false);
         }

         int lvt_5_1_;
         for(lvt_4_2_ = 0; lvt_4_2_ < this.field_74939_a; ++lvt_4_2_) {
            for(lvt_5_1_ = 0; lvt_5_1_ < this.field_74938_c; ++lvt_5_1_) {
               int lvt_6_1_ = -5;
               this.func_175808_b(p_74875_1_, Blocks.field_150322_A.func_176223_P(), lvt_4_2_, lvt_6_1_, lvt_5_1_, p_74875_3_);
            }
         }

         lvt_4_2_ = this.func_151555_a(Blocks.field_150372_bz, 3);
         lvt_5_1_ = this.func_151555_a(Blocks.field_150372_bz, 2);
         ...
         this.func_175811_a(p_74875_1_, Blocks.field_150372_bz.func_176203_a(lvt_4_2_), 2, 10, 0, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150372_bz.func_176203_a(lvt_5_1_), 2, 10, 4, p_74875_3_);
         ...
         this.func_175811_a(p_74875_1_, Blocks.field_150372_bz.func_176203_a(lvt_4_2_), this.field_74939_a - 3, 10, 0, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150372_bz.func_176203_a(lvt_5_1_), this.field_74939_a - 3, 10, 4, p_74875_3_);
         ...
         this.func_175811_a(p_74875_1_, Blocks.field_150372_bz.func_176203_a(lvt_4_2_), 2, 4, 5, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150372_bz.func_176203_a(lvt_4_2_), 2, 3, 4, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150372_bz.func_176203_a(lvt_4_2_), this.field_74939_a - 3, 4, 5, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150372_bz.func_176203_a(lvt_4_2_), this.field_74939_a - 3, 3, 4, p_74875_3_);
         ...
         for(lvt_10_3_ = 5; lvt_10_3_ <= 17; lvt_10_3_ += 2) {
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.SMOOTH.func_176675_a()), 4, 1, lvt_10_3_, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.CHISELED.func_176675_a()), 4, 2, lvt_10_3_, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.SMOOTH.func_176675_a()), this.field_74939_a - 5, 1, lvt_10_3_, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.CHISELED.func_176675_a()), this.field_74939_a - 5, 2, lvt_10_3_, p_74875_3_);
         }
         ...
         for(lvt_10_3_ = 0; lvt_10_3_ <= this.field_74939_a - 1; lvt_10_3_ += this.field_74939_a - 1) {
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.SMOOTH.func_176675_a()), lvt_10_3_, 2, 1, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150406_ce.func_176203_a(lvt_8_1_), lvt_10_3_, 2, 2, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.SMOOTH.func_176675_a()), lvt_10_3_, 2, 3, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.SMOOTH.func_176675_a()), lvt_10_3_, 3, 1, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150406_ce.func_176203_a(lvt_8_1_), lvt_10_3_, 3, 2, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.SMOOTH.func_176675_a()), lvt_10_3_, 3, 3, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150406_ce.func_176203_a(lvt_8_1_), lvt_10_3_, 4, 1, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.CHISELED.func_176675_a()), lvt_10_3_, 4, 2, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150406_ce.func_176203_a(lvt_8_1_), lvt_10_3_, 4, 3, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.SMOOTH.func_176675_a()), lvt_10_3_, 5, 1, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150406_ce.func_176203_a(lvt_8_1_), lvt_10_3_, 5, 2, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.SMOOTH.func_176675_a()), lvt_10_3_, 5, 3, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150406_ce.func_176203_a(lvt_8_1_), lvt_10_3_, 6, 1, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.CHISELED.func_176675_a()), lvt_10_3_, 6, 2, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150406_ce.func_176203_a(lvt_8_1_), lvt_10_3_, 6, 3, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150406_ce.func_176203_a(lvt_8_1_), lvt_10_3_, 7, 1, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150406_ce.func_176203_a(lvt_8_1_), lvt_10_3_, 7, 2, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150406_ce.func_176203_a(lvt_8_1_), lvt_10_3_, 7, 3, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.SMOOTH.func_176675_a()), lvt_10_3_, 8, 1, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.SMOOTH.func_176675_a()), lvt_10_3_, 8, 2, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150322_A.func_176203_a(BlockSandStone.EnumType.SMOOTH.func_176675_a()), lvt_10_3_, 8, 3, p_74875_3_);
         }

         for(lvt_10_3_ = 2; lvt_10_3_ <= this.field_74939_a - 3; lvt_10_3_ += this.field_74939_a - 3 - 2) {
         ...
         Iterator lvt_10_4_ = EnumFacing.Plane.HORIZONTAL.iterator();

         while(lvt_10_4_.hasNext()) {
            EnumFacing lvt_11_1_ = (EnumFacing)lvt_10_4_.next();
            if (!this.field_74940_h[lvt_11_1_.func_176736_b()]) {
               ...
               this.field_74940_h[lvt_11_1_.func_176736_b()] = this.func_180778_a(p_74875_1_, p_74875_3_, p_74875_2_, 10 + lvt_12_1_, -11, 10 + lvt_13_1_, WeightedRandomChestContent.func_177629_a(field_74941_i, Items.field_151134_bR.func_92114_b(p_74875_2_)), 2 + p_74875_2_.nextInt(5));
            }
         }
      ...
      static {
         field_74941_i = Lists.newArrayList((Object[])(new WeightedRandomChestContent(Items.field_151045_i, 0, 1, 3, 3), new WeightedRandomChestContent(Items.field_151042_j, 0, 1, 5, 10), new WeightedRandomChestContent(Items.field_151043_k, 0, 2, 7, 15), new WeightedRandomChestContent(Items.field_151166_bC, 0, 1, 3, 2), new WeightedRandomChestContent(Items.field_151103_aS, 0, 4, 6, 20), new WeightedRandomChestContent(Items.field_151078_bh, 0, 3, 7, 16), new WeightedRandomChestContent(Items.field_151141_av, 0, 1, 1, 3), new WeightedRandomChestContent(Items.field_151138_bX, 0, 1, 1, 1), new WeightedRandomChestContent(Items.field_151136_bY, 0, 1, 1, 1), new WeightedRandomChestContent(Items.field_151125_bZ, 0, 1, 1, 1)));
      }
   }
