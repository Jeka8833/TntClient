   ...
   public static synchronized int[] func_76445_a(int p_76445_0_) {
      ...
      if (p_76445_0_ <= 256) {
         if (field_76449_b.isEmpty()) {
            lvt_1_5_ = new int[256];
            field_76450_c.add(lvt_1_5_);
            return lvt_1_5_;
         } else {
            lvt_1_5_ = (int[])field_76449_b.remove(field_76449_b.size() - 1);
            field_76450_c.add(lvt_1_5_);
            return lvt_1_5_;
         }
         ...
         field_76447_d.clear();
         field_76448_e.clear();
         lvt_1_5_ = new int[field_76451_a];
         ...
         lvt_1_5_ = (int[])field_76447_d.remove(field_76447_d.size() - 1);
         field_76448_e.add(lvt_1_5_);
         return lvt_1_5_;
      }
   }
