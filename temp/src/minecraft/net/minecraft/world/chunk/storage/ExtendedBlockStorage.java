...
public class ExtendedBlockStorage {
   ...
   public void func_177484_a(int p_177484_1_, int p_177484_2_, int p_177484_3_, IBlockState p_177484_4_) {
      if (Reflector.IExtendedBlockState.isInstance(p_177484_4_)) {
         p_177484_4_ = (IBlockState)Reflector.call(p_177484_4_, Reflector.IExtendedBlockState_getClean);
      }
   ...
   public void func_76672_e() {
      IBlockState STATE_AIR = Blocks.field_150350_a.func_176223_P();
      ...
      for(int y = 0; y < 16; ++y) {
         for(int z = 0; z < 16; ++z) {
            for(int x = 0; x < 16; ++x) {
               Block block = this.func_150819_a(x, y, z);
               if (block != Blocks.field_150350_a) {
                  ++localBlockRefCount;
                  if (block.func_149653_t()) {
                     ++localTickRefCount;
