...
public class NibbleArray {
   ...
   public int func_177480_a(int p_177480_1_) {
      int lvt_2_1_ = this.func_177478_c(p_177480_1_);
      return this.func_177479_b(p_177480_1_) ? this.field_76585_a[lvt_2_1_] & 15 : this.field_76585_a[lvt_2_1_] >> 4 & 15;
   }

   public void func_177482_a(int p_177482_1_, int p_177482_2_) {
      int lvt_3_1_ = this.func_177478_c(p_177482_1_);
      if (this.func_177479_b(p_177482_1_)) {
         this.field_76585_a[lvt_3_1_] = (byte)(this.field_76585_a[lvt_3_1_] & 240 | p_177482_2_ & 15);
      } else {
         this.field_76585_a[lvt_3_1_] = (byte)(this.field_76585_a[lvt_3_1_] & 15 | (p_177482_2_ & 15) << 4);
      }
