...
public class ChunkPrimer {
   ...
   public IBlockState func_177856_a(int p_177856_1_, int p_177856_2_, int p_177856_3_) {
      int lvt_4_1_ = p_177856_1_ << 12 | p_177856_3_ << 8 | p_177856_2_;
      return this.func_177858_a(lvt_4_1_);
   }

   public IBlockState func_177858_a(int p_177858_1_) {
      if (p_177858_1_ >= 0 && p_177858_1_ < this.field_177860_a.length) {
         IBlockState lvt_2_1_ = (IBlockState)Block.field_176229_d.func_148745_a(this.field_177860_a[p_177858_1_]);
         return lvt_2_1_ != null ? lvt_2_1_ : this.field_177859_b;
      } else {
   ...
   public void func_177855_a(int p_177855_1_, int p_177855_2_, int p_177855_3_, IBlockState p_177855_4_) {
      int lvt_5_1_ = p_177855_1_ << 12 | p_177855_3_ << 8 | p_177855_2_;
      this.func_177857_a(lvt_5_1_, p_177855_4_);
   }
