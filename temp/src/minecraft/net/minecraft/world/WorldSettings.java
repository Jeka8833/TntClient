...
public final class WorldSettings {
   ...
   public static enum GameType {
      ...
      public static WorldSettings.GameType func_77146_a(int p_77146_0_) {
         WorldSettings.GameType[] lvt_1_1_ = values();
         int lvt_2_1_ = lvt_1_1_.length;

         for(int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_) {
            WorldSettings.GameType lvt_4_1_ = lvt_1_1_[lvt_3_1_];
            if (lvt_4_1_.field_77154_e == p_77146_0_) {
               return lvt_4_1_;
            }
         }
      ...
      public static WorldSettings.GameType func_77142_a(String p_77142_0_) {
         ...
         for(int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_) {
            WorldSettings.GameType lvt_4_1_ = lvt_1_1_[lvt_3_1_];
            if (lvt_4_1_.field_77151_f.equals(p_77142_0_)) {
               return lvt_4_1_;
            }
         }
