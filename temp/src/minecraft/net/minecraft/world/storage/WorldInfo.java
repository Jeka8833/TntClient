...
public class WorldInfo {
   ...
   public WorldInfo(NBTTagCompound p_i2157_1_) {
      ...
      if (p_i2157_1_.func_150297_b("generatorName", 8)) {
         String lvt_2_1_ = p_i2157_1_.func_74779_i("generatorName");
         this.field_76098_b = WorldType.func_77130_a(lvt_2_1_);
         if (this.field_76098_b == null) {
            this.field_76098_b = WorldType.field_77137_b;
         } else if (this.field_76098_b.func_77125_e()) {
            int lvt_3_1_ = 0;
            if (p_i2157_1_.func_150297_b("generatorVersion", 99)) {
               lvt_3_1_ = p_i2157_1_.func_74762_e("generatorVersion");
            }

            this.field_76098_b = this.field_76098_b.func_77132_a(lvt_3_1_);
         }
   ...
   public void func_85118_a(CrashReportCategory p_85118_1_) {
      ...
      p_85118_1_.func_71500_a("Level storage version", new Callable<String>() {
         public String call() throws Exception {
            ...
            return String.format("0x%05X - %s", WorldInfo.this.field_76103_l, lvt_1_1_);
         }
      });
