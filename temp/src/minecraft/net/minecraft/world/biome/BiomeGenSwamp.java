...
public class BiomeGenSwamp extends BiomeGenBase {
   ...
   public int func_180627_b(BlockPos p_180627_1_) {
      double lvt_2_1_ = field_180281_af.func_151601_a((double)p_180627_1_.func_177958_n() * 0.0225D, (double)p_180627_1_.func_177952_p() * 0.0225D);
   ...
   public void func_180622_a(World p_180622_1_, Random p_180622_2_, ChunkPrimer p_180622_3_, int p_180622_4_, int p_180622_5_, double p_180622_6_) {
      double lvt_8_1_ = field_180281_af.func_151601_a((double)p_180622_4_ * 0.25D, (double)p_180622_5_ * 0.25D);
      if (lvt_8_1_ > 0.0D) {
         int lvt_10_1_ = p_180622_4_ & 15;
         int lvt_11_1_ = p_180622_5_ & 15;

         for(int lvt_12_1_ = 255; lvt_12_1_ >= 0; --lvt_12_1_) {
            if (p_180622_3_.func_177856_a(lvt_11_1_, lvt_12_1_, lvt_10_1_).func_177230_c().func_149688_o() != Material.field_151579_a) {
               if (lvt_12_1_ == 62 && p_180622_3_.func_177856_a(lvt_11_1_, lvt_12_1_, lvt_10_1_).func_177230_c() != Blocks.field_150355_j) {
                  p_180622_3_.func_177855_a(lvt_11_1_, lvt_12_1_, lvt_10_1_, Blocks.field_150355_j.func_176223_P());
                  if (lvt_8_1_ < 0.12D) {
                     p_180622_3_.func_177855_a(lvt_11_1_, lvt_12_1_ + 1, lvt_10_1_, Blocks.field_150392_bi.func_176223_P());
                  }
               }
               break;
            }
