...
public abstract class BiomeGenBase {
   ...
   public final float func_180626_a(BlockPos p_180626_1_) {
      if (p_180626_1_.func_177956_o() > 64) {
         float lvt_2_1_ = (float)(field_150605_ac.func_151601_a((double)p_180626_1_.func_177958_n() * 1.0D / 8.0D, (double)p_180626_1_.func_177952_p() * 1.0D / 8.0D) * 4.0D);
         return this.field_76750_F - (lvt_2_1_ + (float)p_180626_1_.func_177956_o() - 64.0F) * 0.05F / 30.0F;
      } else {
   ...
   public int func_180627_b(BlockPos p_180627_1_) {
      double lvt_2_1_ = (double)MathHelper.func_76131_a(this.func_180626_a(p_180627_1_), 0.0F, 1.0F);
      double lvt_4_1_ = (double)MathHelper.func_76131_a(this.func_76727_i(), 0.0F, 1.0F);
      return ColorizerGrass.func_77480_a(lvt_2_1_, lvt_4_1_);
   }

   public int func_180625_c(BlockPos p_180625_1_) {
      double lvt_2_1_ = (double)MathHelper.func_76131_a(this.func_180626_a(p_180625_1_), 0.0F, 1.0F);
      double lvt_4_1_ = (double)MathHelper.func_76131_a(this.func_76727_i(), 0.0F, 1.0F);
      return ColorizerFoliage.func_77470_a(lvt_2_1_, lvt_4_1_);
   }
   ...
   public final void func_180628_b(World p_180628_1_, Random p_180628_2_, ChunkPrimer p_180628_3_, int p_180628_4_, int p_180628_5_, double p_180628_6_) {
      int lvt_8_1_ = p_180628_1_.func_181545_F();
      IBlockState lvt_9_1_ = this.field_76752_A;
      IBlockState lvt_10_1_ = this.field_76753_B;
      int lvt_11_1_ = -1;
      int lvt_12_1_ = (int)(p_180628_6_ / 3.0D + 3.0D + p_180628_2_.nextDouble() * 0.25D);
      int lvt_13_1_ = p_180628_4_ & 15;
      int lvt_14_1_ = p_180628_5_ & 15;
      BlockPos.MutableBlockPos lvt_15_1_ = new BlockPos.MutableBlockPos();

      for(int lvt_16_1_ = 255; lvt_16_1_ >= 0; --lvt_16_1_) {
         if (lvt_16_1_ <= p_180628_2_.nextInt(5)) {
            p_180628_3_.func_177855_a(lvt_14_1_, lvt_16_1_, lvt_13_1_, Blocks.field_150357_h.func_176223_P());
         } else {
            IBlockState lvt_17_1_ = p_180628_3_.func_177856_a(lvt_14_1_, lvt_16_1_, lvt_13_1_);
            if (lvt_17_1_.func_177230_c().func_149688_o() == Material.field_151579_a) {
               lvt_11_1_ = -1;
            } else if (lvt_17_1_.func_177230_c() == Blocks.field_150348_b) {
               if (lvt_11_1_ == -1) {
                  if (lvt_12_1_ <= 0) {
                     lvt_9_1_ = null;
                     lvt_10_1_ = Blocks.field_150348_b.func_176223_P();
                  } else if (lvt_16_1_ >= lvt_8_1_ - 4 && lvt_16_1_ <= lvt_8_1_ + 1) {
                     lvt_9_1_ = this.field_76752_A;
                     lvt_10_1_ = this.field_76753_B;
                  }

                  if (lvt_16_1_ < lvt_8_1_ && (lvt_9_1_ == null || lvt_9_1_.func_177230_c().func_149688_o() == Material.field_151579_a)) {
                     if (this.func_180626_a(lvt_15_1_.func_181079_c(p_180628_4_, lvt_16_1_, p_180628_5_)) < 0.15F) {
                        lvt_9_1_ = Blocks.field_150432_aD.func_176223_P();
                     } else {
                        lvt_9_1_ = Blocks.field_150355_j.func_176223_P();
                     }
                  }

                  lvt_11_1_ = lvt_12_1_;
                  if (lvt_16_1_ >= lvt_8_1_ - 1) {
                     p_180628_3_.func_177855_a(lvt_14_1_, lvt_16_1_, lvt_13_1_, lvt_9_1_);
                  } else if (lvt_16_1_ < lvt_8_1_ - 7 - lvt_12_1_) {
                     lvt_9_1_ = null;
                     lvt_10_1_ = Blocks.field_150348_b.func_176223_P();
                     p_180628_3_.func_177855_a(lvt_14_1_, lvt_16_1_, lvt_13_1_, Blocks.field_150351_n.func_176223_P());
                  } else {
                     p_180628_3_.func_177855_a(lvt_14_1_, lvt_16_1_, lvt_13_1_, lvt_10_1_);
                  }
               } else if (lvt_11_1_ > 0) {
                  --lvt_11_1_;
                  p_180628_3_.func_177855_a(lvt_14_1_, lvt_16_1_, lvt_13_1_, lvt_10_1_);
                  if (lvt_11_1_ == 0 && lvt_10_1_.func_177230_c() == Blocks.field_150354_m) {
                     lvt_11_1_ = p_180628_2_.nextInt(4) + Math.max(0, lvt_16_1_ - 63);
                     lvt_10_1_ = lvt_10_1_.func_177229_b(BlockSand.field_176504_a) == BlockSand.EnumType.RED_SAND ? Blocks.field_180395_cM.func_176223_P() : Blocks.field_150322_A.func_176223_P();
                  }
               }
            }
         }
   ...
   public static BiomeGenBase func_180276_a(int p_180276_0_, BiomeGenBase p_180276_1_) {
      if (p_180276_0_ >= 0 && p_180276_0_ <= field_76773_a.length) {
         BiomeGenBase lvt_2_1_ = field_76773_a[p_180276_0_];
         return lvt_2_1_ == null ? p_180276_1_ : lvt_2_1_;
      } else {
   ...
   static {
      ...
      BiomeGenBase[] lvt_0_1_ = field_76773_a;
      int lvt_1_1_ = lvt_0_1_.length;

      for(int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_; ++lvt_2_1_) {
         BiomeGenBase lvt_3_1_ = lvt_0_1_[lvt_2_1_];
         if (lvt_3_1_ != null) {
            if (field_180278_o.containsKey(lvt_3_1_.field_76791_y)) {
               throw new Error("Biome \"" + lvt_3_1_.field_76791_y + "\" is defined as both ID " + ((BiomeGenBase)field_180278_o.get(lvt_3_1_.field_76791_y)).field_76756_M + " and " + lvt_3_1_.field_76756_M);
            }

            field_180278_o.put(lvt_3_1_.field_76791_y, lvt_3_1_);
            if (lvt_3_1_.field_76756_M < 128) {
               field_150597_n.add(lvt_3_1_);
            }
         }
      }
