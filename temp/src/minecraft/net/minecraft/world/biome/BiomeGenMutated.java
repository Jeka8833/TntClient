...
public class BiomeGenMutated extends BiomeGenBase {
   ...
   public BiomeGenMutated(int p_i45381_1_, BiomeGenBase p_i45381_2_) {
      ...
      this.field_76762_K = Lists.newArrayList((Iterable)p_i45381_2_.field_76762_K);
      this.field_76761_J = Lists.newArrayList((Iterable)p_i45381_2_.field_76761_J);
      this.field_82914_M = Lists.newArrayList((Iterable)p_i45381_2_.field_82914_M);
      this.field_76755_L = Lists.newArrayList((Iterable)p_i45381_2_.field_76755_L);
      this.field_76750_F = p_i45381_2_.field_76750_F;
      this.field_76751_G = p_i45381_2_.field_76751_G;
