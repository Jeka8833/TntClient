...
public class ItemBlock extends Item {
   ...
   public boolean func_180614_a(ItemStack p_180614_1_, EntityPlayer p_180614_2_, World p_180614_3_, BlockPos p_180614_4_, EnumFacing p_180614_5_, float p_180614_6_, float p_180614_7_, float p_180614_8_) {
      ...
      if (p_180614_1_.field_77994_a == 0) {
         ...
         int lvt_11_1_ = this.func_77647_b(p_180614_1_.func_77960_j());
         IBlockState lvt_12_1_ = this.field_150939_a.func_180642_a(p_180614_3_, p_180614_4_, p_180614_5_, p_180614_6_, p_180614_7_, p_180614_8_, lvt_11_1_, p_180614_2_);
         if (p_180614_3_.func_180501_a(p_180614_4_, lvt_12_1_, 3)) {
            lvt_12_1_ = p_180614_3_.func_180495_p(p_180614_4_);
            if (lvt_12_1_.func_177230_c() == this.field_150939_a) {
               func_179224_a(p_180614_3_, p_180614_2_, p_180614_4_, p_180614_1_);
               this.field_150939_a.func_180633_a(p_180614_3_, p_180614_4_, lvt_12_1_, p_180614_2_, p_180614_1_);
            }
   ...
   public static boolean func_179224_a(World p_179224_0_, EntityPlayer p_179224_1_, BlockPos p_179224_2_, ItemStack p_179224_3_) {
      ...
      if (lvt_4_1_ == null) {
         ...
         if (p_179224_3_.func_77942_o() && p_179224_3_.func_77978_p().func_150297_b("BlockEntityTag", 10)) {
            TileEntity lvt_5_1_ = p_179224_0_.func_175625_s(p_179224_2_);
            if (lvt_5_1_ != null) {
               if (!p_179224_0_.field_72995_K && lvt_5_1_.func_183000_F() && !lvt_4_1_.func_71203_ab().func_152596_g(p_179224_1_.func_146103_bH())) {
                  return false;
               }
               ...
               NBTTagCompound lvt_8_1_ = (NBTTagCompound)p_179224_3_.func_77978_p().func_74781_a("BlockEntityTag");
               lvt_6_1_.func_179237_a(lvt_8_1_);
               lvt_6_1_.func_74768_a("x", p_179224_2_.func_177958_n());
               lvt_6_1_.func_74768_a("y", p_179224_2_.func_177956_o());
               lvt_6_1_.func_74768_a("z", p_179224_2_.func_177952_p());
   ...
   public boolean func_179222_a(World p_179222_1_, BlockPos p_179222_2_, EnumFacing p_179222_3_, EntityPlayer p_179222_4_, ItemStack p_179222_5_) {
      Block lvt_6_1_ = p_179222_1_.func_180495_p(p_179222_2_).func_177230_c();
      if (lvt_6_1_ == Blocks.field_150431_aC) {
         p_179222_3_ = EnumFacing.UP;
      } else if (!lvt_6_1_.func_176200_f(p_179222_1_, p_179222_2_)) {
