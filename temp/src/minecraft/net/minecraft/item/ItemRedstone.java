...
public class ItemRedstone extends Item {
   ...
   public boolean func_180614_a(ItemStack p_180614_1_, EntityPlayer p_180614_2_, World p_180614_3_, BlockPos p_180614_4_, EnumFacing p_180614_5_, float p_180614_6_, float p_180614_7_, float p_180614_8_) {
      ...
      if (!p_180614_2_.func_175151_a(lvt_10_1_, p_180614_5_, p_180614_1_)) {
         ...
         Block lvt_11_1_ = p_180614_3_.func_180495_p(lvt_10_1_).func_177230_c();
         if (!p_180614_3_.func_175716_a(lvt_11_1_, lvt_10_1_, false, p_180614_5_, (Entity)null, p_180614_1_)) {
            return false;
         } else if (Blocks.field_150488_af.func_176196_c(p_180614_3_, lvt_10_1_)) {
            --p_180614_1_.field_77994_a;
            p_180614_3_.func_175656_a(lvt_10_1_, Blocks.field_150488_af.func_176223_P());
            return true;
         } else {
            return false;
         }
