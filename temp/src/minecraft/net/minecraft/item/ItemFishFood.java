...
public class ItemFishFood extends ItemFood {
   ...
   public int func_150905_g(ItemStack p_150905_1_) {
      ItemFishFood.FishType lvt_2_1_ = ItemFishFood.FishType.func_150978_a(p_150905_1_);
      return this.field_150907_b && lvt_2_1_.func_150973_i() ? lvt_2_1_.func_150970_e() : lvt_2_1_.func_150975_c();
   }

   public float func_150906_h(ItemStack p_150906_1_) {
      ItemFishFood.FishType lvt_2_1_ = ItemFishFood.FishType.func_150978_a(p_150906_1_);
      return this.field_150907_b && lvt_2_1_.func_150973_i() ? lvt_2_1_.func_150977_f() : lvt_2_1_.func_150967_d();
   }
   ...
   protected void func_77849_c(ItemStack p_77849_1_, World p_77849_2_, EntityPlayer p_77849_3_) {
      ItemFishFood.FishType lvt_4_1_ = ItemFishFood.FishType.func_150978_a(p_77849_1_);
      if (lvt_4_1_ == ItemFishFood.FishType.PUFFERFISH) {
   ...
   public void func_150895_a(Item p_150895_1_, CreativeTabs p_150895_2_, List<ItemStack> p_150895_3_) {
      ItemFishFood.FishType[] lvt_4_1_ = ItemFishFood.FishType.values();
      int lvt_5_1_ = lvt_4_1_.length;

      for(int lvt_6_1_ = 0; lvt_6_1_ < lvt_5_1_; ++lvt_6_1_) {
         ItemFishFood.FishType lvt_7_1_ = lvt_4_1_[lvt_6_1_];
         if (!this.field_150907_b || lvt_7_1_.func_150973_i()) {
            p_150895_3_.add(new ItemStack(this, 1, lvt_7_1_.func_150976_a()));
         }
      }
   ...
   public String func_77667_c(ItemStack p_77667_1_) {
      ItemFishFood.FishType lvt_2_1_ = ItemFishFood.FishType.func_150978_a(p_77667_1_);
      return this.func_77658_a() + "." + lvt_2_1_.func_150972_b() + "." + (this.field_150907_b && lvt_2_1_.func_150973_i() ? "cooked" : "raw");
   }
   ...
   public static enum FishType {
      ...
      public static ItemFishFood.FishType func_150974_a(int p_150974_0_) {
         ItemFishFood.FishType lvt_1_1_ = (ItemFishFood.FishType)field_150983_e.get(p_150974_0_);
         return lvt_1_1_ == null ? COD : lvt_1_1_;
      }
      ...
      static {
         ItemFishFood.FishType[] lvt_0_1_ = values();
         int lvt_1_1_ = lvt_0_1_.length;

         for(int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_; ++lvt_2_1_) {
            ItemFishFood.FishType lvt_3_1_ = lvt_0_1_[lvt_2_1_];
            field_150983_e.put(lvt_3_1_.func_150976_a(), lvt_3_1_);
         }
