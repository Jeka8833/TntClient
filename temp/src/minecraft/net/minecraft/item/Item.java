...
public class Item {
   ...
   public static Item func_111206_d(String p_111206_0_) {
      Item lvt_1_1_ = (Item)field_150901_e.func_82594_a(new ResourceLocation(p_111206_0_));
      if (lvt_1_1_ == null) {
         try {
   ...
   public String func_77657_g(ItemStack p_77657_1_) {
      String lvt_2_1_ = this.func_77667_c(p_77657_1_);
      return lvt_2_1_ == null ? "" : StatCollector.func_74838_a(lvt_2_1_);
   }
   ...
   protected MovingObjectPosition func_77621_a(World p_77621_1_, EntityPlayer p_77621_2_, boolean p_77621_3_) {
      float lvt_4_1_ = p_77621_2_.field_70125_A;
      float lvt_5_1_ = p_77621_2_.field_70177_z;
      double lvt_6_1_ = p_77621_2_.field_70165_t;
      double lvt_8_1_ = p_77621_2_.field_70163_u + (double)p_77621_2_.func_70047_e();
      double lvt_10_1_ = p_77621_2_.field_70161_v;
      Vec3 lvt_12_1_ = new Vec3(lvt_6_1_, lvt_8_1_, lvt_10_1_);
      float lvt_13_1_ = MathHelper.func_76134_b(-lvt_5_1_ * 0.017453292F - 3.1415927F);
      float lvt_14_1_ = MathHelper.func_76126_a(-lvt_5_1_ * 0.017453292F - 3.1415927F);
      float lvt_15_1_ = -MathHelper.func_76134_b(-lvt_4_1_ * 0.017453292F);
      float lvt_16_1_ = MathHelper.func_76126_a(-lvt_4_1_ * 0.017453292F);
      float lvt_17_1_ = lvt_14_1_ * lvt_15_1_;
      float lvt_19_1_ = lvt_13_1_ * lvt_15_1_;
      double lvt_20_1_ = 5.0D;
      Vec3 lvt_22_1_ = lvt_12_1_.func_72441_c((double)lvt_17_1_ * lvt_20_1_, (double)lvt_16_1_ * lvt_20_1_, (double)lvt_19_1_ * lvt_20_1_);
      return p_77621_1_.func_147447_a(lvt_12_1_, lvt_22_1_, p_77621_3_, !p_77621_3_, false);
   }
   ...
   public static void func_150900_l() {
      ...
      Item lvt_0_1_ = (new ItemBucket(Blocks.field_150350_a)).func_77655_b("bucket").func_77625_d(16);
      func_179217_a(325, "bucket", lvt_0_1_);
      func_179217_a(326, "water_bucket", (new ItemBucket(Blocks.field_150358_i)).func_77655_b("bucketWater").func_77642_a(lvt_0_1_));
      func_179217_a(327, "lava_bucket", (new ItemBucket(Blocks.field_150356_k)).func_77655_b("bucketLava").func_77642_a(lvt_0_1_));
      ...
      func_179217_a(335, "milk_bucket", (new ItemBucketMilk()).func_77655_b("milk").func_77642_a(lvt_0_1_));
