...
public class ItemReed extends Item {
   ...
   public boolean func_180614_a(ItemStack p_180614_1_, EntityPlayer p_180614_2_, World p_180614_3_, BlockPos p_180614_4_, EnumFacing p_180614_5_, float p_180614_6_, float p_180614_7_, float p_180614_8_) {
      ...
      if (lvt_10_1_ == Blocks.field_150431_aC && (Integer)lvt_9_1_.func_177229_b(BlockSnow.field_176315_a) < 1) {
         p_180614_5_ = EnumFacing.UP;
      } else if (!lvt_10_1_.func_176200_f(p_180614_3_, p_180614_4_)) {
      ...
      if (!p_180614_2_.func_175151_a(p_180614_4_, p_180614_5_, p_180614_1_)) {
         ...
         if (p_180614_3_.func_175716_a(this.field_150935_a, p_180614_4_, false, p_180614_5_, (Entity)null, p_180614_1_)) {
            IBlockState lvt_11_1_ = this.field_150935_a.func_180642_a(p_180614_3_, p_180614_4_, p_180614_5_, p_180614_6_, p_180614_7_, p_180614_8_, 0, p_180614_2_);
            if (p_180614_3_.func_180501_a(p_180614_4_, lvt_11_1_, 3)) {
               lvt_11_1_ = p_180614_3_.func_180495_p(p_180614_4_);
               if (lvt_11_1_.func_177230_c() == this.field_150935_a) {
                  ItemBlock.func_179224_a(p_180614_3_, p_180614_2_, p_180614_4_, p_180614_1_);
                  lvt_11_1_.func_177230_c().func_180633_a(p_180614_3_, p_180614_4_, lvt_11_1_, p_180614_2_, p_180614_1_);
               }
