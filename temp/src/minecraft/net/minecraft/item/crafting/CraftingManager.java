...
public class CraftingManager {
   ...
   public ShapedRecipes func_92103_a(ItemStack p_92103_1_, Object... p_92103_2_) {
      ...
      int lvt_5_1_ = 0;
      int lvt_6_1_ = 0;
      if (p_92103_2_[lvt_4_1_] instanceof String[]) {
         String[] lvt_7_1_ = (String[])((String[])p_92103_2_[lvt_4_1_++]);

         for(int lvt_8_1_ = 0; lvt_8_1_ < lvt_7_1_.length; ++lvt_8_1_) {
            String lvt_9_1_ = lvt_7_1_[lvt_8_1_];
            ++lvt_6_1_;
            lvt_5_1_ = lvt_9_1_.length();
            lvt_3_1_ = lvt_3_1_ + lvt_9_1_;
         }
      } else {
         while(p_92103_2_[lvt_4_1_] instanceof String) {
            String lvt_7_2_ = (String)p_92103_2_[lvt_4_1_++];
            ++lvt_6_1_;
      ...
      HashMap lvt_7_3_;
      for(lvt_7_3_ = Maps.newHashMap(); lvt_4_1_ < p_92103_2_.length; lvt_4_1_ += 2) {
         Character lvt_8_2_ = (Character)p_92103_2_[lvt_4_1_];
         ItemStack lvt_9_2_ = null;
         if (p_92103_2_[lvt_4_1_ + 1] instanceof Item) {
            lvt_9_2_ = new ItemStack((Item)p_92103_2_[lvt_4_1_ + 1]);
         } else if (p_92103_2_[lvt_4_1_ + 1] instanceof Block) {
            lvt_9_2_ = new ItemStack((Block)p_92103_2_[lvt_4_1_ + 1], 1, 32767);
         } else if (p_92103_2_[lvt_4_1_ + 1] instanceof ItemStack) {
            lvt_9_2_ = (ItemStack)p_92103_2_[lvt_4_1_ + 1];
         }

         lvt_7_3_.put(lvt_8_2_, lvt_9_2_);
      }

      ItemStack[] lvt_8_3_ = new ItemStack[lvt_5_1_ * lvt_6_1_];

      for(int lvt_9_3_ = 0; lvt_9_3_ < lvt_5_1_ * lvt_6_1_; ++lvt_9_3_) {
         char lvt_10_1_ = lvt_3_1_.charAt(lvt_9_3_);
         if (lvt_7_3_.containsKey(lvt_10_1_)) {
            lvt_8_3_[lvt_9_3_] = ((ItemStack)lvt_7_3_.get(lvt_10_1_)).func_77946_l();
         } else {
            lvt_8_3_[lvt_9_3_] = null;
         }
      }

      ShapedRecipes lvt_9_4_ = new ShapedRecipes(lvt_5_1_, lvt_6_1_, lvt_8_3_, p_92103_1_);
      this.field_77597_b.add(lvt_9_4_);
      return lvt_9_4_;
   }

   public void func_77596_b(ItemStack p_77596_1_, Object... p_77596_2_) {
      List<ItemStack> lvt_3_1_ = Lists.newArrayList();
      Object[] lvt_4_1_ = p_77596_2_;
      int lvt_5_1_ = p_77596_2_.length;

      for(int lvt_6_1_ = 0; lvt_6_1_ < lvt_5_1_; ++lvt_6_1_) {
         Object lvt_7_1_ = lvt_4_1_[lvt_6_1_];
         if (lvt_7_1_ instanceof ItemStack) {
            lvt_3_1_.add(((ItemStack)lvt_7_1_).func_77946_l());
         } else if (lvt_7_1_ instanceof Item) {
      ...
      this.field_77597_b.add(new ShapelessRecipes(p_77596_1_, lvt_3_1_));
   }
   ...
   public ItemStack func_82787_a(InventoryCrafting p_82787_1_, World p_82787_2_) {
      Iterator lvt_3_1_ = this.field_77597_b.iterator();
      ...
      do {
         ...
         lvt_4_1_ = (IRecipe)lvt_3_1_.next();
      } while(!lvt_4_1_.func_77569_a(p_82787_1_, p_82787_2_));

      return lvt_4_1_.func_77572_b(p_82787_1_);
   }
   ...
   public ItemStack[] func_180303_b(InventoryCrafting p_180303_1_, World p_180303_2_) {
      ...
      while(lvt_3_1_.hasNext()) {
         IRecipe lvt_4_1_ = (IRecipe)lvt_3_1_.next();
         if (lvt_4_1_.func_77569_a(p_180303_1_, p_180303_2_)) {
            return lvt_4_1_.func_179532_b(p_180303_1_);
         }
      }

      ItemStack[] lvt_3_2_ = new ItemStack[p_180303_1_.func_70302_i_()];

      for(int lvt_4_2_ = 0; lvt_4_2_ < lvt_3_2_.length; ++lvt_4_2_) {
         lvt_3_2_[lvt_4_2_] = p_180303_1_.func_70301_a(lvt_4_2_);
      }
