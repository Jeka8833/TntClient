...
public class FurnaceRecipes {
   ...
   private FurnaceRecipes() {
      ...
      ItemFishFood.FishType[] lvt_1_1_ = ItemFishFood.FishType.values();
      int lvt_2_1_ = lvt_1_1_.length;

      for(int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_) {
         ItemFishFood.FishType lvt_4_1_ = lvt_1_1_[lvt_3_1_];
         if (lvt_4_1_.func_150973_i()) {
            this.func_151394_a(new ItemStack(Items.field_151115_aP, 1, lvt_4_1_.func_150976_a()), new ItemStack(Items.field_179566_aV, 1, lvt_4_1_.func_150976_a()), 0.35F);
         }
      }
   ...
   public ItemStack func_151395_a(ItemStack p_151395_1_) {
      Iterator lvt_2_1_ = this.field_77604_b.entrySet().iterator();
      ...
      do {
         ...
         lvt_3_1_ = (Entry)lvt_2_1_.next();
      } while(!this.func_151397_a(p_151395_1_, (ItemStack)lvt_3_1_.getKey()));

      return (ItemStack)lvt_3_1_.getValue();
   }
   ...
   public float func_151398_b(ItemStack p_151398_1_) {
      Iterator lvt_2_1_ = this.field_77605_c.entrySet().iterator();
      ...
      do {
         ...
         lvt_3_1_ = (Entry)lvt_2_1_.next();
      } while(!this.func_151397_a(p_151398_1_, (ItemStack)lvt_3_1_.getKey()));

      return (Float)lvt_3_1_.getValue();
   }
}
