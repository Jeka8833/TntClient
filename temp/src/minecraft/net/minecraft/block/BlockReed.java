...
public class BlockReed extends Block {
   ...
   protected BlockReed() {
      ...
      this.func_149676_a(0.5F - lvt_1_1_, 0.0F, 0.5F - lvt_1_1_, 0.5F + lvt_1_1_, 1.0F, 0.5F + lvt_1_1_);
   ...
   public void func_180650_b(World p_180650_1_, BlockPos p_180650_2_, IBlockState p_180650_3_, Random p_180650_4_) {
      if (p_180650_1_.func_180495_p(p_180650_2_.func_177977_b()).func_177230_c() == Blocks.field_150436_aH || this.func_176353_e(p_180650_1_, p_180650_2_, p_180650_3_)) {
         if (p_180650_1_.func_175623_d(p_180650_2_.func_177984_a())) {
            int lvt_5_1_;
            for(lvt_5_1_ = 1; p_180650_1_.func_180495_p(p_180650_2_.func_177979_c(lvt_5_1_)).func_177230_c() == this; ++lvt_5_1_) {
            }

            if (lvt_5_1_ < 3) {
               int lvt_6_1_ = (Integer)p_180650_3_.func_177229_b(field_176355_a);
               if (lvt_6_1_ == 15) {
                  ...
                  p_180650_1_.func_180501_a(p_180650_2_, p_180650_3_.func_177226_a(field_176355_a, lvt_6_1_ + 1), 4);
               }
            }
         }
   ...
   public boolean func_176196_c(World p_176196_1_, BlockPos p_176196_2_) {
      Block lvt_3_1_ = p_176196_1_.func_180495_p(p_176196_2_.func_177977_b()).func_177230_c();
      if (lvt_3_1_ == this) {
         return true;
      } else if (lvt_3_1_ != Blocks.field_150349_c && lvt_3_1_ != Blocks.field_150346_d && lvt_3_1_ != Blocks.field_150354_m) {
         return false;
      } else {
         ...
         do {
            ...
            lvt_5_1_ = (EnumFacing)lvt_4_1_.next();
         } while(p_176196_1_.func_180495_p(p_176196_2_.func_177972_a(lvt_5_1_).func_177977_b()).func_177230_c().func_149688_o() != Material.field_151586_h);
   ...
   public int func_176201_c(IBlockState p_176201_1_) {
      return (Integer)p_176201_1_.func_177229_b(field_176355_a);
   }
