...
public class BlockDoublePlant extends BlockBush implements IGrowable {
   ...
   public BlockDoublePlant.EnumPlantType func_176490_e(IBlockAccess p_176490_1_, BlockPos p_176490_2_) {
      IBlockState lvt_3_1_ = p_176490_1_.func_180495_p(p_176490_2_);
      if (lvt_3_1_.func_177230_c() == this) {
         lvt_3_1_ = this.func_176221_a(lvt_3_1_, p_176490_1_, p_176490_2_);
         return (BlockDoublePlant.EnumPlantType)lvt_3_1_.func_177229_b(field_176493_a);
      } else {
   ...
   public boolean func_176200_f(World p_176200_1_, BlockPos p_176200_2_) {
      IBlockState lvt_3_1_ = p_176200_1_.func_180495_p(p_176200_2_);
      if (lvt_3_1_.func_177230_c() != this) {
         return true;
      } else {
         BlockDoublePlant.EnumPlantType lvt_4_1_ = (BlockDoublePlant.EnumPlantType)this.func_176221_a(lvt_3_1_, p_176200_1_, p_176200_2_).func_177229_b(field_176493_a);
         return lvt_4_1_ == BlockDoublePlant.EnumPlantType.FERN || lvt_4_1_ == BlockDoublePlant.EnumPlantType.GRASS;
      }
   }
   ...
   protected void func_176475_e(World p_176475_1_, BlockPos p_176475_2_, IBlockState p_176475_3_) {
      if (!this.func_180671_f(p_176475_1_, p_176475_2_, p_176475_3_)) {
         boolean lvt_4_1_ = p_176475_3_.func_177229_b(field_176492_b) == BlockDoublePlant.EnumBlockHalf.UPPER;
         BlockPos lvt_5_1_ = lvt_4_1_ ? p_176475_2_ : p_176475_2_.func_177984_a();
         BlockPos lvt_6_1_ = lvt_4_1_ ? p_176475_2_.func_177977_b() : p_176475_2_;
         Block lvt_7_1_ = lvt_4_1_ ? this : p_176475_1_.func_180495_p(lvt_5_1_).func_177230_c();
         Block lvt_8_1_ = lvt_4_1_ ? p_176475_1_.func_180495_p(lvt_6_1_).func_177230_c() : this;
         if (lvt_7_1_ == this) {
            p_176475_1_.func_180501_a(lvt_5_1_, Blocks.field_150350_a.func_176223_P(), 2);
         }

         if (lvt_8_1_ == this) {
            p_176475_1_.func_180501_a(lvt_6_1_, Blocks.field_150350_a.func_176223_P(), 3);
            if (!lvt_4_1_) {
               this.func_176226_b(p_176475_1_, lvt_6_1_, p_176475_3_, 0);
            }
         }
   ...
   public boolean func_180671_f(World p_180671_1_, BlockPos p_180671_2_, IBlockState p_180671_3_) {
      if (p_180671_3_.func_177229_b(field_176492_b) == BlockDoublePlant.EnumBlockHalf.UPPER) {
         ...
         IBlockState lvt_4_1_ = p_180671_1_.func_180495_p(p_180671_2_.func_177984_a());
         return lvt_4_1_.func_177230_c() == this && super.func_180671_f(p_180671_1_, p_180671_2_, lvt_4_1_);
      }
   }
   ...
   public Item func_180660_a(IBlockState p_180660_1_, Random p_180660_2_, int p_180660_3_) {
      if (p_180660_1_.func_177229_b(field_176492_b) == BlockDoublePlant.EnumBlockHalf.UPPER) {
         ...
         BlockDoublePlant.EnumPlantType lvt_4_1_ = (BlockDoublePlant.EnumPlantType)p_180660_1_.func_177229_b(field_176493_a);
         if (lvt_4_1_ == BlockDoublePlant.EnumPlantType.FERN) {
            return null;
         } else if (lvt_4_1_ == BlockDoublePlant.EnumPlantType.GRASS) {
   ...
   public int func_180662_a(IBlockAccess p_180662_1_, BlockPos p_180662_2_, int p_180662_3_) {
      BlockDoublePlant.EnumPlantType lvt_4_1_ = this.func_176490_e(p_180662_1_, p_180662_2_);
      return lvt_4_1_ != BlockDoublePlant.EnumPlantType.GRASS && lvt_4_1_ != BlockDoublePlant.EnumPlantType.FERN ? 16777215 : BiomeColorHelper.func_180286_a(p_180662_1_, p_180662_2_);
   }
      ...
      if (p_176208_3_.func_177229_b(field_176492_b) == BlockDoublePlant.EnumBlockHalf.UPPER) {
         if (p_176208_1_.func_180495_p(p_176208_2_.func_177977_b()).func_177230_c() == this) {
            if (!p_176208_4_.field_71075_bZ.field_75098_d) {
               IBlockState lvt_5_1_ = p_176208_1_.func_180495_p(p_176208_2_.func_177977_b());
               BlockDoublePlant.EnumPlantType lvt_6_1_ = (BlockDoublePlant.EnumPlantType)lvt_5_1_.func_177229_b(field_176493_a);
               if (lvt_6_1_ != BlockDoublePlant.EnumPlantType.FERN && lvt_6_1_ != BlockDoublePlant.EnumPlantType.GRASS) {
                  ...
                  if (p_176208_4_.func_71045_bC() != null && p_176208_4_.func_71045_bC().func_77973_b() == Items.field_151097_aZ) {
                     this.func_176489_b(p_176208_1_, p_176208_2_, lvt_5_1_, p_176208_4_);
   ...
   private boolean func_176489_b(World p_176489_1_, BlockPos p_176489_2_, IBlockState p_176489_3_, EntityPlayer p_176489_4_) {
      BlockDoublePlant.EnumPlantType lvt_5_1_ = (BlockDoublePlant.EnumPlantType)p_176489_3_.func_177229_b(field_176493_a);
      if (lvt_5_1_ != BlockDoublePlant.EnumPlantType.FERN && lvt_5_1_ != BlockDoublePlant.EnumPlantType.GRASS) {
         return false;
      } else {
         p_176489_4_.func_71029_a(StatList.field_75934_C[Block.func_149682_b(this)]);
         int lvt_6_1_ = (lvt_5_1_ == BlockDoublePlant.EnumPlantType.GRASS ? BlockTallGrass.EnumType.GRASS : BlockTallGrass.EnumType.FERN).func_177044_a();
         func_180635_a(p_176489_1_, p_176489_2_, new ItemStack(Blocks.field_150329_H, 2, lvt_6_1_));
         return true;
      }
   }

   public void func_149666_a(Item p_149666_1_, CreativeTabs p_149666_2_, List<ItemStack> p_149666_3_) {
      BlockDoublePlant.EnumPlantType[] lvt_4_1_ = BlockDoublePlant.EnumPlantType.values();
      int lvt_5_1_ = lvt_4_1_.length;

      for(int lvt_6_1_ = 0; lvt_6_1_ < lvt_5_1_; ++lvt_6_1_) {
         BlockDoublePlant.EnumPlantType lvt_7_1_ = lvt_4_1_[lvt_6_1_];
         p_149666_3_.add(new ItemStack(p_149666_1_, 1, lvt_7_1_.func_176936_a()));
      }
   ...
   public boolean func_176473_a(World p_176473_1_, BlockPos p_176473_2_, IBlockState p_176473_3_, boolean p_176473_4_) {
      BlockDoublePlant.EnumPlantType lvt_5_1_ = this.func_176490_e(p_176473_1_, p_176473_2_);
      return lvt_5_1_ != BlockDoublePlant.EnumPlantType.GRASS && lvt_5_1_ != BlockDoublePlant.EnumPlantType.FERN;
   }
   ...
   public IBlockState func_176221_a(IBlockState p_176221_1_, IBlockAccess p_176221_2_, BlockPos p_176221_3_) {
      if (p_176221_1_.func_177229_b(field_176492_b) == BlockDoublePlant.EnumBlockHalf.UPPER) {
         IBlockState lvt_4_1_ = p_176221_2_.func_180495_p(p_176221_3_.func_177977_b());
         if (lvt_4_1_.func_177230_c() == this) {
            p_176221_1_ = p_176221_1_.func_177226_a(field_176493_a, lvt_4_1_.func_177229_b(field_176493_a));
         }
      }
   ...
   public static enum EnumPlantType implements IStringSerializable {
      ...
      static {
         BlockDoublePlant.EnumPlantType[] lvt_0_1_ = values();
         int lvt_1_1_ = lvt_0_1_.length;

         for(int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_; ++lvt_2_1_) {
            BlockDoublePlant.EnumPlantType lvt_3_1_ = lvt_0_1_[lvt_2_1_];
            field_176941_g[lvt_3_1_.func_176936_a()] = lvt_3_1_;
         }
