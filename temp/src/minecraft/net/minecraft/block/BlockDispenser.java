...
public class BlockDispenser extends BlockContainer {
   ...
   private void func_176438_e(World p_176438_1_, BlockPos p_176438_2_, IBlockState p_176438_3_) {
      if (!p_176438_1_.field_72995_K) {
         EnumFacing lvt_4_1_ = (EnumFacing)p_176438_3_.func_177229_b(field_176441_a);
         boolean lvt_5_1_ = p_176438_1_.func_180495_p(p_176438_2_.func_177978_c()).func_177230_c().func_149730_j();
         boolean lvt_6_1_ = p_176438_1_.func_180495_p(p_176438_2_.func_177968_d()).func_177230_c().func_149730_j();
         if (lvt_4_1_ == EnumFacing.NORTH && lvt_5_1_ && !lvt_6_1_) {
            ...
            boolean lvt_7_1_ = p_176438_1_.func_180495_p(p_176438_2_.func_177976_e()).func_177230_c().func_149730_j();
            boolean lvt_8_1_ = p_176438_1_.func_180495_p(p_176438_2_.func_177974_f()).func_177230_c().func_149730_j();
         ...
         p_176438_1_.func_180501_a(p_176438_2_, p_176438_3_.func_177226_a(field_176441_a, lvt_4_1_).func_177226_a(field_176440_b, false), 2);
      }
   }
   ...
   public boolean func_180639_a(World p_180639_1_, BlockPos p_180639_2_, IBlockState p_180639_3_, EntityPlayer p_180639_4_, EnumFacing p_180639_5_, float p_180639_6_, float p_180639_7_, float p_180639_8_) {
      if (p_180639_1_.field_72995_K) {
         ...
         if (lvt_9_1_ instanceof TileEntityDispenser) {
            p_180639_4_.func_71007_a((TileEntityDispenser)lvt_9_1_);
   ...
   protected void func_176439_d(World p_176439_1_, BlockPos p_176439_2_) {
      ...
      if (lvt_4_1_ != null) {
         ...
         if (lvt_5_1_ < 0) {
            ...
            IBehaviorDispenseItem lvt_7_1_ = this.func_149940_a(lvt_6_1_);
            if (lvt_7_1_ != IBehaviorDispenseItem.field_82483_a) {
               ItemStack lvt_8_1_ = lvt_7_1_.func_82482_a(lvt_3_1_, lvt_6_1_);
               lvt_4_1_.func_70299_a(lvt_5_1_, lvt_8_1_.field_77994_a <= 0 ? null : lvt_8_1_);
            }
   ...
   public void func_176204_a(World p_176204_1_, BlockPos p_176204_2_, IBlockState p_176204_3_, Block p_176204_4_) {
      boolean lvt_5_1_ = p_176204_1_.func_175640_z(p_176204_2_) || p_176204_1_.func_175640_z(p_176204_2_.func_177984_a());
      boolean lvt_6_1_ = (Boolean)p_176204_3_.func_177229_b(field_176440_b);
      if (lvt_5_1_ && !lvt_6_1_) {
         p_176204_1_.func_175684_a(p_176204_2_, this, this.func_149738_a(p_176204_1_));
         p_176204_1_.func_180501_a(p_176204_2_, p_176204_3_.func_177226_a(field_176440_b, true), 4);
      } else if (!lvt_5_1_ && lvt_6_1_) {
         p_176204_1_.func_180501_a(p_176204_2_, p_176204_3_.func_177226_a(field_176440_b, false), 4);
      }
   ...
   public IBlockState func_180642_a(World p_180642_1_, BlockPos p_180642_2_, EnumFacing p_180642_3_, float p_180642_4_, float p_180642_5_, float p_180642_6_, int p_180642_7_, EntityLivingBase p_180642_8_) {
      return this.func_176223_P().func_177226_a(field_176441_a, BlockPistonBase.func_180695_a(p_180642_1_, p_180642_2_, p_180642_8_)).func_177226_a(field_176440_b, false);
   }
   ...
   public void func_180633_a(World p_180633_1_, BlockPos p_180633_2_, IBlockState p_180633_3_, EntityLivingBase p_180633_4_, ItemStack p_180633_5_) {
      ...
      if (p_180633_5_.func_82837_s()) {
         ...
         if (lvt_6_1_ instanceof TileEntityDispenser) {
            ((TileEntityDispenser)lvt_6_1_).func_146018_a(p_180633_5_.func_82833_r());
         }
      }
   ...
   public void func_180663_b(World p_180663_1_, BlockPos p_180663_2_, IBlockState p_180663_3_) {
      ...
      if (lvt_4_1_ instanceof TileEntityDispenser) {
         InventoryHelper.func_180175_a(p_180663_1_, p_180663_2_, (TileEntityDispenser)lvt_4_1_);
   ...
   public static IPosition func_149939_a(IBlockSource p_149939_0_) {
      EnumFacing lvt_1_1_ = func_149937_b(p_149939_0_.func_82620_h());
      double lvt_2_1_ = p_149939_0_.func_82615_a() + 0.7D * (double)lvt_1_1_.func_82601_c();
      double lvt_4_1_ = p_149939_0_.func_82617_b() + 0.7D * (double)lvt_1_1_.func_96559_d();
      double lvt_6_1_ = p_149939_0_.func_82616_c() + 0.7D * (double)lvt_1_1_.func_82599_e();
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      return this.func_176223_P().func_177226_a(field_176441_a, func_149937_b(p_176203_1_)).func_177226_a(field_176440_b, (p_176203_1_ & 8) > 0);
   }

   public int func_176201_c(IBlockState p_176201_1_) {
      int lvt_2_1_ = 0;
      int lvt_2_1_ = lvt_2_1_ | ((EnumFacing)p_176201_1_.func_177229_b(field_176441_a)).func_176745_a();
      if ((Boolean)p_176201_1_.func_177229_b(field_176440_b)) {
         lvt_2_1_ |= 8;
      }
