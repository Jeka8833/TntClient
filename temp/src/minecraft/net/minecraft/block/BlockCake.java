...
public class BlockCake extends Block {
   ...
   public void func_180654_a(IBlockAccess p_180654_1_, BlockPos p_180654_2_) {
      ...
      float lvt_4_1_ = (float)(1 + (Integer)p_180654_1_.func_180495_p(p_180654_2_).func_177229_b(field_176589_a) * 2) / 16.0F;
      float lvt_5_1_ = 0.5F;
      this.func_149676_a(lvt_4_1_, 0.0F, lvt_3_1_, 1.0F - lvt_3_1_, lvt_5_1_, 1.0F - lvt_3_1_);
   }

   public void func_149683_g() {
      float lvt_1_1_ = 0.0625F;
      float lvt_2_1_ = 0.5F;
      this.func_149676_a(lvt_1_1_, 0.0F, lvt_1_1_, 1.0F - lvt_1_1_, lvt_2_1_, 1.0F - lvt_1_1_);
   }

   public AxisAlignedBB func_180640_a(World p_180640_1_, BlockPos p_180640_2_, IBlockState p_180640_3_) {
      float lvt_4_1_ = 0.0625F;
      float lvt_5_1_ = (float)(1 + (Integer)p_180640_3_.func_177229_b(field_176589_a) * 2) / 16.0F;
      float lvt_6_1_ = 0.5F;
      return new AxisAlignedBB((double)((float)p_180640_2_.func_177958_n() + lvt_5_1_), (double)p_180640_2_.func_177956_o(), (double)((float)p_180640_2_.func_177952_p() + lvt_4_1_), (double)((float)(p_180640_2_.func_177958_n() + 1) - lvt_4_1_), (double)((float)p_180640_2_.func_177956_o() + lvt_6_1_), (double)((float)(p_180640_2_.func_177952_p() + 1) - lvt_4_1_));
   }
   ...
   private void func_180682_b(World p_180682_1_, BlockPos p_180682_2_, IBlockState p_180682_3_, EntityPlayer p_180682_4_) {
      if (p_180682_4_.func_71043_e(false)) {
         ...
         int lvt_5_1_ = (Integer)p_180682_3_.func_177229_b(field_176589_a);
         if (lvt_5_1_ < 6) {
            p_180682_1_.func_180501_a(p_180682_2_, p_180682_3_.func_177226_a(field_176589_a, lvt_5_1_ + 1), 3);
         } else {
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      return this.func_176223_P().func_177226_a(field_176589_a, p_176203_1_);
   }

   public int func_176201_c(IBlockState p_176201_1_) {
      return (Integer)p_176201_1_.func_177229_b(field_176589_a);
   }
   ...
   public int func_180641_l(World p_180641_1_, BlockPos p_180641_2_) {
      return (7 - (Integer)p_180641_1_.func_180495_p(p_180641_2_).func_177229_b(field_176589_a)) * 2;
   }
