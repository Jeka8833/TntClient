...
public abstract class PropertyHelper<T extends Comparable<T>> implements IProperty<T> {
   ...
   public String toString() {
      return Objects.toStringHelper((Object)this).add("name", this.field_177703_b).add("clazz", this.field_177704_a).add("values", this.func_177700_c()).toString();
   }
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         PropertyHelper lvt_2_1_ = (PropertyHelper)p_equals_1_;
         return this.field_177704_a.equals(lvt_2_1_.field_177704_a) && this.field_177703_b.equals(lvt_2_1_.field_177703_b);
      } else {
         return false;
      }
   }
