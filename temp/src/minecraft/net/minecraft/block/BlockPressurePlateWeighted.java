...
public class BlockPressurePlateWeighted extends BlockBasePressurePlate {
   ...
   protected int func_180669_e(World p_180669_1_, BlockPos p_180669_2_) {
      int lvt_3_1_ = Math.min(p_180669_1_.func_72872_a(Entity.class, this.func_180667_a(p_180669_2_)).size(), this.field_150068_a);
      if (lvt_3_1_ > 0) {
         float lvt_4_1_ = (float)Math.min(this.field_150068_a, lvt_3_1_) / (float)this.field_150068_a;
         return MathHelper.func_76123_f(lvt_4_1_ * 15.0F);
      } else {
         return 0;
      }
   }
   ...
   protected int func_176576_e(IBlockState p_176576_1_) {
      return (Integer)p_176576_1_.func_177229_b(field_176579_a);
   }

   protected IBlockState func_176575_a(IBlockState p_176575_1_, int p_176575_2_) {
      return p_176575_1_.func_177226_a(field_176579_a, p_176575_2_);
   }
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      return this.func_176223_P().func_177226_a(field_176579_a, p_176203_1_);
   }

   public int func_176201_c(IBlockState p_176201_1_) {
      return (Integer)p_176201_1_.func_177229_b(field_176579_a);
   }
