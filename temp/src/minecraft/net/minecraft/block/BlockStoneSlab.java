...
public abstract class BlockStoneSlab extends BlockSlab {
   ...
   public BlockStoneSlab() {
      ...
      if (this.func_176552_j()) {
         lvt_1_1_ = lvt_1_1_.func_177226_a(field_176555_b, false);
      } else {
         lvt_1_1_ = lvt_1_1_.func_177226_a(field_176554_a, BlockSlab.EnumBlockHalf.BOTTOM);
      }

      this.func_180632_j(lvt_1_1_.func_177226_a(field_176556_M, BlockStoneSlab.EnumType.STONE));
   ...
   public void func_149666_a(Item p_149666_1_, CreativeTabs p_149666_2_, List<ItemStack> p_149666_3_) {
      if (p_149666_1_ != Item.func_150898_a(Blocks.field_150334_T)) {
         BlockStoneSlab.EnumType[] lvt_4_1_ = BlockStoneSlab.EnumType.values();
         int lvt_5_1_ = lvt_4_1_.length;

         for(int lvt_6_1_ = 0; lvt_6_1_ < lvt_5_1_; ++lvt_6_1_) {
            BlockStoneSlab.EnumType lvt_7_1_ = lvt_4_1_[lvt_6_1_];
            if (lvt_7_1_ != BlockStoneSlab.EnumType.WOOD) {
               p_149666_3_.add(new ItemStack(p_149666_1_, 1, lvt_7_1_.func_176624_a()));
            }
         }
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      IBlockState lvt_2_1_ = this.func_176223_P().func_177226_a(field_176556_M, BlockStoneSlab.EnumType.func_176625_a(p_176203_1_ & 7));
      if (this.func_176552_j()) {
         lvt_2_1_ = lvt_2_1_.func_177226_a(field_176555_b, (p_176203_1_ & 8) != 0);
      } else {
   ...
   public int func_176201_c(IBlockState p_176201_1_) {
      int lvt_2_1_ = 0;
      int lvt_2_1_ = lvt_2_1_ | ((BlockStoneSlab.EnumType)p_176201_1_.func_177229_b(field_176556_M)).func_176624_a();
      if (this.func_176552_j()) {
         if ((Boolean)p_176201_1_.func_177229_b(field_176555_b)) {
            lvt_2_1_ |= 8;
         }
   ...
   public static enum EnumType implements IStringSerializable {
      ...
      static {
         BlockStoneSlab.EnumType[] lvt_0_1_ = values();
         int lvt_1_1_ = lvt_0_1_.length;

         for(int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_; ++lvt_2_1_) {
            BlockStoneSlab.EnumType lvt_3_1_ = lvt_0_1_[lvt_2_1_];
            field_176640_i[lvt_3_1_.func_176624_a()] = lvt_3_1_;
         }
