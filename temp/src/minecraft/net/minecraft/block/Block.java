...
public class Block {
   ...
   public static int func_176210_f(IBlockState p_176210_0_) {
      Block lvt_1_1_ = p_176210_0_.func_177230_c();
      return func_149682_b(lvt_1_1_) + (lvt_1_1_.func_176201_c(p_176210_0_) << 12);
   }
   ...
   public static IBlockState func_176220_d(int p_176220_0_) {
      int lvt_1_1_ = p_176220_0_ & 4095;
      int lvt_2_1_ = p_176220_0_ >> 12 & 15;
      return func_149729_e(lvt_1_1_).func_176203_a(lvt_2_1_);
   }
   ...
   public static Block func_149684_b(String p_149684_0_) {
      ResourceLocation lvt_1_1_ = new ResourceLocation(p_149684_0_);
      if (field_149771_c.func_148741_d(lvt_1_1_)) {
         return (Block)field_149771_c.func_82594_a(lvt_1_1_);
      } else {
         try {
   ...
   public int func_176207_c(IBlockAccess p_176207_1_, BlockPos p_176207_2_) {
      Block lvt_3_1_ = p_176207_1_.func_180495_p(p_176207_2_).func_177230_c();
      int lvt_4_1_ = p_176207_1_.func_175626_b(p_176207_2_, lvt_3_1_.func_149750_m());
      if (lvt_4_1_ == 0 && lvt_3_1_ instanceof BlockSlab) {
         p_176207_2_ = p_176207_2_.func_177977_b();
         lvt_3_1_ = p_176207_1_.func_180495_p(p_176207_2_).func_177230_c();
         return p_176207_1_.func_175626_b(p_176207_2_, lvt_3_1_.func_149750_m());
      } else {
         return lvt_4_1_;
      }
   }
   ...
   public void func_180638_a(World p_180638_1_, BlockPos p_180638_2_, IBlockState p_180638_3_, AxisAlignedBB p_180638_4_, List<AxisAlignedBB> p_180638_5_, Entity p_180638_6_) {
      AxisAlignedBB lvt_7_1_ = this.func_180640_a(p_180638_1_, p_180638_2_, p_180638_3_);
      if (lvt_7_1_ != null && p_180638_4_.func_72326_a(lvt_7_1_)) {
         p_180638_5_.add(lvt_7_1_);
      }
   ...
   public float func_180647_a(EntityPlayer p_180647_1_, World p_180647_2_, BlockPos p_180647_3_) {
      float lvt_4_1_ = this.func_176195_g(p_180647_2_, p_180647_3_);
      if (lvt_4_1_ < 0.0F) {
         return 0.0F;
      } else {
         return !p_180647_1_.func_146099_a(this) ? p_180647_1_.func_180471_a(this) / lvt_4_1_ / 100.0F : p_180647_1_.func_180471_a(this) / lvt_4_1_ / 30.0F;
      }
   }
   ...
   public void func_180653_a(World p_180653_1_, BlockPos p_180653_2_, IBlockState p_180653_3_, float p_180653_4_, int p_180653_5_) {
      if (!p_180653_1_.field_72995_K) {
         int lvt_6_1_ = this.func_149679_a(p_180653_5_, p_180653_1_.field_73012_v);

         for(int lvt_7_1_ = 0; lvt_7_1_ < lvt_6_1_; ++lvt_7_1_) {
            if (p_180653_1_.field_73012_v.nextFloat() <= p_180653_4_) {
               Item lvt_8_1_ = this.func_180660_a(p_180653_3_, p_180653_1_.field_73012_v, p_180653_5_);
               if (lvt_8_1_ != null) {
                  func_180635_a(p_180653_1_, p_180653_2_, new ItemStack(lvt_8_1_, 1, this.func_180651_a(p_180653_3_)));
               }
            }
         }
   ...
   public static void func_180635_a(World p_180635_0_, BlockPos p_180635_1_, ItemStack p_180635_2_) {
      if (!p_180635_0_.field_72995_K && p_180635_0_.func_82736_K().func_82766_b("doTileDrops")) {
         float lvt_3_1_ = 0.5F;
         double lvt_4_1_ = (double)(p_180635_0_.field_73012_v.nextFloat() * lvt_3_1_) + (double)(1.0F - lvt_3_1_) * 0.5D;
         double lvt_6_1_ = (double)(p_180635_0_.field_73012_v.nextFloat() * lvt_3_1_) + (double)(1.0F - lvt_3_1_) * 0.5D;
         double lvt_8_1_ = (double)(p_180635_0_.field_73012_v.nextFloat() * lvt_3_1_) + (double)(1.0F - lvt_3_1_) * 0.5D;
         EntityItem lvt_10_1_ = new EntityItem(p_180635_0_, (double)p_180635_1_.func_177958_n() + lvt_4_1_, (double)p_180635_1_.func_177956_o() + lvt_6_1_, (double)p_180635_1_.func_177952_p() + lvt_8_1_, p_180635_2_);
         lvt_10_1_.func_174869_p();
         p_180635_0_.func_72838_d(lvt_10_1_);
      }
   }
   ...
   protected void func_180637_b(World p_180637_1_, BlockPos p_180637_2_, int p_180637_3_) {
      if (!p_180637_1_.field_72995_K) {
         while(p_180637_3_ > 0) {
            int lvt_4_1_ = EntityXPOrb.func_70527_a(p_180637_3_);
            p_180637_3_ -= lvt_4_1_;
            p_180637_1_.func_72838_d(new EntityXPOrb(p_180637_1_, (double)p_180637_2_.func_177958_n() + 0.5D, (double)p_180637_2_.func_177956_o() + 0.5D, (double)p_180637_2_.func_177952_p() + 0.5D, lvt_4_1_));
         }
      }
   ...
   public MovingObjectPosition func_180636_a(World p_180636_1_, BlockPos p_180636_2_, Vec3 p_180636_3_, Vec3 p_180636_4_) {
      ...
      Vec3 lvt_5_1_ = p_180636_3_.func_72429_b(p_180636_4_, this.field_149759_B);
      Vec3 lvt_6_1_ = p_180636_3_.func_72429_b(p_180636_4_, this.field_149755_E);
      Vec3 lvt_7_1_ = p_180636_3_.func_72435_c(p_180636_4_, this.field_149760_C);
      Vec3 lvt_8_1_ = p_180636_3_.func_72435_c(p_180636_4_, this.field_149756_F);
      Vec3 lvt_9_1_ = p_180636_3_.func_72434_d(p_180636_4_, this.field_149754_D);
      Vec3 lvt_10_1_ = p_180636_3_.func_72434_d(p_180636_4_, this.field_149757_G);
      if (!this.func_149654_a(lvt_5_1_)) {
         lvt_5_1_ = null;
      }

      if (!this.func_149654_a(lvt_6_1_)) {
         lvt_6_1_ = null;
      }

      if (!this.func_149687_b(lvt_7_1_)) {
         lvt_7_1_ = null;
      }

      if (!this.func_149687_b(lvt_8_1_)) {
         lvt_8_1_ = null;
      }

      if (!this.func_149661_c(lvt_9_1_)) {
         lvt_9_1_ = null;
      }

      if (!this.func_149661_c(lvt_10_1_)) {
         lvt_10_1_ = null;
      }

      Vec3 lvt_11_1_ = null;
      if (lvt_5_1_ != null && (lvt_11_1_ == null || p_180636_3_.func_72436_e(lvt_5_1_) < p_180636_3_.func_72436_e(lvt_11_1_))) {
         lvt_11_1_ = lvt_5_1_;
      }

      if (lvt_6_1_ != null && (lvt_11_1_ == null || p_180636_3_.func_72436_e(lvt_6_1_) < p_180636_3_.func_72436_e(lvt_11_1_))) {
         lvt_11_1_ = lvt_6_1_;
      }

      if (lvt_7_1_ != null && (lvt_11_1_ == null || p_180636_3_.func_72436_e(lvt_7_1_) < p_180636_3_.func_72436_e(lvt_11_1_))) {
         lvt_11_1_ = lvt_7_1_;
      }

      if (lvt_8_1_ != null && (lvt_11_1_ == null || p_180636_3_.func_72436_e(lvt_8_1_) < p_180636_3_.func_72436_e(lvt_11_1_))) {
         lvt_11_1_ = lvt_8_1_;
      }

      if (lvt_9_1_ != null && (lvt_11_1_ == null || p_180636_3_.func_72436_e(lvt_9_1_) < p_180636_3_.func_72436_e(lvt_11_1_))) {
         lvt_11_1_ = lvt_9_1_;
      }

      if (lvt_10_1_ != null && (lvt_11_1_ == null || p_180636_3_.func_72436_e(lvt_10_1_) < p_180636_3_.func_72436_e(lvt_11_1_))) {
         lvt_11_1_ = lvt_10_1_;
      }
      ...
      if (lvt_11_1_ == null) {
         ...
         return new MovingObjectPosition(lvt_11_1_.func_72441_c((double)p_180636_2_.func_177958_n(), (double)p_180636_2_.func_177956_o(), (double)p_180636_2_.func_177952_p()), lvt_12_1_, p_180636_2_);
      }
   }
   ...
   public void func_180657_a(World p_180657_1_, EntityPlayer p_180657_2_, BlockPos p_180657_3_, IBlockState p_180657_4_, TileEntity p_180657_5_) {
      ...
      if (this.func_149700_E() && EnchantmentHelper.func_77502_d(p_180657_2_)) {
         ItemStack lvt_6_1_ = this.func_180643_i(p_180657_4_);
         if (lvt_6_1_ != null) {
            func_180635_a(p_180657_1_, p_180657_3_, lvt_6_1_);
         }
      } else {
         int lvt_6_2_ = EnchantmentHelper.func_77517_e(p_180657_2_);
         this.func_176226_b(p_180657_1_, p_180657_3_, p_180657_4_, lvt_6_2_);
      }
   ...
   protected ItemStack func_180643_i(IBlockState p_180643_1_) {
      int lvt_2_1_ = 0;
      Item lvt_3_1_ = Item.func_150898_a(this);
      if (lvt_3_1_ != null && lvt_3_1_.func_77614_k()) {
         lvt_2_1_ = this.func_176201_c(p_180643_1_);
      }
   ...
   public static void func_149671_p() {
      ...
      Block lvt_0_1_ = (new Block(Material.field_151576_e)).func_149711_c(2.0F).func_149752_b(10.0F).func_149672_a(field_149780_i).func_149663_c("stonebrick").func_149647_a(CreativeTabs.field_78030_b);
      func_176219_a(4, "cobblestone", lvt_0_1_);
      Block lvt_1_1_ = (new BlockPlanks()).func_149711_c(2.0F).func_149752_b(5.0F).func_149672_a(field_149766_f).func_149663_c("wood");
      func_176219_a(5, "planks", lvt_1_1_);
      ...
      Block lvt_2_1_ = (new BlockSandStone()).func_149672_a(field_149780_i).func_149711_c(0.8F).func_149663_c("sandStone");
      func_176219_a(24, "sandstone", lvt_2_1_);
      ...
      Block lvt_3_1_ = (new BlockMushroom()).func_149711_c(0.0F).func_149672_a(field_149779_h).func_149715_a(0.125F).func_149663_c("mushroom");
      func_176219_a(39, "brown_mushroom", lvt_3_1_);
      Block lvt_4_1_ = (new BlockMushroom()).func_149711_c(0.0F).func_149672_a(field_149779_h).func_149663_c("mushroom");
      func_176219_a(40, "red_mushroom", lvt_4_1_);
      ...
      Block lvt_5_1_ = (new Block(Material.field_151576_e, MapColor.field_151645_D)).func_149711_c(2.0F).func_149752_b(10.0F).func_149672_a(field_149780_i).func_149663_c("brick").func_149647_a(CreativeTabs.field_78030_b);
      func_176219_a(45, "brick_block", lvt_5_1_);
      ...
      func_176219_a(53, "oak_stairs", (new BlockStairs(lvt_1_1_.func_176223_P().func_177226_a(BlockPlanks.field_176383_a, BlockPlanks.EnumType.OAK))).func_149663_c("stairsWood"));
      ...
      Block lvt_6_1_ = (new BlockFarmland()).func_149711_c(0.6F).func_149672_a(field_149767_g).func_149663_c("farmland");
      func_176219_a(60, "farmland", lvt_6_1_);
      ...
      func_176219_a(67, "stone_stairs", (new BlockStairs(lvt_0_1_.func_176223_P())).func_149663_c("stairsStone"));
      ...
      Block lvt_7_1_ = (new BlockPumpkin()).func_149711_c(1.0F).func_149672_a(field_149766_f).func_149663_c("pumpkin");
      func_176219_a(86, "pumpkin", lvt_7_1_);
      ...
      Block lvt_8_1_ = (new BlockStoneBrick()).func_149711_c(1.5F).func_149752_b(10.0F).func_149672_a(field_149780_i).func_149663_c("stonebricksmooth");
      func_176219_a(98, "stonebrick", lvt_8_1_);
      func_176219_a(99, "brown_mushroom_block", (new BlockHugeMushroom(Material.field_151575_d, MapColor.field_151664_l, lvt_3_1_)).func_149711_c(0.2F).func_149672_a(field_149766_f).func_149663_c("mushroom"));
      func_176219_a(100, "red_mushroom_block", (new BlockHugeMushroom(Material.field_151575_d, MapColor.field_151645_D, lvt_4_1_)).func_149711_c(0.2F).func_149672_a(field_149766_f).func_149663_c("mushroom"));
      ...
      Block lvt_9_1_ = (new BlockMelon()).func_149711_c(1.0F).func_149672_a(field_149766_f).func_149663_c("melon");
      func_176219_a(103, "melon_block", lvt_9_1_);
      func_176219_a(104, "pumpkin_stem", (new BlockStem(lvt_7_1_)).func_149711_c(0.0F).func_149672_a(field_149766_f).func_149663_c("pumpkinStem"));
      func_176219_a(105, "melon_stem", (new BlockStem(lvt_9_1_)).func_149711_c(0.0F).func_149672_a(field_149766_f).func_149663_c("pumpkinStem"));
      ...
      func_176219_a(108, "brick_stairs", (new BlockStairs(lvt_5_1_.func_176223_P())).func_149663_c("stairsBrick"));
      func_176219_a(109, "stone_brick_stairs", (new BlockStairs(lvt_8_1_.func_176223_P().func_177226_a(BlockStoneBrick.field_176249_a, BlockStoneBrick.EnumType.DEFAULT))).func_149663_c("stairsStoneBrickSmooth"));
      ...
      Block lvt_10_1_ = (new BlockNetherBrick()).func_149711_c(2.0F).func_149752_b(10.0F).func_149672_a(field_149780_i).func_149663_c("netherBrick").func_149647_a(CreativeTabs.field_78030_b);
      func_176219_a(112, "nether_brick", lvt_10_1_);
      ...
      func_176219_a(114, "nether_brick_stairs", (new BlockStairs(lvt_10_1_.func_176223_P())).func_149663_c("stairsNetherBrick"));
      ...
      func_176219_a(128, "sandstone_stairs", (new BlockStairs(lvt_2_1_.func_176223_P().func_177226_a(BlockSandStone.field_176297_a, BlockSandStone.EnumType.SMOOTH))).func_149663_c("stairsSandStone"));
      ...
      func_176219_a(134, "spruce_stairs", (new BlockStairs(lvt_1_1_.func_176223_P().func_177226_a(BlockPlanks.field_176383_a, BlockPlanks.EnumType.SPRUCE))).func_149663_c("stairsWoodSpruce"));
      func_176219_a(135, "birch_stairs", (new BlockStairs(lvt_1_1_.func_176223_P().func_177226_a(BlockPlanks.field_176383_a, BlockPlanks.EnumType.BIRCH))).func_149663_c("stairsWoodBirch"));
      func_176219_a(136, "jungle_stairs", (new BlockStairs(lvt_1_1_.func_176223_P().func_177226_a(BlockPlanks.field_176383_a, BlockPlanks.EnumType.JUNGLE))).func_149663_c("stairsWoodJungle"));
      ...
      func_176219_a(139, "cobblestone_wall", (new BlockWall(lvt_0_1_)).func_149663_c("cobbleWall"));
      ...
      Block lvt_11_1_ = (new BlockQuartz()).func_149672_a(field_149780_i).func_149711_c(0.8F).func_149663_c("quartzBlock");
      func_176219_a(155, "quartz_block", lvt_11_1_);
      func_176219_a(156, "quartz_stairs", (new BlockStairs(lvt_11_1_.func_176223_P().func_177226_a(BlockQuartz.field_176335_a, BlockQuartz.EnumType.DEFAULT))).func_149663_c("stairsQuartz"));
      ...
      func_176219_a(163, "acacia_stairs", (new BlockStairs(lvt_1_1_.func_176223_P().func_177226_a(BlockPlanks.field_176383_a, BlockPlanks.EnumType.ACACIA))).func_149663_c("stairsWoodAcacia"));
      func_176219_a(164, "dark_oak_stairs", (new BlockStairs(lvt_1_1_.func_176223_P().func_177226_a(BlockPlanks.field_176383_a, BlockPlanks.EnumType.DARK_OAK))).func_149663_c("stairsWoodDarkOak"));
      ...
      Block lvt_12_1_ = (new BlockRedSandstone()).func_149672_a(field_149780_i).func_149711_c(0.8F).func_149663_c("redSandStone");
      func_176219_a(179, "red_sandstone", lvt_12_1_);
      func_176219_a(180, "red_sandstone_stairs", (new BlockStairs(lvt_12_1_.func_176223_P().func_177226_a(BlockRedSandstone.field_176336_a, BlockRedSandstone.EnumType.SMOOTH))).func_149663_c("stairsRedSandStone"));
      ...
      Iterator lvt_13_2_ = field_149771_c.iterator();

      while(true) {
         Block lvt_14_2_;
         while(lvt_13_2_.hasNext()) {
            lvt_14_2_ = (Block)lvt_13_2_.next();
            if (lvt_14_2_.field_149764_J == Material.field_151579_a) {
               lvt_14_2_.field_149783_u = false;
            } else {
               boolean lvt_15_1_ = false;
               boolean lvt_16_1_ = lvt_14_2_ instanceof BlockStairs;
               boolean lvt_17_1_ = lvt_14_2_ instanceof BlockSlab;
               boolean lvt_18_1_ = lvt_14_2_ == lvt_6_1_;
               boolean lvt_19_1_ = lvt_14_2_.field_149785_s;
               boolean lvt_20_1_ = lvt_14_2_.field_149786_r == 0;
               if (lvt_16_1_ || lvt_17_1_ || lvt_18_1_ || lvt_19_1_ || lvt_20_1_) {
                  lvt_15_1_ = true;
               }

               lvt_14_2_.field_149783_u = lvt_15_1_;
            }
         }

         lvt_13_2_ = field_149771_c.iterator();

         while(lvt_13_2_.hasNext()) {
            lvt_14_2_ = (Block)lvt_13_2_.next();
            Iterator lvt_15_2_ = lvt_14_2_.func_176194_O().func_177619_a().iterator();

            while(lvt_15_2_.hasNext()) {
               IBlockState lvt_16_2_ = (IBlockState)lvt_15_2_.next();
               int lvt_17_2_ = field_149771_c.func_148757_b(lvt_14_2_) << 4 | lvt_14_2_.func_176201_c(lvt_16_2_);
               field_176229_d.func_148746_a(lvt_16_2_, lvt_17_2_);
            }
         }
