...
public class BlockCommandBlock extends BlockContainer {
   ...
   public void func_176204_a(World p_176204_1_, BlockPos p_176204_2_, IBlockState p_176204_3_, Block p_176204_4_) {
      if (!p_176204_1_.field_72995_K) {
         ...
         boolean lvt_6_1_ = (Boolean)p_176204_3_.func_177229_b(field_176452_a);
         if (lvt_5_1_ && !lvt_6_1_) {
            p_176204_1_.func_180501_a(p_176204_2_, p_176204_3_.func_177226_a(field_176452_a, true), 4);
            p_176204_1_.func_175684_a(p_176204_2_, this, this.func_149738_a(p_176204_1_));
         } else if (!lvt_5_1_ && lvt_6_1_) {
            p_176204_1_.func_180501_a(p_176204_2_, p_176204_3_.func_177226_a(field_176452_a, false), 4);
         }
      }
   ...
   public void func_180650_b(World p_180650_1_, BlockPos p_180650_2_, IBlockState p_180650_3_, Random p_180650_4_) {
      TileEntity lvt_5_1_ = p_180650_1_.func_175625_s(p_180650_2_);
      if (lvt_5_1_ instanceof TileEntityCommandBlock) {
         ((TileEntityCommandBlock)lvt_5_1_).func_145993_a().func_145755_a(p_180650_1_);
   ...
   public boolean func_180639_a(World p_180639_1_, BlockPos p_180639_2_, IBlockState p_180639_3_, EntityPlayer p_180639_4_, EnumFacing p_180639_5_, float p_180639_6_, float p_180639_7_, float p_180639_8_) {
      ...
      return lvt_9_1_ instanceof TileEntityCommandBlock ? ((TileEntityCommandBlock)lvt_9_1_).func_145993_a().func_175574_a(p_180639_4_) : false;
   }
   ...
   public int func_180641_l(World p_180641_1_, BlockPos p_180641_2_) {
      ...
      return lvt_3_1_ instanceof TileEntityCommandBlock ? ((TileEntityCommandBlock)lvt_3_1_).func_145993_a().func_145760_g() : 0;
   }
   ...
   public void func_180633_a(World p_180633_1_, BlockPos p_180633_2_, IBlockState p_180633_3_, EntityLivingBase p_180633_4_, ItemStack p_180633_5_) {
      ...
      if (lvt_6_1_ instanceof TileEntityCommandBlock) {
         CommandBlockLogic lvt_7_1_ = ((TileEntityCommandBlock)lvt_6_1_).func_145993_a();
         if (p_180633_5_.func_82837_s()) {
            lvt_7_1_.func_145754_b(p_180633_5_.func_82833_r());
         }

         if (!p_180633_1_.field_72995_K) {
            lvt_7_1_.func_175573_a(p_180633_1_.func_82736_K().func_82766_b("sendCommandFeedback"));
         }
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      return this.func_176223_P().func_177226_a(field_176452_a, (p_176203_1_ & 1) > 0);
   }

   public int func_176201_c(IBlockState p_176201_1_) {
      int lvt_2_1_ = 0;
      if ((Boolean)p_176201_1_.func_177229_b(field_176452_a)) {
         lvt_2_1_ |= 1;
      }
