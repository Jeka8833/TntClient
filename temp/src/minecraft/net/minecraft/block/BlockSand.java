...
public class BlockSand extends BlockFalling {
   ...
   public void func_149666_a(Item p_149666_1_, CreativeTabs p_149666_2_, List<ItemStack> p_149666_3_) {
      BlockSand.EnumType[] lvt_4_1_ = BlockSand.EnumType.values();
      int lvt_5_1_ = lvt_4_1_.length;

      for(int lvt_6_1_ = 0; lvt_6_1_ < lvt_5_1_; ++lvt_6_1_) {
         BlockSand.EnumType lvt_7_1_ = lvt_4_1_[lvt_6_1_];
         p_149666_3_.add(new ItemStack(p_149666_1_, 1, lvt_7_1_.func_176688_a()));
      }
   ...
   public static enum EnumType implements IStringSerializable {
      ...
      static {
         BlockSand.EnumType[] lvt_0_1_ = values();
         int lvt_1_1_ = lvt_0_1_.length;

         for(int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_; ++lvt_2_1_) {
            BlockSand.EnumType lvt_3_1_ = lvt_0_1_[lvt_2_1_];
            field_176695_c[lvt_3_1_.func_176688_a()] = lvt_3_1_;
         }
