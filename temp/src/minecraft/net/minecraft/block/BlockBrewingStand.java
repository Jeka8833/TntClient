...
public class BlockBrewingStand extends BlockContainer {
   ...
   public boolean func_180639_a(World p_180639_1_, BlockPos p_180639_2_, IBlockState p_180639_3_, EntityPlayer p_180639_4_, EnumFacing p_180639_5_, float p_180639_6_, float p_180639_7_, float p_180639_8_) {
      if (p_180639_1_.field_72995_K) {
         ...
         if (lvt_9_1_ instanceof TileEntityBrewingStand) {
            p_180639_4_.func_71007_a((TileEntityBrewingStand)lvt_9_1_);
   ...
   public void func_180633_a(World p_180633_1_, BlockPos p_180633_2_, IBlockState p_180633_3_, EntityLivingBase p_180633_4_, ItemStack p_180633_5_) {
      if (p_180633_5_.func_82837_s()) {
         ...
         if (lvt_6_1_ instanceof TileEntityBrewingStand) {
            ((TileEntityBrewingStand)lvt_6_1_).func_145937_a(p_180633_5_.func_82833_r());
         }
      }
   ...
   public void func_180655_c(World p_180655_1_, BlockPos p_180655_2_, IBlockState p_180655_3_, Random p_180655_4_) {
      double lvt_5_1_ = (double)((float)p_180655_2_.func_177958_n() + 0.4F + p_180655_4_.nextFloat() * 0.2F);
      double lvt_7_1_ = (double)((float)p_180655_2_.func_177956_o() + 0.7F + p_180655_4_.nextFloat() * 0.3F);
      double lvt_9_1_ = (double)((float)p_180655_2_.func_177952_p() + 0.4F + p_180655_4_.nextFloat() * 0.2F);
      p_180655_1_.func_175688_a(EnumParticleTypes.SMOKE_NORMAL, lvt_5_1_, lvt_7_1_, lvt_9_1_, 0.0D, 0.0D, 0.0D);
   }

   public void func_180663_b(World p_180663_1_, BlockPos p_180663_2_, IBlockState p_180663_3_) {
      TileEntity lvt_4_1_ = p_180663_1_.func_175625_s(p_180663_2_);
      if (lvt_4_1_ instanceof TileEntityBrewingStand) {
         InventoryHelper.func_180175_a(p_180663_1_, p_180663_2_, (TileEntityBrewingStand)lvt_4_1_);
      }
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      ...
      for(int lvt_3_1_ = 0; lvt_3_1_ < 3; ++lvt_3_1_) {
         lvt_2_1_ = lvt_2_1_.func_177226_a(field_176451_a[lvt_3_1_], (p_176203_1_ & 1 << lvt_3_1_) > 0);
      }
   ...
   public int func_176201_c(IBlockState p_176201_1_) {
      ...
      for(int lvt_3_1_ = 0; lvt_3_1_ < 3; ++lvt_3_1_) {
         if ((Boolean)p_176201_1_.func_177229_b(field_176451_a[lvt_3_1_])) {
            lvt_2_1_ |= 1 << lvt_3_1_;
         }
      }
