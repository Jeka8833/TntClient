...
public class BlockQuartz extends Block {
   ...
   public int func_180651_a(IBlockState p_180651_1_) {
      BlockQuartz.EnumType lvt_2_1_ = (BlockQuartz.EnumType)p_180651_1_.func_177229_b(field_176335_a);
      return lvt_2_1_ != BlockQuartz.EnumType.LINES_X && lvt_2_1_ != BlockQuartz.EnumType.LINES_Z ? lvt_2_1_.func_176796_a() : BlockQuartz.EnumType.LINES_Y.func_176796_a();
   }

   protected ItemStack func_180643_i(IBlockState p_180643_1_) {
      BlockQuartz.EnumType lvt_2_1_ = (BlockQuartz.EnumType)p_180643_1_.func_177229_b(field_176335_a);
      return lvt_2_1_ != BlockQuartz.EnumType.LINES_X && lvt_2_1_ != BlockQuartz.EnumType.LINES_Z ? super.func_180643_i(p_180643_1_) : new ItemStack(Item.func_150898_a(this), 1, BlockQuartz.EnumType.LINES_Y.func_176796_a());
   }
   ...
   public static enum EnumType implements IStringSerializable {
      ...
      static {
         BlockQuartz.EnumType[] lvt_0_1_ = values();
         int lvt_1_1_ = lvt_0_1_.length;

         for(int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_; ++lvt_2_1_) {
            BlockQuartz.EnumType lvt_3_1_ = lvt_0_1_[lvt_2_1_];
            field_176797_f[lvt_3_1_.func_176796_a()] = lvt_3_1_;
         }
