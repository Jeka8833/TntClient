...
public class BlockCauldron extends Block {
   ...
   public void func_180634_a(World p_180634_1_, BlockPos p_180634_2_, IBlockState p_180634_3_, Entity p_180634_4_) {
      int lvt_5_1_ = (Integer)p_180634_3_.func_177229_b(field_176591_a);
   ...
   public boolean func_180639_a(World p_180639_1_, BlockPos p_180639_2_, IBlockState p_180639_3_, EntityPlayer p_180639_4_, EnumFacing p_180639_5_, float p_180639_6_, float p_180639_7_, float p_180639_8_) {
      if (p_180639_1_.field_72995_K) {
         ...
         if (lvt_9_1_ == null) {
            ...
            int lvt_10_1_ = (Integer)p_180639_3_.func_177229_b(field_176591_a);
            ...
            if (lvt_11_1_ == Items.field_151131_as) {
               ...
               ItemStack lvt_12_3_;
               if (lvt_11_1_ == Items.field_151069_bo) {
                  if (lvt_10_1_ > 0) {
                     if (!p_180639_4_.field_71075_bZ.field_75098_d) {
                        lvt_12_3_ = new ItemStack(Items.field_151068_bn, 1, 0);
                  ...
                  if (lvt_10_1_ > 0 && lvt_11_1_ instanceof ItemBanner && TileEntityBanner.func_175113_c(lvt_9_1_) > 0) {
                     lvt_12_3_ = lvt_9_1_.func_77946_l();
   ...
   public void func_176224_k(World p_176224_1_, BlockPos p_176224_2_) {
      if (p_176224_1_.field_73012_v.nextInt(20) == 1) {
         ...
         if ((Integer)lvt_3_1_.func_177229_b(field_176591_a) < 3) {
   ...
   public int func_180641_l(World p_180641_1_, BlockPos p_180641_2_) {
      return (Integer)p_180641_1_.func_180495_p(p_180641_2_).func_177229_b(field_176591_a);
   }

   public IBlockState func_176203_a(int p_176203_1_) {
      return this.func_176223_P().func_177226_a(field_176591_a, p_176203_1_);
   }

   public int func_176201_c(IBlockState p_176201_1_) {
      return (Integer)p_176201_1_.func_177229_b(field_176591_a);
   }
