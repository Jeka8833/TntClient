...
public class BlockSnow extends Block {
   ...
   public boolean func_176205_b(IBlockAccess p_176205_1_, BlockPos p_176205_2_) {
      return (Integer)p_176205_1_.func_180495_p(p_176205_2_).func_177229_b(field_176315_a) < 5;
   }

   public AxisAlignedBB func_180640_a(World p_180640_1_, BlockPos p_180640_2_, IBlockState p_180640_3_) {
      int lvt_4_1_ = (Integer)p_180640_3_.func_177229_b(field_176315_a) - 1;
      float lvt_5_1_ = 0.125F;
      return new AxisAlignedBB((double)p_180640_2_.func_177958_n() + this.field_149759_B, (double)p_180640_2_.func_177956_o() + this.field_149760_C, (double)p_180640_2_.func_177952_p() + this.field_149754_D, (double)p_180640_2_.func_177958_n() + this.field_149755_E, (double)((float)p_180640_2_.func_177956_o() + (float)lvt_4_1_ * lvt_5_1_), (double)p_180640_2_.func_177952_p() + this.field_149757_G);
   }
   ...
   public void func_180654_a(IBlockAccess p_180654_1_, BlockPos p_180654_2_) {
      ...
      this.func_150154_b((Integer)lvt_3_1_.func_177229_b(field_176315_a));
   }
   ...
   public boolean func_176196_c(World p_176196_1_, BlockPos p_176196_2_) {
      IBlockState lvt_3_1_ = p_176196_1_.func_180495_p(p_176196_2_.func_177977_b());
      Block lvt_4_1_ = lvt_3_1_.func_177230_c();
      if (lvt_4_1_ != Blocks.field_150432_aD && lvt_4_1_ != Blocks.field_150403_cj) {
         if (lvt_4_1_.func_149688_o() == Material.field_151584_j) {
            return true;
         } else if (lvt_4_1_ == this && (Integer)lvt_3_1_.func_177229_b(field_176315_a) >= 7) {
            return true;
         } else {
            return lvt_4_1_.func_149662_c() && lvt_4_1_.field_149764_J.func_76230_c();
         }
      } else {
         return false;
      }
   ...
   public void func_180657_a(World p_180657_1_, EntityPlayer p_180657_2_, BlockPos p_180657_3_, IBlockState p_180657_4_, TileEntity p_180657_5_) {
      func_180635_a(p_180657_1_, p_180657_3_, new ItemStack(Items.field_151126_ay, (Integer)p_180657_4_.func_177229_b(field_176315_a) + 1, 0));
   ...
   public boolean func_176200_f(World p_176200_1_, BlockPos p_176200_2_) {
      return (Integer)p_176200_1_.func_180495_p(p_176200_2_).func_177229_b(field_176315_a) == 1;
   }

   public int func_176201_c(IBlockState p_176201_1_) {
      return (Integer)p_176201_1_.func_177229_b(field_176315_a) - 1;
   }
