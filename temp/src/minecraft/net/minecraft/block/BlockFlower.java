...
public abstract class BlockFlower extends BlockBush {
   ...
   public void func_149666_a(Item p_149666_1_, CreativeTabs p_149666_2_, List<ItemStack> p_149666_3_) {
      BlockFlower.EnumFlowerType[] lvt_4_1_ = BlockFlower.EnumFlowerType.func_176966_a(this.func_176495_j());
      int lvt_5_1_ = lvt_4_1_.length;

      for(int lvt_6_1_ = 0; lvt_6_1_ < lvt_5_1_; ++lvt_6_1_) {
         BlockFlower.EnumFlowerType lvt_7_1_ = lvt_4_1_[lvt_6_1_];
         p_149666_3_.add(new ItemStack(p_149666_1_, 1, lvt_7_1_.func_176968_b()));
      }
   ...
   public static enum EnumFlowerType implements IStringSerializable {
      ...
      public static BlockFlower.EnumFlowerType func_176967_a(BlockFlower.EnumFlowerColor p_176967_0_, int p_176967_1_) {
         BlockFlower.EnumFlowerType[] lvt_2_1_ = field_176981_k[p_176967_0_.ordinal()];
         if (p_176967_1_ < 0 || p_176967_1_ >= lvt_2_1_.length) {
            p_176967_1_ = 0;
         }

         return lvt_2_1_[p_176967_1_];
      }
      ...
      static {
         BlockFlower.EnumFlowerColor[] lvt_0_1_ = BlockFlower.EnumFlowerColor.values();
         int lvt_1_1_ = lvt_0_1_.length;

         for(int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_; ++lvt_2_1_) {
            final BlockFlower.EnumFlowerColor lvt_3_1_ = lvt_0_1_[lvt_2_1_];
            Collection<BlockFlower.EnumFlowerType> lvt_4_1_ = Collections2.filter(Lists.newArrayList((Object[])values()), new Predicate<BlockFlower.EnumFlowerType>() {
               public boolean apply(BlockFlower.EnumFlowerType p_apply_1_) {
                  return p_apply_1_.func_176964_a() == lvt_3_1_;
               }
            });
            field_176981_k[lvt_3_1_.ordinal()] = (BlockFlower.EnumFlowerType[])lvt_4_1_.toArray(new BlockFlower.EnumFlowerType[lvt_4_1_.size()]);
         }
