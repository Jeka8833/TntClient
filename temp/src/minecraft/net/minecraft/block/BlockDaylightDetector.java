...
public class BlockDaylightDetector extends BlockContainer {
   ...
   public int func_180656_a(IBlockAccess p_180656_1_, BlockPos p_180656_2_, IBlockState p_180656_3_, EnumFacing p_180656_4_) {
      return (Integer)p_180656_3_.func_177229_b(field_176436_a);
   }

   public void func_180677_d(World p_180677_1_, BlockPos p_180677_2_) {
      if (!p_180677_1_.field_73011_w.func_177495_o()) {
         IBlockState lvt_3_1_ = p_180677_1_.func_180495_p(p_180677_2_);
         int lvt_4_1_ = p_180677_1_.func_175642_b(EnumSkyBlock.SKY, p_180677_2_) - p_180677_1_.func_175657_ab();
         float lvt_5_1_ = p_180677_1_.func_72929_e(1.0F);
         float lvt_6_1_ = lvt_5_1_ < 3.1415927F ? 0.0F : 6.2831855F;
         lvt_5_1_ += (lvt_6_1_ - lvt_5_1_) * 0.2F;
         lvt_4_1_ = Math.round((float)lvt_4_1_ * MathHelper.func_76134_b(lvt_5_1_));
         lvt_4_1_ = MathHelper.func_76125_a(lvt_4_1_, 0, 15);
         if (this.field_176435_b) {
            lvt_4_1_ = 15 - lvt_4_1_;
         }

         if ((Integer)lvt_3_1_.func_177229_b(field_176436_a) != lvt_4_1_) {
            p_180677_1_.func_180501_a(p_180677_2_, lvt_3_1_.func_177226_a(field_176436_a, lvt_4_1_), 3);
         }
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      return this.func_176223_P().func_177226_a(field_176436_a, p_176203_1_);
   }

   public int func_176201_c(IBlockState p_176201_1_) {
      return (Integer)p_176201_1_.func_177229_b(field_176436_a);
   }
