...
public abstract class BlockBasePressurePlate extends Block {
   ...
   protected void func_180668_d(IBlockState p_180668_1_) {
      boolean lvt_2_1_ = this.func_176576_e(p_180668_1_) > 0;
   ...
   public void func_180650_b(World p_180650_1_, BlockPos p_180650_2_, IBlockState p_180650_3_, Random p_180650_4_) {
      if (!p_180650_1_.field_72995_K) {
         int lvt_5_1_ = this.func_176576_e(p_180650_3_);
         if (lvt_5_1_ > 0) {
            this.func_180666_a(p_180650_1_, p_180650_2_, p_180650_3_, lvt_5_1_);
         }
   ...
   public void func_180634_a(World p_180634_1_, BlockPos p_180634_2_, IBlockState p_180634_3_, Entity p_180634_4_) {
      if (!p_180634_1_.field_72995_K) {
         int lvt_5_1_ = this.func_176576_e(p_180634_3_);
         if (lvt_5_1_ == 0) {
            this.func_180666_a(p_180634_1_, p_180634_2_, p_180634_3_, lvt_5_1_);
         }
   ...
   protected void func_180666_a(World p_180666_1_, BlockPos p_180666_2_, IBlockState p_180666_3_, int p_180666_4_) {
      int lvt_5_1_ = this.func_180669_e(p_180666_1_, p_180666_2_);
      boolean lvt_6_1_ = p_180666_4_ > 0;
      boolean lvt_7_1_ = lvt_5_1_ > 0;
      if (p_180666_4_ != lvt_5_1_) {
         p_180666_3_ = this.func_176575_a(p_180666_3_, lvt_5_1_);
