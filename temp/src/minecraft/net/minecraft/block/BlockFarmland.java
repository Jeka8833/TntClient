...
public class BlockFarmland extends Block {
   ...
   public void func_180650_b(World p_180650_1_, BlockPos p_180650_2_, IBlockState p_180650_3_, Random p_180650_4_) {
      int lvt_5_1_ = (Integer)p_180650_3_.func_177229_b(field_176531_a);
      if (!this.func_176530_e(p_180650_1_, p_180650_2_) && !p_180650_1_.func_175727_C(p_180650_2_.func_177984_a())) {
         if (lvt_5_1_ > 0) {
            p_180650_1_.func_180501_a(p_180650_2_, p_180650_3_.func_177226_a(field_176531_a, lvt_5_1_ - 1), 2);
   ...
   private boolean func_176529_d(World p_176529_1_, BlockPos p_176529_2_) {
      Block lvt_3_1_ = p_176529_1_.func_180495_p(p_176529_2_.func_177984_a()).func_177230_c();
      return lvt_3_1_ instanceof BlockCrops || lvt_3_1_ instanceof BlockStem;
   }

   private boolean func_176530_e(World p_176530_1_, BlockPos p_176530_2_) {
      Iterator lvt_3_1_ = BlockPos.func_177975_b(p_176530_2_.func_177982_a(-4, 0, -4), p_176530_2_.func_177982_a(4, 1, 4)).iterator();

      BlockPos.MutableBlockPos lvt_4_1_;
      do {
         if (!lvt_3_1_.hasNext()) {
            return false;
         }

         lvt_4_1_ = (BlockPos.MutableBlockPos)lvt_3_1_.next();
      } while(p_176530_1_.func_180495_p(lvt_4_1_).func_177230_c().func_149688_o() != Material.field_151586_h);
   ...
   public boolean func_176225_a(IBlockAccess p_176225_1_, BlockPos p_176225_2_, EnumFacing p_176225_3_) {
      ...
      case WEST:
      case EAST:
         Block lvt_4_1_ = p_176225_1_.func_180495_p(p_176225_2_).func_177230_c();
         return !lvt_4_1_.func_149662_c() && lvt_4_1_ != Blocks.field_150458_ak;
      default:
   ...
   public int func_176201_c(IBlockState p_176201_1_) {
      return (Integer)p_176201_1_.func_177229_b(field_176531_a);
   }
