...
public class BlockDirt extends Block {
   ...
   public IBlockState func_176221_a(IBlockState p_176221_1_, IBlockAccess p_176221_2_, BlockPos p_176221_3_) {
      if (p_176221_1_.func_177229_b(field_176386_a) == BlockDirt.DirtType.PODZOL) {
         ...
         p_176221_1_ = p_176221_1_.func_177226_a(field_176385_b, lvt_4_1_ == Blocks.field_150433_aE || lvt_4_1_ == Blocks.field_150431_aC);
      }
   ...
   public int func_176222_j(World p_176222_1_, BlockPos p_176222_2_) {
      ...
      return lvt_3_1_.func_177230_c() != this ? 0 : ((BlockDirt.DirtType)lvt_3_1_.func_177229_b(field_176386_a)).func_176925_a();
   }
   ...
   public int func_180651_a(IBlockState p_180651_1_) {
      BlockDirt.DirtType lvt_2_1_ = (BlockDirt.DirtType)p_180651_1_.func_177229_b(field_176386_a);
      if (lvt_2_1_ == BlockDirt.DirtType.PODZOL) {
         lvt_2_1_ = BlockDirt.DirtType.DIRT;
      }

      return lvt_2_1_.func_176925_a();
   }
   ...
   public static enum DirtType implements IStringSerializable {
      ...
      static {
         BlockDirt.DirtType[] lvt_0_1_ = values();
         int lvt_1_1_ = lvt_0_1_.length;

         for(int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_; ++lvt_2_1_) {
            BlockDirt.DirtType lvt_3_1_ = lvt_0_1_[lvt_2_1_];
            field_176930_d[lvt_3_1_.func_176925_a()] = lvt_3_1_;
         }
