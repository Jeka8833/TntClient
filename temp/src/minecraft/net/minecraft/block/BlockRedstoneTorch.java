...
public class BlockRedstoneTorch extends BlockTorch {
   ...
   private boolean func_176598_a(World p_176598_1_, BlockPos p_176598_2_, boolean p_176598_3_) {
      ...
      if (p_176598_3_) {
         lvt_4_1_.add(new BlockRedstoneTorch.Toggle(p_176598_2_, p_176598_1_.func_82737_E()));
      }
      ...
      for(int lvt_6_1_ = 0; lvt_6_1_ < lvt_4_1_.size(); ++lvt_6_1_) {
         ...
         if (lvt_7_1_.field_180111_a.equals(p_176598_2_)) {
            ++lvt_5_1_;
            if (lvt_5_1_ >= 8) {
               return true;
            }
   ...
   public void func_176213_c(World p_176213_1_, BlockPos p_176213_2_, IBlockState p_176213_3_) {
      if (this.field_150113_a) {
         ...
         for(int lvt_6_1_ = 0; lvt_6_1_ < lvt_5_1_; ++lvt_6_1_) {
            ...
            p_176213_1_.func_175685_c(p_176213_2_.func_177972_a(lvt_7_1_), this);
         }
      }
   ...
   private boolean func_176597_g(World p_176597_1_, BlockPos p_176597_2_, IBlockState p_176597_3_) {
      EnumFacing lvt_4_1_ = ((EnumFacing)p_176597_3_.func_177229_b(field_176596_a)).func_176734_d();
      return p_176597_1_.func_175709_b(p_176597_2_.func_177972_a(lvt_4_1_), lvt_4_1_);
   }
   ...
   public void func_180650_b(World p_180650_1_, BlockPos p_180650_2_, IBlockState p_180650_3_, Random p_180650_4_) {
      boolean lvt_5_1_ = this.func_176597_g(p_180650_1_, p_180650_2_, p_180650_3_);
      List lvt_6_1_ = (List)field_150112_b.get(p_180650_1_);

      while(lvt_6_1_ != null && !lvt_6_1_.isEmpty() && p_180650_1_.func_82737_E() - ((BlockRedstoneTorch.Toggle)lvt_6_1_.get(0)).field_150844_d > 60L) {
         lvt_6_1_.remove(0);
      }
         ...
         if (lvt_5_1_) {
            ...
            if (this.func_176598_a(p_180650_1_, p_180650_2_, true)) {
               ...
               for(int lvt_7_1_ = 0; lvt_7_1_ < 5; ++lvt_7_1_) {
                  double lvt_8_1_ = (double)p_180650_2_.func_177958_n() + p_180650_4_.nextDouble() * 0.6D + 0.2D;
                  double lvt_10_1_ = (double)p_180650_2_.func_177956_o() + p_180650_4_.nextDouble() * 0.6D + 0.2D;
                  double lvt_12_1_ = (double)p_180650_2_.func_177952_p() + p_180650_4_.nextDouble() * 0.6D + 0.2D;
                  p_180650_1_.func_175688_a(EnumParticleTypes.SMOKE_NORMAL, lvt_8_1_, lvt_10_1_, lvt_12_1_, 0.0D, 0.0D, 0.0D);
               }

               p_180650_1_.func_175684_a(p_180650_2_, p_180650_1_.func_180495_p(p_180650_2_).func_177230_c(), 160);
            }
         }
      } else if (!lvt_5_1_ && !this.func_176598_a(p_180650_1_, p_180650_2_, false)) {
   ...
   public void func_180655_c(World p_180655_1_, BlockPos p_180655_2_, IBlockState p_180655_3_, Random p_180655_4_) {
      if (this.field_150113_a) {
         double lvt_5_1_ = (double)p_180655_2_.func_177958_n() + 0.5D + (p_180655_4_.nextDouble() - 0.5D) * 0.2D;
         double lvt_7_1_ = (double)p_180655_2_.func_177956_o() + 0.7D + (p_180655_4_.nextDouble() - 0.5D) * 0.2D;
         double lvt_9_1_ = (double)p_180655_2_.func_177952_p() + 0.5D + (p_180655_4_.nextDouble() - 0.5D) * 0.2D;
         EnumFacing lvt_11_1_ = (EnumFacing)p_180655_3_.func_177229_b(field_176596_a);
         if (lvt_11_1_.func_176740_k().func_176722_c()) {
            EnumFacing lvt_12_1_ = lvt_11_1_.func_176734_d();
            double lvt_13_1_ = 0.27D;
            lvt_5_1_ += 0.27D * (double)lvt_12_1_.func_82601_c();
            lvt_7_1_ += 0.22D;
            lvt_9_1_ += 0.27D * (double)lvt_12_1_.func_82599_e();
         }

         p_180655_1_.func_175688_a(EnumParticleTypes.REDSTONE, lvt_5_1_, lvt_7_1_, lvt_9_1_, 0.0D, 0.0D, 0.0D);
      }
   }
