...
public class BlockSponge extends Block {
   ...
   public int func_180651_a(IBlockState p_180651_1_) {
      return (Boolean)p_180651_1_.func_177229_b(field_176313_a) ? 1 : 0;
   }
   ...
   protected void func_176311_e(World p_176311_1_, BlockPos p_176311_2_, IBlockState p_176311_3_) {
      if (!(Boolean)p_176311_3_.func_177229_b(field_176313_a) && this.func_176312_d(p_176311_1_, p_176311_2_)) {
         p_176311_1_.func_180501_a(p_176311_2_, p_176311_3_.func_177226_a(field_176313_a, true), 2);
   ...
   private boolean func_176312_d(World p_176312_1_, BlockPos p_176312_2_) {
      ...
      while(!lvt_3_1_.isEmpty()) {
         ...
         lvt_7_1_ = (BlockPos)lvt_6_1_.func_76341_a();
         int lvt_8_1_ = (Integer)lvt_6_1_.func_76340_b();
         ...
         for(int lvt_11_1_ = 0; lvt_11_1_ < lvt_10_1_; ++lvt_11_1_) {
            ...
            if (p_176312_1_.func_180495_p(lvt_13_1_).func_177230_c().func_149688_o() == Material.field_151586_h) {
               ...
               ++lvt_5_1_;
               if (lvt_8_1_ < 6) {
                  lvt_3_1_.add(new Tuple(lvt_13_1_, lvt_8_1_ + 1));
               }
            }
         }
      ...
      Iterator lvt_6_2_ = lvt_4_1_.iterator();

      while(lvt_6_2_.hasNext()) {
         lvt_7_1_ = (BlockPos)lvt_6_2_.next();
         p_176312_1_.func_175685_c(lvt_7_1_, Blocks.field_150350_a);
      }
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      return this.func_176223_P().func_177226_a(field_176313_a, (p_176203_1_ & 1) == 1);
   }

   public int func_176201_c(IBlockState p_176201_1_) {
      return (Boolean)p_176201_1_.func_177229_b(field_176313_a) ? 1 : 0;
   }
   ...
   public void func_180655_c(World p_180655_1_, BlockPos p_180655_2_, IBlockState p_180655_3_, Random p_180655_4_) {
      if ((Boolean)p_180655_3_.func_177229_b(field_176313_a)) {
         ...
         if (lvt_5_1_ != EnumFacing.UP && !World.func_175683_a(p_180655_1_, p_180655_2_.func_177972_a(lvt_5_1_))) {
            ...
            if (lvt_5_1_ == EnumFacing.DOWN) {
               ...
               lvt_8_1_ += p_180655_4_.nextDouble() * 0.8D;
            ...
            p_180655_1_.func_175688_a(EnumParticleTypes.DRIP_WATER, lvt_6_1_, lvt_8_1_, lvt_10_1_, 0.0D, 0.0D, 0.0D);
         }
      }
   }
}
