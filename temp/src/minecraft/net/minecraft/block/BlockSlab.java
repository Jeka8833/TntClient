...
public abstract class BlockSlab extends Block {
   ...
   public void func_180654_a(IBlockAccess p_180654_1_, BlockPos p_180654_2_) {
      if (this.func_176552_j()) {
         ...
         if (lvt_3_1_.func_177230_c() == this) {
            if (lvt_3_1_.func_177229_b(field_176554_a) == BlockSlab.EnumBlockHalf.TOP) {
   ...
   public IBlockState func_180642_a(World p_180642_1_, BlockPos p_180642_2_, EnumFacing p_180642_3_, float p_180642_4_, float p_180642_5_, float p_180642_6_, int p_180642_7_, EntityLivingBase p_180642_8_) {
      IBlockState lvt_9_1_ = super.func_180642_a(p_180642_1_, p_180642_2_, p_180642_3_, p_180642_4_, p_180642_5_, p_180642_6_, p_180642_7_, p_180642_8_).func_177226_a(field_176554_a, BlockSlab.EnumBlockHalf.BOTTOM);
      if (this.func_176552_j()) {
         return lvt_9_1_;
      } else {
         return p_180642_3_ != EnumFacing.DOWN && (p_180642_3_ == EnumFacing.UP || (double)p_180642_5_ <= 0.5D) ? lvt_9_1_ : lvt_9_1_.func_177226_a(field_176554_a, BlockSlab.EnumBlockHalf.TOP);
      }
   }
   ...
   public boolean func_176225_a(IBlockAccess p_176225_1_, BlockPos p_176225_2_, EnumFacing p_176225_3_) {
      if (this.func_176552_j()) {
         ...
         BlockPos lvt_4_1_ = p_176225_2_.func_177972_a(p_176225_3_.func_176734_d());
         IBlockState lvt_5_1_ = p_176225_1_.func_180495_p(p_176225_2_);
         IBlockState lvt_6_1_ = p_176225_1_.func_180495_p(lvt_4_1_);
         boolean lvt_7_1_ = func_150003_a(lvt_5_1_.func_177230_c()) && lvt_5_1_.func_177229_b(field_176554_a) == BlockSlab.EnumBlockHalf.TOP;
         boolean lvt_8_1_ = func_150003_a(lvt_6_1_.func_177230_c()) && lvt_6_1_.func_177229_b(field_176554_a) == BlockSlab.EnumBlockHalf.TOP;
         if (lvt_8_1_) {
            if (p_176225_3_ == EnumFacing.DOWN) {
               ...
               return !func_150003_a(lvt_5_1_.func_177230_c()) || !lvt_7_1_;
            }
