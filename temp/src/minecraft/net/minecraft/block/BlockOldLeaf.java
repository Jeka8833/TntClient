...
public class BlockOldLeaf extends BlockLeaves {
   ...
   public int func_180644_h(IBlockState p_180644_1_) {
      if (p_180644_1_.func_177230_c() != this) {
         ...
         BlockPlanks.EnumType lvt_2_1_ = (BlockPlanks.EnumType)p_180644_1_.func_177229_b(field_176239_P);
         if (lvt_2_1_ == BlockPlanks.EnumType.SPRUCE) {
            return ColorizerFoliage.func_77466_a();
         } else {
            return lvt_2_1_ == BlockPlanks.EnumType.BIRCH ? ColorizerFoliage.func_77469_b() : super.func_180644_h(p_180644_1_);
         }
      }
   }
   ...
   public int func_180662_a(IBlockAccess p_180662_1_, BlockPos p_180662_2_, int p_180662_3_) {
      ...
      if (lvt_4_1_.func_177230_c() == this) {
         BlockPlanks.EnumType lvt_5_1_ = (BlockPlanks.EnumType)lvt_4_1_.func_177229_b(field_176239_P);
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      return this.func_176223_P().func_177226_a(field_176239_P, this.func_176233_b(p_176203_1_)).func_177226_a(field_176237_a, (p_176203_1_ & 4) == 0).func_177226_a(field_176236_b, (p_176203_1_ & 8) > 0);
   }

   public int func_176201_c(IBlockState p_176201_1_) {
      int lvt_2_1_ = 0;
      int lvt_2_1_ = lvt_2_1_ | ((BlockPlanks.EnumType)p_176201_1_.func_177229_b(field_176239_P)).func_176839_a();
      if (!(Boolean)p_176201_1_.func_177229_b(field_176237_a)) {
         lvt_2_1_ |= 4;
      }

      if ((Boolean)p_176201_1_.func_177229_b(field_176236_b)) {
         lvt_2_1_ |= 8;
      }
