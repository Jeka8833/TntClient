...
public class BlockBanner extends BlockContainer {
   ...
   protected BlockBanner() {
      ...
      float lvt_2_1_ = 1.0F;
      this.func_149676_a(0.5F - lvt_1_1_, 0.0F, 0.5F - lvt_1_1_, 0.5F + lvt_1_1_, lvt_2_1_, 0.5F + lvt_1_1_);
   }
   ...
   public void func_180653_a(World p_180653_1_, BlockPos p_180653_2_, IBlockState p_180653_3_, float p_180653_4_, int p_180653_5_) {
      TileEntity lvt_6_1_ = p_180653_1_.func_175625_s(p_180653_2_);
      if (lvt_6_1_ instanceof TileEntityBanner) {
         ItemStack lvt_7_1_ = new ItemStack(Items.field_179564_cE, 1, ((TileEntityBanner)lvt_6_1_).func_175115_b());
         NBTTagCompound lvt_8_1_ = new NBTTagCompound();
         lvt_6_1_.func_145841_b(lvt_8_1_);
         lvt_8_1_.func_82580_o("x");
         lvt_8_1_.func_82580_o("y");
         lvt_8_1_.func_82580_o("z");
         lvt_8_1_.func_82580_o("id");
         lvt_7_1_.func_77983_a("BlockEntityTag", lvt_8_1_);
         func_180635_a(p_180653_1_, p_180653_2_, lvt_7_1_);
      } else {
   ...
   public void func_180657_a(World p_180657_1_, EntityPlayer p_180657_2_, BlockPos p_180657_3_, IBlockState p_180657_4_, TileEntity p_180657_5_) {
      if (p_180657_5_ instanceof TileEntityBanner) {
         TileEntityBanner lvt_6_1_ = (TileEntityBanner)p_180657_5_;
         ItemStack lvt_7_1_ = new ItemStack(Items.field_179564_cE, 1, ((TileEntityBanner)p_180657_5_).func_175115_b());
         NBTTagCompound lvt_8_1_ = new NBTTagCompound();
         TileEntityBanner.func_181020_a(lvt_8_1_, lvt_6_1_.func_175115_b(), lvt_6_1_.func_181021_d());
         lvt_7_1_.func_77983_a("BlockEntityTag", lvt_8_1_);
         func_180635_a(p_180657_1_, p_180657_3_, lvt_7_1_);
      } else {
   ...
   public static class BlockBannerStanding extends BlockBanner {
      ...
      public int func_176201_c(IBlockState p_176201_1_) {
         return (Integer)p_176201_1_.func_177229_b(field_176448_b);
      }
   ...
   public static class BlockBannerHanging extends BlockBanner {
      ...
      public void func_180654_a(IBlockAccess p_180654_1_, BlockPos p_180654_2_) {
         EnumFacing lvt_3_1_ = (EnumFacing)p_180654_1_.func_180495_p(p_180654_2_).func_177229_b(field_176449_a);
         float lvt_4_1_ = 0.0F;
      ...
      public void func_176204_a(World p_176204_1_, BlockPos p_176204_2_, IBlockState p_176204_3_, Block p_176204_4_) {
         EnumFacing lvt_5_1_ = (EnumFacing)p_176204_3_.func_177229_b(field_176449_a);
      ...
      public IBlockState func_176203_a(int p_176203_1_) {
         ...
         return this.func_176223_P().func_177226_a(field_176449_a, lvt_2_1_);
      }
