...
public class BlockStoneBrick extends Block {
   ...
   public void func_149666_a(Item p_149666_1_, CreativeTabs p_149666_2_, List<ItemStack> p_149666_3_) {
      BlockStoneBrick.EnumType[] lvt_4_1_ = BlockStoneBrick.EnumType.values();
      int lvt_5_1_ = lvt_4_1_.length;

      for(int lvt_6_1_ = 0; lvt_6_1_ < lvt_5_1_; ++lvt_6_1_) {
         BlockStoneBrick.EnumType lvt_7_1_ = lvt_4_1_[lvt_6_1_];
         p_149666_3_.add(new ItemStack(p_149666_1_, 1, lvt_7_1_.func_176612_a()));
      }
   ...
   public static enum EnumType implements IStringSerializable {
      ...
      static {
         BlockStoneBrick.EnumType[] lvt_0_1_ = values();
         int lvt_1_1_ = lvt_0_1_.length;

         for(int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_; ++lvt_2_1_) {
            BlockStoneBrick.EnumType lvt_3_1_ = lvt_0_1_[lvt_2_1_];
            field_176618_e[lvt_3_1_.func_176612_a()] = lvt_3_1_;
         }
