...
public class BlockRailDetector extends BlockRailBase {
   ...
   public void func_180634_a(World p_180634_1_, BlockPos p_180634_2_, IBlockState p_180634_3_, Entity p_180634_4_) {
      if (!p_180634_1_.field_72995_K) {
         if (!(Boolean)p_180634_3_.func_177229_b(field_176574_M)) {
   ...
   public void func_180650_b(World p_180650_1_, BlockPos p_180650_2_, IBlockState p_180650_3_, Random p_180650_4_) {
      if (!p_180650_1_.field_72995_K && (Boolean)p_180650_3_.func_177229_b(field_176574_M)) {
   ...
   private void func_176570_e(World p_176570_1_, BlockPos p_176570_2_, IBlockState p_176570_3_) {
      boolean lvt_4_1_ = (Boolean)p_176570_3_.func_177229_b(field_176574_M);
      boolean lvt_5_1_ = false;
      List<EntityMinecart> lvt_6_1_ = this.func_176571_a(p_176570_1_, p_176570_2_, EntityMinecart.class);
      if (!lvt_6_1_.isEmpty()) {
         lvt_5_1_ = true;
      }
   ...
   public int func_180641_l(World p_180641_1_, BlockPos p_180641_2_) {
      if ((Boolean)p_180641_1_.func_180495_p(p_180641_2_).func_177229_b(field_176574_M)) {
         List<EntityMinecartCommandBlock> lvt_3_1_ = this.func_176571_a(p_180641_1_, p_180641_2_, EntityMinecartCommandBlock.class);
         if (!lvt_3_1_.isEmpty()) {
            return ((EntityMinecartCommandBlock)lvt_3_1_.get(0)).func_145822_e().func_145760_g();
         }

         List<EntityMinecart> lvt_4_1_ = this.func_176571_a(p_180641_1_, p_180641_2_, EntityMinecart.class, EntitySelectors.field_96566_b);
         if (!lvt_4_1_.isEmpty()) {
            return Container.func_94526_b((IInventory)lvt_4_1_.get(0));
         }
      }
   ...
   protected <T extends EntityMinecart> List<T> func_176571_a(World p_176571_1_, BlockPos p_176571_2_, Class<T> p_176571_3_, Predicate<Entity>... p_176571_4_) {
      AxisAlignedBB lvt_5_1_ = this.func_176572_a(p_176571_2_);
      return p_176571_4_.length != 1 ? p_176571_1_.func_72872_a(p_176571_3_, lvt_5_1_) : p_176571_1_.func_175647_a(p_176571_3_, lvt_5_1_, p_176571_4_[0]);
   }
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      return this.func_176223_P().func_177226_a(field_176573_b, BlockRailBase.EnumRailDirection.func_177016_a(p_176203_1_ & 7)).func_177226_a(field_176574_M, (p_176203_1_ & 8) > 0);
   }

   public int func_176201_c(IBlockState p_176201_1_) {
      int lvt_2_1_ = 0;
      int lvt_2_1_ = lvt_2_1_ | ((BlockRailBase.EnumRailDirection)p_176201_1_.func_177229_b(field_176573_b)).func_177015_a();
      if ((Boolean)p_176201_1_.func_177229_b(field_176574_M)) {
         lvt_2_1_ |= 8;
      }
