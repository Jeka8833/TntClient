...
public class BlockEndPortalFrame extends Block {
   ...
   public void func_180638_a(World p_180638_1_, BlockPos p_180638_2_, IBlockState p_180638_3_, AxisAlignedBB p_180638_4_, List<AxisAlignedBB> p_180638_5_, Entity p_180638_6_) {
      ...
      if ((Boolean)p_180638_1_.func_180495_p(p_180638_2_).func_177229_b(field_176507_b)) {
   ...
   public IBlockState func_180642_a(World p_180642_1_, BlockPos p_180642_2_, EnumFacing p_180642_3_, float p_180642_4_, float p_180642_5_, float p_180642_6_, int p_180642_7_, EntityLivingBase p_180642_8_) {
      return this.func_176223_P().func_177226_a(field_176508_a, p_180642_8_.func_174811_aO().func_176734_d()).func_177226_a(field_176507_b, false);
   }
   ...
   public int func_180641_l(World p_180641_1_, BlockPos p_180641_2_) {
      return (Boolean)p_180641_1_.func_180495_p(p_180641_2_).func_177229_b(field_176507_b) ? 15 : 0;
   }

   public IBlockState func_176203_a(int p_176203_1_) {
      return this.func_176223_P().func_177226_a(field_176507_b, (p_176203_1_ & 4) != 0).func_177226_a(field_176508_a, EnumFacing.func_176731_b(p_176203_1_ & 3));
   }

   public int func_176201_c(IBlockState p_176201_1_) {
      int lvt_2_1_ = 0;
      int lvt_2_1_ = lvt_2_1_ | ((EnumFacing)p_176201_1_.func_177229_b(field_176508_a)).func_176736_b();
      if ((Boolean)p_176201_1_.func_177229_b(field_176507_b)) {
         lvt_2_1_ |= 4;
      }
