...
public class BlockTallGrass extends BlockBush implements IGrowable {
   ...
   protected BlockTallGrass() {
      ...
      float lvt_1_1_ = 0.4F;
      this.func_149676_a(0.5F - lvt_1_1_, 0.0F, 0.5F - lvt_1_1_, 0.5F + lvt_1_1_, 0.8F, 0.5F + lvt_1_1_);
   }
   ...
   public int func_180644_h(IBlockState p_180644_1_) {
      if (p_180644_1_.func_177230_c() != this) {
         ...
         BlockTallGrass.EnumType lvt_2_1_ = (BlockTallGrass.EnumType)p_180644_1_.func_177229_b(field_176497_a);
         return lvt_2_1_ == BlockTallGrass.EnumType.DEAD_BUSH ? 16777215 : ColorizerGrass.func_77480_a(0.5D, 1.0D);
      }
   }
   ...
   public void func_149666_a(Item p_149666_1_, CreativeTabs p_149666_2_, List<ItemStack> p_149666_3_) {
      for(int lvt_4_1_ = 1; lvt_4_1_ < 3; ++lvt_4_1_) {
         p_149666_3_.add(new ItemStack(p_149666_1_, 1, lvt_4_1_));
      }
   ...
   public void func_176474_b(World p_176474_1_, Random p_176474_2_, BlockPos p_176474_3_, IBlockState p_176474_4_) {
      BlockDoublePlant.EnumPlantType lvt_5_1_ = BlockDoublePlant.EnumPlantType.GRASS;
      if (p_176474_4_.func_177229_b(field_176497_a) == BlockTallGrass.EnumType.FERN) {
         lvt_5_1_ = BlockDoublePlant.EnumPlantType.FERN;
      }

      if (Blocks.field_150398_cm.func_176196_c(p_176474_1_, p_176474_3_)) {
         Blocks.field_150398_cm.func_176491_a(p_176474_1_, p_176474_3_, lvt_5_1_, 2);
      }
   ...
   public static enum EnumType implements IStringSerializable {
      ...
      static {
         BlockTallGrass.EnumType[] lvt_0_1_ = values();
         int lvt_1_1_ = lvt_0_1_.length;

         for(int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_; ++lvt_2_1_) {
            BlockTallGrass.EnumType lvt_3_1_ = lvt_0_1_[lvt_2_1_];
            field_177048_d[lvt_3_1_.func_177044_a()] = lvt_3_1_;
         }
