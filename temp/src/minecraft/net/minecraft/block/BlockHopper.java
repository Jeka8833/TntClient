...
public class BlockHopper extends BlockContainer {
   ...
   public IBlockState func_180642_a(World p_180642_1_, BlockPos p_180642_2_, EnumFacing p_180642_3_, float p_180642_4_, float p_180642_5_, float p_180642_6_, int p_180642_7_, EntityLivingBase p_180642_8_) {
      EnumFacing lvt_9_1_ = p_180642_3_.func_176734_d();
      if (lvt_9_1_ == EnumFacing.UP) {
         lvt_9_1_ = EnumFacing.DOWN;
      }

      return this.func_176223_P().func_177226_a(field_176430_a, lvt_9_1_).func_177226_a(field_176429_b, true);
   }
   ...
   public void func_180633_a(World p_180633_1_, BlockPos p_180633_2_, IBlockState p_180633_3_, EntityLivingBase p_180633_4_, ItemStack p_180633_5_) {
      ...
      if (p_180633_5_.func_82837_s()) {
         ...
         if (lvt_6_1_ instanceof TileEntityHopper) {
            ((TileEntityHopper)lvt_6_1_).func_145886_a(p_180633_5_.func_82833_r());
         }
      }
   ...
   public boolean func_180639_a(World p_180639_1_, BlockPos p_180639_2_, IBlockState p_180639_3_, EntityPlayer p_180639_4_, EnumFacing p_180639_5_, float p_180639_6_, float p_180639_7_, float p_180639_8_) {
      if (p_180639_1_.field_72995_K) {
         ...
         if (lvt_9_1_ instanceof TileEntityHopper) {
            p_180639_4_.func_71007_a((TileEntityHopper)lvt_9_1_);
   ...
   private void func_176427_e(World p_176427_1_, BlockPos p_176427_2_, IBlockState p_176427_3_) {
      boolean lvt_4_1_ = !p_176427_1_.func_175640_z(p_176427_2_);
      if (lvt_4_1_ != (Boolean)p_176427_3_.func_177229_b(field_176429_b)) {
         p_176427_1_.func_180501_a(p_176427_2_, p_176427_3_.func_177226_a(field_176429_b, lvt_4_1_), 4);
      }
   ...
   public void func_180663_b(World p_180663_1_, BlockPos p_180663_2_, IBlockState p_180663_3_) {
      ...
      if (lvt_4_1_ instanceof TileEntityHopper) {
         InventoryHelper.func_180175_a(p_180663_1_, p_180663_2_, (TileEntityHopper)lvt_4_1_);
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      return this.func_176223_P().func_177226_a(field_176430_a, func_176428_b(p_176203_1_)).func_177226_a(field_176429_b, func_149917_c(p_176203_1_));
   }

   public int func_176201_c(IBlockState p_176201_1_) {
      int lvt_2_1_ = 0;
      int lvt_2_1_ = lvt_2_1_ | ((EnumFacing)p_176201_1_.func_177229_b(field_176430_a)).func_176745_a();
      if (!(Boolean)p_176201_1_.func_177229_b(field_176429_b)) {
         lvt_2_1_ |= 8;
      }
