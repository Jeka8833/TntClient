...
public class GuiRenameWorld extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      WorldInfo lvt_2_1_ = lvt_1_1_.func_75803_c(this.field_146584_g);
      String lvt_3_1_ = lvt_2_1_.func_76065_j();
      ...
      this.field_146583_f.func_146180_a(lvt_3_1_);
   }
   ...
   protected void func_146284_a(GuiButton p_146284_1_) throws IOException {
      if (p_146284_1_.field_146124_l) {
         if (p_146284_1_.field_146127_k == 1) {
            ...
            lvt_2_1_.func_75806_a(this.field_146584_g, this.field_146583_f.func_146179_b().trim());
            this.field_146297_k.func_147108_a(this.field_146585_a);
         }
