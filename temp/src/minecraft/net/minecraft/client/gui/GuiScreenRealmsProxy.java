...
public class GuiScreenRealmsProxy extends GuiScreen {
   ...
   public List<RealmsButton> func_154320_j() {
      List<RealmsButton> lvt_1_1_ = Lists.newArrayListWithExpectedSize(super.field_146292_n.size());
      Iterator lvt_2_1_ = super.field_146292_n.iterator();

      while(lvt_2_1_.hasNext()) {
         GuiButton lvt_3_1_ = (GuiButton)lvt_2_1_.next();
         lvt_1_1_.add(((GuiButtonRealmsProxy)lvt_3_1_).func_154317_g());
      }
