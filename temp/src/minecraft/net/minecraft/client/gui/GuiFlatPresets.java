...
public class GuiFlatPresets extends GuiScreen {
   ...
   public void func_146426_g() {
      boolean lvt_1_1_ = this.func_146430_p();
      this.field_146434_t.field_146124_l = lvt_1_1_;
   }
   ...
   private static void func_175354_a(String p_175354_0_, Item p_175354_1_, int p_175354_2_, BiomeGenBase p_175354_3_, List<String> p_175354_4_, FlatLayerInfo... p_175354_5_) {
      ...
      for(int lvt_7_1_ = p_175354_5_.length - 1; lvt_7_1_ >= 0; --lvt_7_1_) {
         lvt_6_1_.func_82650_c().add(p_175354_5_[lvt_7_1_]);
      }

      lvt_6_1_.func_82647_a(p_175354_3_.field_76756_M);
      lvt_6_1_.func_82645_d();
      if (p_175354_4_ != null) {
         Iterator lvt_7_2_ = p_175354_4_.iterator();

         while(lvt_7_2_.hasNext()) {
            String lvt_8_1_ = (String)lvt_7_2_.next();
            lvt_6_1_.func_82644_b().put(lvt_8_1_, Maps.newHashMap());
         }
      }

      field_146431_f.add(new GuiFlatPresets.LayerItem(p_175354_1_, p_175354_2_, p_175354_0_, lvt_6_1_.toString()));
   }
   ...
   class ListSlot extends GuiSlot {
      ...
      private void func_148171_c(int p_148171_1_, int p_148171_2_, int p_148171_3_, int p_148171_4_) {
         ...
         lvt_10_1_.func_181662_b((double)(p_148171_1_ + 0), (double)(p_148171_2_ + 18), (double)GuiFlatPresets.this.field_73735_i).func_181673_a((double)((float)(p_148171_3_ + 0) * 0.0078125F), (double)((float)(p_148171_4_ + 18) * 0.0078125F)).func_181675_d();
         lvt_10_1_.func_181662_b((double)(p_148171_1_ + 18), (double)(p_148171_2_ + 18), (double)GuiFlatPresets.this.field_73735_i).func_181673_a((double)((float)(p_148171_3_ + 18) * 0.0078125F), (double)((float)(p_148171_4_ + 18) * 0.0078125F)).func_181675_d();
         lvt_10_1_.func_181662_b((double)(p_148171_1_ + 18), (double)(p_148171_2_ + 0), (double)GuiFlatPresets.this.field_73735_i).func_181673_a((double)((float)(p_148171_3_ + 18) * 0.0078125F), (double)((float)(p_148171_4_ + 0) * 0.0078125F)).func_181675_d();
         lvt_10_1_.func_181662_b((double)(p_148171_1_ + 0), (double)(p_148171_2_ + 0), (double)GuiFlatPresets.this.field_73735_i).func_181673_a((double)((float)(p_148171_3_ + 0) * 0.0078125F), (double)((float)(p_148171_4_ + 0) * 0.0078125F)).func_181675_d();
      ...
      protected void func_180791_a(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
         GuiFlatPresets.LayerItem lvt_7_1_ = (GuiFlatPresets.LayerItem)GuiFlatPresets.field_146431_f.get(p_180791_1_);
         this.func_178054_a(p_180791_2_, p_180791_3_, lvt_7_1_.field_148234_a, lvt_7_1_.field_179037_b);
         GuiFlatPresets.this.field_146289_q.func_78276_b(lvt_7_1_.field_148232_b, p_180791_2_ + 18 + 5, p_180791_3_ + 6, 16777215);
      }
   }
}
