...
public class GuiLabel extends Gui {
   ...
   public void func_146159_a(Minecraft p_146159_1_, int p_146159_2_, int p_146159_3_) {
      if (this.field_146172_j) {
         ...
         int lvt_4_1_ = this.field_146174_h + this.field_146161_f / 2 + this.field_146163_s / 2;
         int lvt_5_1_ = lvt_4_1_ - this.field_146173_k.size() * 10 / 2;

         for(int lvt_6_1_ = 0; lvt_6_1_ < this.field_146173_k.size(); ++lvt_6_1_) {
            if (this.field_146170_l) {
               this.func_73732_a(this.field_146164_r, (String)this.field_146173_k.get(lvt_6_1_), this.field_146162_g + this.field_146167_a / 2, lvt_5_1_ + lvt_6_1_ * 10, this.field_146168_n);
            } else {
               this.func_73731_b(this.field_146164_r, (String)this.field_146173_k.get(lvt_6_1_), this.field_146162_g, lvt_5_1_ + lvt_6_1_ * 10, this.field_146168_n);
            }
         }
   ...
   protected void func_146160_b(Minecraft p_146160_1_, int p_146160_2_, int p_146160_3_) {
      if (this.field_146171_m) {
         int lvt_4_1_ = this.field_146167_a + this.field_146163_s * 2;
         int lvt_5_1_ = this.field_146161_f + this.field_146163_s * 2;
         int lvt_6_1_ = this.field_146162_g - this.field_146163_s;
         int lvt_7_1_ = this.field_146174_h - this.field_146163_s;
         func_73734_a(lvt_6_1_, lvt_7_1_, lvt_6_1_ + lvt_4_1_, lvt_7_1_ + lvt_5_1_, this.field_146169_o);
         this.func_73730_a(lvt_6_1_, lvt_6_1_ + lvt_4_1_, lvt_7_1_, this.field_146166_p);
         this.func_73730_a(lvt_6_1_, lvt_6_1_ + lvt_4_1_, lvt_7_1_ + lvt_5_1_, this.field_146165_q);
         this.func_73728_b(lvt_6_1_, lvt_7_1_, lvt_7_1_ + lvt_5_1_, this.field_146166_p);
         this.func_73728_b(lvt_6_1_ + lvt_4_1_, lvt_7_1_, lvt_7_1_ + lvt_5_1_, this.field_146165_q);
      }
