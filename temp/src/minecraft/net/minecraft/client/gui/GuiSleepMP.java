...
public class GuiSleepMP extends GuiChat {
   ...
   protected void func_73869_a(char p_73869_1_, int p_73869_2_) throws IOException {
      if (p_73869_2_ == 1) {
         ...
         if (!lvt_3_1_.isEmpty()) {
            this.field_146297_k.field_71439_g.func_71165_d(lvt_3_1_);
         }
   ...
   private void func_146418_g() {
      NetHandlerPlayClient lvt_1_1_ = this.field_146297_k.field_71439_g.field_71174_a;
      lvt_1_1_.func_147297_a(new C0BPacketEntityAction(this.field_146297_k.field_71439_g, C0BPacketEntityAction.Action.STOP_SLEEPING));
   }
}
