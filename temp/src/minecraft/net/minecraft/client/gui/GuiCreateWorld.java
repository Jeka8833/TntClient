...
public class GuiCreateWorld extends GuiScreen {
   ...
   private void func_146314_g() {
      ...
      char[] lvt_1_1_ = ChatAllowedCharacters.field_71567_b;
      int lvt_2_1_ = lvt_1_1_.length;

      for(int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_) {
         char lvt_4_1_ = lvt_1_1_[lvt_3_1_];
         this.field_146336_i = this.field_146336_i.replace(lvt_4_1_, '_');
      }
   ...
   protected void func_146284_a(GuiButton p_146284_1_) throws IOException {
      if (p_146284_1_.field_146124_l) {
         if (p_146284_1_.field_146127_k == 1) {
            ...
            long lvt_2_1_ = (new Random()).nextLong();
            String lvt_4_1_ = this.field_146335_h.func_146179_b();
            if (!StringUtils.isEmpty(lvt_4_1_)) {
               try {
                  long lvt_5_1_ = Long.parseLong(lvt_4_1_);
                  if (lvt_5_1_ != 0L) {
                     lvt_2_1_ = lvt_5_1_;
                  }
               } catch (NumberFormatException var7) {
                  lvt_2_1_ = (long)lvt_4_1_.hashCode();
               }
            }

            WorldSettings.GameType lvt_5_3_ = WorldSettings.GameType.func_77142_a(this.field_146342_r);
            WorldSettings lvt_6_1_ = new WorldSettings(lvt_2_1_, lvt_5_3_, this.field_146341_s, this.field_146337_w, WorldType.field_77139_a[this.field_146331_K]);
            lvt_6_1_.func_82750_a(this.field_146334_a);
            if (this.field_146338_v && !this.field_146337_w) {
               lvt_6_1_.func_77159_a();
            }

            if (this.field_146340_t && !this.field_146337_w) {
               lvt_6_1_.func_77166_b();
            }

            this.field_146297_k.func_71371_a(this.field_146336_i, this.field_146333_g.func_146179_b().trim(), lvt_6_1_);
   ...
   private boolean func_175299_g() {
      WorldType lvt_1_1_ = WorldType.field_77139_a[this.field_146331_K];
      if (lvt_1_1_ != null && lvt_1_1_.func_77126_d()) {
         return lvt_1_1_ == WorldType.field_180272_g ? func_146272_n() : true;
      } else {
         return false;
      }
   }
