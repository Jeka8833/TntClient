...
public class GuiShareToLan extends GuiScreen {
   ...
   protected void func_146284_a(GuiButton p_146284_1_) throws IOException {
      if (p_146284_1_.field_146127_k == 102) {
         ...
         String lvt_2_1_ = this.field_146297_k.func_71401_C().func_71206_a(WorldSettings.GameType.func_77142_a(this.field_146599_h), this.field_146600_i);
         Object lvt_3_2_;
         if (lvt_2_1_ != null) {
            lvt_3_2_ = new ChatComponentTranslation("commands.publish.started", new Object[]{lvt_2_1_});
         } else {
            lvt_3_2_ = new ChatComponentText("commands.publish.failed");
         }

         this.field_146297_k.field_71456_v.func_146158_b().func_146227_a((IChatComponent)lvt_3_2_);
      }
