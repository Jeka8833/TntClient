...
public class GuiCommandBlock extends GuiScreen {
   ...
   protected void func_146284_a(GuiButton p_146284_1_) throws IOException {
      if (p_146284_1_.field_146124_l) {
         if (p_146284_1_.field_146127_k == 1) {
            ...
            lvt_2_1_.writeByte(this.field_146489_h.func_145751_f());
            this.field_146489_h.func_145757_a(lvt_2_1_);
            lvt_2_1_.func_180714_a(this.field_146485_f.func_146179_b());
            lvt_2_1_.writeBoolean(this.field_146489_h.func_175571_m());
            this.field_146297_k.func_147114_u().func_147297_a(new C17PacketCustomPayload("MC|AdvCdm", lvt_2_1_));
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      int lvt_5_1_ = lvt_5_1_ + 1;
      this.func_73731_b(var10001, var10002, var10003, lvt_4_1_ + lvt_5_1_ * this.field_146289_q.field_78288_b, 10526880);
      this.func_73731_b(this.field_146289_q, I18n.func_135052_a("advMode.randomPlayer"), this.field_146294_l / 2 - 150, lvt_4_1_ + lvt_5_1_++ * this.field_146289_q.field_78288_b, 10526880);
      this.func_73731_b(this.field_146289_q, I18n.func_135052_a("advMode.allPlayers"), this.field_146294_l / 2 - 150, lvt_4_1_ + lvt_5_1_++ * this.field_146289_q.field_78288_b, 10526880);
      this.func_73731_b(this.field_146289_q, I18n.func_135052_a("advMode.allEntities"), this.field_146294_l / 2 - 150, lvt_4_1_ + lvt_5_1_++ * this.field_146289_q.field_78288_b, 10526880);
      this.func_73731_b(this.field_146289_q, "", this.field_146294_l / 2 - 150, lvt_4_1_ + lvt_5_1_++ * this.field_146289_q.field_78288_b, 10526880);
      if (this.field_146486_g.func_146179_b().length() > 0) {
         int lvt_4_1_ = lvt_4_1_ + lvt_5_1_ * this.field_146289_q.field_78288_b + 16;
         this.func_73731_b(this.field_146289_q, I18n.func_135052_a("advMode.previousOutput"), this.field_146294_l / 2 - 150, lvt_4_1_, 10526880);
