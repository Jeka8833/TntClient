...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
   ...
   private Predicate<String> field_175332_D = new Predicate<String>() {
      public boolean apply(String p_apply_1_) {
         Float lvt_2_1_ = Floats.tryParse(p_apply_1_);
         return p_apply_1_.length() == 0 || lvt_2_1_ != null && Floats.isFinite(lvt_2_1_) && lvt_2_1_ >= 0.0F;
      }
   };
   ...
   public void func_73866_w_() {
      ...
      if (this.field_175349_r != null) {
         lvt_1_1_ = this.field_175349_r.func_178059_e();
         lvt_2_1_ = this.field_175349_r.func_148148_g();
      }
      ...
      this.func_175325_f();
      if (lvt_1_1_ != 0) {
         this.field_175349_r.func_181156_c(lvt_1_1_);
         this.field_175349_r.func_148145_f(lvt_2_1_);
         this.func_175328_i();
      }
   ...
   public void func_175319_a(int p_175319_1_, String p_175319_2_) {
      ...
      try {
         lvt_3_1_ = Float.parseFloat(p_175319_2_);
      ...
      switch(p_175319_1_) {
      case 132:
         lvt_4_1_ = this.field_175336_F.field_177917_i = MathHelper.func_76131_a(lvt_3_1_, 1.0F, 5000.0F);
         break;
      case 133:
         lvt_4_1_ = this.field_175336_F.field_177911_j = MathHelper.func_76131_a(lvt_3_1_, 1.0F, 5000.0F);
         break;
      case 134:
         lvt_4_1_ = this.field_175336_F.field_177913_k = MathHelper.func_76131_a(lvt_3_1_, 1.0F, 5000.0F);
         break;
      case 135:
         lvt_4_1_ = this.field_175336_F.field_177893_f = MathHelper.func_76131_a(lvt_3_1_, 1.0F, 2000.0F);
         break;
      case 136:
         lvt_4_1_ = this.field_175336_F.field_177894_g = MathHelper.func_76131_a(lvt_3_1_, 1.0F, 2000.0F);
         break;
      case 137:
         lvt_4_1_ = this.field_175336_F.field_177915_h = MathHelper.func_76131_a(lvt_3_1_, 0.01F, 20.0F);
         break;
      case 138:
         lvt_4_1_ = this.field_175336_F.field_177907_l = MathHelper.func_76131_a(lvt_3_1_, 1.0F, 25.0F);
         break;
      case 139:
         lvt_4_1_ = this.field_175336_F.field_177899_b = MathHelper.func_76131_a(lvt_3_1_, 1.0F, 6000.0F);
         break;
      case 140:
         lvt_4_1_ = this.field_175336_F.field_177900_c = MathHelper.func_76131_a(lvt_3_1_, 1.0F, 6000.0F);
         break;
      case 141:
         lvt_4_1_ = this.field_175336_F.field_177909_m = MathHelper.func_76131_a(lvt_3_1_, 0.01F, 50.0F);
         break;
      case 142:
         lvt_4_1_ = this.field_175336_F.field_177896_d = MathHelper.func_76131_a(lvt_3_1_, 1.0F, 5000.0F);
         break;
      case 143:
         lvt_4_1_ = this.field_175336_F.field_177898_e = MathHelper.func_76131_a(lvt_3_1_, 1.0F, 5000.0F);
         break;
      case 144:
         lvt_4_1_ = this.field_175336_F.field_177903_n = MathHelper.func_76131_a(lvt_3_1_, 1.0F, 20.0F);
         break;
      case 145:
         lvt_4_1_ = this.field_175336_F.field_177905_o = MathHelper.func_76131_a(lvt_3_1_, 0.0F, 20.0F);
         break;
      case 146:
         lvt_4_1_ = this.field_175336_F.field_177933_p = MathHelper.func_76131_a(lvt_3_1_, 1.0F, 20.0F);
         break;
      case 147:
         lvt_4_1_ = this.field_175336_F.field_177931_q = MathHelper.func_76131_a(lvt_3_1_, 0.0F, 20.0F);
      }

      if (lvt_4_1_ != lvt_3_1_ && lvt_3_1_ != 0.0F) {
         ((GuiTextField)this.field_175349_r.func_178061_c(p_175319_1_)).func_146180_a(this.func_175330_b(p_175319_1_, lvt_4_1_));
      }

      ((GuiSlider)this.field_175349_r.func_178061_c(p_175319_1_ - 132 + 100)).func_175218_a(lvt_4_1_, false);
   ...
   private String func_175330_b(int p_175330_1_, float p_175330_2_) {
      ...
      case 162:
         if (p_175330_2_ < 0.0F) {
            ...
            BiomeGenBase lvt_3_2_;
            if ((int)p_175330_2_ >= BiomeGenBase.field_76778_j.field_76756_M) {
               lvt_3_2_ = BiomeGenBase.func_150565_n()[(int)p_175330_2_ + 2];
               return lvt_3_2_ != null ? lvt_3_2_.field_76791_y : "?";
            } else {
               lvt_3_2_ = BiomeGenBase.func_150565_n()[(int)p_175330_2_];
               return lvt_3_2_ != null ? lvt_3_2_.field_76791_y : "?";
            }
         }
      }
   ...
   public void func_175320_a(int p_175320_1_, float p_175320_2_) {
      ...
      if (p_175320_1_ >= 100 && p_175320_1_ < 116) {
         Gui lvt_3_1_ = this.field_175349_r.func_178061_c(p_175320_1_ - 100 + 132);
         if (lvt_3_1_ != null) {
            ((GuiTextField)lvt_3_1_).func_146180_a(this.func_175330_b(p_175320_1_, p_175320_2_));
         }
      }
   ...
   protected void func_146284_a(GuiButton p_146284_1_) throws IOException {
      if (p_146284_1_.field_146124_l) {
         ...
         case 300:
            ...
            break;
         case 301:
            for(int lvt_2_1_ = 0; lvt_2_1_ < this.field_175349_r.func_148127_b(); ++lvt_2_1_) {
               GuiPageButtonList.GuiEntry lvt_3_1_ = this.field_175349_r.func_148180_b(lvt_2_1_);
               Gui lvt_4_1_ = lvt_3_1_.func_178022_a();
               if (lvt_4_1_ instanceof GuiButton) {
                  GuiButton lvt_5_1_ = (GuiButton)lvt_4_1_;
                  if (lvt_5_1_ instanceof GuiSlider) {
                     float lvt_6_1_ = ((GuiSlider)lvt_5_1_).func_175217_d() * (0.75F + this.field_175337_G.nextFloat() * 0.5F) + (this.field_175337_G.nextFloat() * 0.1F - 0.05F);
                     ((GuiSlider)lvt_5_1_).func_175219_a(MathHelper.func_76131_a(lvt_6_1_, 0.0F, 1.0F));
                  } else if (lvt_5_1_ instanceof GuiListButton) {
                     ((GuiListButton)lvt_5_1_).func_175212_b(this.field_175337_G.nextBoolean());
                  }
               }

               Gui lvt_5_2_ = lvt_3_1_.func_178021_b();
               if (lvt_5_2_ instanceof GuiButton) {
                  GuiButton lvt_6_2_ = (GuiButton)lvt_5_2_;
                  if (lvt_6_2_ instanceof GuiSlider) {
                     float lvt_7_1_ = ((GuiSlider)lvt_6_2_).func_175217_d() * (0.75F + this.field_175337_G.nextFloat() * 0.5F) + (this.field_175337_G.nextFloat() * 0.1F - 0.05F);
                     ((GuiSlider)lvt_6_2_).func_175219_a(MathHelper.func_76131_a(lvt_7_1_, 0.0F, 1.0F));
                  } else if (lvt_6_2_ instanceof GuiListButton) {
                     ((GuiListButton)lvt_6_2_).func_175212_b(this.field_175337_G.nextBoolean());
                  }
               }
            }
   ...
   private void func_175327_a(float p_175327_1_) {
      Gui lvt_2_1_ = this.field_175349_r.func_178056_g();
      if (lvt_2_1_ instanceof GuiTextField) {
         float lvt_3_1_ = p_175327_1_;
         if (GuiScreen.func_146272_n()) {
            lvt_3_1_ = p_175327_1_ * 0.1F;
            if (GuiScreen.func_146271_m()) {
               lvt_3_1_ *= 0.1F;
            }
         } else if (GuiScreen.func_146271_m()) {
            lvt_3_1_ = p_175327_1_ * 10.0F;
            if (GuiScreen.func_175283_s()) {
               lvt_3_1_ *= 10.0F;
            }
         }

         GuiTextField lvt_4_1_ = (GuiTextField)lvt_2_1_;
         Float lvt_5_1_ = Floats.tryParse(lvt_4_1_.func_146179_b());
         if (lvt_5_1_ != null) {
            lvt_5_1_ = lvt_5_1_ + lvt_3_1_;
            int lvt_6_1_ = lvt_4_1_.func_175206_d();
            String lvt_7_1_ = this.func_175330_b(lvt_4_1_.func_175206_d(), lvt_5_1_);
            lvt_4_1_.func_146180_a(lvt_7_1_);
            this.func_175319_a(lvt_6_1_, lvt_7_1_);
         }
      }
   }
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      if (this.field_175339_B != 0) {
         ...
         lvt_7_1_.func_181662_b((double)(this.field_146294_l / 2 - 90), 185.0D, 0.0D).func_181673_a(0.0D, 2.65625D).func_181669_b(64, 64, 64, 64).func_181675_d();
         lvt_7_1_.func_181662_b((double)(this.field_146294_l / 2 + 90), 185.0D, 0.0D).func_181673_a(5.625D, 2.65625D).func_181669_b(64, 64, 64, 64).func_181675_d();
         lvt_7_1_.func_181662_b((double)(this.field_146294_l / 2 + 90), 100.0D, 0.0D).func_181673_a(5.625D, 0.0D).func_181669_b(64, 64, 64, 64).func_181675_d();
         lvt_7_1_.func_181662_b((double)(this.field_146294_l / 2 - 90), 100.0D, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(64, 64, 64, 64).func_181675_d();
