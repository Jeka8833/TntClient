...
public class GuiClickableScrolledSelectionListProxy extends GuiSlot {
   ...
   protected void func_148120_b(int p_148120_1_, int p_148120_2_, int p_148120_3_, int p_148120_4_) {
      ...
      for(int lvt_6_1_ = 0; lvt_6_1_ < lvt_5_1_; ++lvt_6_1_) {
         int lvt_7_1_ = p_148120_2_ + lvt_6_1_ * this.field_148149_f + this.field_148160_j;
         int lvt_8_1_ = this.field_148149_f - 4;
         if (lvt_7_1_ > this.field_148154_c || lvt_7_1_ + lvt_8_1_ < this.field_148153_b) {
            this.func_178040_a(lvt_6_1_, p_148120_1_, lvt_7_1_);
         }

         if (this.field_148166_t && this.func_148131_a(lvt_6_1_)) {
            this.func_178043_a(this.field_148155_a, lvt_7_1_, lvt_8_1_, Tezzelator.instance);
         }

         this.func_180791_a(lvt_6_1_, p_148120_1_, lvt_7_1_, lvt_8_1_, p_148120_3_, p_148120_4_);
      }
