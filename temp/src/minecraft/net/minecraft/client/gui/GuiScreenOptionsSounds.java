...
public class GuiScreenOptionsSounds extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.field_146292_n.add(new GuiScreenOptionsSounds.Button(SoundCategory.MASTER.func_147156_b(), this.field_146294_l / 2 - 155 + lvt_1_1_ % 2 * 160, this.field_146295_m / 6 - 12 + 24 * (lvt_1_1_ >> 1), SoundCategory.MASTER, true));
      int lvt_1_1_ = lvt_1_1_ + 2;
      SoundCategory[] lvt_2_1_ = SoundCategory.values();
      int lvt_3_1_ = lvt_2_1_.length;

      for(int lvt_4_1_ = 0; lvt_4_1_ < lvt_3_1_; ++lvt_4_1_) {
         SoundCategory lvt_5_1_ = lvt_2_1_[lvt_4_1_];
         if (lvt_5_1_ != SoundCategory.MASTER) {
            this.field_146292_n.add(new GuiScreenOptionsSounds.Button(lvt_5_1_.func_147156_b(), this.field_146294_l / 2 - 155 + lvt_1_1_ % 2 * 160, this.field_146295_m / 6 - 12 + 24 * (lvt_1_1_ >> 1), lvt_5_1_, false));
            ++lvt_1_1_;
         }
      }
   ...
   protected String func_146504_a(SoundCategory p_146504_1_) {
      float lvt_2_1_ = this.field_146506_g.func_151438_a(p_146504_1_);
      return lvt_2_1_ == 0.0F ? this.field_146508_h : (int)(lvt_2_1_ * 100.0F) + "%";
   }
