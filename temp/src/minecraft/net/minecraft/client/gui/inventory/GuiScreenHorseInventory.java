...
public class GuiScreenHorseInventory extends GuiContainer {
   ...
   protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
      ...
      if (this.field_147034_x.func_110261_ca()) {
         this.func_73729_b(lvt_4_1_ + 79, lvt_5_1_ + 17, 0, this.field_147000_g, 90, 54);
      }

      if (this.field_147034_x.func_110259_cr()) {
         this.func_73729_b(lvt_4_1_ + 7, lvt_5_1_ + 35, 0, this.field_147000_g + 54, 18, 18);
      }

      GuiInventory.func_147046_a(lvt_4_1_ + 51, lvt_5_1_ + 60, 17, (float)(lvt_4_1_ + 51) - this.field_147033_y, (float)(lvt_5_1_ + 75 - 50) - this.field_147032_z, this.field_147034_x);
   }
