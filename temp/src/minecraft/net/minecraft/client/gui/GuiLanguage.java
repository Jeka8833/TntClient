...
public class GuiLanguage extends GuiScreen {
      ...
      if (p_146284_1_.field_146124_l) {
         ...
         case 100:
            if (p_146284_1_ instanceof GuiOptionButton) {
               ...
               ScaledResolution lvt_2_1_ = new ScaledResolution(this.field_146297_k);
               int lvt_3_1_ = lvt_2_1_.func_78326_a();
               int lvt_4_1_ = lvt_2_1_.func_78328_b();
               this.func_146280_a(this.field_146297_k, lvt_3_1_, lvt_4_1_);
            }
            break;
         default:
   ...
   class List extends GuiSlot {
      ...
      public List(Minecraft p_i45519_2_) {
         ...
         Iterator lvt_3_1_ = GuiLanguage.this.field_146454_h.func_135040_d().iterator();

         while(lvt_3_1_.hasNext()) {
            Language lvt_4_1_ = (Language)lvt_3_1_.next();
            this.field_148177_m.put(lvt_4_1_.func_135034_a(), lvt_4_1_);
            this.field_148176_l.add(lvt_4_1_.func_135034_a());
         }
      ...
      protected void func_148144_a(int p_148144_1_, boolean p_148144_2_, int p_148144_3_, int p_148144_4_) {
         Language lvt_5_1_ = (Language)this.field_148177_m.get(this.field_148176_l.get(p_148144_1_));
         GuiLanguage.this.field_146454_h.func_135045_a(lvt_5_1_);
         GuiLanguage.this.field_146451_g.field_151455_aw = lvt_5_1_.func_135034_a();
         this.field_148161_k.func_110436_a();
         GuiLanguage.this.field_146289_q.func_78264_a(GuiLanguage.this.field_146454_h.func_135042_a() || GuiLanguage.this.field_146451_g.field_151454_ax);
