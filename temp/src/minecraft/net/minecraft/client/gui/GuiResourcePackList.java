...
public abstract class GuiResourcePackList extends GuiListExtended {
   ...
   protected void func_148129_a(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_) {
      String lvt_4_1_ = EnumChatFormatting.UNDERLINE + "" + EnumChatFormatting.BOLD + this.func_148202_k();
      this.field_148205_k.field_71466_p.func_78276_b(lvt_4_1_, p_148129_1_ + this.field_148155_a / 2 - this.field_148205_k.field_71466_p.func_78256_a(lvt_4_1_) / 2, Math.min(this.field_148153_b + 3, p_148129_2_), 16777215);
   }
