...
public class ServerSelectionList extends GuiListExtended {
   ...
   public void func_148195_a(ServerList p_148195_1_) {
      ...
      for(int lvt_2_1_ = 0; lvt_2_1_ < p_148195_1_.func_78856_c(); ++lvt_2_1_) {
         this.field_148198_l.add(new ServerListEntryNormal(this.field_148200_k, p_148195_1_.func_78850_a(lvt_2_1_)));
      }
   ...
   public void func_148194_a(List<LanServerDetector.LanServer> p_148194_1_) {
      ...
      Iterator lvt_2_1_ = p_148194_1_.iterator();

      while(lvt_2_1_.hasNext()) {
         LanServerDetector.LanServer lvt_3_1_ = (LanServerDetector.LanServer)lvt_2_1_.next();
         this.field_148199_m.add(new ServerListEntryLanDetected(this.field_148200_k, lvt_3_1_));
      }
