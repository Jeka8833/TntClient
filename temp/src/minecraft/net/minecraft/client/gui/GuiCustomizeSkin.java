...
public class GuiCustomizeSkin extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.field_146292_n.add(new GuiButtonOF(210, this.field_146294_l / 2 - 100, this.field_146295_m / 6 + 24 * (i >> 1), I18n.func_135052_a("of.options.skinCustomisation.ofCape")));
      i += 2;
   ...
   protected void func_146284_a(GuiButton p_146284_1_) throws IOException {
      if (p_146284_1_.field_146124_l) {
         if (p_146284_1_.field_146127_k == 210) {
            this.field_146297_k.func_147108_a(new GuiScreenCapeOF(this));
         }
