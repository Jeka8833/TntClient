...
public class GuiControls extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      int lvt_1_1_ = 0;
      GameSettings.Options[] lvt_2_1_ = field_146492_g;
      ...
      for(int lvt_4_1_ = 0; lvt_4_1_ < lvt_3_1_; ++lvt_4_1_) {
         ...
         if (lvt_5_1_.func_74380_a()) {
            this.field_146292_n.add(new GuiOptionSlider(lvt_5_1_.func_74381_c(), this.field_146294_l / 2 - 155 + lvt_1_1_ % 2 * 160, 18 + 24 * (lvt_1_1_ >> 1), lvt_5_1_));
         } else {
            this.field_146292_n.add(new GuiOptionButton(lvt_5_1_.func_74381_c(), this.field_146294_l / 2 - 155 + lvt_1_1_ % 2 * 160, 18 + 24 * (lvt_1_1_ >> 1), lvt_5_1_, this.field_146497_i.func_74297_c(lvt_5_1_)));
         }
   ...
   protected void func_146284_a(GuiButton p_146284_1_) throws IOException {
      if (p_146284_1_.field_146127_k == 200) {
         ...
         KeyBinding[] lvt_2_1_ = this.field_146297_k.field_71474_y.field_74317_L;
         int lvt_3_1_ = lvt_2_1_.length;

         for(int lvt_4_1_ = 0; lvt_4_1_ < lvt_3_1_; ++lvt_4_1_) {
            KeyBinding lvt_5_1_ = lvt_2_1_[lvt_4_1_];
            lvt_5_1_.func_151462_b(lvt_5_1_.func_151469_h());
         }
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      KeyBinding[] lvt_5_1_ = this.field_146497_i.field_74317_L;
      int lvt_6_1_ = lvt_5_1_.length;

      for(int lvt_7_1_ = 0; lvt_7_1_ < lvt_6_1_; ++lvt_7_1_) {
         KeyBinding lvt_8_1_ = lvt_5_1_[lvt_7_1_];
         if (lvt_8_1_.func_151463_i() != lvt_8_1_.func_151469_h()) {
            lvt_4_1_ = false;
            break;
         }
      }

      this.field_146493_s.field_146124_l = !lvt_4_1_;
