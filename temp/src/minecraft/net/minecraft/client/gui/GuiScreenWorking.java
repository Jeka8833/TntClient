...
public class GuiScreenWorking extends GuiScreen implements IProgressUpdate {
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      if (this.field_146592_h) {
         ...
         if (this.customLoadingScreen != null && this.field_146297_k.field_71441_e == null) {
            this.customLoadingScreen.drawBackground(this.field_146294_l, this.field_146295_m);
         } else {
            this.func_146276_q_();
         }
