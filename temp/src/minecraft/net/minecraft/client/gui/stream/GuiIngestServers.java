...
public class GuiIngestServers extends GuiScreen {
   ...
   class ServerList extends GuiSlot {
      ...
      protected void func_180791_a(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
         IngestServer lvt_7_1_ = this.field_148161_k.func_152346_Z().func_152925_v()[p_180791_1_];
         String lvt_8_1_ = lvt_7_1_.serverUrl.replaceAll("\\{stream_key\\}", "");
         String lvt_9_1_ = (int)lvt_7_1_.bitrateKbps + " kbps";
         String lvt_10_1_ = null;
         IngestServerTester lvt_11_1_ = this.field_148161_k.func_152346_Z().func_152932_y();
         if (lvt_11_1_ != null) {
            if (lvt_7_1_ == lvt_11_1_.func_153040_c()) {
               lvt_8_1_ = EnumChatFormatting.GREEN + lvt_8_1_;
               lvt_9_1_ = (int)(lvt_11_1_.func_153030_h() * 100.0F) + "%";
            } else if (p_180791_1_ < lvt_11_1_.func_153028_p()) {
               if (lvt_7_1_.bitrateKbps == 0.0F) {
                  lvt_9_1_ = EnumChatFormatting.RED + "Down!";
               }
            } else {
               lvt_9_1_ = EnumChatFormatting.OBFUSCATED + "1234" + EnumChatFormatting.RESET + " kbps";
            }
         } else if (lvt_7_1_.bitrateKbps == 0.0F) {
            lvt_9_1_ = EnumChatFormatting.RED + "Down!";
         }

         p_180791_2_ -= 15;
         if (this.func_148131_a(p_180791_1_)) {
            lvt_10_1_ = EnumChatFormatting.BLUE + "(Preferred)";
         } else if (lvt_7_1_.defaultServer) {
            lvt_10_1_ = EnumChatFormatting.GREEN + "(Default)";
         }

         GuiIngestServers.this.func_73731_b(GuiIngestServers.this.field_146289_q, lvt_7_1_.serverName, p_180791_2_ + 2, p_180791_3_ + 5, 16777215);
         GuiIngestServers.this.func_73731_b(GuiIngestServers.this.field_146289_q, lvt_8_1_, p_180791_2_ + 2, p_180791_3_ + GuiIngestServers.this.field_146289_q.field_78288_b + 5 + 3, 3158064);
         GuiIngestServers.this.func_73731_b(GuiIngestServers.this.field_146289_q, lvt_9_1_, this.func_148137_d() - 5 - GuiIngestServers.this.field_146289_q.func_78256_a(lvt_9_1_), p_180791_3_ + 5, 8421504);
         if (lvt_10_1_ != null) {
            GuiIngestServers.this.func_73731_b(GuiIngestServers.this.field_146289_q, lvt_10_1_, this.func_148137_d() - 5 - GuiIngestServers.this.field_146289_q.func_78256_a(lvt_10_1_), p_180791_3_ + 5 + 3 + GuiIngestServers.this.field_146289_q.field_78288_b, 8421504);
         }
