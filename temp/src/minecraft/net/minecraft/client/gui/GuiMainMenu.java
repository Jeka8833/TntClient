...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
   ...
   private void func_73969_a(int p_73969_1_, int p_73969_2_) {
      ...
      if (Reflector.GuiModList_Constructor.exists()) {
         this.field_146292_n.add(this.field_175372_K = new GuiButton(14, this.field_146294_l / 2 + 2, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.func_135052_a("menu.online").replace("Minecraft", "").trim()));
         this.field_146292_n.add(this.modButton = new GuiButton(6, this.field_146294_l / 2 - 100, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.func_135052_a("fml.menu.mods")));
      } else {
   ...
   protected void func_146284_a(GuiButton p_146284_1_) throws IOException {
      ...
      if (p_146284_1_.field_146127_k == 6 && Reflector.GuiModList_Constructor.exists()) {
         this.field_146297_k.func_147108_a((GuiScreen)Reflector.newInstance(Reflector.GuiModList_Constructor, this));
      }
   ...
   private void func_73970_b(int p_73970_1_, int p_73970_2_, float p_73970_3_) {
      ...
      for(int j = 0; j < blurCount1; ++j) {
         ...
         for(int k = 0; k < 6; ++k) {
            ...
            ResourceLocation[] panoramaLocations = field_73978_o;
            if (cpp != null) {
               panoramaLocations = cpp.getPanoramaLocations();
            }

            this.field_146297_k.func_110434_K().func_110577_a(panoramaLocations[k]);
            vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
            int l = 255 / (j + 1);
            float f3 = 0.0F;
            vertexbuffer.func_181662_b(-1.0D, -1.0D, 1.0D).func_181673_a(0.0D, 0.0D).func_181669_b(255, 255, 255, l).func_181675_d();
            vertexbuffer.func_181662_b(1.0D, -1.0D, 1.0D).func_181673_a(1.0D, 0.0D).func_181669_b(255, 255, 255, l).func_181675_d();
            vertexbuffer.func_181662_b(1.0D, 1.0D, 1.0D).func_181673_a(1.0D, 1.0D).func_181669_b(255, 255, 255, l).func_181675_d();
            vertexbuffer.func_181662_b(-1.0D, 1.0D, 1.0D).func_181673_a(0.0D, 1.0D).func_181669_b(255, 255, 255, l).func_181675_d();
   ...
   private void func_73968_a(float p_73968_1_) {
      ...
      for(int j = 0; j < blurCount2; ++j) {
         ...
         vertexbuffer.func_181662_b((double)k, (double)l, (double)this.field_73735_i).func_181673_a((double)(0.0F + f1), 1.0D).func_181666_a(1.0F, 1.0F, 1.0F, f).func_181675_d();
         vertexbuffer.func_181662_b((double)k, 0.0D, (double)this.field_73735_i).func_181673_a((double)(1.0F + f1), 1.0D).func_181666_a(1.0F, 1.0F, 1.0F, f).func_181675_d();
         vertexbuffer.func_181662_b(0.0D, 0.0D, (double)this.field_73735_i).func_181673_a((double)(1.0F + f1), 0.0D).func_181666_a(1.0F, 1.0F, 1.0F, f).func_181675_d();
         vertexbuffer.func_181662_b(0.0D, (double)l, (double)this.field_73735_i).func_181673_a((double)(0.0F + f1), 0.0D).func_181666_a(1.0F, 1.0F, 1.0F, f).func_181675_d();
      }
   ...
   private void func_73971_c(int p_73971_1_, int p_73971_2_, float p_73971_3_) {
      ...
      WorldRenderer vertexbuffer = tessellator.func_178180_c();
      vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
      vertexbuffer.func_181662_b(0.0D, (double)j, (double)this.field_73735_i).func_181673_a((double)(0.5F - f1), (double)(0.5F + f2)).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
      vertexbuffer.func_181662_b((double)i, (double)j, (double)this.field_73735_i).func_181673_a((double)(0.5F - f1), (double)(0.5F - f2)).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
      vertexbuffer.func_181662_b((double)i, 0.0D, (double)this.field_73735_i).func_181673_a((double)(0.5F + f1), (double)(0.5F - f2)).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
      vertexbuffer.func_181662_b(0.0D, 0.0D, (double)this.field_73735_i).func_181673_a((double)(0.5F + f1), (double)(0.5F + f2)).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
      tessellator.func_78381_a();
   }
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      if (overlay1Top != 0 || overlay1Bottom != 0) {
         this.func_73733_a(0, 0, this.field_146294_l, this.field_146295_m, overlay1Top, overlay1Bottom);
      }

      if (overlay2Top != 0 || overlay2Bottom != 0) {
         this.func_73733_a(0, 0, this.field_146294_l, this.field_146295_m, overlay2Top, overlay2Bottom);
      }
      ...
      if (Reflector.FMLCommonHandler_getBrandings.exists()) {
         ...
         List<String> brandings = Lists.reverse((List)Reflector.call(instance, Reflector.FMLCommonHandler_getBrandings, true));
         ...
         if (Reflector.ForgeHooksClient_renderMainMenu.exists()) {
            Reflector.call(Reflector.ForgeHooksClient_renderMainMenu, this, this.field_146289_q, this.field_146294_l, this.field_146295_m);
         }
      } else {
      ...
      if (this.modUpdateNotification != null) {
         this.modUpdateNotification.func_73863_a(p_73863_1_, p_73863_2_, p_73863_3_);
      }
