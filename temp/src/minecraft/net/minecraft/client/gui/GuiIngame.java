...
public class GuiIngame extends Gui {
   ...
   public void func_175180_a(float p_175180_1_) {
      ...
      if (this.field_73839_d.field_71439_g.func_71060_bI() > 0) {
         ...
         k1 = this.field_73839_d.field_71439_g.func_71060_bI();
         f3 = (float)k1 / 100.0F;
         if (f3 > 1.0F) {
      ...
      if (this.field_73845_h > 0) {
         ...
         f3 = (float)this.field_73845_h - p_175180_1_;
         ...
         if (i2 > 8) {
            ...
            if (this.field_73844_j) {
               j2 = MathHelper.func_181758_c(f3 / 50.0F, 0.7F, 0.6F) & 16777215;
            }

            this.func_175179_f().func_78276_b(this.field_73838_g, -this.func_175179_f().func_78256_a(this.field_73838_g) / 2, -4, j2 + (i2 << 24 & -16777216));
            GlStateManager.func_179084_k();
      ...
      if (this.field_175195_w > 0) {
         ...
         f3 = (float)this.field_175195_w - p_175180_1_;
         i2 = 255;
   ...
   public void func_175176_b(ScaledResolution p_175176_1_, int p_175176_2_) {
      ...
      if (i > 0) {
         ...
         l1 = p_175176_1_.func_78328_b() - 32 + 3;
         this.func_73729_b(p_175176_2_, l1, 0, 64, j, 5);
         if (k > 0) {
            this.func_73729_b(p_175176_2_, l1, 0, 69, k, 5);
         }
      }
      ...
      if (this.field_73839_d.field_71439_g.field_71068_ca > 0) {
         ...
         l1 = (p_175176_1_.func_78326_a() - this.func_175179_f().func_78256_a(s)) / 2;
   ...
   private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
      ...
      List<Score> list = Lists.newArrayList(Iterables.filter(collection, (Predicate)(new Predicate<Score>() {
      ...
      String s;
      for(Iterator i$ = collection.iterator(); i$.hasNext(); i = Math.max(i, this.func_175179_f().func_78256_a(s))) {
      ...
      if (this.field_73839_d.func_175606_aa() instanceof EntityPlayer) {
         ...
         for(i6 = 0; i6 < 10; ++i6) {
            if (k2 > 0) {
               j6 = i1 + i6 * 8;
               if (i6 * 2 + 1 < k2) {
                  this.func_73729_b(j6, j2, 34, 9, 9, 9);
               }

               if (i6 * 2 + 1 == k2) {
                  this.func_73729_b(j6, j2, 25, 9, 9, 9);
               }

               if (i6 * 2 + 1 > k2) {
                  this.func_73729_b(j6, j2, 16, 9, 9, 9);
               }
            }
         }
         ...
         int i4;
         int j4;
         for(i6 = MathHelper.func_76123_f((f + f1) / 2.0F) - 1; i6 >= 0; --i6) {
            j6 = 16;
            ...
            l7 = MathHelper.func_76123_f((float)(i6 + 1) / 10.0F) - 1;
            i4 = i1 + i6 % 10 * 8;
            j4 = k1 - l7 * i2;
            if (i <= 4) {
         ...
         if (entity == null) {
            ...
            for(j6 = 0; j6 < 10; ++j6) {
               ...
               j4 = j1 - j6 * 8 - 9;
               this.func_73729_b(j4, j7, 16 + j8 * 9, 27, 9, 9);
               if (flag1) {
                  if (j6 * 2 + 1 < l) {
                     this.func_73729_b(j4, j7, l7 + 54, 27, 9, 9);
                  }

                  if (j6 * 2 + 1 == l) {
                     this.func_73729_b(j4, j7, l7 + 63, 27, 9, 9);
                  }
               }

               if (j6 * 2 + 1 < k) {
                  this.func_73729_b(j4, j7, l7 + 36, 27, 9, 9);
               }

               if (j6 * 2 + 1 == k) {
                  this.func_73729_b(j4, j7, l7 + 45, 27, 9, 9);
               }
            }
         } else if (entity instanceof EntityLivingBase) {
            this.field_73839_d.field_71424_I.func_76318_c("mountHealth");
            EntityLivingBase entitylivingbase = (EntityLivingBase)entity;
            j7 = (int)Math.ceil((double)entitylivingbase.func_110143_aJ());
            ...
            for(int k9 = 0; i4 > 0; k9 += 20) {
               ...
               for(int i5 = 0; i5 < l4; ++i5) {
                  ...
                  int l5 = j1 - i5 * 8 - 9;
                  this.func_73729_b(l5, j4, j5 + k5 * 9, 9, 9, 9);
                  if (i5 * 2 + 1 + k9 < j7) {
                     this.func_73729_b(l5, j4, j5 + 36, 9, 9, 9);
                  }

                  if (i5 * 2 + 1 + k9 == j7) {
                     this.func_73729_b(l5, j4, j5 + 45, 9, 9, 9);
                  }
               }
         ...
         if (entityplayer.func_70055_a(Material.field_151586_h)) {
            j6 = this.field_73839_d.field_71439_g.func_70086_ai();
            j7 = MathHelper.func_76143_f((double)(j6 - 2) * 10.0D / 300.0D);
            l7 = MathHelper.func_76143_f((double)j6 * 10.0D / 300.0D) - j7;

            for(i4 = 0; i4 < j7 + l7; ++i4) {
               if (i4 < j7) {
                  this.func_73729_b(j1 - i4 * 8 - 9, j2, 16, 18, 9, 9);
               } else {
                  this.func_73729_b(j1 - i4 * 8 - 9, j2, 25, 18, 9, 9);
               }
            }
         }
   ...
   private void func_180476_e(ScaledResolution p_180476_1_) {
      ...
      vertexbuffer.func_181662_b(0.0D, (double)p_180476_1_.func_78328_b(), -90.0D).func_181673_a(0.0D, 1.0D).func_181675_d();
      vertexbuffer.func_181662_b((double)p_180476_1_.func_78326_a(), (double)p_180476_1_.func_78328_b(), -90.0D).func_181673_a(1.0D, 1.0D).func_181675_d();
      vertexbuffer.func_181662_b((double)p_180476_1_.func_78326_a(), 0.0D, -90.0D).func_181673_a(1.0D, 0.0D).func_181675_d();
      vertexbuffer.func_181662_b(0.0D, 0.0D, -90.0D).func_181673_a(0.0D, 0.0D).func_181675_d();
   ...
   private void func_180480_a(float p_180480_1_, ScaledResolution p_180480_2_) {
      if (!Config.isVignetteEnabled()) {
         ...
         WorldRenderer vertexbuffer = tessellator.func_178180_c();
         vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
         vertexbuffer.func_181662_b(0.0D, (double)p_180480_2_.func_78328_b(), -90.0D).func_181673_a(0.0D, 1.0D).func_181675_d();
         vertexbuffer.func_181662_b((double)p_180480_2_.func_78326_a(), (double)p_180480_2_.func_78328_b(), -90.0D).func_181673_a(1.0D, 1.0D).func_181675_d();
         vertexbuffer.func_181662_b((double)p_180480_2_.func_78326_a(), 0.0D, -90.0D).func_181673_a(1.0D, 0.0D).func_181675_d();
         vertexbuffer.func_181662_b(0.0D, 0.0D, -90.0D).func_181673_a(0.0D, 0.0D).func_181675_d();
         tessellator.func_78381_a();
         GlStateManager.func_179132_a(true);
         GlStateManager.func_179126_j();
   ...
   private void func_180474_b(float p_180474_1_, ScaledResolution p_180474_2_) {
      ...
      WorldRenderer vertexbuffer = tessellator.func_178180_c();
      vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
      vertexbuffer.func_181662_b(0.0D, (double)p_180474_2_.func_78328_b(), -90.0D).func_181673_a((double)f, (double)f3).func_181675_d();
      vertexbuffer.func_181662_b((double)p_180474_2_.func_78326_a(), (double)p_180474_2_.func_78328_b(), -90.0D).func_181673_a((double)f2, (double)f3).func_181675_d();
      vertexbuffer.func_181662_b((double)p_180474_2_.func_78326_a(), 0.0D, -90.0D).func_181673_a((double)f2, (double)f1).func_181675_d();
      vertexbuffer.func_181662_b(0.0D, 0.0D, -90.0D).func_181673_a((double)f, (double)f1).func_181675_d();
      tessellator.func_78381_a();
      GlStateManager.func_179132_a(true);
      GlStateManager.func_179126_j();
      GlStateManager.func_179141_d();
