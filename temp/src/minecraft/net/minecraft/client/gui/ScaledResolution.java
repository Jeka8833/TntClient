...
public class ScaledResolution {
   ...
   public ScaledResolution(Minecraft p_i46445_1_) {
      ...
      boolean lvt_2_1_ = p_i46445_1_.func_152349_b();
      int lvt_3_1_ = p_i46445_1_.field_71474_y.field_74362_aa;
      if (lvt_3_1_ == 0) {
         lvt_3_1_ = 1000;
      }

      while(this.field_78330_e < lvt_3_1_ && this.field_78333_a / (this.field_78330_e + 1) >= 320 && this.field_78331_b / (this.field_78330_e + 1) >= 240) {
         ++this.field_78330_e;
      }

      if (lvt_2_1_ && this.field_78330_e % 2 != 0 && this.field_78330_e != 1) {
         --this.field_78330_e;
      }
