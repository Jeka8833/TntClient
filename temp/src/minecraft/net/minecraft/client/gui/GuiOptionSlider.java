...
public class GuiOptionSlider extends GuiButton {
   ...
   public GuiOptionSlider(int p_i45017_1_, int p_i45017_2_, int p_i45017_3_, GameSettings.Options p_i45017_4_, float p_i45017_5_, float p_i45017_6_) {
      ...
      Minecraft lvt_7_1_ = Minecraft.func_71410_x();
      this.field_146134_p = p_i45017_4_.func_148266_c(lvt_7_1_.field_71474_y.func_74296_a(p_i45017_4_));
      this.field_146126_j = lvt_7_1_.field_71474_y.func_74297_c(p_i45017_4_);
   }
   ...
   protected void func_146119_b(Minecraft p_146119_1_, int p_146119_2_, int p_146119_3_) {
      if (this.field_146125_m) {
         if (this.field_146135_o) {
            ...
            float lvt_4_1_ = this.field_146133_q.func_148262_d(this.field_146134_p);
            p_146119_1_.field_71474_y.func_74304_a(this.field_146133_q, lvt_4_1_);
            this.field_146134_p = this.field_146133_q.func_148266_c(lvt_4_1_);
