...
public class GuiCreateFlatWorld extends GuiScreen {
   ...
   protected void func_146284_a(GuiButton p_146284_1_) throws IOException {
      int lvt_2_1_ = this.field_146387_g.func_82650_c().size() - this.field_146390_s.field_148228_k - 1;
      if (p_146284_1_.field_146127_k == 1) {
         ...
         this.field_146387_g.func_82650_c().remove(lvt_2_1_);
   ...
   public void func_146375_g() {
      ...
      this.field_146386_v.field_146124_l = lvt_1_1_;
      this.field_146388_u.field_146124_l = lvt_1_1_;
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      int lvt_4_1_ = this.field_146294_l / 2 - 92 - 16;
      this.func_73731_b(this.field_146289_q, this.field_146394_i, lvt_4_1_, 32, 16777215);
      this.func_73731_b(this.field_146289_q, this.field_146391_r, lvt_4_1_ + 2 + 213 - this.field_146289_q.func_78256_a(this.field_146391_r), 32, 16777215);
   ...
   class Details extends GuiSlot {
      ...
      private void func_148224_c(int p_148224_1_, int p_148224_2_, int p_148224_3_, int p_148224_4_) {
         ...
         lvt_10_1_.func_181662_b((double)(p_148224_1_ + 0), (double)(p_148224_2_ + 18), (double)GuiCreateFlatWorld.this.field_73735_i).func_181673_a((double)((float)(p_148224_3_ + 0) * 0.0078125F), (double)((float)(p_148224_4_ + 18) * 0.0078125F)).func_181675_d();
         lvt_10_1_.func_181662_b((double)(p_148224_1_ + 18), (double)(p_148224_2_ + 18), (double)GuiCreateFlatWorld.this.field_73735_i).func_181673_a((double)((float)(p_148224_3_ + 18) * 0.0078125F), (double)((float)(p_148224_4_ + 18) * 0.0078125F)).func_181675_d();
         lvt_10_1_.func_181662_b((double)(p_148224_1_ + 18), (double)(p_148224_2_ + 0), (double)GuiCreateFlatWorld.this.field_73735_i).func_181673_a((double)((float)(p_148224_3_ + 18) * 0.0078125F), (double)((float)(p_148224_4_ + 0) * 0.0078125F)).func_181675_d();
         lvt_10_1_.func_181662_b((double)(p_148224_1_ + 0), (double)(p_148224_2_ + 0), (double)GuiCreateFlatWorld.this.field_73735_i).func_181673_a((double)((float)(p_148224_3_ + 0) * 0.0078125F), (double)((float)(p_148224_4_ + 0) * 0.0078125F)).func_181675_d();
      ...
      protected void func_180791_a(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
         FlatLayerInfo lvt_7_1_ = (FlatLayerInfo)GuiCreateFlatWorld.this.field_146387_g.func_82650_c().get(GuiCreateFlatWorld.this.field_146387_g.func_82650_c().size() - p_180791_1_ - 1);
         IBlockState lvt_8_1_ = lvt_7_1_.func_175900_c();
         Block lvt_9_1_ = lvt_8_1_.func_177230_c();
         Item lvt_10_1_ = Item.func_150898_a(lvt_9_1_);
         ItemStack lvt_11_1_ = lvt_9_1_ != Blocks.field_150350_a && lvt_10_1_ != null ? new ItemStack(lvt_10_1_, 1, lvt_9_1_.func_176201_c(lvt_8_1_)) : null;
         String lvt_12_1_ = lvt_11_1_ == null ? "Air" : lvt_10_1_.func_77653_i(lvt_11_1_);
         if (lvt_10_1_ == null) {
            if (lvt_9_1_ != Blocks.field_150355_j && lvt_9_1_ != Blocks.field_150358_i) {
               if (lvt_9_1_ == Blocks.field_150353_l || lvt_9_1_ == Blocks.field_150356_k) {
                  lvt_10_1_ = Items.field_151129_at;
               }
            } else {
               lvt_10_1_ = Items.field_151131_as;
            }

            if (lvt_10_1_ != null) {
               lvt_11_1_ = new ItemStack(lvt_10_1_, 1, lvt_9_1_.func_176201_c(lvt_8_1_));
               lvt_12_1_ = lvt_9_1_.func_149732_F();
            }
         }

         this.func_148225_a(p_180791_2_, p_180791_3_, lvt_11_1_);
         GuiCreateFlatWorld.this.field_146289_q.func_78276_b(lvt_12_1_, p_180791_2_ + 18 + 5, p_180791_3_ + 3, 16777215);
         String lvt_13_3_;
         if (p_180791_1_ == 0) {
            lvt_13_3_ = I18n.func_135052_a("createWorld.customize.flat.layer.top", lvt_7_1_.func_82657_a());
         } else if (p_180791_1_ == GuiCreateFlatWorld.this.field_146387_g.func_82650_c().size() - 1) {
            lvt_13_3_ = I18n.func_135052_a("createWorld.customize.flat.layer.bottom", lvt_7_1_.func_82657_a());
         } else {
            lvt_13_3_ = I18n.func_135052_a("createWorld.customize.flat.layer", lvt_7_1_.func_82657_a());
         }

         GuiCreateFlatWorld.this.field_146289_q.func_78276_b(lvt_13_3_, p_180791_2_ + 2 + 213 - GuiCreateFlatWorld.this.field_146289_q.func_78256_a(lvt_13_3_), p_180791_3_ + 3, 16777215);
      }
