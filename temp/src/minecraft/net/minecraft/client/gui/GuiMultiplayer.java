...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
   ...
   public void func_73876_c() {
      ...
      if (this.field_146799_A.func_77553_a()) {
         List<LanServerDetector.LanServer> lvt_1_1_ = this.field_146799_A.func_77554_c();
         this.field_146799_A.func_77552_b();
         this.field_146803_h.func_148194_a(lvt_1_1_);
      }
   ...
   protected void func_146284_a(GuiButton p_146284_1_) throws IOException {
      if (p_146284_1_.field_146124_l) {
         GuiListExtended.IGuiListEntry lvt_2_1_ = this.field_146803_h.func_148193_k() < 0 ? null : this.field_146803_h.func_148180_b(this.field_146803_h.func_148193_k());
         if (p_146284_1_.field_146127_k == 2 && lvt_2_1_ instanceof ServerListEntryNormal) {
            String lvt_3_1_ = ((ServerListEntryNormal)lvt_2_1_).func_148296_a().field_78847_a;
            if (lvt_3_1_ != null) {
               this.field_146807_u = true;
               String lvt_4_1_ = I18n.func_135052_a("selectServer.deleteQuestion");
               String lvt_5_1_ = "'" + lvt_3_1_ + "' " + I18n.func_135052_a("selectServer.deleteWarning");
               String lvt_6_1_ = I18n.func_135052_a("selectServer.deleteButton");
               String lvt_7_1_ = I18n.func_135052_a("gui.cancel");
               GuiYesNo lvt_8_1_ = new GuiYesNo(this, lvt_4_1_, lvt_5_1_, lvt_6_1_, lvt_7_1_, this.field_146803_h.func_148193_k());
               this.field_146297_k.func_147108_a(lvt_8_1_);
            }
         ...
         } else if (p_146284_1_.field_146127_k == 7 && lvt_2_1_ instanceof ServerListEntryNormal) {
            this.field_146805_w = true;
            ServerData lvt_3_2_ = ((ServerListEntryNormal)lvt_2_1_).func_148296_a();
            this.field_146811_z = new ServerData(lvt_3_2_.field_78847_a, lvt_3_2_.field_78845_b, false);
            this.field_146811_z.func_152583_a(lvt_3_2_);
   ...
   public void func_73878_a(boolean p_73878_1_, int p_73878_2_) {
      GuiListExtended.IGuiListEntry lvt_3_1_ = this.field_146803_h.func_148193_k() < 0 ? null : this.field_146803_h.func_148180_b(this.field_146803_h.func_148193_k());
      if (this.field_146807_u) {
         this.field_146807_u = false;
         if (p_73878_1_ && lvt_3_1_ instanceof ServerListEntryNormal) {
         ...
         if (p_73878_1_ && lvt_3_1_ instanceof ServerListEntryNormal) {
            ServerData lvt_4_1_ = ((ServerListEntryNormal)lvt_3_1_).func_148296_a();
            lvt_4_1_.field_78847_a = this.field_146811_z.field_78847_a;
            lvt_4_1_.field_78845_b = this.field_146811_z.field_78845_b;
            lvt_4_1_.func_152583_a(this.field_146811_z);
            this.field_146804_i.func_78855_b();
            this.field_146803_h.func_148195_a(this.field_146804_i);
         }
   ...
   protected void func_73869_a(char p_73869_1_, int p_73869_2_) throws IOException {
      int lvt_3_1_ = this.field_146803_h.func_148193_k();
      GuiListExtended.IGuiListEntry lvt_4_1_ = lvt_3_1_ < 0 ? null : this.field_146803_h.func_148180_b(lvt_3_1_);
      if (p_73869_2_ == 63) {
         this.func_146792_q();
      } else {
         if (lvt_3_1_ >= 0) {
            if (p_73869_2_ == 200) {
               if (func_146272_n()) {
                  if (lvt_3_1_ > 0 && lvt_4_1_ instanceof ServerListEntryNormal) {
                     this.field_146804_i.func_78857_a(lvt_3_1_, lvt_3_1_ - 1);
               ...
               if (func_146272_n()) {
                  if (lvt_3_1_ < this.field_146804_i.func_78856_c() - 1) {
                     this.field_146804_i.func_78857_a(lvt_3_1_, lvt_3_1_ + 1);
                     this.func_146790_a(lvt_3_1_ + 1);
                     this.field_146803_h.func_148145_f(this.field_146803_h.func_148146_j());
                     this.field_146803_h.func_148195_a(this.field_146804_i);
                  }
               } else if (lvt_3_1_ < this.field_146803_h.func_148127_b()) {
                  this.func_146790_a(this.field_146803_h.func_148193_k() + 1);
                  this.field_146803_h.func_148145_f(this.field_146803_h.func_148146_j());
                  if (this.field_146803_h.func_148180_b(this.field_146803_h.func_148193_k()) instanceof ServerListEntryLanScan) {
   ...
   public void func_146796_h() {
      GuiListExtended.IGuiListEntry lvt_1_1_ = this.field_146803_h.func_148193_k() < 0 ? null : this.field_146803_h.func_148180_b(this.field_146803_h.func_148193_k());
      if (lvt_1_1_ instanceof ServerListEntryNormal) {
         this.func_146791_a(((ServerListEntryNormal)lvt_1_1_).func_148296_a());
      } else if (lvt_1_1_ instanceof ServerListEntryLanDetected) {
         LanServerDetector.LanServer lvt_2_1_ = ((ServerListEntryLanDetected)lvt_1_1_).func_148289_a();
         this.func_146791_a(new ServerData(lvt_2_1_.func_77487_a(), lvt_2_1_.func_77488_b(), true));
      }
   ...
   public void func_146790_a(int p_146790_1_) {
      ...
      GuiListExtended.IGuiListEntry lvt_2_1_ = p_146790_1_ < 0 ? null : this.field_146803_h.func_148180_b(p_146790_1_);
      this.field_146809_s.field_146124_l = false;
      this.field_146810_r.field_146124_l = false;
      this.field_146808_t.field_146124_l = false;
      if (lvt_2_1_ != null && !(lvt_2_1_ instanceof ServerListEntryLanScan)) {
         this.field_146809_s.field_146124_l = true;
         if (lvt_2_1_ instanceof ServerListEntryNormal) {
   ...
   public void func_175391_a(ServerListEntryNormal p_175391_1_, int p_175391_2_, boolean p_175391_3_) {
      int lvt_4_1_ = p_175391_3_ ? 0 : p_175391_2_ - 1;
      this.field_146804_i.func_78857_a(p_175391_2_, lvt_4_1_);
      if (this.field_146803_h.func_148193_k() == p_175391_2_) {
         this.func_146790_a(lvt_4_1_);
      }
   ...
   public void func_175393_b(ServerListEntryNormal p_175393_1_, int p_175393_2_, boolean p_175393_3_) {
      int lvt_4_1_ = p_175393_3_ ? this.field_146804_i.func_78856_c() - 1 : p_175393_2_ + 1;
      this.field_146804_i.func_78857_a(p_175393_2_, lvt_4_1_);
