...
public abstract class GuiSlot {
   ...
   public void func_148128_a(int p_148128_1_, int p_148128_2_, float p_148128_3_) {
      if (this.field_178041_q) {
         ...
         vertexbuffer.func_181662_b((double)this.field_148152_e, (double)(this.field_148153_b + i1), 0.0D).func_181673_a(0.0D, 1.0D).func_181669_b(0, 0, 0, 0).func_181675_d();
         vertexbuffer.func_181662_b((double)this.field_148151_d, (double)(this.field_148153_b + i1), 0.0D).func_181673_a(1.0D, 1.0D).func_181669_b(0, 0, 0, 0).func_181675_d();
         vertexbuffer.func_181662_b((double)this.field_148151_d, (double)this.field_148153_b, 0.0D).func_181673_a(1.0D, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
         vertexbuffer.func_181662_b((double)this.field_148152_e, (double)this.field_148153_b, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
         tessellator.func_78381_a();
         vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
         vertexbuffer.func_181662_b((double)this.field_148152_e, (double)this.field_148154_c, 0.0D).func_181673_a(0.0D, 1.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
         vertexbuffer.func_181662_b((double)this.field_148151_d, (double)this.field_148154_c, 0.0D).func_181673_a(1.0D, 1.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
         vertexbuffer.func_181662_b((double)this.field_148151_d, (double)(this.field_148154_c - i1), 0.0D).func_181673_a(1.0D, 0.0D).func_181669_b(0, 0, 0, 0).func_181675_d();
         vertexbuffer.func_181662_b((double)this.field_148152_e, (double)(this.field_148154_c - i1), 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(0, 0, 0, 0).func_181675_d();
         tessellator.func_78381_a();
         ...
         if (j1 > 0) {
            ...
            vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
            vertexbuffer.func_181662_b((double)i, (double)this.field_148154_c, 0.0D).func_181673_a(0.0D, 1.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)j, (double)this.field_148154_c, 0.0D).func_181673_a(1.0D, 1.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)j, (double)this.field_148153_b, 0.0D).func_181673_a(1.0D, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)i, (double)this.field_148153_b, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
            tessellator.func_78381_a();
            vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
            vertexbuffer.func_181662_b((double)i, (double)(l1 + k1), 0.0D).func_181673_a(0.0D, 1.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)j, (double)(l1 + k1), 0.0D).func_181673_a(1.0D, 1.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)j, (double)l1, 0.0D).func_181673_a(1.0D, 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)i, (double)l1, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
            tessellator.func_78381_a();
            vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
            vertexbuffer.func_181662_b((double)i, (double)(l1 + k1 - 1), 0.0D).func_181673_a(0.0D, 1.0D).func_181669_b(192, 192, 192, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)(j - 1), (double)(l1 + k1 - 1), 0.0D).func_181673_a(1.0D, 1.0D).func_181669_b(192, 192, 192, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)(j - 1), (double)l1, 0.0D).func_181673_a(1.0D, 0.0D).func_181669_b(192, 192, 192, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)i, (double)l1, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(192, 192, 192, 255).func_181675_d();
            tessellator.func_78381_a();
         }
   ...
   public void func_178039_p() {
      if (this.func_148141_e(this.field_148162_h)) {
         ...
         if (Mouse.getEventButton() == 0 && Mouse.getEventButtonState() && this.field_148162_h >= this.field_148153_b && this.field_148162_h <= this.field_148154_c) {
            i2 = (this.field_148155_a - this.func_148139_c()) / 2;
            j2 = (this.field_148155_a + this.func_148139_c()) / 2;
            k2 = this.field_148162_h - this.field_148153_b - this.field_148160_j + (int)this.field_148169_q - 4;
            l2 = k2 / this.field_148149_f;
            if (l2 < this.func_148127_b() && this.field_148150_g >= i2 && this.field_148150_g <= j2 && l2 >= 0 && k2 >= 0) {
         ...
         if (Mouse.isButtonDown(0) && this.func_148125_i()) {
            if (this.field_148157_o != -1) {
               ...
               if (this.field_148162_h >= this.field_148153_b && this.field_148162_h <= this.field_148154_c) {
                  j2 = (this.field_148155_a - this.func_148139_c()) / 2;
                  k2 = (this.field_148155_a + this.func_148139_c()) / 2;
                  l2 = this.field_148162_h - this.field_148153_b - this.field_148160_j + (int)this.field_148169_q - 4;
   ...
   protected void func_148120_b(int p_148120_1_, int p_148120_2_, int p_148120_3_, int p_148120_4_) {
      ...
      for(int j = 0; j < i; ++j) {
         ...
         if (this.field_148166_t && this.func_148131_a(j)) {
            ...
            GlStateManager.func_179090_x();
            vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
            vertexbuffer.func_181662_b((double)i1, (double)(k + l + 2), 0.0D).func_181673_a(0.0D, 1.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)j1, (double)(k + l + 2), 0.0D).func_181673_a(1.0D, 1.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)j1, (double)(k - 2), 0.0D).func_181673_a(1.0D, 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)i1, (double)(k - 2), 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)(i1 + 1), (double)(k + l + 1), 0.0D).func_181673_a(0.0D, 1.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)(j1 - 1), (double)(k + l + 1), 0.0D).func_181673_a(1.0D, 1.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)(j1 - 1), (double)(k - 1), 0.0D).func_181673_a(1.0D, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)(i1 + 1), (double)(k - 1), 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
            tessellator.func_78381_a();
            GlStateManager.func_179098_w();
         }

         if (!(this instanceof GuiResourcePackList) || k >= this.field_148153_b - this.field_148149_f && k <= this.field_148154_c) {
   ...
   protected void func_148136_c(int p_148136_1_, int p_148136_2_, int p_148136_3_, int p_148136_4_) {
      ...
      float f = 32.0F;
      vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
      vertexbuffer.func_181662_b((double)this.field_148152_e, (double)p_148136_2_, 0.0D).func_181673_a(0.0D, (double)((float)p_148136_2_ / 32.0F)).func_181669_b(64, 64, 64, p_148136_4_).func_181675_d();
      vertexbuffer.func_181662_b((double)(this.field_148152_e + this.field_148155_a), (double)p_148136_2_, 0.0D).func_181673_a((double)((float)this.field_148155_a / 32.0F), (double)((float)p_148136_2_ / 32.0F)).func_181669_b(64, 64, 64, p_148136_4_).func_181675_d();
      vertexbuffer.func_181662_b((double)(this.field_148152_e + this.field_148155_a), (double)p_148136_1_, 0.0D).func_181673_a((double)((float)this.field_148155_a / 32.0F), (double)((float)p_148136_1_ / 32.0F)).func_181669_b(64, 64, 64, p_148136_3_).func_181675_d();
      vertexbuffer.func_181662_b((double)this.field_148152_e, (double)p_148136_1_, 0.0D).func_181673_a(0.0D, (double)((float)p_148136_1_ / 32.0F)).func_181669_b(64, 64, 64, p_148136_3_).func_181675_d();
      tessellator.func_78381_a();
   }
   ...
   protected void drawContainerBackground(Tessellator p_drawContainerBackground_1_) {
      WorldRenderer vertexbuffer = p_drawContainerBackground_1_.func_178180_c();
      this.field_148161_k.func_110434_K().func_110577_a(Gui.field_110325_k);
      GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
      float f = 32.0F;
      vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
      vertexbuffer.func_181662_b((double)this.field_148152_e, (double)this.field_148154_c, 0.0D).func_181673_a((double)((float)this.field_148152_e / f), (double)((float)(this.field_148154_c + (int)this.field_148169_q) / f)).func_181669_b(32, 32, 32, 255).func_181675_d();
      vertexbuffer.func_181662_b((double)this.field_148151_d, (double)this.field_148154_c, 0.0D).func_181673_a((double)((float)this.field_148151_d / f), (double)((float)(this.field_148154_c + (int)this.field_148169_q) / f)).func_181669_b(32, 32, 32, 255).func_181675_d();
      vertexbuffer.func_181662_b((double)this.field_148151_d, (double)this.field_148153_b, 0.0D).func_181673_a((double)((float)this.field_148151_d / f), (double)((float)(this.field_148153_b + (int)this.field_148169_q) / f)).func_181669_b(32, 32, 32, 255).func_181675_d();
      vertexbuffer.func_181662_b((double)this.field_148152_e, (double)this.field_148153_b, 0.0D).func_181673_a((double)((float)this.field_148152_e / f), (double)((float)(this.field_148153_b + (int)this.field_148169_q) / f)).func_181669_b(32, 32, 32, 255).func_181675_d();
      p_drawContainerBackground_1_.func_78381_a();
   }
}
