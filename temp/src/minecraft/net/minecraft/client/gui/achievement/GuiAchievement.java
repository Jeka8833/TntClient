...
public class GuiAchievement extends Gui {
   ...
   private void func_146258_c() {
      ...
      ScaledResolution lvt_1_1_ = new ScaledResolution(this.field_146259_f);
      this.field_146260_g = lvt_1_1_.func_78326_a();
      this.field_146267_h = lvt_1_1_.func_78328_b();
   ...
   public void func_146254_a() {
      if (this.field_146266_k != null && this.field_146263_l != 0L && Minecraft.func_71410_x().field_71439_g != null) {
         double lvt_1_1_ = (double)(Minecraft.func_71386_F() - this.field_146263_l) / 3000.0D;
         ...
         lvt_3_1_ *= lvt_3_1_;
         lvt_3_1_ *= lvt_3_1_;
         int lvt_5_1_ = this.field_146260_g - 160;
         int lvt_6_1_ = 0 - (int)(lvt_3_1_ * 36.0D);
         GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
         GlStateManager.func_179098_w();
         this.field_146259_f.func_110434_K().func_110577_a(field_146261_a);
         GlStateManager.func_179140_f();
         this.func_73729_b(lvt_5_1_, lvt_6_1_, 96, 202, 160, 32);
         if (this.field_146262_n) {
            this.field_146259_f.field_71466_p.func_78279_b(this.field_146265_j, lvt_5_1_ + 30, lvt_6_1_ + 7, 120, -1);
         } else {
            this.field_146259_f.field_71466_p.func_78276_b(this.field_146268_i, lvt_5_1_ + 30, lvt_6_1_ + 7, -256);
            this.field_146259_f.field_71466_p.func_78276_b(this.field_146265_j, lvt_5_1_ + 30, lvt_6_1_ + 18, -1);
         }
         ...
         this.field_146264_m.func_180450_b(this.field_146266_k.field_75990_d, lvt_5_1_ + 8, lvt_6_1_ + 8);
         GlStateManager.func_179140_f();
