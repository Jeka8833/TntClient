...
public class GuiLockIconButton extends GuiButton {
   ...
   public void func_146112_a(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_) {
      if (this.field_146125_m) {
         ...
         GuiLockIconButton.Icon lvt_5_6_;
         if (this.field_175231_o) {
            if (!this.field_146124_l) {
               lvt_5_6_ = GuiLockIconButton.Icon.LOCKED_DISABLED;
            } else if (lvt_4_1_) {
               lvt_5_6_ = GuiLockIconButton.Icon.LOCKED_HOVER;
            } else {
               lvt_5_6_ = GuiLockIconButton.Icon.LOCKED;
            }
         } else if (!this.field_146124_l) {
            lvt_5_6_ = GuiLockIconButton.Icon.UNLOCKED_DISABLED;
         } else if (lvt_4_1_) {
            lvt_5_6_ = GuiLockIconButton.Icon.UNLOCKED_HOVER;
         } else {
            lvt_5_6_ = GuiLockIconButton.Icon.UNLOCKED;
         }

         this.func_73729_b(this.field_146128_h, this.field_146129_i, lvt_5_6_.func_178910_a(), lvt_5_6_.func_178912_b(), this.field_146120_f, this.field_146121_g);
      }
   }
