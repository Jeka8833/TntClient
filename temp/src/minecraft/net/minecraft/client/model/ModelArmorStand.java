...
public class ModelArmorStand extends ModelArmorStandArmor {
   ...
   public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
      ...
      if (p_78087_7_ instanceof EntityArmorStand) {
         ...
         this.field_178724_i.field_78806_j = lvt_8_1_.func_175402_q();
         this.field_178723_h.field_78806_j = lvt_8_1_.func_175402_q();
         this.field_178737_d.field_78806_j = !lvt_8_1_.func_175414_r();
         this.field_178722_k.func_78793_a(1.9F, 12.0F, 0.0F);
         this.field_178721_j.func_78793_a(-1.9F, 12.0F, 0.0F);
         this.field_178740_a.field_78795_f = 0.017453292F * lvt_8_1_.func_175408_t().func_179415_b();
         this.field_178740_a.field_78796_g = 0.017453292F * lvt_8_1_.func_175408_t().func_179416_c();
         this.field_178740_a.field_78808_h = 0.017453292F * lvt_8_1_.func_175408_t().func_179413_d();
         this.field_178738_b.field_78795_f = 0.017453292F * lvt_8_1_.func_175408_t().func_179415_b();
         this.field_178738_b.field_78796_g = 0.017453292F * lvt_8_1_.func_175408_t().func_179416_c();
         this.field_178738_b.field_78808_h = 0.017453292F * lvt_8_1_.func_175408_t().func_179413_d();
         this.field_178739_c.field_78795_f = 0.017453292F * lvt_8_1_.func_175408_t().func_179415_b();
         this.field_178739_c.field_78796_g = 0.017453292F * lvt_8_1_.func_175408_t().func_179416_c();
         this.field_178739_c.field_78808_h = 0.017453292F * lvt_8_1_.func_175408_t().func_179413_d();
         float lvt_9_1_ = (lvt_8_1_.func_175403_w().func_179415_b() + lvt_8_1_.func_175407_x().func_179415_b()) / 2.0F;
         float lvt_10_1_ = (lvt_8_1_.func_175403_w().func_179416_c() + lvt_8_1_.func_175407_x().func_179416_c()) / 2.0F;
         float lvt_11_1_ = (lvt_8_1_.func_175403_w().func_179413_d() + lvt_8_1_.func_175407_x().func_179413_d()) / 2.0F;
   ...
   public void func_78088_a(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
      ...
      if (this.field_78091_s) {
         float lvt_8_1_ = 2.0F;
         GlStateManager.func_179152_a(1.0F / lvt_8_1_, 1.0F / lvt_8_1_, 1.0F / lvt_8_1_);
   ...
   public void func_178718_a(float p_178718_1_) {
      boolean lvt_2_1_ = this.field_178723_h.field_78806_j;
      this.field_178723_h.field_78806_j = true;
      super.func_178718_a(p_178718_1_);
      this.field_178723_h.field_78806_j = lvt_2_1_;
   }
}
