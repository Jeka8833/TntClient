...
public class ModelRenderer {
   ...
   public void func_78785_a(float p_78785_1_) {
      if (!this.field_78807_k && this.field_78806_j) {
         ...
         GlStateManager.func_179109_b(-this.field_82906_o, -this.field_82908_p, -this.field_82907_q);
         if (lastTextureId != 0) {
            GlStateManager.func_179144_i(lastTextureId);
         }
      }
      ...
      if (!this.field_78807_k && this.field_78806_j) {
         ...
         if (this.field_78805_m != null) {
            for(int i = 0; i < this.field_78805_m.size(); ++i) {
               ((ModelRenderer)this.field_78805_m.get(i)).func_78785_a(p_78791_1_);
            }
         }
   ...
   private void func_78788_d(float p_78788_1_) {
      ...
      WorldRenderer vertexbuffer = Tessellator.func_178181_a().func_178180_c();
      ...
      for(i = 0; i < this.spriteList.size(); ++i) {
         ...
         sprite.render(Tessellator.func_178181_a(), p_78788_1_);
      }
   ...
   public ModelRenderer getChild(String p_getChild_1_) {
      if (p_getChild_1_ == null) {
         ...
         if (this.field_78805_m != null) {
            for(int i = 0; i < this.field_78805_m.size(); ++i) {
               ModelRenderer child = (ModelRenderer)this.field_78805_m.get(i);
               if (p_getChild_1_.equals(child.getId())) {
                  return child;
               }
            }
         }
   ...
   public ModelRenderer getChildDeep(String p_getChildDeep_1_) {
      if (p_getChildDeep_1_ == null) {
         ...
         ModelRenderer mrChild = this.getChild(p_getChildDeep_1_);
         if (mrChild != null) {
            return mrChild;
         } else {
            if (this.field_78805_m != null) {
               for(int i = 0; i < this.field_78805_m.size(); ++i) {
                  ModelRenderer child = (ModelRenderer)this.field_78805_m.get(i);
                  ModelRenderer mr = child.getChildDeep(p_getChildDeep_1_);
                  if (mr != null) {
                     return mr;
                  }
               }
   ...
   public String toString() {
      ...
      sb.append("id: " + this.id + ", boxes: " + (this.field_78804_l != null ? this.field_78804_l.size() : null) + ", submodels: " + (this.field_78805_m != null ? this.field_78805_m.size() : null));
      return sb.toString();
   }
}
