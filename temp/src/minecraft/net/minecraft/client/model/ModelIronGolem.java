...
public class ModelIronGolem extends ModelBase {
   ...
   public ModelIronGolem(float p_i46362_1_, float p_i46362_2_) {
      int lvt_3_1_ = 128;
      int lvt_4_1_ = 128;
      this.field_78178_a = (new ModelRenderer(this)).func_78787_b(lvt_3_1_, lvt_4_1_);
      ...
      this.field_78176_b = (new ModelRenderer(this)).func_78787_b(lvt_3_1_, lvt_4_1_);
      ...
      this.field_78177_c = (new ModelRenderer(this)).func_78787_b(lvt_3_1_, lvt_4_1_);
      ...
      this.field_78174_d = (new ModelRenderer(this)).func_78787_b(lvt_3_1_, lvt_4_1_);
      ...
      this.field_78175_e = (new ModelRenderer(this, 0, 22)).func_78787_b(lvt_3_1_, lvt_4_1_);
      ...
      this.field_78173_f = (new ModelRenderer(this, 0, 22)).func_78787_b(lvt_3_1_, lvt_4_1_);
   ...
   public void func_78086_a(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_) {
      EntityIronGolem lvt_5_1_ = (EntityIronGolem)p_78086_1_;
      int lvt_6_1_ = lvt_5_1_.func_70854_o();
      if (lvt_6_1_ > 0) {
         this.field_78177_c.field_78795_f = -2.0F + 1.5F * this.func_78172_a((float)lvt_6_1_ - p_78086_4_, 10.0F);
         this.field_78174_d.field_78795_f = -2.0F + 1.5F * this.func_78172_a((float)lvt_6_1_ - p_78086_4_, 10.0F);
      } else {
         int lvt_7_1_ = lvt_5_1_.func_70853_p();
         if (lvt_7_1_ > 0) {
            this.field_78177_c.field_78795_f = -0.8F + 0.025F * this.func_78172_a((float)lvt_7_1_, 70.0F);
