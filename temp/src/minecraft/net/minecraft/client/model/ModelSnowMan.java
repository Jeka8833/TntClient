...
public class ModelSnowMan extends ModelBase {
   ...
   public ModelSnowMan() {
      ...
      this.field_78195_c.func_78790_a(-4.0F, -8.0F, -4.0F, 8, 8, 8, lvt_2_1_ - 0.5F);
      this.field_78195_c.func_78793_a(0.0F, 0.0F + lvt_1_1_, 0.0F);
      this.field_78192_d = (new ModelRenderer(this, 32, 0)).func_78787_b(64, 64);
      this.field_78192_d.func_78790_a(-1.0F, 0.0F, -1.0F, 12, 2, 2, lvt_2_1_ - 0.5F);
      this.field_78192_d.func_78793_a(0.0F, 0.0F + lvt_1_1_ + 9.0F - 7.0F, 0.0F);
      this.field_78193_e = (new ModelRenderer(this, 32, 0)).func_78787_b(64, 64);
      this.field_78193_e.func_78790_a(-1.0F, 0.0F, -1.0F, 12, 2, 2, lvt_2_1_ - 0.5F);
      this.field_78193_e.func_78793_a(0.0F, 0.0F + lvt_1_1_ + 9.0F - 7.0F, 0.0F);
      this.field_78196_a = (new ModelRenderer(this, 0, 16)).func_78787_b(64, 64);
      this.field_78196_a.func_78790_a(-5.0F, -10.0F, -5.0F, 10, 10, 10, lvt_2_1_ - 0.5F);
      this.field_78196_a.func_78793_a(0.0F, 0.0F + lvt_1_1_ + 9.0F, 0.0F);
      this.field_78194_b = (new ModelRenderer(this, 0, 36)).func_78787_b(64, 64);
      this.field_78194_b.func_78790_a(-6.0F, -12.0F, -6.0F, 12, 12, 12, lvt_2_1_ - 0.5F);
      this.field_78194_b.func_78793_a(0.0F, 0.0F + lvt_1_1_ + 20.0F, 0.0F);
   }
   ...
   public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
      ...
      float lvt_8_1_ = MathHelper.func_76126_a(this.field_78196_a.field_78796_g);
      float lvt_9_1_ = MathHelper.func_76134_b(this.field_78196_a.field_78796_g);
      ...
      this.field_78192_d.field_78800_c = lvt_9_1_ * 5.0F;
      this.field_78192_d.field_78798_e = -lvt_8_1_ * 5.0F;
      this.field_78193_e.field_78800_c = -lvt_9_1_ * 5.0F;
      this.field_78193_e.field_78798_e = lvt_8_1_ * 5.0F;
   }
