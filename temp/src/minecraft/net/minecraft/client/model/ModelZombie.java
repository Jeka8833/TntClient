...
public class ModelZombie extends ModelBiped {
   ...
   public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
      ...
      float lvt_8_1_ = MathHelper.func_76126_a(this.field_78095_p * 3.1415927F);
      float lvt_9_1_ = MathHelper.func_76126_a((1.0F - (1.0F - this.field_78095_p) * (1.0F - this.field_78095_p)) * 3.1415927F);
      this.field_178723_h.field_78808_h = 0.0F;
      this.field_178724_i.field_78808_h = 0.0F;
      this.field_178723_h.field_78796_g = -(0.1F - lvt_8_1_ * 0.6F);
      this.field_178724_i.field_78796_g = 0.1F - lvt_8_1_ * 0.6F;
      ...
      var10000.field_78795_f -= lvt_8_1_ * 1.2F - lvt_9_1_ * 0.4F;
