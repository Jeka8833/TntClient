...
public class ModelWolf extends ModelBase {
   ...
   public ModelWolf() {
      ...
      this.field_78185_a.func_78790_a(-3.0F, -3.0F, -2.0F, 6, 6, 4, lvt_1_1_);
      this.field_78185_a.func_78793_a(-1.0F, lvt_2_1_, -7.0F);
      this.field_78183_b = new ModelRenderer(this, 18, 14);
      this.field_78183_b.func_78790_a(-4.0F, -2.0F, -3.0F, 6, 9, 6, lvt_1_1_);
      this.field_78183_b.func_78793_a(0.0F, 14.0F, 2.0F);
      this.field_78186_h = new ModelRenderer(this, 21, 0);
      this.field_78186_h.func_78790_a(-4.0F, -3.0F, -3.0F, 8, 6, 7, lvt_1_1_);
      this.field_78186_h.func_78793_a(-1.0F, 14.0F, 2.0F);
      this.field_78184_c = new ModelRenderer(this, 0, 18);
      this.field_78184_c.func_78790_a(-1.0F, 0.0F, -1.0F, 2, 8, 2, lvt_1_1_);
      this.field_78184_c.func_78793_a(-2.5F, 16.0F, 7.0F);
      this.field_78181_d = new ModelRenderer(this, 0, 18);
      this.field_78181_d.func_78790_a(-1.0F, 0.0F, -1.0F, 2, 8, 2, lvt_1_1_);
      this.field_78181_d.func_78793_a(0.5F, 16.0F, 7.0F);
      this.field_78182_e = new ModelRenderer(this, 0, 18);
      this.field_78182_e.func_78790_a(-1.0F, 0.0F, -1.0F, 2, 8, 2, lvt_1_1_);
      this.field_78182_e.func_78793_a(-2.5F, 16.0F, -4.0F);
      this.field_78179_f = new ModelRenderer(this, 0, 18);
      this.field_78179_f.func_78790_a(-1.0F, 0.0F, -1.0F, 2, 8, 2, lvt_1_1_);
      this.field_78179_f.func_78793_a(0.5F, 16.0F, -4.0F);
      this.field_78180_g = new ModelRenderer(this, 9, 18);
      this.field_78180_g.func_78790_a(-1.0F, 0.0F, -1.0F, 2, 8, 2, lvt_1_1_);
      this.field_78180_g.func_78793_a(-1.0F, 12.0F, 8.0F);
      this.field_78185_a.func_78784_a(16, 14).func_78790_a(-3.0F, -5.0F, 0.0F, 2, 2, 1, lvt_1_1_);
      this.field_78185_a.func_78784_a(16, 14).func_78790_a(1.0F, -5.0F, 0.0F, 2, 2, 1, lvt_1_1_);
      this.field_78185_a.func_78784_a(0, 10).func_78790_a(-1.5F, 0.0F, -5.0F, 3, 3, 4, lvt_1_1_);
   }
   ...
   public void func_78086_a(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_) {
      EntityWolf lvt_5_1_ = (EntityWolf)p_78086_1_;
      if (lvt_5_1_.func_70919_bu()) {
      ...
      this.field_78185_a.field_78808_h = lvt_5_1_.func_70917_k(p_78086_4_) + lvt_5_1_.func_70923_f(p_78086_4_, 0.0F);
      this.field_78186_h.field_78808_h = lvt_5_1_.func_70923_f(p_78086_4_, -0.08F);
      this.field_78183_b.field_78808_h = lvt_5_1_.func_70923_f(p_78086_4_, -0.16F);
      this.field_78180_g.field_78808_h = lvt_5_1_.func_70923_f(p_78086_4_, -0.2F);
   }
