...
public class ModelBiped extends ModelBase {
   ...
   public void func_78088_a(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
      ...
      if (this.field_78091_s) {
         float lvt_8_1_ = 2.0F;
         GlStateManager.func_179152_a(1.5F / lvt_8_1_, 1.5F / lvt_8_1_, 1.5F / lvt_8_1_);
   ...
   public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
      ...
      if (this.field_78095_p > -9990.0F) {
         ...
         this.field_78115_e.field_78796_g = MathHelper.func_76126_a(MathHelper.func_76129_c(lvt_8_2_) * 3.1415927F * 2.0F) * 0.2F;
         ...
         lvt_9_2_ = MathHelper.func_76126_a(lvt_8_2_ * 3.1415927F);
         float lvt_10_1_ = MathHelper.func_76126_a(this.field_78095_p * 3.1415927F) * -(this.field_78116_c.field_78795_f - 0.7F) * 0.75F;
         var10000 = this.field_178723_h;
         var10000.field_78795_f = (float)((double)var10000.field_78795_f - ((double)lvt_9_2_ * 1.2D + (double)lvt_10_1_));
         var10000 = this.field_178723_h;
   ...
   public void func_178686_a(ModelBase p_178686_1_) {
      ...
      if (p_178686_1_ instanceof ModelBiped) {
         ModelBiped lvt_2_1_ = (ModelBiped)p_178686_1_;
         this.field_78119_l = lvt_2_1_.field_78119_l;
         this.field_78120_m = lvt_2_1_.field_78120_m;
         this.field_78117_n = lvt_2_1_.field_78117_n;
         this.field_78118_o = lvt_2_1_.field_78118_o;
      }
