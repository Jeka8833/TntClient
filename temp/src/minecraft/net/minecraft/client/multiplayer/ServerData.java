...
public class ServerData {
   ...
   public NBTTagCompound func_78836_a() {
      ...
      lvt_1_1_.func_74778_a("name", this.field_78847_a);
      lvt_1_1_.func_74778_a("ip", this.field_78845_b);
      if (this.field_147411_m != null) {
         lvt_1_1_.func_74778_a("icon", this.field_147411_m);
      }

      if (this.field_152587_j == ServerData.ServerResourceMode.ENABLED) {
         lvt_1_1_.func_74757_a("acceptTextures", true);
      } else if (this.field_152587_j == ServerData.ServerResourceMode.DISABLED) {
         lvt_1_1_.func_74757_a("acceptTextures", false);
      }
   ...
   public static ServerData func_78837_a(NBTTagCompound p_78837_0_) {
      ServerData lvt_1_1_ = new ServerData(p_78837_0_.func_74779_i("name"), p_78837_0_.func_74779_i("ip"), false);
      if (p_78837_0_.func_150297_b("icon", 8)) {
         lvt_1_1_.func_147407_a(p_78837_0_.func_74779_i("icon"));
      }

      if (p_78837_0_.func_150297_b("acceptTextures", 1)) {
         if (p_78837_0_.func_74767_n("acceptTextures")) {
            lvt_1_1_.func_152584_a(ServerData.ServerResourceMode.ENABLED);
         } else {
            lvt_1_1_.func_152584_a(ServerData.ServerResourceMode.DISABLED);
         }
      } else {
         lvt_1_1_.func_152584_a(ServerData.ServerResourceMode.PROMPT);
      }
