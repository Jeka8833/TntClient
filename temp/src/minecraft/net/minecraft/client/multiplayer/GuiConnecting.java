...
public class GuiConnecting extends GuiScreen {
   ...
   public GuiConnecting(GuiScreen p_i1181_1_, Minecraft p_i1181_2_, ServerData p_i1181_3_) {
      ...
      ServerAddress lvt_4_1_ = ServerAddress.func_78860_a(p_i1181_3_.field_78845_b);
      p_i1181_2_.func_71403_a((WorldClient)null);
      p_i1181_2_.func_71351_a(p_i1181_3_);
      this.func_146367_a(lvt_4_1_.func_78861_a(), lvt_4_1_.func_78864_b());
   }
      ...
      (new Thread("Server Connector #" + field_146372_a.incrementAndGet()) {
         public void run() {
            ...
            try {
               ...
               GuiConnecting.this.field_146371_g = NetworkManager.func_181124_a(lvt_1_1_, p_146367_2_, GuiConnecting.this.field_146297_k.field_71474_y.func_181148_f());
               ...
               GuiConnecting.field_146370_f.error((String)"Couldn't connect to server", (Throwable)var5);
               ...
               GuiConnecting.field_146370_f.error((String)"Couldn't connect to server", (Throwable)var6);
               String lvt_3_1_ = var6.toString();
               if (lvt_1_1_ != null) {
                  String lvt_4_1_ = lvt_1_1_.toString() + ":" + p_146367_2_;
                  lvt_3_1_ = lvt_3_1_.replaceAll(lvt_4_1_, "");
               }

               GuiConnecting.this.field_146297_k.func_147108_a(new GuiDisconnected(GuiConnecting.this.field_146374_i, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", new Object[]{lvt_3_1_})));
            }
