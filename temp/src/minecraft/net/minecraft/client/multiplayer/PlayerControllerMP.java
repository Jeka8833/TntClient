...
public class PlayerControllerMP {
   ...
   public boolean func_178888_a(BlockPos p_178888_1_, EnumFacing p_178888_2_) {
      if (this.field_78779_k.func_82752_c()) {
         ...
         if (!this.field_78776_a.field_71439_g.func_175142_cm()) {
            Block lvt_3_1_ = this.field_78776_a.field_71441_e.func_180495_p(p_178888_1_).func_177230_c();
            ItemStack lvt_4_1_ = this.field_78776_a.field_71439_g.func_71045_bC();
            if (lvt_4_1_ == null) {
               return false;
            }
      ...
      if (this.field_78779_k.func_77145_d() && this.field_78776_a.field_71439_g.func_70694_bm() != null && this.field_78776_a.field_71439_g.func_70694_bm().func_77973_b() instanceof ItemSword) {
         ...
         World lvt_3_2_ = this.field_78776_a.field_71441_e;
         IBlockState lvt_4_2_ = lvt_3_2_.func_180495_p(p_178888_1_);
         Block lvt_5_1_ = lvt_4_2_.func_177230_c();
         if (lvt_5_1_.func_149688_o() == Material.field_151579_a) {
            return false;
         } else {
            lvt_3_2_.func_175718_b(2001, p_178888_1_, Block.func_176210_f(lvt_4_2_));
            boolean lvt_6_1_ = lvt_3_2_.func_175698_g(p_178888_1_);
            if (lvt_6_1_) {
               lvt_5_1_.func_176206_d(lvt_3_2_, p_178888_1_, lvt_4_2_);
            }

            this.field_178895_c = new BlockPos(this.field_178895_c.func_177958_n(), -1, this.field_178895_c.func_177952_p());
            if (!this.field_78779_k.func_77145_d()) {
               ItemStack lvt_7_1_ = this.field_78776_a.field_71439_g.func_71045_bC();
               if (lvt_7_1_ != null) {
                  lvt_7_1_.func_179548_a(lvt_3_2_, lvt_5_1_, p_178888_1_, this.field_78776_a.field_71439_g);
   ...
   public boolean func_180511_b(BlockPos p_180511_1_, EnumFacing p_180511_2_) {
      ...
      if (this.field_78779_k.func_82752_c()) {
         ...
         if (!this.field_78776_a.field_71439_g.func_175142_cm()) {
            lvt_3_2_ = this.field_78776_a.field_71441_e.func_180495_p(p_180511_1_).func_177230_c();
            ItemStack lvt_4_1_ = this.field_78776_a.field_71439_g.func_71045_bC();
            if (lvt_4_1_ == null) {
               return false;
            }

            if (!lvt_4_1_.func_179544_c(lvt_3_2_)) {
               return false;
            }
         }
      }
      ...
      if (!this.field_78776_a.field_71441_e.func_175723_af().func_177746_a(p_180511_1_)) {
         ...
         if (this.field_78779_k.func_77145_d()) {
            ...
            this.field_78774_b.func_147297_a(new C07PacketPlayerDigging(C07PacketPlayerDigging.Action.START_DESTROY_BLOCK, p_180511_1_, p_180511_2_));
            lvt_3_2_ = this.field_78776_a.field_71441_e.func_180495_p(p_180511_1_).func_177230_c();
            boolean lvt_4_2_ = lvt_3_2_.func_149688_o() != Material.field_151579_a;
            if (lvt_4_2_ && this.field_78770_f == 0.0F) {
               lvt_3_2_.func_180649_a(this.field_78776_a.field_71441_e, p_180511_1_, this.field_78776_a.field_71439_g);
            }

            if (lvt_4_2_ && lvt_3_2_.func_180647_a(this.field_78776_a.field_71439_g, this.field_78776_a.field_71439_g.field_70170_p, p_180511_1_) >= 1.0F) {
   ...
   public boolean func_180512_c(BlockPos p_180512_1_, EnumFacing p_180512_2_) {
      ...
      if (this.field_78781_i > 0) {
         ...
         Block lvt_3_1_ = this.field_78776_a.field_71441_e.func_180495_p(p_180512_1_).func_177230_c();
         if (lvt_3_1_.func_149688_o() == Material.field_151579_a) {
            this.field_78778_j = false;
            return false;
         } else {
            this.field_78770_f += lvt_3_1_.func_180647_a(this.field_78776_a.field_71439_g, this.field_78776_a.field_71439_g.field_70170_p, p_180512_1_);
            if (this.field_78780_h % 4.0F == 0.0F) {
               this.field_78776_a.func_147118_V().func_147682_a(new PositionedSoundRecord(new ResourceLocation(lvt_3_1_.field_149762_H.func_150498_e()), (lvt_3_1_.field_149762_H.func_150497_c() + 1.0F) / 8.0F, lvt_3_1_.field_149762_H.func_150494_d() * 0.5F, (float)p_180512_1_.func_177958_n() + 0.5F, (float)p_180512_1_.func_177956_o() + 0.5F, (float)p_180512_1_.func_177952_p() + 0.5F));
            }
   ...
   private boolean func_178893_a(BlockPos p_178893_1_) {
      ItemStack lvt_2_1_ = this.field_78776_a.field_71439_g.func_70694_bm();
      boolean lvt_3_1_ = this.field_85183_f == null && lvt_2_1_ == null;
      if (this.field_85183_f != null && lvt_2_1_ != null) {
         lvt_3_1_ = lvt_2_1_.func_77973_b() == this.field_85183_f.func_77973_b() && ItemStack.func_77970_a(lvt_2_1_, this.field_85183_f) && (lvt_2_1_.func_77984_f() || lvt_2_1_.func_77960_j() == this.field_85183_f.func_77960_j());
      }

      return p_178893_1_.equals(this.field_178895_c) && lvt_3_1_;
   }

   private void func_78750_j() {
      int lvt_1_1_ = this.field_78776_a.field_71439_g.field_71071_by.field_70461_c;
      if (lvt_1_1_ != this.field_78777_l) {
         this.field_78777_l = lvt_1_1_;
   ...
   public boolean func_178890_a(EntityPlayerSP p_178890_1_, WorldClient p_178890_2_, ItemStack p_178890_3_, BlockPos p_178890_4_, EnumFacing p_178890_5_, Vec3 p_178890_6_) {
      this.func_78750_j();
      float lvt_7_1_ = (float)(p_178890_6_.field_72450_a - (double)p_178890_4_.func_177958_n());
      float lvt_8_1_ = (float)(p_178890_6_.field_72448_b - (double)p_178890_4_.func_177956_o());
      float lvt_9_1_ = (float)(p_178890_6_.field_72449_c - (double)p_178890_4_.func_177952_p());
      boolean lvt_10_1_ = false;
      if (!this.field_78776_a.field_71441_e.func_175723_af().func_177746_a(p_178890_4_)) {
         return false;
      } else {
         if (this.field_78779_k != WorldSettings.GameType.SPECTATOR) {
            IBlockState lvt_11_1_ = p_178890_2_.func_180495_p(p_178890_4_);
            if ((!p_178890_1_.func_70093_af() || p_178890_1_.func_70694_bm() == null) && lvt_11_1_.func_177230_c().func_180639_a(p_178890_2_, p_178890_4_, lvt_11_1_, p_178890_1_, p_178890_5_, lvt_7_1_, lvt_8_1_, lvt_9_1_)) {
               lvt_10_1_ = true;
            }

            if (!lvt_10_1_ && p_178890_3_ != null && p_178890_3_.func_77973_b() instanceof ItemBlock) {
               ItemBlock lvt_12_1_ = (ItemBlock)p_178890_3_.func_77973_b();
               if (!lvt_12_1_.func_179222_a(p_178890_2_, p_178890_4_, p_178890_5_, p_178890_1_, p_178890_3_)) {
                  return false;
               }
            }
         }

         this.field_78774_b.func_147297_a(new C08PacketPlayerBlockPlacement(p_178890_4_, p_178890_5_.func_176745_a(), p_178890_1_.field_71071_by.func_70448_g(), lvt_7_1_, lvt_8_1_, lvt_9_1_));
         if (!lvt_10_1_ && this.field_78779_k != WorldSettings.GameType.SPECTATOR) {
            if (p_178890_3_ == null) {
               return false;
            } else if (this.field_78779_k.func_77145_d()) {
               int lvt_11_2_ = p_178890_3_.func_77960_j();
               int lvt_12_2_ = p_178890_3_.field_77994_a;
               boolean lvt_13_1_ = p_178890_3_.func_179546_a(p_178890_1_, p_178890_2_, p_178890_4_, p_178890_5_, lvt_7_1_, lvt_8_1_, lvt_9_1_);
               p_178890_3_.func_77964_b(lvt_11_2_);
               p_178890_3_.field_77994_a = lvt_12_2_;
               return lvt_13_1_;
            } else {
               return p_178890_3_.func_179546_a(p_178890_1_, p_178890_2_, p_178890_4_, p_178890_5_, lvt_7_1_, lvt_8_1_, lvt_9_1_);
            }
         } else {
            return true;
         }
   ...
   public boolean func_78769_a(EntityPlayer p_78769_1_, World p_78769_2_, ItemStack p_78769_3_) {
      if (this.field_78779_k == WorldSettings.GameType.SPECTATOR) {
         ...
         int lvt_4_1_ = p_78769_3_.field_77994_a;
         ItemStack lvt_5_1_ = p_78769_3_.func_77957_a(p_78769_2_, p_78769_1_);
         if (lvt_5_1_ != p_78769_3_ || lvt_5_1_ != null && lvt_5_1_.field_77994_a != lvt_4_1_) {
            p_78769_1_.field_71071_by.field_70462_a[p_78769_1_.field_71071_by.field_70461_c] = lvt_5_1_;
   ...
   public boolean func_178894_a(EntityPlayer p_178894_1_, Entity p_178894_2_, MovingObjectPosition p_178894_3_) {
      this.func_78750_j();
      Vec3 lvt_4_1_ = new Vec3(p_178894_3_.field_72307_f.field_72450_a - p_178894_2_.field_70165_t, p_178894_3_.field_72307_f.field_72448_b - p_178894_2_.field_70163_u, p_178894_3_.field_72307_f.field_72449_c - p_178894_2_.field_70161_v);
      this.field_78774_b.func_147297_a(new C02PacketUseEntity(p_178894_2_, lvt_4_1_));
      return this.field_78779_k != WorldSettings.GameType.SPECTATOR && p_178894_2_.func_174825_a(p_178894_1_, lvt_4_1_);
   }

   public ItemStack func_78753_a(int p_78753_1_, int p_78753_2_, int p_78753_3_, int p_78753_4_, EntityPlayer p_78753_5_) {
      short lvt_6_1_ = p_78753_5_.field_71070_bA.func_75136_a(p_78753_5_.field_71071_by);
      ItemStack lvt_7_1_ = p_78753_5_.field_71070_bA.func_75144_a(p_78753_2_, p_78753_3_, p_78753_4_, p_78753_5_);
      this.field_78774_b.func_147297_a(new C0EPacketClickWindow(p_78753_1_, p_78753_2_, p_78753_3_, p_78753_4_, lvt_7_1_, lvt_6_1_));
      return lvt_7_1_;
   }
