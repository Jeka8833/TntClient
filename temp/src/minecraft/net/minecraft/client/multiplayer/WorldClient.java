...
public class WorldClient extends World {
   ...
   protected void func_147456_g() {
      ...
      int i = 0;
      Iterator i$ = this.field_72993_I.iterator();

      while(i$.hasNext()) {
         ChunkCoordIntPair chunkcoordintpair = (ChunkCoordIntPair)i$.next();
   ...
   public void func_73022_a() {
      ...
      int j1;
      int k1;
      for(i1 = 0; i1 < this.field_72997_g.size(); ++i1) {
         entity1 = (Entity)this.field_72997_g.get(i1);
         j1 = entity1.field_70176_ah;
         k1 = entity1.field_70164_aj;
      ...
      for(i1 = 0; i1 < this.field_72996_f.size(); ++i1) {
         entity1 = (Entity)this.field_72996_f.get(i1);
   ...
   public int func_175626_b(BlockPos p_175626_1_, int p_175626_2_) {
      int combinedLight = super.func_175626_b(p_175626_1_, p_175626_2_);
      if (Config.isDynamicLights()) {
         combinedLight = DynamicLights.getCombinedLight(p_175626_1_, combinedLight);
      }
   ...
   public boolean func_180501_a(BlockPos p_180501_1_, IBlockState p_180501_2_, int p_180501_3_) {
      ...
      boolean res = super.func_180501_a(p_180501_1_, p_180501_2_, p_180501_3_);
