...
public class NetHandlerLoginClient implements INetHandlerLoginClient {
   ...
   public void func_147389_a(S01PacketEncryptionRequest p_147389_1_) {
      final SecretKey lvt_2_1_ = CryptManager.func_75890_a();
      String lvt_3_1_ = p_147389_1_.func_149609_c();
      PublicKey lvt_4_1_ = p_147389_1_.func_149608_d();
      String lvt_5_1_ = (new BigInteger(CryptManager.func_75895_a(lvt_3_1_, lvt_4_1_, lvt_2_1_))).toString(16);
      if (this.field_147394_b.func_147104_D() != null && this.field_147394_b.func_147104_D().func_181041_d()) {
         try {
            this.func_147391_c().joinServer(this.field_147394_b.func_110432_I().func_148256_e(), this.field_147394_b.func_110432_I().func_148254_d(), lvt_5_1_);
      ...
      this.field_147393_d.func_179288_a(new C01PacketEncryptionResponse(lvt_2_1_, lvt_4_1_, p_147389_1_.func_149607_e()), new GenericFutureListener<Future<? super Void>>() {
         public void operationComplete(Future<? super Void> p_operationComplete_1_) throws Exception {
            NetHandlerLoginClient.this.field_147393_d.func_150727_a(lvt_2_1_);
         }
      });
   }
