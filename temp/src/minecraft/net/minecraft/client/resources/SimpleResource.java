...
public class SimpleResource implements IResource {
   ...
   public <T extends IMetadataSection> T func_110526_a(String p_110526_1_) {
      if (!this.func_110528_c()) {
         ...
         if (this.field_110530_g == null && !this.field_110529_f) {
            ...
            try {
               lvt_2_1_ = new BufferedReader(new InputStreamReader(this.field_110531_d));
               this.field_110530_g = (new JsonParser()).parse((Reader)lvt_2_1_).getAsJsonObject();
            } finally {
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         if (this.field_110533_b != null) {
            if (!this.field_110533_b.equals(lvt_2_1_.field_110533_b)) {
               return false;
            }
         } else if (lvt_2_1_.field_110533_b != null) {
            return false;
         }

         if (this.field_177242_b != null) {
            if (!this.field_177242_b.equals(lvt_2_1_.field_177242_b)) {
               return false;
            }
         } else if (lvt_2_1_.field_177242_b != null) {
            return false;
         }
   ...
   public int hashCode() {
      int lvt_1_1_ = this.field_177242_b != null ? this.field_177242_b.hashCode() : 0;
      lvt_1_1_ = 31 * lvt_1_1_ + (this.field_110533_b != null ? this.field_110533_b.hashCode() : 0);
      return lvt_1_1_;
   }
}
