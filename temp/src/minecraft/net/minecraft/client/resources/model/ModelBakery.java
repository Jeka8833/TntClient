...
public class ModelBakery {
   ...
   private void func_177577_b() {
      ...
      this.field_177612_i.put(field_177604_a, new ModelBlockDefinition.Variants(field_177604_a.func_177518_c(), Lists.newArrayList((Object[])(new ModelBlockDefinition.Variant(new ResourceLocation(field_177604_a.func_110623_a()), ModelRotation.X0_Y0, false, 1)))));
   ...
   private void func_177591_a(Collection<ModelResourceLocation> p_177591_1_) {
      Iterator i$ = p_177591_1_.iterator();

      while(i$.hasNext()) {
         ModelResourceLocation modelresourcelocation = (ModelResourceLocation)i$.next();
         ...
         try {
            ...
            try {
               ...
               field_177603_c.warn((String)("Unable to load variant: " + modelresourcelocation.func_177518_c() + " from " + modelresourcelocation), (Throwable)var6);
            }
         } catch (Exception var7) {
            field_177603_c.warn((String)("Unable to load definition " + modelresourcelocation), (Throwable)var7);
         }
      }
   ...
   private ModelBlockDefinition func_177586_a(ResourceLocation p_177586_1_) {
      ...
      if (modelblockdefinition == null) {
         ...
         try {
            Iterator i$ = this.field_177598_f.func_135056_b(resourcelocation).iterator();

            while(i$.hasNext()) {
               IResource iresource = (IResource)i$.next();
               ...
               try {
                  ...
                  throw new RuntimeException("Encountered an exception when loading model definition of '" + p_177586_1_ + "' from: '" + iresource.func_177241_a() + "' in resourcepack: '" + iresource.func_177240_d() + "'", var13);
               } finally {
   ...
   private void func_177595_c() {
      Iterator i$ = this.field_177612_i.keySet().iterator();

      while(i$.hasNext()) {
         ModelResourceLocation modelresourcelocation = (ModelResourceLocation)i$.next();
         Iterator i$ = ((ModelBlockDefinition.Variants)this.field_177612_i.get(modelresourcelocation)).func_178420_b().iterator();

         while(i$.hasNext()) {
            ModelBlockDefinition.Variant modelblockdefinition$variant = (ModelBlockDefinition.Variant)i$.next();
            ...
            if (this.field_177611_h.get(resourcelocation) == null) {
               try {
                  ...
                  field_177603_c.warn((String)("Unable to load block model: '" + resourcelocation + "' for variant: '" + modelresourcelocation + "'"), (Throwable)var7);
               }
            }
         }
      }
   ...
   private ModelBlock func_177594_c(ResourceLocation p_177594_1_) throws IOException {
      ...
      if ("builtin/generated".equals(s)) {
         ...
         if (s.startsWith("builtin/")) {
            ...
            p_177594_1_ = this.func_177580_d(p_177594_1_);
            IResource iresource = this.field_177598_f.func_110536_a(p_177594_1_);
         ...
         try {
            ...
            String basePath = TextureUtils.getBasePath(p_177594_1_.func_110623_a());
            fixModelLocations(modelblock, basePath);
         } finally {
            ((Reader)reader).close();
         }
   ...
   private ResourceLocation func_177580_d(ResourceLocation p_177580_1_) {
      ResourceLocation location = p_177580_1_;
      String path = p_177580_1_.func_110623_a();
      if (!path.startsWith("mcpatcher") && !path.startsWith("optifine")) {
         ...
         if (!path.endsWith(".json")) {
            location = new ResourceLocation(p_177580_1_.func_110624_b(), path + ".json");
         }
   ...
   private void func_177590_d() {
      ...
      while(i$.hasNext()) {
         ...
         Iterator i$ = this.func_177596_a(item).iterator();
         ...
         while(i$.hasNext()) {
            ...
            if (this.field_177611_h.get(resourcelocation) == null) {
               try {
                  ...
                  field_177603_c.warn((String)("Unable to load item model: '" + resourcelocation + "' for item: '" + Item.field_150901_e.func_177774_c(item) + "'"), (Throwable)var7);
               }
            }
         }
      }
   ...
   public void loadItemModel(String p_loadItemModel_1_, ResourceLocation p_loadItemModel_2_, ResourceLocation p_loadItemModel_3_) {
      this.field_177615_s.put(p_loadItemModel_1_, p_loadItemModel_2_);
      if (this.field_177611_h.get(p_loadItemModel_2_) == null) {
         try {
            ModelBlock modelblock = this.func_177594_c(p_loadItemModel_2_);
            this.field_177611_h.put(p_loadItemModel_2_, modelblock);
         } catch (Exception var5) {
            field_177603_c.warn("Unable to load item model: '{}' for item: '{}'", p_loadItemModel_2_, p_loadItemModel_3_);
            field_177603_c.warn(var5.getClass().getName() + ": " + var5.getMessage());
         }
      }
   ...
   private void func_177592_e() {
      ...
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150348_b), Lists.newArrayList((Object[])("stone", "granite", "granite_smooth", "diorite", "diorite_smooth", "andesite", "andesite_smooth")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150346_d), Lists.newArrayList((Object[])("dirt", "coarse_dirt", "podzol")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150344_f), Lists.newArrayList((Object[])("oak_planks", "spruce_planks", "birch_planks", "jungle_planks", "acacia_planks", "dark_oak_planks")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150345_g), Lists.newArrayList((Object[])("oak_sapling", "spruce_sapling", "birch_sapling", "jungle_sapling", "acacia_sapling", "dark_oak_sapling")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150354_m), Lists.newArrayList((Object[])("sand", "red_sand")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150364_r), Lists.newArrayList((Object[])("oak_log", "spruce_log", "birch_log", "jungle_log")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150362_t), Lists.newArrayList((Object[])("oak_leaves", "spruce_leaves", "birch_leaves", "jungle_leaves")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150360_v), Lists.newArrayList((Object[])("sponge", "sponge_wet")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150322_A), Lists.newArrayList((Object[])("sandstone", "chiseled_sandstone", "smooth_sandstone")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_180395_cM), Lists.newArrayList((Object[])("red_sandstone", "chiseled_red_sandstone", "smooth_red_sandstone")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150329_H), Lists.newArrayList((Object[])("dead_bush", "tall_grass", "fern")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150330_I), Lists.newArrayList((Object[])("dead_bush")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150325_L), Lists.newArrayList((Object[])("black_wool", "red_wool", "green_wool", "brown_wool", "blue_wool", "purple_wool", "cyan_wool", "silver_wool", "gray_wool", "pink_wool", "lime_wool", "yellow_wool", "light_blue_wool", "magenta_wool", "orange_wool", "white_wool")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150327_N), Lists.newArrayList((Object[])("dandelion")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150328_O), Lists.newArrayList((Object[])("poppy", "blue_orchid", "allium", "houstonia", "red_tulip", "orange_tulip", "white_tulip", "pink_tulip", "oxeye_daisy")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150333_U), Lists.newArrayList((Object[])("stone_slab", "sandstone_slab", "cobblestone_slab", "brick_slab", "stone_brick_slab", "nether_brick_slab", "quartz_slab")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_180389_cP), Lists.newArrayList((Object[])("red_sandstone_slab")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150399_cn), Lists.newArrayList((Object[])("black_stained_glass", "red_stained_glass", "green_stained_glass", "brown_stained_glass", "blue_stained_glass", "purple_stained_glass", "cyan_stained_glass", "silver_stained_glass", "gray_stained_glass", "pink_stained_glass", "lime_stained_glass", "yellow_stained_glass", "light_blue_stained_glass", "magenta_stained_glass", "orange_stained_glass", "white_stained_glass")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150418_aU), Lists.newArrayList((Object[])("stone_monster_egg", "cobblestone_monster_egg", "stone_brick_monster_egg", "mossy_brick_monster_egg", "cracked_brick_monster_egg", "chiseled_brick_monster_egg")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150417_aV), Lists.newArrayList((Object[])("stonebrick", "mossy_stonebrick", "cracked_stonebrick", "chiseled_stonebrick")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150376_bx), Lists.newArrayList((Object[])("oak_slab", "spruce_slab", "birch_slab", "jungle_slab", "acacia_slab", "dark_oak_slab")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150463_bK), Lists.newArrayList((Object[])("cobblestone_wall", "mossy_cobblestone_wall")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150467_bQ), Lists.newArrayList((Object[])("anvil_intact", "anvil_slightly_damaged", "anvil_very_damaged")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150371_ca), Lists.newArrayList((Object[])("quartz_block", "chiseled_quartz_block", "quartz_column")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150406_ce), Lists.newArrayList((Object[])("black_stained_hardened_clay", "red_stained_hardened_clay", "green_stained_hardened_clay", "brown_stained_hardened_clay", "blue_stained_hardened_clay", "purple_stained_hardened_clay", "cyan_stained_hardened_clay", "silver_stained_hardened_clay", "gray_stained_hardened_clay", "pink_stained_hardened_clay", "lime_stained_hardened_clay", "yellow_stained_hardened_clay", "light_blue_stained_hardened_clay", "magenta_stained_hardened_clay", "orange_stained_hardened_clay", "white_stained_hardened_clay")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150397_co), Lists.newArrayList((Object[])("black_stained_glass_pane", "red_stained_glass_pane", "green_stained_glass_pane", "brown_stained_glass_pane", "blue_stained_glass_pane", "purple_stained_glass_pane", "cyan_stained_glass_pane", "silver_stained_glass_pane", "gray_stained_glass_pane", "pink_stained_glass_pane", "lime_stained_glass_pane", "yellow_stained_glass_pane", "light_blue_stained_glass_pane", "magenta_stained_glass_pane", "orange_stained_glass_pane", "white_stained_glass_pane")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150361_u), Lists.newArrayList((Object[])("acacia_leaves", "dark_oak_leaves")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150363_s), Lists.newArrayList((Object[])("acacia_log", "dark_oak_log")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_180397_cI), Lists.newArrayList((Object[])("prismarine", "prismarine_bricks", "dark_prismarine")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150404_cg), Lists.newArrayList((Object[])("black_carpet", "red_carpet", "green_carpet", "brown_carpet", "blue_carpet", "purple_carpet", "cyan_carpet", "silver_carpet", "gray_carpet", "pink_carpet", "lime_carpet", "yellow_carpet", "light_blue_carpet", "magenta_carpet", "orange_carpet", "white_carpet")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150398_cm), Lists.newArrayList((Object[])("sunflower", "syringa", "double_grass", "double_fern", "double_rose", "paeonia")));
      this.field_177613_u.put(Items.field_151031_f, Lists.newArrayList((Object[])("bow", "bow_pulling_0", "bow_pulling_1", "bow_pulling_2")));
      this.field_177613_u.put(Items.field_151044_h, Lists.newArrayList((Object[])("coal", "charcoal")));
      this.field_177613_u.put(Items.field_151112_aM, Lists.newArrayList((Object[])("fishing_rod", "fishing_rod_cast")));
      this.field_177613_u.put(Items.field_151115_aP, Lists.newArrayList((Object[])("cod", "salmon", "clownfish", "pufferfish")));
      this.field_177613_u.put(Items.field_179566_aV, Lists.newArrayList((Object[])("cooked_cod", "cooked_salmon")));
      this.field_177613_u.put(Items.field_151100_aR, Lists.newArrayList((Object[])("dye_black", "dye_red", "dye_green", "dye_brown", "dye_blue", "dye_purple", "dye_cyan", "dye_silver", "dye_gray", "dye_pink", "dye_lime", "dye_yellow", "dye_light_blue", "dye_magenta", "dye_orange", "dye_white")));
      this.field_177613_u.put(Items.field_151068_bn, Lists.newArrayList((Object[])("bottle_drinkable", "bottle_splash")));
      this.field_177613_u.put(Items.field_151144_bL, Lists.newArrayList((Object[])("skull_skeleton", "skull_wither", "skull_zombie", "skull_char", "skull_creeper")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_180390_bo), Lists.newArrayList((Object[])("oak_fence_gate")));
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_180407_aO), Lists.newArrayList((Object[])("oak_fence")));
      this.field_177613_u.put(Items.field_179570_aq, Lists.newArrayList((Object[])("oak_door")));
      Iterator i$ = customVariantNames.entrySet().iterator();

      while(i$.hasNext()) {
         Entry<RegistryDelegate<Item>, Set<String>> e = (Entry)i$.next();
         this.field_177613_u.put(((RegistryDelegate)e.getKey()).get(), Lists.newArrayList(((Set)e.getValue()).iterator()));
      }
   ...
   private void func_177588_f() {
      ...
      i$ = this.field_177615_s.entrySet().iterator();

      while(true) {
         while(i$.hasNext()) {
            Entry<String, ResourceLocation> entry = (Entry)i$.next();
   ...
   private Set<ResourceLocation> func_177575_g() {
      ...
      List<ModelResourceLocation> list = Lists.newArrayList((Iterable)this.field_177612_i.keySet());
      ...
      while(i$.hasNext()) {
         ...
         Iterator i$ = modelblockdefinition$variants.func_178420_b().iterator();
   ...
   protected IBakedModel bakeModel(ModelBlock p_bakeModel_1_, ITransformation p_bakeModel_2_, boolean p_bakeModel_3_) {
      ...
      SimpleBakedModel.Builder simplebakedmodel$builder = (new SimpleBakedModel.Builder(p_bakeModel_1_)).func_177646_a(textureatlassprite);
      Iterator i$ = p_bakeModel_1_.func_178298_a().iterator();

      label32:
      while(i$.hasNext()) {
         BlockPart blockpart = (BlockPart)i$.next();
         Iterator i$ = blockpart.field_178240_c.keySet().iterator();
         ...
         while(true) {
            while(true) {
               ...
               if (Reflector.ForgeHooksClient.exists()) {
                  isMatrixInteger = TRSRTransformation.isInteger(p_bakeModel_2_.getMatrix());
               }

               if (blockpartface.field_178244_b != null && isMatrixInteger) {
   ...
   private void func_177597_h() {
      this.func_177574_i();
      Iterator i$ = this.field_177611_h.values().iterator();

      while(i$.hasNext()) {
         ModelBlock modelblock = (ModelBlock)i$.next();
   ...
   private void func_177574_i() {
      ...
      Set<ResourceLocation> set = Sets.newHashSet();
      Iterator i$ = this.field_177611_h.keySet().iterator();

      ResourceLocation resourcelocation3;
      while(i$.hasNext()) {
         ResourceLocation resourcelocation = (ResourceLocation)i$.next();
         set.add(resourcelocation);
         resourcelocation3 = ((ModelBlock)this.field_177611_h.get(resourcelocation)).func_178305_e();
      ...
      while(!deque.isEmpty()) {
         ...
         try {
            ...
            resourcelocation3 = modelblock.func_178305_e();
            if (resourcelocation3 != null && !set.contains(resourcelocation3)) {
               deque.add(resourcelocation3);
            }
         } catch (Exception var6) {
            field_177603_c.warn("In parent chain: " + field_177601_e.join((Iterable)this.func_177573_e(resourcelocation2)) + "; unable to load model: '" + resourcelocation2 + "'");
         }
   ...
   private List<ResourceLocation> func_177573_e(ResourceLocation p_177573_1_) {
      List<ResourceLocation> list = Lists.newArrayList((Object[])(p_177573_1_));
   ...
   private ResourceLocation func_177576_f(ResourceLocation p_177576_1_) {
      Iterator i$ = this.field_177611_h.entrySet().iterator();
      ...
      } while(modelblock == null || !p_177576_1_.equals(modelblock.func_178305_e()));
   ...
   private Set<ResourceLocation> func_177585_a(ModelBlock p_177585_1_) {
      Set<ResourceLocation> set = Sets.newHashSet();
      Iterator i$ = p_177585_1_.func_178298_a().iterator();

      while(i$.hasNext()) {
         BlockPart blockpart = (BlockPart)i$.next();
         Iterator i$ = blockpart.field_178240_c.values().iterator();

         while(i$.hasNext()) {
            BlockPartFace blockpartface = (BlockPartFace)i$.next();
   ...
   private Set<ResourceLocation> func_177571_k() {
      Set<ResourceLocation> set = Sets.newHashSet();
      Iterator i$ = this.field_177615_s.values().iterator();
      ...
      while(true) {
         while(true) {
            ...
            if (this.func_177581_b(modelblock)) {
               for(i$ = ItemModelGenerator.field_178398_a.iterator(); i$.hasNext(); set.add(resourcelocation2)) {
                  String s = (String)i$.next();
                  resourcelocation2 = new ResourceLocation(modelblock.func_178308_c(s));
               ...
               i$ = modelblock.func_178298_a().iterator();
   ...
   private void func_177593_l() {
      ...
      i$ = this.field_177599_g.values().iterator();

      while(i$.hasNext()) {
         TextureAtlasSprite textureatlassprite = (TextureAtlasSprite)i$.next();
   ...
   public ModelBlock getModelBlock(ResourceLocation p_getModelBlock_1_) {
      ModelBlock modelblock = (ModelBlock)this.field_177611_h.get(p_getModelBlock_1_);
      return modelblock;
   }

   public static void fixModelLocations(ModelBlock p_fixModelLocations_0_, String p_fixModelLocations_1_) {
      ResourceLocation parentLocFixed = fixModelLocation(p_fixModelLocations_0_.func_178305_e(), p_fixModelLocations_1_);
      if (parentLocFixed != p_fixModelLocations_0_.func_178305_e()) {
         Reflector.setFieldValue(p_fixModelLocations_0_, Reflector.ModelBlock_parentLocation, parentLocFixed);
      }

      Map<String, String> textures = (Map)Reflector.getFieldValue(p_fixModelLocations_0_, Reflector.ModelBlock_textures);
      if (textures != null) {
         ...
         while(it.hasNext()) {
            ...
            String pathFixed = fixResourcePath(path, p_fixModelLocations_1_);
            if (pathFixed != path) {
   ...
   public static ResourceLocation fixModelLocation(ResourceLocation p_fixModelLocation_0_, String p_fixModelLocation_1_) {
      if (p_fixModelLocation_0_ != null && p_fixModelLocation_1_ != null) {
         if (!p_fixModelLocation_0_.func_110624_b().equals("minecraft")) {
            ...
            String path = p_fixModelLocation_0_.func_110623_a();
            String pathFixed = fixResourcePath(path, p_fixModelLocation_1_);
            if (pathFixed != path) {
               p_fixModelLocation_0_ = new ResourceLocation(p_fixModelLocation_0_.func_110624_b(), pathFixed);
            }
   ...
   public static void addVariantName(Item p_addVariantName_0_, String... p_addVariantName_1_) {
      RegistryDelegate delegate = (RegistryDelegate)Reflector.getFieldValue(p_addVariantName_0_, Reflector.ForgeItem_delegate);
      if (customVariantNames.containsKey(delegate)) {
         ((Set)customVariantNames.get(delegate)).addAll(Lists.newArrayList((Object[])p_addVariantName_1_));
      } else {
         customVariantNames.put(delegate, Sets.newHashSet((Object[])p_addVariantName_1_));
      }
   ...
   public static <T extends ResourceLocation> void registerItemVariants(Item p_registerItemVariants_0_, T... p_registerItemVariants_1_) {
      RegistryDelegate delegate = (RegistryDelegate)Reflector.getFieldValue(p_registerItemVariants_0_, Reflector.ForgeItem_delegate);
      if (!customVariantNames.containsKey(delegate)) {
         customVariantNames.put(delegate, Sets.newHashSet());
      }

      ResourceLocation[] arr$ = p_registerItemVariants_1_;
      int len$ = p_registerItemVariants_1_.length;

      for(int i$ = 0; i$ < len$; ++i$) {
         ResourceLocation name = arr$[i$];
         ((Set)customVariantNames.get(delegate)).add(name.toString());
      }
