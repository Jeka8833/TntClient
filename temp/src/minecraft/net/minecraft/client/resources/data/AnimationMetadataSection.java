...
public class AnimationMetadataSection implements IMetadataSection {
   ...
   public int func_110472_a(int p_110472_1_) {
      AnimationFrame lvt_2_1_ = this.func_130072_d(p_110472_1_);
      return lvt_2_1_.func_110495_a() ? this.field_110475_d : lvt_2_1_.func_110497_b();
   }
   ...
   public Set<Integer> func_130073_e() {
      ...
      Iterator lvt_2_1_ = this.field_110478_a.iterator();

      while(lvt_2_1_.hasNext()) {
         AnimationFrame lvt_3_1_ = (AnimationFrame)lvt_2_1_.next();
         lvt_1_1_.add(lvt_3_1_.func_110496_c());
      }
