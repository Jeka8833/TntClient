...
public class IMetadataSerializer {
   ...
   public <T extends IMetadataSection> T func_110503_a(String p_110503_1_, JsonObject p_110503_2_) {
      if (p_110503_1_ == null) {
         ...
         IMetadataSerializer.Registration<?> lvt_3_1_ = (IMetadataSerializer.Registration)this.field_110508_a.func_82594_a(p_110503_1_);
         if (lvt_3_1_ == null) {
            throw new IllegalArgumentException("Don't know how to handle metadata section '" + p_110503_1_ + "'");
         } else {
            return (IMetadataSection)this.func_110505_a().fromJson((JsonElement)p_110503_2_.getAsJsonObject(p_110503_1_), (Type)lvt_3_1_.field_110500_b);
         }
      }
   }
