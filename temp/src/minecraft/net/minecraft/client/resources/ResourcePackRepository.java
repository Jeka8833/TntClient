...
public class ResourcePackRepository {
   ...
   public List<ResourcePackRepository.Entry> field_110617_f = Lists.newArrayList();
   ...
   public ResourcePackRepository(File p_i45101_1_, File p_i45101_2_, IResourcePack p_i45101_3_, IMetadataSerializer p_i45101_4_, GameSettings p_i45101_5_) {
      ...
      while(true) {
         while(iterator.hasNext()) {
            ...
            Iterator i$ = this.field_110619_e.iterator();

            while(i$.hasNext()) {
               ResourcePackRepository.Entry resourcepackrepository$entry = (ResourcePackRepository.Entry)i$.next();
   ...
   public void func_110611_a() {
      ...
      Iterator i$ = this.func_110614_g().iterator();

      while(i$.hasNext()) {
         File file1 = (File)i$.next();
      ...
      i$ = this.field_110619_e.iterator();

      while(i$.hasNext()) {
         ResourcePackRepository.Entry resourcepackrepository$entry1 = (ResourcePackRepository.Entry)i$.next();
      ...
      try {
         ...
         if (file1.exists() && p_180601_2_.length() == 40) {
            try {
               ...
               field_177320_c.warn((String)("File " + file1 + " couldn't be hashed. Deleting it."), (Throwable)var14);
               FileUtils.deleteQuietly(file1);
            }
         }
   ...
   private void func_183028_i() {
      List<File> list = Lists.newArrayList((Iterable)FileUtils.listFiles(this.field_148534_e, TrueFileFilter.TRUE, (IOFileFilter)null));
