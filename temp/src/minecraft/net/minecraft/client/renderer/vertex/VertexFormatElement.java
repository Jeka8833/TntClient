...
public class VertexFormatElement {
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         if (this.field_177378_e != lvt_2_1_.field_177378_e) {
            return false;
         } else if (this.field_177377_d != lvt_2_1_.field_177377_d) {
            return false;
         } else if (this.field_177379_b != lvt_2_1_.field_177379_b) {
            return false;
         } else {
            return this.field_177380_c == lvt_2_1_.field_177380_c;
         }
      } else {
         return false;
      }
   ...
   public int hashCode() {
      int lvt_1_1_ = this.field_177379_b.hashCode();
      lvt_1_1_ = 31 * lvt_1_1_ + this.field_177380_c.hashCode();
      lvt_1_1_ = 31 * lvt_1_1_ + this.field_177377_d;
      lvt_1_1_ = 31 * lvt_1_1_ + this.field_177378_e;
      return lvt_1_1_;
   }
