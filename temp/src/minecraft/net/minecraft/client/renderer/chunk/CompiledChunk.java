...
public class CompiledChunk {
   ...
   private final List<TileEntity> field_178499_e;
   ...
   public CompiledChunk() {
      this.field_178500_b = new boolean[RenderChunk.ENUM_WORLD_BLOCK_LAYERS.length];
      this.field_178501_c = new boolean[RenderChunk.ENUM_WORLD_BLOCK_LAYERS.length];
