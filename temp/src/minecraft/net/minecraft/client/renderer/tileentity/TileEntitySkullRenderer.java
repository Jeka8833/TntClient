...
public class TileEntitySkullRenderer extends TileEntitySpecialRenderer<TileEntitySkull> {
   ...
   public void func_180535_a(TileEntitySkull p_180535_1_, double p_180535_2_, double p_180535_4_, double p_180535_6_, float p_180535_8_, int p_180535_9_) {
      EnumFacing lvt_10_1_ = EnumFacing.func_82600_a(p_180535_1_.func_145832_p() & 7);
      this.func_180543_a((float)p_180535_2_, (float)p_180535_4_, (float)p_180535_6_, lvt_10_1_, (float)(p_180535_1_.func_145906_b() * 360) / 16.0F, p_180535_1_.func_145904_a(), p_180535_1_.func_152108_a(), p_180535_9_);
   }
   ...
   public void func_180543_a(float p_180543_1_, float p_180543_2_, float p_180543_3_, EnumFacing p_180543_4_, float p_180543_5_, int p_180543_6_, GameProfile p_180543_7_, int p_180543_8_) {
      ModelBase lvt_9_1_ = this.field_178467_h;
      if (p_180543_8_ >= 0) {
         ...
         case 2:
            ...
            lvt_9_1_ = this.field_178468_i;
            break;
         case 3:
            lvt_9_1_ = this.field_178468_i;
            ResourceLocation lvt_10_1_ = DefaultPlayerSkin.func_177335_a();
            if (p_180543_7_ != null) {
               Minecraft lvt_11_1_ = Minecraft.func_71410_x();
               Map<Type, MinecraftProfileTexture> lvt_12_1_ = lvt_11_1_.func_152342_ad().func_152788_a(p_180543_7_);
               if (lvt_12_1_.containsKey(Type.SKIN)) {
                  lvt_10_1_ = lvt_11_1_.func_152342_ad().func_152792_a((MinecraftProfileTexture)lvt_12_1_.get(Type.SKIN), Type.SKIN);
               } else {
                  UUID lvt_13_1_ = EntityPlayer.func_146094_a(p_180543_7_);
                  lvt_10_1_ = DefaultPlayerSkin.func_177334_a(lvt_13_1_);
               }
            }

            this.func_147499_a(lvt_10_1_);
            break;
         case 4:
      ...
      lvt_9_1_.func_78088_a((Entity)null, 0.0F, 0.0F, 0.0F, p_180543_5_, 0.0F, lvt_10_2_);
