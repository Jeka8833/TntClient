...
public class TileEntityRendererDispatcher {
   public Map<Class<? extends TileEntity>, TileEntitySpecialRenderer<? extends TileEntity>> field_147559_m = Maps.newHashMap();
   ...
   private TileEntityRendererDispatcher() {
      ...
      Iterator i$ = this.field_147559_m.values().iterator();

      while(i$.hasNext()) {
         TileEntitySpecialRenderer<?> tileentityspecialrenderer = (TileEntitySpecialRenderer)i$.next();
   ...
   public void func_180546_a(TileEntity p_180546_1_, float p_180546_2_, int p_180546_3_) {
      if (p_180546_1_.func_145835_a(this.field_147560_j, this.field_147561_k, this.field_147558_l) < p_180546_1_.func_145833_n()) {
         ...
         if (Reflector.ForgeTileEntity_hasFastRenderer.exists()) {
            setLightmap = !this.drawingBatch || !Reflector.callBoolean(p_180546_1_, Reflector.ForgeTileEntity_hasFastRenderer);
         }
   ...
   public void func_178469_a(TileEntity p_178469_1_, double p_178469_2_, double p_178469_4_, double p_178469_6_, float p_178469_8_, int p_178469_9_) {
      TileEntitySpecialRenderer<TileEntity> tileentityspecialrenderer = this.func_147547_b(p_178469_1_);
      if (tileentityspecialrenderer != null) {
         try {
            ...
            CrashReport crashreport = CrashReport.func_85055_a(var14, "Rendering Block Entity");
