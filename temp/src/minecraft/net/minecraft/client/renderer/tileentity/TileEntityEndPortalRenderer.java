...
public class TileEntityEndPortalRenderer extends TileEntitySpecialRenderer<TileEntityEndPortal> {
   ...
   public void func_180535_a(TileEntityEndPortal p_180535_1_, double p_180535_2_, double p_180535_4_, double p_180535_6_, float p_180535_8_, int p_180535_9_) {
      if (!Config.isShaders() || !ShadersRender.renderEndPortal(p_180535_1_, p_180535_2_, p_180535_4_, p_180535_6_, p_180535_8_, p_180535_9_, 0.75F)) {
         ...
         for(int i = 0; i < 16; ++i) {
            ...
            float f10 = f8 / f9;
            f10 += (float)(p_180535_4_ + (double)f3);
            ...
            vertexbuffer.func_181662_b(p_180535_2_, p_180535_4_ + (double)f3, p_180535_6_).func_181666_a(f11, f12, f13, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b(p_180535_2_, p_180535_4_ + (double)f3, p_180535_6_ + 1.0D).func_181666_a(f11, f12, f13, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b(p_180535_2_ + 1.0D, p_180535_4_ + (double)f3, p_180535_6_ + 1.0D).func_181666_a(f11, f12, f13, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b(p_180535_2_ + 1.0D, p_180535_4_ + (double)f3, p_180535_6_).func_181666_a(f11, f12, f13, 1.0F).func_181675_d();
