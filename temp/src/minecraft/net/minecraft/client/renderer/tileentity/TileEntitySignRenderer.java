...
public class TileEntitySignRenderer extends TileEntitySpecialRenderer<TileEntitySign> {
   ...
   private static boolean isRenderText(TileEntitySign p_isRenderText_0_) {
      if (Shaders.isShadowPass) {
         ...
         if (!Config.zoomMode && p_isRenderText_0_.field_145918_i < 0) {
            Entity viewEntity = Config.getMinecraft().func_175606_aa();
            double distSq = p_isRenderText_0_.func_145835_a(viewEntity.field_70165_t, viewEntity.field_70163_u, viewEntity.field_70161_v);
   ...
   public static void updateTextRenderDistance() {
      ...
      double textRenderDistance = Math.max(1.5D * (double)mc.field_71440_d / fov, 16.0D);
