...
public class RenderItemFrame extends Render<EntityItemFrame> {
   ...
   private void func_82402_b(EntityItemFrame p_82402_1_) {
      ...
      if (itemstack != null) {
         ...
         if (!Config.zoomMode) {
            Entity player = this.field_147917_g.field_71439_g;
            double distSq = p_82402_1_.func_70092_e(player.field_70165_t, player.field_70163_u, player.field_70161_v);
            if (distSq > 4096.0D) {
               return;
            }
         }
   ...
   private boolean isRenderItem(EntityItemFrame p_isRenderItem_1_) {
      if (Shaders.isShadowPass) {
         ...
         if (!Config.zoomMode) {
            ...
            double distSq = p_isRenderItem_1_.func_70092_e(viewEntity.field_70165_t, viewEntity.field_70163_u, viewEntity.field_70161_v);
   ...
   public static void updateItemRenderDistance() {
      ...
      double fov = (double)Config.limit(mc.field_71474_y.field_74333_Y, 1.0F, 120.0F);
      double itemRenderDistance = Math.max(6.0D * (double)mc.field_71440_d / fov, 16.0D);
