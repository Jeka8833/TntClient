...
public class Stitcher {
   ...
   public void func_94305_f() {
      Stitcher.Holder[] astitcher$holder = (Stitcher.Holder[])((Stitcher.Holder[])this.field_94319_a.toArray(new Stitcher.Holder[this.field_94319_a.size()]));
      Arrays.sort((Object[])astitcher$holder);
      Stitcher.Holder[] arr$ = astitcher$holder;
      int len$ = astitcher$holder.length;

      for(int i$ = 0; i$ < len$; ++i$) {
         Stitcher.Holder stitcher$holder = arr$[i$];
         if (!this.func_94310_b(stitcher$holder)) {
            String s = String.format("Unable to fit: %s, size: %dx%d, atlas: %dx%d, atlasMax: %dx%d - Maybe try a lower resolution resourcepack?", stitcher$holder.func_98150_a().func_94215_i(), stitcher$holder.func_98150_a().func_94211_a(), stitcher$holder.func_98150_a().func_94216_b(), this.field_94318_c, this.field_94315_d, this.field_94316_e, this.field_94313_f);
   ...
   public List<TextureAtlasSprite> func_94309_g() {
      ...
      Iterator i$ = this.field_94317_b.iterator();

      while(i$.hasNext()) {
         Stitcher.Slot stitcher$slot = (Stitcher.Slot)i$.next();
      ...
      while(i$.hasNext()) {
         Stitcher.Slot stitcher$slot1 = (Stitcher.Slot)i$.next();
         ...
         if (this.field_94187_f != null) {
            ...
            if (i <= this.field_94191_c && j <= this.field_94188_d) {
               if (i == this.field_94191_c && j == this.field_94188_d) {
                  ...
                  Iterator i$ = this.field_94189_e.iterator();
                  ...
                  do {
                     ...
                     stitcher$slot = (Stitcher.Slot)i$.next();
                  } while(!stitcher$slot.func_94182_a(p_94182_1_));
