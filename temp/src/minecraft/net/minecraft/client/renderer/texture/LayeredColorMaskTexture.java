...
public class LayeredColorMaskTexture extends AbstractTexture {
   ...
   public void func_110551_a(IResourceManager p_110551_1_) throws IOException {
      ...
      try {
         ...
         field_174947_f.error((String)"Couldn't load layered image", (Throwable)var17);
         return;
      }

      if (Config.isShaders()) {
         ShadersTex.loadSimpleTexture(this.func_110552_b(), bufferedimage, false, false, p_110551_1_, this.field_174948_g, this.getMultiTexID());
      } else {
