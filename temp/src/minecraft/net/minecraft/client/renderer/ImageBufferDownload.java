...
public class ImageBufferDownload implements IImageBuffer {
   ...
   public BufferedImage func_78432_a(BufferedImage p_78432_1_) {
      if (p_78432_1_ == null) {
         ...
         int k;
         for(k = 1; this.field_78436_b < srcWidth || this.field_78437_c < srcHeight; k *= 2) {
         ...
         this.func_78433_b(0 * k, 0 * k, 32 * k, 16 * k);
         this.func_78434_a(32 * k, 0 * k, 64 * k, 32 * k);
         this.func_78433_b(0 * k, 16 * k, 64 * k, 32 * k);
         this.func_78434_a(0 * k, 32 * k, 16 * k, 48 * k);
         this.func_78434_a(16 * k, 32 * k, 40 * k, 48 * k);
         this.func_78434_a(40 * k, 32 * k, 56 * k, 48 * k);
         this.func_78434_a(0 * k, 48 * k, 16 * k, 64 * k);
      ...
      if (!this.func_78435_c(p_78434_1_, p_78434_2_, p_78434_3_, p_78434_4_)) {
         for(int i = p_78434_1_; i < p_78434_3_; ++i) {
            for(int j = p_78434_2_; j < p_78434_4_; ++j) {
               ...
               int var10001 = i + j * this.field_78436_b;
