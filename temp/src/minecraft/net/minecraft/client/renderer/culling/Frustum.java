...
public class Frustum implements ICamera {
   ...
   public boolean isBoxInFrustumFully(double p_isBoxInFrustumFully_1_, double p_isBoxInFrustumFully_3_, double p_isBoxInFrustumFully_5_, double p_isBoxInFrustumFully_7_, double p_isBoxInFrustumFully_9_, double p_isBoxInFrustumFully_11_) {
      return this.field_78552_a.isBoxInFrustumFully(p_isBoxInFrustumFully_1_ - this.field_78550_b, p_isBoxInFrustumFully_3_ - this.field_78551_c, p_isBoxInFrustumFully_5_ - this.field_78549_d, p_isBoxInFrustumFully_7_ - this.field_78550_b, p_isBoxInFrustumFully_9_ - this.field_78551_c, p_isBoxInFrustumFully_11_ - this.field_78549_d);
   }
}
