...
public class BlockFluidRenderer {
   ...
   public boolean func_178270_a(IBlockAccess p_178270_1_, IBlockState p_178270_2_, BlockPos p_178270_3_, WorldRenderer p_178270_4_) {
      ...
      try {
         ...
         RenderEnv renderEnv = p_178270_4_.getRenderEnv(p_178270_2_, p_178270_3_);
         ...
         if (flag) {
            ...
            if (f12 < -999.0F) {
               ...
               f40 = textureatlassprite.func_94207_b(0.0D);
               f14 = f13;
               ...
               f40 = textureatlassprite.func_94207_b((double)(8.0F + (-f22 + f21) * 16.0F));
               ...
               f39 = textureatlassprite.func_94214_a((double)(8.0F + (f22 - f21) * 16.0F));
            ...
            float f25 = f4 * f1;
            f41 = f4 * f2;
            p_178270_4_.func_181662_b(d0 + 0.0D, d1 + (double)f7, d2 + 0.0D).func_181666_a(f24, f25, f41, 1.0F).func_181673_a((double)f13, (double)f40).func_181671_a(l2, i3).func_181675_d();
            p_178270_4_.func_181662_b(d0 + 0.0D, d1 + (double)f8, d2 + 1.0D).func_181666_a(f24, f25, f41, 1.0F).func_181673_a((double)f14, (double)f18).func_181671_a(l2, i3).func_181675_d();
            p_178270_4_.func_181662_b(d0 + 1.0D, d1 + (double)f9, d2 + 1.0D).func_181666_a(f24, f25, f41, 1.0F).func_181673_a((double)f15, (double)f19).func_181671_a(l2, i3).func_181675_d();
            p_178270_4_.func_181662_b(d0 + 1.0D, d1 + (double)f10, d2 + 0.0D).func_181666_a(f24, f25, f41, 1.0F).func_181673_a((double)f39, (double)f20).func_181671_a(l2, i3).func_181675_d();
         ...
         if (flag1) {
            p_178270_4_.setSprite(atextureatlassprite[0]);
            float f35 = atextureatlassprite[0].func_94209_e();
            f12 = atextureatlassprite[0].func_94212_f();
            f13 = atextureatlassprite[0].func_94206_g();
            f14 = atextureatlassprite[0].func_94210_h();
            int l1 = blockliquid.func_176207_c(p_178270_1_, p_178270_3_.func_177977_b());
            int i2 = l1 >> 16 & '\uffff';
            int j2 = l1 & '\uffff';
            f18 = FaceBakery.func_178412_b(EnumFacing.DOWN);
            p_178270_4_.func_181662_b(d0, d1, d2 + 1.0D).func_181666_a(f * f18, f1 * f18, f2 * f18, 1.0F).func_181673_a((double)f35, (double)f14).func_181671_a(i2, j2).func_181675_d();
            p_178270_4_.func_181662_b(d0, d1, d2).func_181666_a(f * f18, f1 * f18, f2 * f18, 1.0F).func_181673_a((double)f35, (double)f13).func_181671_a(i2, j2).func_181675_d();
            p_178270_4_.func_181662_b(d0 + 1.0D, d1, d2).func_181666_a(f * f18, f1 * f18, f2 * f18, 1.0F).func_181673_a((double)f12, (double)f13).func_181671_a(i2, j2).func_181675_d();
            p_178270_4_.func_181662_b(d0 + 1.0D, d1, d2 + 1.0D).func_181666_a(f * f18, f1 * f18, f2 * f18, 1.0F).func_181673_a((double)f12, (double)f14).func_181671_a(i2, j2).func_181675_d();
            flag2 = true;
         }
         ...
         for(int i1 = 0; i1 < 4; ++i1) {
            ...
            if (aboolean[i1]) {
               ...
               flag2 = true;
               f41 = textureatlassprite1.func_94214_a(0.0D);
               ...
               int k = j >> 16 & '\uffff';
               int l = j & '\uffff';
               float f31 = i1 < 2 ? FaceBakery.func_178412_b(EnumFacing.NORTH) : FaceBakery.func_178412_b(EnumFacing.WEST);
               float f32 = f4 * f31 * f;
               float f33 = f4 * f31 * f1;
               float f34 = f4 * f31 * f2;
   ...
   private float func_178269_a(IBlockAccess p_178269_1_, BlockPos p_178269_2_, Material p_178269_3_) {
      ...
      for(int j = 0; j < 4; ++j) {
         ...
         if (material != p_178269_3_) {
            ...
            int k = (Integer)iblockstate.func_177229_b(BlockLiquid.field_176367_b);
            if (k >= 8 || k == 0) {
