...
public class RenderManager {
   ...
   public void func_180597_a(World p_180597_1_, FontRenderer p_180597_2_, Entity p_180597_3_, Entity p_180597_4_, GameSettings p_180597_5_, float p_180597_6_) {
      ...
      if (p_180597_3_ instanceof EntityLivingBase && ((EntityLivingBase)p_180597_3_).func_70608_bn()) {
         ...
         if (Reflector.callBoolean(block, Reflector.ForgeBlock_isBed, iblockstate, p_180597_1_, new BlockPos(p_180597_3_), (EntityLivingBase)p_180597_3_)) {
            EnumFacing facing = (EnumFacing)Reflector.call(block, Reflector.ForgeBlock_getBedDirection, iblockstate, p_180597_1_, new BlockPos(p_180597_3_));
      ...
      if (p_180597_5_.field_74330_P == 2) {
   ...
   public void func_178630_b(Entity p_178630_1_, float p_178630_2_) {
      ...
      Render<Entity> render = this.func_78713_a(p_178630_1_);
   ...
   public boolean func_147939_a(Entity p_147939_1_, double p_147939_2_, double p_147939_4_, double p_147939_6_, float p_147939_8_, float p_147939_9_, boolean p_147939_10_) {
      ...
      try {
         ...
         CrashReport crashreport = CrashReport.func_85055_a(var19, "Rendering entity in world");
         ...
         crashreportcategory1.func_71507_a("Rotation", p_147939_8_);
         crashreportcategory1.func_71507_a("Delta", p_147939_9_);
   ...
   private void func_85094_b(Entity p_85094_1_, double p_85094_2_, double p_85094_4_, double p_85094_6_, float p_85094_8_, float p_85094_9_) {
      ...
      vertexbuffer.func_181662_b(p_85094_2_ + vec3.field_72450_a * 2.0D, p_85094_4_ + (double)p_85094_1_.func_70047_e() + vec3.field_72448_b * 2.0D, p_85094_6_ + vec3.field_72449_c * 2.0D).func_181669_b(0, 0, 255, 255).func_181675_d();
