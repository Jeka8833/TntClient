...
public class RenderXPOrb extends Render<EntityXPOrb> {
   ...
   public void func_76986_a(EntityXPOrb p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
      ...
      vertexbuffer.func_181662_b((double)(0.0F - f5), (double)(0.0F - f6), 0.0D).func_181673_a((double)f, (double)f3).func_181669_b(red, green, blue, 128).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
      vertexbuffer.func_181662_b((double)(f4 - f5), (double)(0.0F - f6), 0.0D).func_181673_a((double)f1, (double)f3).func_181669_b(red, green, blue, 128).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
      vertexbuffer.func_181662_b((double)(f4 - f5), (double)(1.0F - f6), 0.0D).func_181673_a((double)f1, (double)f2).func_181669_b(red, green, blue, 128).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
      vertexbuffer.func_181662_b((double)(0.0F - f5), (double)(1.0F - f6), 0.0D).func_181673_a((double)f, (double)f2).func_181669_b(red, green, blue, 128).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
