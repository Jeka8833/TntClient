...
public class RenderItem implements IResourceManagerReloadListener {
   ...
   public RenderItem(TextureManager p_i46165_1_, ModelManager p_i46165_2_) {
      ...
      if (Reflector.ItemModelMesherForge_Constructor.exists()) {
         this.field_175059_m = (ItemModelMesher)Reflector.newInstance(Reflector.ItemModelMesherForge_Constructor, p_i46165_2_);
      } else {
   ...
   private void func_175045_a(IBakedModel p_175045_1_, int p_175045_2_, ItemStack p_175045_3_) {
      ...
      boolean renderTextureMap = Minecraft.func_71410_x().func_147117_R().isTextureBound();
      boolean multiTexture = Config.isMultiTexture() && renderTextureMap;
      if (multiTexture) {
         vertexbuffer.setBlockLayer(EnumWorldBlockLayer.SOLID);
      }
      ...
      for(int i$ = 0; i$ < len$; ++i$) {
         ...
         this.func_175032_a(vertexbuffer, p_175045_1_.func_177551_a(enumfacing), p_175045_2_, p_175045_3_);
      }

      this.func_175032_a(vertexbuffer, p_175045_1_.func_177550_a(), p_175045_2_, p_175045_3_);
      tessellator.func_78381_a();
      if (multiTexture) {
         vertexbuffer.setBlockLayer((EnumWorldBlockLayer)null);
      ...
      if (p_175049_1_ != null && p_175049_2_ != null) {
         ...
         if (p_175049_2_ instanceof EntityPlayer) {
            ...
            if (item == Items.field_151112_aM && entityplayer.field_71104_cf != null) {
               ...
               modelresourcelocation = (ModelResourceLocation)Reflector.call(item, Reflector.ForgeItem_getModel, p_175049_1_, entityplayer, entityplayer.func_71052_bv());
            }
   ...
   protected void func_175040_a(ItemStack p_175040_1_, IBakedModel p_175040_2_, ItemCameraTransforms.TransformType p_175040_3_) {
      ...
      if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
         p_175040_2_ = (IBakedModel)Reflector.call(Reflector.ForgeHooksClient_handleCameraTransforms, p_175040_2_, p_175040_3_);
      } else {
   ...
   public void func_180450_b(final ItemStack p_180450_1_, int p_180450_2_, int p_180450_3_) {
      if (p_180450_1_ != null && p_180450_1_.func_77973_b() != null) {
         ...
         try {
            ...
            CrashReport crashreport = CrashReport.func_85055_a(var7, "Rendering item");
      ...
      if (p_180453_2_ != null) {
         ...
         if (ReflectorForge.isItemDamaged(p_180453_2_)) {
            ...
            if (Reflector.ForgeItem_getDurabilityForDisplay.exists()) {
               double health = Reflector.callDouble(p_180453_2_.func_77973_b(), Reflector.ForgeItem_getDurabilityForDisplay, p_180453_2_);
               j = (int)Math.round(13.0D - health * 13.0D);
               i = (int)Math.round(255.0D - health * 255.0D);
            }
            ...
            int blue = 0;
            if (Config.isCustomColors()) {
               int col = CustomColors.getDurabilityColor(i);
               if (col >= 0) {
                  red = col >> 16 & 255;
                  green = col >> 8 & 255;
                  blue = col >> 0 & 255;
            ...
            this.func_181565_a(vertexbuffer, p_180453_3_ + 2, p_180453_4_ + 13, j, 1, red, green, blue, 255);
            GlStateManager.func_179147_l();
            GlStateManager.func_179141_d();
   ...
   public static void forgeHooksClient_putQuadColor(WorldRenderer p_forgeHooksClient_putQuadColor_0_, BakedQuad p_forgeHooksClient_putQuadColor_1_, int p_forgeHooksClient_putQuadColor_2_) {
      float cr = (float)(p_forgeHooksClient_putQuadColor_2_ & 255);
      float cg = (float)(p_forgeHooksClient_putQuadColor_2_ >>> 8 & 255);
      float cb = (float)(p_forgeHooksClient_putQuadColor_2_ >>> 16 & 255);
      float ca = (float)(p_forgeHooksClient_putQuadColor_2_ >>> 24 & 255);
      int[] vd = p_forgeHooksClient_putQuadColor_1_.func_178209_a();
      ...
      for(int i = 0; i < 4; ++i) {
         ...
         p_forgeHooksClient_putQuadColor_0_.func_178972_a(p_forgeHooksClient_putQuadColor_0_.func_78909_a(4 - i), ncr, ncg, ncb, nca);
      }
