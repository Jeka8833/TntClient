      ...
      if (!Config.isShaders() || !Shaders.isShadowPass) {
         ...
         if (entity != null) {
            ...
            for(k = 0; k <= 24; ++k) {
               ...
               f7 = (float)k / 24.0F;
               vertexbuffer.func_181662_b(p_110827_2_ + d13 * (double)f7 + 0.0D, p_110827_4_ + d14 * (double)(f7 * f7 + f7) * 0.5D + (double)((24.0F - (float)k) / 18.0F + 0.125F), p_110827_6_ + d15 * (double)f7).func_181666_a(f4, f5, f6, 1.0F).func_181675_d();
               vertexbuffer.func_181662_b(p_110827_2_ + d13 * (double)f7 + 0.025D, p_110827_4_ + d14 * (double)(f7 * f7 + f7) * 0.5D + (double)((24.0F - (float)k) / 18.0F + 0.125F) + 0.025D, p_110827_6_ + d15 * (double)f7).func_181666_a(f4, f5, f6, 1.0F).func_181675_d();
            }
