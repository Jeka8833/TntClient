...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
   ...
   public void func_76986_a(T p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
      if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, p_76986_1_, this, p_76986_2_, p_76986_4_, p_76986_6_)) {
         ...
         if (Reflector.ForgeEntity_shouldRiderSit.exists()) {
            this.field_77045_g.field_78093_q = p_76986_1_.func_70115_ae() && p_76986_1_.field_70154_o != null && Reflector.callBoolean(p_76986_1_.field_70154_o, Reflector.ForgeEntity_shouldRiderSit);
         }
         ...
         try {
            ...
            f8 = this.func_77044_a(p_76986_1_, p_76986_9_);
            ...
            if (this.field_177098_i) {
               flag = this.func_177088_c(p_76986_1_);
               this.func_77036_a(p_76986_1_, f6, f5, f8, f2, f7, 0.0625F);
               if (flag) {
                  this.func_180565_e();
               }
            } else {
               flag = this.func_177090_c(p_76986_1_, p_76986_9_);
            ...
            field_147923_a.error((String)"Couldn't render entity", (Throwable)var19);
         }
         ...
         if (Reflector.RenderLivingEvent_Post_Constructor.exists()) {
            Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Post_Constructor, p_76986_1_, this, p_76986_2_, p_76986_4_, p_76986_6_);
         }
   ...
   protected void func_177093_a(T p_177093_1_, float p_177093_2_, float p_177093_3_, float p_177093_4_, float p_177093_5_, float p_177093_6_, float p_177093_7_, float p_177093_8_) {
      Iterator i$ = this.field_177097_h.iterator();

      while(i$.hasNext()) {
         LayerRenderer<T> layerrenderer = (LayerRenderer)i$.next();
         ...
         if (this.func_177070_b(p_177067_1_)) {
            ...
            if (d0 < (double)(f * f)) {
               ...
               if (p_177067_1_.func_70093_af()) {
                  ...
                  vertexbuffer.func_181662_b((double)(-i - 1), -1.0D, 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).func_181675_d();
                  vertexbuffer.func_181662_b((double)(-i - 1), 8.0D, 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).func_181675_d();
                  vertexbuffer.func_181662_b((double)(i + 1), 8.0D, 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).func_181675_d();
                  vertexbuffer.func_181662_b((double)(i + 1), -1.0D, 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).func_181675_d();
