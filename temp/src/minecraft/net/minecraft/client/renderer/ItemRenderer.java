...
public class ItemRenderer {
   ...
   private void func_178097_a(AbstractClientPlayer p_178097_1_, float p_178097_2_, float p_178097_3_, float p_178097_4_) {
      ...
      vertexbuffer.func_181662_b(-7.0D, 135.0D, 0.0D).func_181673_a(0.0D, 1.0D).func_181675_d();
      vertexbuffer.func_181662_b(135.0D, 135.0D, 0.0D).func_181673_a(1.0D, 1.0D).func_181675_d();
      vertexbuffer.func_181662_b(135.0D, -7.0D, 0.0D).func_181673_a(1.0D, 0.0D).func_181675_d();
      vertexbuffer.func_181662_b(-7.0D, -7.0D, 0.0D).func_181673_a(0.0D, 0.0D).func_181675_d();
   ...
   public void func_78447_b(float p_78447_1_) {
      ...
      if (this.field_78455_a.field_71439_g.func_70094_T()) {
         ...
         if (iblockstate.func_177230_c().func_149645_b() != -1) {
            ...
            if (!Reflector.callBoolean(Reflector.ForgeEventFactory_renderBlockOverlay, this.field_78455_a.field_71439_g, p_78447_1_, overlayType, iblockstate, overlayPos)) {
      ...
      if (!this.field_78455_a.field_71439_g.func_175149_v()) {
         if (this.field_78455_a.field_71439_g.func_70055_a(Material.field_151586_h) && !Reflector.callBoolean(Reflector.ForgeEventFactory_renderWaterOverlay, this.field_78455_a.field_71439_g, p_78447_1_)) {
            this.func_78448_c(p_78447_1_);
         }

         if (this.field_78455_a.field_71439_g.func_70027_ad() && !Reflector.callBoolean(Reflector.ForgeEventFactory_renderFireOverlay, this.field_78455_a.field_71439_g, p_78447_1_)) {
   ...
   private void func_178108_a(float p_178108_1_, TextureAtlasSprite p_178108_2_) {
      ...
      vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
      vertexbuffer.func_181662_b(-1.0D, -1.0D, -0.5D).func_181673_a((double)f7, (double)f9).func_181675_d();
      vertexbuffer.func_181662_b(1.0D, -1.0D, -0.5D).func_181673_a((double)f6, (double)f9).func_181675_d();
      vertexbuffer.func_181662_b(1.0D, 1.0D, -0.5D).func_181673_a((double)f6, (double)f8).func_181675_d();
      vertexbuffer.func_181662_b(-1.0D, 1.0D, -0.5D).func_181673_a((double)f7, (double)f8).func_181675_d();
      tessellator.func_78381_a();
      GlStateManager.func_179121_F();
   ...
   private void func_78448_c(float p_78448_1_) {
      if (!Config.isShaders() || Shaders.isUnderwaterOverlay()) {
         ...
         vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
         vertexbuffer.func_181662_b(-1.0D, -1.0D, -0.5D).func_181673_a((double)(4.0F + f7), (double)(4.0F + f8)).func_181675_d();
         vertexbuffer.func_181662_b(1.0D, -1.0D, -0.5D).func_181673_a((double)(0.0F + f7), (double)(4.0F + f8)).func_181675_d();
         vertexbuffer.func_181662_b(1.0D, 1.0D, -0.5D).func_181673_a((double)(0.0F + f7), (double)(0.0F + f8)).func_181675_d();
         vertexbuffer.func_181662_b(-1.0D, 1.0D, -0.5D).func_181673_a((double)(4.0F + f7), (double)(0.0F + f8)).func_181675_d();
         tessellator.func_78381_a();
         GlStateManager.func_179121_F();
         GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   private void func_78442_d(float p_78442_1_) {
      ...
      for(int i = 0; i < 2; ++i) {
         ...
         vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
         vertexbuffer.setSprite(textureatlassprite);
         vertexbuffer.func_181662_b((double)f5, (double)f7, (double)f9).func_181673_a((double)f2, (double)f4).func_181675_d();
         vertexbuffer.func_181662_b((double)f6, (double)f7, (double)f9).func_181673_a((double)f1, (double)f4).func_181675_d();
         vertexbuffer.func_181662_b((double)f6, (double)f8, (double)f9).func_181673_a((double)f1, (double)f3).func_181675_d();
         vertexbuffer.func_181662_b((double)f5, (double)f8, (double)f9).func_181673_a((double)f2, (double)f3).func_181675_d();
         tessellator.func_78381_a();
         GlStateManager.func_179121_F();
      }
      ...
      if (this.field_78453_b != null && itemstack != null) {
         if (!this.field_78453_b.func_179549_c(itemstack)) {
            if (Reflector.ForgeItem_shouldCauseReequipAnimation.exists()) {
               boolean reequip = Reflector.callBoolean(this.field_78453_b.func_77973_b(), Reflector.ForgeItem_shouldCauseReequipAnimation, this.field_78453_b, itemstack, this.field_78450_g != entityplayer.field_71071_by.field_70461_c);
               if (!reequip) {
