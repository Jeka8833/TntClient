...
public class EntityPlayerSP extends AbstractClientPlayer {
   ...
   public void func_175161_p() {
      boolean lvt_1_1_ = this.func_70051_ag();
      if (lvt_1_1_ != this.field_175171_bO) {
         if (lvt_1_1_) {
         ...
         this.field_175171_bO = lvt_1_1_;
      }

      boolean lvt_2_1_ = this.func_70093_af();
      if (lvt_2_1_ != this.field_175170_bN) {
         if (lvt_2_1_) {
         ...
         this.field_175170_bN = lvt_2_1_;
      }

      if (this.func_175160_A()) {
         double lvt_3_1_ = this.field_70165_t - this.field_175172_bI;
         double lvt_5_1_ = this.func_174813_aQ().field_72338_b - this.field_175166_bJ;
         double lvt_7_1_ = this.field_70161_v - this.field_175167_bK;
         double lvt_9_1_ = (double)(this.field_70177_z - this.field_175164_bL);
         double lvt_11_1_ = (double)(this.field_70125_A - this.field_175165_bM);
         boolean lvt_13_1_ = lvt_3_1_ * lvt_3_1_ + lvt_5_1_ * lvt_5_1_ + lvt_7_1_ * lvt_7_1_ > 9.0E-4D || this.field_175168_bP >= 20;
         boolean lvt_14_1_ = lvt_9_1_ != 0.0D || lvt_11_1_ != 0.0D;
   ...
   public EntityItem func_71040_bB(boolean p_71040_1_) {
      C07PacketPlayerDigging.Action lvt_2_1_ = p_71040_1_ ? C07PacketPlayerDigging.Action.DROP_ALL_ITEMS : C07PacketPlayerDigging.Action.DROP_ITEM;
      this.field_71174_a.func_147297_a(new C07PacketPlayerDigging(lvt_2_1_, BlockPos.field_177992_a, EnumFacing.DOWN));
      return null;
   }
   ...
   public void func_71150_b(float p_71150_1_) {
      if (this.field_175169_bQ) {
         float lvt_2_1_ = this.func_110143_aJ() - p_71150_1_;
         if (lvt_2_1_ <= 0.0F) {
            ...
            this.field_110153_bc = lvt_2_1_;
            this.func_70606_j(this.func_110143_aJ());
            this.field_70172_ad = this.field_70771_an;
            this.func_70665_d(DamageSource.field_76377_j, lvt_2_1_);
   ...
   protected boolean func_145771_j(double p_145771_1_, double p_145771_3_, double p_145771_5_) {
      if (this.field_70145_X) {
         ...
         double lvt_10_1_ = p_145771_5_ - (double)lvt_7_1_.func_177952_p();
         if (!this.func_175162_d(lvt_7_1_)) {
            int lvt_12_1_ = -1;
            double lvt_13_1_ = 9999.0D;
            if (this.func_175162_d(lvt_7_1_.func_177976_e()) && lvt_8_1_ < lvt_13_1_) {
               lvt_13_1_ = lvt_8_1_;
               lvt_12_1_ = 0;
            }

            if (this.func_175162_d(lvt_7_1_.func_177974_f()) && 1.0D - lvt_8_1_ < lvt_13_1_) {
               lvt_13_1_ = 1.0D - lvt_8_1_;
               lvt_12_1_ = 1;
            }

            if (this.func_175162_d(lvt_7_1_.func_177978_c()) && lvt_10_1_ < lvt_13_1_) {
               lvt_13_1_ = lvt_10_1_;
               lvt_12_1_ = 4;
            }

            if (this.func_175162_d(lvt_7_1_.func_177968_d()) && 1.0D - lvt_10_1_ < lvt_13_1_) {
               lvt_13_1_ = 1.0D - lvt_10_1_;
               lvt_12_1_ = 5;
            }

            float lvt_15_1_ = 0.1F;
            if (lvt_12_1_ == 0) {
               this.field_70159_w = (double)(-lvt_15_1_);
            }
            ...
            if (lvt_12_1_ == 4) {
               this.field_70179_y = (double)(-lvt_15_1_);
            }
   ...
   public void func_71048_c(ItemStack p_71048_1_) {
      ...
      if (lvt_2_1_ == Items.field_151099_bA) {
   ...
   public void func_71007_a(IInventory p_71007_1_) {
      String lvt_2_1_ = p_71007_1_ instanceof IInteractionObject ? ((IInteractionObject)p_71007_1_).func_174875_k() : "minecraft:container";
      if ("minecraft:chest".equals(lvt_2_1_)) {
         this.field_71159_c.func_147108_a(new GuiChest(this.field_71071_by, p_71007_1_));
      } else if ("minecraft:hopper".equals(lvt_2_1_)) {
         this.field_71159_c.func_147108_a(new GuiHopper(this.field_71071_by, p_71007_1_));
      } else if ("minecraft:furnace".equals(lvt_2_1_)) {
         this.field_71159_c.func_147108_a(new GuiFurnace(this.field_71071_by, p_71007_1_));
      } else if ("minecraft:brewing_stand".equals(lvt_2_1_)) {
         this.field_71159_c.func_147108_a(new GuiBrewingStand(this.field_71071_by, p_71007_1_));
      } else if ("minecraft:beacon".equals(lvt_2_1_)) {
         this.field_71159_c.func_147108_a(new GuiBeacon(this.field_71071_by, p_71007_1_));
      } else if (!"minecraft:dispenser".equals(lvt_2_1_) && !"minecraft:dropper".equals(lvt_2_1_)) {
         this.field_71159_c.func_147108_a(new GuiChest(this.field_71071_by, p_71007_1_));
      } else {
   ...
   public boolean func_70093_af() {
      boolean lvt_1_1_ = this.field_71158_b != null ? this.field_71158_b.field_78899_d : false;
      return lvt_1_1_ && !this.field_71083_bS;
   }
   ...
   public void func_70636_d() {
      ...
      boolean lvt_1_1_ = this.field_71158_b.field_78901_c;
      boolean lvt_2_1_ = this.field_71158_b.field_78899_d;
      float lvt_3_1_ = 0.8F;
      boolean lvt_4_1_ = this.field_71158_b.field_78900_b >= lvt_3_1_;
      ...
      this.func_145771_j(this.field_70165_t + (double)this.field_70130_N * 0.35D, this.func_174813_aQ().field_72338_b + 0.5D, this.field_70161_v - (double)this.field_70130_N * 0.35D);
      this.func_145771_j(this.field_70165_t + (double)this.field_70130_N * 0.35D, this.func_174813_aQ().field_72338_b + 0.5D, this.field_70161_v + (double)this.field_70130_N * 0.35D);
      boolean lvt_5_1_ = (float)this.func_71024_bL().func_75116_a() > 6.0F || this.field_71075_bZ.field_75101_c;
      if (this.field_70122_E && !lvt_2_1_ && !lvt_4_1_ && this.field_71158_b.field_78900_b >= lvt_3_1_ && !this.func_70051_ag() && lvt_5_1_ && !this.func_71039_bw() && !this.func_70644_a(Potion.field_76440_q)) {
         if (this.field_71156_d <= 0 && !this.field_71159_c.field_71474_y.field_151445_Q.func_151470_d()) {
      ...
      if (!this.func_70051_ag() && this.field_71158_b.field_78900_b >= lvt_3_1_ && lvt_5_1_ && !this.func_71039_bw() && !this.func_70644_a(Potion.field_76440_q) && this.field_71159_c.field_71474_y.field_151445_Q.func_151470_d()) {
         this.func_70031_b(true);
      }

      if (this.func_70051_ag() && (this.field_71158_b.field_78900_b < lvt_3_1_ || this.field_70123_F || !lvt_5_1_)) {
         this.func_70031_b(false);
      }
      ...
      if (this.field_71075_bZ.field_75101_c) {
         ...
         } else if (!lvt_1_1_ && this.field_71158_b.field_78901_c) {
      ...
      if (this.func_110317_t()) {
         ...
         if (lvt_1_1_ && !this.field_71158_b.field_78901_c) {
