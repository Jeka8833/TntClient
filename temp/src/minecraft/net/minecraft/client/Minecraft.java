...
public class Minecraft implements IThreadListener, IPlayerUsage {
   ...
   public void func_99999_d() {
      ...
      try {
         ...
         lvt_2_2_ = CrashReport.func_85055_a(var11, "Initializing game");
         lvt_2_2_.func_85058_a("Initialization");
         this.func_71377_b(this.func_71396_d(lvt_2_2_));
         return;
      }
      ...
      while(true) {
         try {
            ...
            this.func_71398_f();
            field_147123_G.fatal((String)"Reported exception thrown!", (Throwable)var13);
            this.func_71377_b(var13.func_71575_a());
         } catch (Throwable var14) {
            lvt_2_2_ = this.func_71396_d(new CrashReport("Unexpected error", var14));
            this.func_71398_f();
            field_147123_G.fatal("Unreported exception thrown!", var14);
            this.func_71377_b(lvt_2_2_);
         } finally {
            this.func_71405_e();
         }
   ...
   private void func_71384_a() throws LWJGLException, IOException {
      ...
      this.field_135017_as = new LanguageManager(this.field_110452_an, this.field_71474_y.field_151455_aw);
      ...
      if (this.field_71474_y.field_151455_aw != null) {
      ...
      AchievementList.field_76004_f.func_75988_a(new IStatStringFormat() {
         public String func_74535_a(String p_74535_1_) {
            try {
               return String.format(p_74535_1_, GameSettings.func_74298_c(Minecraft.this.field_71474_y.field_74313_G.func_151463_i()));
   ...
   private void func_175609_am() throws LWJGLException {
      ...
      try {
         ...
         field_147123_G.error((String)"Couldn't set pixel format", (Throwable)var4);
   ...
   private void func_175605_an() throws LWJGLException {
      if (this.field_71431_Q) {
         ...
         this.field_71443_c = Math.max(1, lvt_1_1_.getWidth());
         this.field_71440_d = Math.max(1, lvt_1_1_.getHeight());
      } else {
   ...
   private void func_175594_ao() {
      Util.EnumOS lvt_1_1_ = Util.func_110647_a();
      if (lvt_1_1_ != Util.EnumOS.OSX) {
         InputStream lvt_2_1_ = null;
         InputStream lvt_3_1_ = null;

         try {
            lvt_2_1_ = this.field_110450_ap.func_152780_c(new ResourceLocation("icons/icon_16x16.png"));
            lvt_3_1_ = this.field_110450_ap.func_152780_c(new ResourceLocation("icons/icon_32x32.png"));
            if (lvt_2_1_ != null && lvt_3_1_ != null) {
               Display.setIcon(new ByteBuffer[]{this.func_152340_a(lvt_2_1_), this.func_152340_a(lvt_3_1_)});
            }
         } catch (IOException var8) {
            field_147123_G.error((String)"Couldn't set icon", (Throwable)var8);
         } finally {
   ...
   private static boolean func_147122_X() {
      ...
      String[] lvt_1_1_ = lvt_0_1_;
      int lvt_2_1_ = lvt_0_1_.length;

      for(int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_) {
         String lvt_4_1_ = lvt_1_1_[lvt_3_1_];
   ...
   public void func_71377_b(CrashReport p_71377_1_) {
      File lvt_2_1_ = new File(func_71410_x().field_71412_D, "crash-reports");
      ...
      if (p_71377_1_.func_71497_f() != null) {
         ...
         System.exit(-1);
      } else if (p_71377_1_.func_147149_a(lvt_3_1_)) {
         Bootstrap.func_179870_a("#@!@# Game crashed! Crash report saved to: #@!@# " + lvt_3_1_.getAbsolutePath());
         System.exit(-1);
      } else {
   ...
   public boolean func_152349_b() {
      return this.field_135017_as.func_135042_a() || this.field_71474_y.field_151454_ax;
   }

   public void func_110436_a() {
      List<IResourcePack> lvt_1_1_ = Lists.newArrayList((Iterable)this.field_110449_ao);
      Iterator lvt_2_1_ = this.field_110448_aq.func_110613_c().iterator();

      while(lvt_2_1_.hasNext()) {
         ResourcePackRepository.Entry lvt_3_1_ = (ResourcePackRepository.Entry)lvt_2_1_.next();
         lvt_1_1_.add(lvt_3_1_.func_110514_c());
      }

      if (this.field_110448_aq.func_148530_e() != null) {
         lvt_1_1_.add(this.field_110448_aq.func_148530_e());
      }

      try {
         this.field_110451_am.func_110541_a(lvt_1_1_);
      } catch (RuntimeException var4) {
         field_147123_G.info((String)"Caught error stitching, removing all assigned resourcepacks", (Throwable)var4);
         lvt_1_1_.clear();
      ...
      this.field_135017_as.func_135043_a(lvt_1_1_);
   ...
   private ByteBuffer func_152340_a(InputStream p_152340_1_) throws IOException {
      BufferedImage lvt_2_1_ = ImageIO.read(p_152340_1_);
      ...
      int lvt_6_1_ = lvt_3_1_.length;

      for(int lvt_7_1_ = 0; lvt_7_1_ < lvt_6_1_; ++lvt_7_1_) {
         int lvt_8_1_ = lvt_5_1_[lvt_7_1_];
   ...
   private void func_110441_Q() throws LWJGLException {
      ...
      if (!lvt_1_1_.contains(lvt_2_1_) && Util.func_110647_a() == Util.EnumOS.OSX) {
         Iterator lvt_3_1_ = field_110445_I.iterator();

         label52:
         while(true) {
            while(true) {
               DisplayMode lvt_4_1_;
               boolean lvt_5_1_;
               Iterator lvt_6_2_;
               ...
               do {
                  ...
                  lvt_4_1_ = (DisplayMode)lvt_3_1_.next();
                  lvt_5_1_ = true;
                  lvt_6_2_ = lvt_1_1_.iterator();

                  while(lvt_6_2_.hasNext()) {
                     lvt_7_2_ = (DisplayMode)lvt_6_2_.next();
                     if (lvt_7_2_.getBitsPerPixel() == 32 && lvt_7_2_.getWidth() == lvt_4_1_.getWidth() && lvt_7_2_.getHeight() == lvt_4_1_.getHeight()) {
                        lvt_5_1_ = false;
                        break;
                     }
                  }
      ...
      this.field_71443_c = lvt_2_1_.getWidth();
      this.field_71440_d = lvt_2_1_.getHeight();
   }
   ...
   private void func_180510_a(TextureManager p_180510_1_) throws LWJGLException {
      ...
      int lvt_3_1_ = lvt_2_1_.func_78325_e();
      Framebuffer lvt_4_1_ = new Framebuffer(lvt_2_1_.func_78326_a() * lvt_3_1_, lvt_2_1_.func_78328_b() * lvt_3_1_, true);
      lvt_4_1_.func_147610_a(false);
      GlStateManager.func_179128_n(5889);
      GlStateManager.func_179096_D();
      GlStateManager.func_179130_a(0.0D, (double)lvt_2_1_.func_78326_a(), (double)lvt_2_1_.func_78328_b(), 0.0D, 1000.0D, 3000.0D);
      GlStateManager.func_179128_n(5888);
      GlStateManager.func_179096_D();
      ...
      try {
         lvt_5_1_ = this.field_110450_ap.func_110590_a(field_110444_H);
         this.field_152354_ay = p_180510_1_.func_110578_a("logo", new DynamicTexture(ImageIO.read(lvt_5_1_)));
         p_180510_1_.func_110577_a(this.field_152354_ay);
      } catch (IOException var12) {
         field_147123_G.error((String)("Unable to load logo: " + field_110444_H), (Throwable)var12);
      } finally {
         IOUtils.closeQuietly(lvt_5_1_);
      }

      Tessellator lvt_6_2_ = Tessellator.func_178181_a();
      WorldRenderer lvt_7_1_ = lvt_6_2_.func_178180_c();
      lvt_7_1_.func_181668_a(7, DefaultVertexFormats.field_181709_i);
      lvt_7_1_.func_181662_b(0.0D, (double)this.field_71440_d, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
      lvt_7_1_.func_181662_b((double)this.field_71443_c, (double)this.field_71440_d, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
      lvt_7_1_.func_181662_b((double)this.field_71443_c, 0.0D, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
      lvt_7_1_.func_181662_b(0.0D, 0.0D, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
      lvt_6_2_.func_78381_a();
      GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
      int lvt_8_1_ = 256;
      int lvt_9_1_ = 256;
      this.func_181536_a((lvt_2_1_.func_78326_a() - lvt_8_1_) / 2, (lvt_2_1_.func_78328_b() - lvt_9_1_) / 2, 0, 0, lvt_8_1_, lvt_9_1_, 255, 255, 255, 255);
      GlStateManager.func_179140_f();
      GlStateManager.func_179106_n();
      lvt_4_1_.func_147609_e();
      lvt_4_1_.func_147615_c(lvt_2_1_.func_78326_a() * lvt_3_1_, lvt_2_1_.func_78328_b() * lvt_3_1_);
      GlStateManager.func_179141_d();
      GlStateManager.func_179092_a(516, 0.1F);
      this.func_175601_h();
   }
   ...
   public void func_181536_a(int p_181536_1_, int p_181536_2_, int p_181536_3_, int p_181536_4_, int p_181536_5_, int p_181536_6_, int p_181536_7_, int p_181536_8_, int p_181536_9_, int p_181536_10_) {
      ...
      WorldRenderer lvt_13_1_ = Tessellator.func_178181_a().func_178180_c();
      lvt_13_1_.func_181668_a(7, DefaultVertexFormats.field_181709_i);
      lvt_13_1_.func_181662_b((double)p_181536_1_, (double)(p_181536_2_ + p_181536_6_), 0.0D).func_181673_a((double)((float)p_181536_3_ * lvt_11_1_), (double)((float)(p_181536_4_ + p_181536_6_) * lvt_12_1_)).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
      lvt_13_1_.func_181662_b((double)(p_181536_1_ + p_181536_5_), (double)(p_181536_2_ + p_181536_6_), 0.0D).func_181673_a((double)((float)(p_181536_3_ + p_181536_5_) * lvt_11_1_), (double)((float)(p_181536_4_ + p_181536_6_) * lvt_12_1_)).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
      lvt_13_1_.func_181662_b((double)(p_181536_1_ + p_181536_5_), (double)p_181536_2_, 0.0D).func_181673_a((double)((float)(p_181536_3_ + p_181536_5_) * lvt_11_1_), (double)((float)p_181536_4_ * lvt_12_1_)).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
      lvt_13_1_.func_181662_b((double)p_181536_1_, (double)p_181536_2_, 0.0D).func_181673_a((double)((float)p_181536_3_ * lvt_11_1_), (double)((float)p_181536_4_ * lvt_12_1_)).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
   ...
   public void func_147108_a(GuiScreen p_147108_1_) {
      ...
      if (p_147108_1_ instanceof GuiMainMenu) {
         this.field_71474_y.field_74329_Q = false;
      ...
      if (p_147108_1_ != null) {
         ...
         ((GuiScreen)p_147108_1_).func_146280_a(this, lvt_3_1_, lvt_4_1_);
   ...
   private void func_71361_d(String p_71361_1_) {
      if (this.field_175619_R) {
         ...
         if (lvt_2_1_ != 0) {
            ...
            field_147123_G.error(lvt_2_1_ + ": " + lvt_3_1_);
         }
   ...
   private void func_71411_J() throws IOException {
      ...
      if (this.field_71445_n && this.field_71441_e != null) {
         float lvt_3_1_ = this.field_71428_T.field_74281_c;
         this.field_71428_T.func_74275_a();
         this.field_71428_T.field_74281_c = lvt_3_1_;
      } else {
         this.field_71428_T.func_74275_a();
      }
      ...
      for(int lvt_5_1_ = 0; lvt_5_1_ < this.field_71428_T.field_74280_b; ++lvt_5_1_) {
         this.func_71407_l();
      }
      ...
      if (this.field_71439_g != null && this.field_71439_g.func_70094_T()) {
         this.field_71474_y.field_74330_P = 0;
      }

      this.field_71424_I.func_76319_b();
      if (!this.field_71454_w) {
         this.field_71424_I.func_76318_c("gameRenderer");
         this.field_71460_t.func_181560_a(this.field_71428_T.field_74281_c, lvt_1_1_);
         this.field_71424_I.func_76319_b();
      }

      this.field_71424_I.func_76319_b();
      if (this.field_71474_y.field_74329_Q && this.field_71474_y.field_181657_aC && !this.field_71474_y.field_74320_O) {
         if (!this.field_71424_I.field_76327_a) {
            this.field_71424_I.func_76317_a();
         }

         this.field_71424_I.field_76327_a = true;
         this.func_71366_a(lvt_5_2_);
      } else {
      ...
      this.field_181542_y.func_181747_a(lvt_7_1_ - this.field_181543_z);
      this.field_181543_z = lvt_7_1_;
   ...
   protected void func_175604_i() {
      if (!this.field_71431_Q && Display.wasResized()) {
         int lvt_1_1_ = this.field_71443_c;
         int lvt_2_1_ = this.field_71440_d;
         this.field_71443_c = Display.getWidth();
         this.field_71440_d = Display.getHeight();
         if (this.field_71443_c != lvt_1_1_ || this.field_71440_d != lvt_2_1_) {
   ...
   private void func_71383_b(int p_71383_1_) {
      List<Profiler.Result> lvt_2_1_ = this.field_71424_I.func_76321_b(this.field_71465_an);
      if (lvt_2_1_ != null && !lvt_2_1_.isEmpty()) {
         ...
         if (p_71383_1_ == 0) {
            if (lvt_3_1_.field_76331_c.length() > 0) {
               int lvt_4_1_ = this.field_71465_an.lastIndexOf(".");
               if (lvt_4_1_ >= 0) {
                  this.field_71465_an = this.field_71465_an.substring(0, lvt_4_1_);
               }
            }
         } else {
            --p_71383_1_;
            if (p_71383_1_ < lvt_2_1_.size() && !((Profiler.Result)lvt_2_1_.get(p_71383_1_)).field_76331_c.equals("unspecified")) {
               if (this.field_71465_an.length() > 0) {
                  this.field_71465_an = this.field_71465_an + ".";
               }

               this.field_71465_an = this.field_71465_an + ((Profiler.Result)lvt_2_1_.get(p_71383_1_)).field_76331_c;
            }
         }
   ...
   private void func_71366_a(long p_71366_1_) {
      if (this.field_71424_I.field_76327_a) {
         List<Profiler.Result> lvt_3_1_ = this.field_71424_I.func_76321_b(this.field_71465_an);
         ...
         int lvt_7_1_ = 160;
         int lvt_8_1_ = this.field_71443_c - lvt_7_1_ - 10;
         int lvt_9_1_ = this.field_71440_d - lvt_7_1_ * 2;
         GlStateManager.func_179147_l();
         lvt_6_1_.func_181668_a(7, DefaultVertexFormats.field_181706_f);
         lvt_6_1_.func_181662_b((double)((float)lvt_8_1_ - (float)lvt_7_1_ * 1.1F), (double)((float)lvt_9_1_ - (float)lvt_7_1_ * 0.6F - 16.0F), 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
         lvt_6_1_.func_181662_b((double)((float)lvt_8_1_ - (float)lvt_7_1_ * 1.1F), (double)(lvt_9_1_ + lvt_7_1_ * 2), 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
         lvt_6_1_.func_181662_b((double)((float)lvt_8_1_ + (float)lvt_7_1_ * 1.1F), (double)(lvt_9_1_ + lvt_7_1_ * 2), 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
         lvt_6_1_.func_181662_b((double)((float)lvt_8_1_ + (float)lvt_7_1_ * 1.1F), (double)((float)lvt_9_1_ - (float)lvt_7_1_ * 0.6F - 16.0F), 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
         ...
         for(int lvt_12_1_ = 0; lvt_12_1_ < lvt_3_1_.size(); ++lvt_12_1_) {
            ...
            lvt_14_1_ = MathHelper.func_76128_c(lvt_13_1_.field_76332_a / 4.0D) + 1;
            lvt_6_1_.func_181668_a(6, DefaultVertexFormats.field_181706_f);
            int lvt_15_1_ = lvt_13_1_.func_76329_a();
            int lvt_16_1_ = lvt_15_1_ >> 16 & 255;
            int lvt_17_1_ = lvt_15_1_ >> 8 & 255;
            int lvt_18_1_ = lvt_15_1_ & 255;
            lvt_6_1_.func_181662_b((double)lvt_8_1_, (double)lvt_9_1_, 0.0D).func_181669_b(lvt_16_1_, lvt_17_1_, lvt_18_1_, 255).func_181675_d();

            int lvt_19_2_;
            float lvt_20_2_;
            float lvt_21_2_;
            float lvt_22_2_;
            for(lvt_19_2_ = lvt_14_1_; lvt_19_2_ >= 0; --lvt_19_2_) {
               lvt_20_2_ = (float)((lvt_10_1_ + lvt_13_1_.field_76332_a * (double)lvt_19_2_ / (double)lvt_14_1_) * 3.1415927410125732D * 2.0D / 100.0D);
               lvt_21_2_ = MathHelper.func_76126_a(lvt_20_2_) * (float)lvt_7_1_;
               lvt_22_2_ = MathHelper.func_76134_b(lvt_20_2_) * (float)lvt_7_1_ * 0.5F;
               lvt_6_1_.func_181662_b((double)((float)lvt_8_1_ + lvt_21_2_), (double)((float)lvt_9_1_ - lvt_22_2_), 0.0D).func_181669_b(lvt_16_1_, lvt_17_1_, lvt_18_1_, 255).func_181675_d();
            }

            lvt_5_1_.func_78381_a();
            lvt_6_1_.func_181668_a(5, DefaultVertexFormats.field_181706_f);

            for(lvt_19_2_ = lvt_14_1_; lvt_19_2_ >= 0; --lvt_19_2_) {
               lvt_20_2_ = (float)((lvt_10_1_ + lvt_13_1_.field_76332_a * (double)lvt_19_2_ / (double)lvt_14_1_) * 3.1415927410125732D * 2.0D / 100.0D);
               lvt_21_2_ = MathHelper.func_76126_a(lvt_20_2_) * (float)lvt_7_1_;
               lvt_22_2_ = MathHelper.func_76134_b(lvt_20_2_) * (float)lvt_7_1_ * 0.5F;
               lvt_6_1_.func_181662_b((double)((float)lvt_8_1_ + lvt_21_2_), (double)((float)lvt_9_1_ - lvt_22_2_), 0.0D).func_181669_b(lvt_16_1_ >> 1, lvt_17_1_ >> 1, lvt_18_1_ >> 1, 255).func_181675_d();
               lvt_6_1_.func_181662_b((double)((float)lvt_8_1_ + lvt_21_2_), (double)((float)lvt_9_1_ - lvt_22_2_ + 10.0F), 0.0D).func_181669_b(lvt_16_1_ >> 1, lvt_17_1_ >> 1, lvt_18_1_ >> 1, 255).func_181675_d();
            }
         ...
         lvt_14_1_ = 16777215;
         this.field_71466_p.func_175063_a(lvt_13_2_, (float)(lvt_8_1_ - lvt_7_1_), (float)(lvt_9_1_ - lvt_7_1_ / 2 - 16), lvt_14_1_);
         this.field_71466_p.func_175063_a(lvt_13_2_ = lvt_12_2_.format(lvt_4_1_.field_76330_b) + "%", (float)(lvt_8_1_ + lvt_7_1_ - this.field_71466_p.func_78256_a(lvt_13_2_)), (float)(lvt_9_1_ - lvt_7_1_ / 2 - 16), lvt_14_1_);
         ...
         for(int lvt_13_3_ = 0; lvt_13_3_ < lvt_3_1_.size(); ++lvt_13_3_) {
            ...
            this.field_71466_p.func_175063_a(lvt_15_2_, (float)(lvt_8_1_ - lvt_7_1_), (float)(lvt_9_1_ + lvt_7_1_ / 2 + lvt_13_3_ * 8 + 20), lvt_14_3_.func_76329_a());
            this.field_71466_p.func_175063_a(lvt_15_2_ = lvt_12_2_.format(lvt_14_3_.field_76332_a) + "%", (float)(lvt_8_1_ + lvt_7_1_ - 50 - this.field_71466_p.func_78256_a(lvt_15_2_)), (float)(lvt_9_1_ + lvt_7_1_ / 2 + lvt_13_3_ * 8 + 20), lvt_14_3_.func_76329_a());
            this.field_71466_p.func_175063_a(lvt_15_2_ = lvt_12_2_.format(lvt_14_3_.field_76330_b) + "%", (float)(lvt_8_1_ + lvt_7_1_ - this.field_71466_p.func_78256_a(lvt_15_2_)), (float)(lvt_9_1_ + lvt_7_1_ / 2 + lvt_13_3_ * 8 + 20), lvt_14_3_.func_76329_a());
         }
   ...
   private void func_147115_a(boolean p_147115_1_) {
      ...
      if (this.field_71429_W <= 0 && !this.field_71439_g.func_71039_bw()) {
         if (p_147115_1_ && this.field_71476_x != null && this.field_71476_x.field_72313_a == MovingObjectPosition.MovingObjectType.BLOCK) {
            BlockPos lvt_2_1_ = this.field_71476_x.func_178782_a();
            if (this.field_71441_e.func_180495_p(lvt_2_1_).func_177230_c().func_149688_o() != Material.field_151579_a && this.field_71442_b.func_180512_c(lvt_2_1_, this.field_71476_x.field_178784_b)) {
               this.field_71452_i.func_180532_a(lvt_2_1_, this.field_71476_x.field_178784_b);
      ...
      if (this.field_71429_W <= 0) {
         ...
         if (this.field_71476_x == null) {
            ...
            case ENTITY:
               ...
               break;
            case BLOCK:
               BlockPos lvt_1_1_ = this.field_71476_x.func_178782_a();
               if (this.field_71441_e.func_180495_p(lvt_1_1_).func_177230_c().func_149688_o() != Material.field_151579_a) {
                  this.field_71442_b.func_180511_b(lvt_1_1_, this.field_71476_x.field_178784_b);
                  break;
               }
            case MISS:
            default:
   ...
   private void func_147121_ag() {
      if (!this.field_71442_b.func_181040_m()) {
         ...
         ItemStack lvt_2_1_ = this.field_71439_g.field_71071_by.func_70448_g();
         if (this.field_71476_x == null) {
            ...
            case ENTITY:
               ...
               break;
            case BLOCK:
               BlockPos lvt_3_1_ = this.field_71476_x.func_178782_a();
               if (this.field_71441_e.func_180495_p(lvt_3_1_).func_177230_c().func_149688_o() != Material.field_151579_a) {
                  int lvt_4_1_ = lvt_2_1_ != null ? lvt_2_1_.field_77994_a : 0;
                  if (this.field_71442_b.func_178890_a(this.field_71439_g, this.field_71441_e, lvt_2_1_, lvt_3_1_, this.field_71476_x.field_178784_b, this.field_71476_x.field_72307_f)) {
                     lvt_1_1_ = false;
                     this.field_71439_g.func_71038_i();
                  }
                  ...
                  } else if (lvt_2_1_.field_77994_a != lvt_4_1_ || this.field_71442_b.func_78758_h()) {
         ...
         if (lvt_1_1_) {
            ItemStack lvt_3_2_ = this.field_71439_g.field_71071_by.func_70448_g();
            if (lvt_3_2_ != null && this.field_71442_b.func_78769_a(this.field_71439_g, this.field_71441_e, lvt_3_2_)) {
   ...
   public void func_71352_k() {
      try {
         ...
         field_147123_G.error((String)"Couldn't toggle fullscreen", (Throwable)var2);
      }
   ...
   private void func_71370_a(int p_71370_1_, int p_71370_2_) {
      ...
      if (this.field_71462_r != null) {
         ...
         this.field_71462_r.func_175273_b(this, lvt_3_1_.func_78326_a(), lvt_3_1_.func_78328_b());
      }
   ...
   public void func_71407_l() throws IOException {
      ...
      CrashReport lvt_2_5_;
      CrashReportCategory lvt_3_3_;
      if (this.field_71462_r != null) {
         try {
            this.field_71462_r.func_146269_k();
         } catch (Throwable var7) {
            lvt_2_5_ = CrashReport.func_85055_a(var7, "Updating screen events");
            lvt_3_3_ = lvt_2_5_.func_85058_a("Affected screen");
            lvt_3_3_.func_71500_a("Screen name", new Callable<String>() {
         ...
         if (this.field_71462_r != null) {
            try {
               ...
               lvt_2_5_ = CrashReport.func_85055_a(var6, "Ticking screen");
               lvt_3_3_ = lvt_2_5_.func_85058_a("Affected screen");
               lvt_3_3_.func_71500_a("Screen name", new Callable<String>() {
                  public String call() throws Exception {
                     return Minecraft.this.field_71462_r.getClass().getCanonicalName();
      ...
      if (this.field_71462_r == null || this.field_71462_r.field_146291_p) {
         ...
         int lvt_1_4_;
         while(Mouse.next()) {
            lvt_1_4_ = Mouse.getEventButton();
            KeyBinding.func_74510_a(lvt_1_4_ - 100, Mouse.getEventButtonState());
            if (Mouse.getEventButtonState()) {
               if (this.field_71439_g.func_175149_v() && lvt_1_4_ == 2) {
                  this.field_71456_v.func_175187_g().func_175261_b();
               } else {
                  KeyBinding.func_74507_a(lvt_1_4_ - 100);
               }
            }

            long lvt_2_3_ = func_71386_F() - this.field_71423_H;
            if (lvt_2_3_ <= 200L) {
               ...
               if (lvt_4_1_ != 0) {
                  if (this.field_71439_g.func_175149_v()) {
                     ...
                     if (this.field_71456_v.func_175187_g().func_175262_a()) {
                        this.field_71456_v.func_175187_g().func_175259_b(-lvt_4_1_);
                     } else {
                        float lvt_5_1_ = MathHelper.func_76131_a(this.field_71439_g.field_71075_bZ.func_75093_a() + (float)lvt_4_1_ * 0.005F, 0.0F, 0.2F);
                        this.field_71439_g.field_71075_bZ.func_75092_a(lvt_5_1_);
                     }
                  } else {
                     this.field_71439_g.field_71071_by.func_70453_c(lvt_4_1_);
                  }
               }
         ...
         while(true) {
            do {
               do {
                  do {
                     if (!Keyboard.next()) {
                        for(lvt_1_4_ = 0; lvt_1_4_ < 9; ++lvt_1_4_) {
                           if (this.field_71474_y.field_74324_K[lvt_1_4_].func_151468_f()) {
                              if (this.field_71439_g.func_175149_v()) {
                                 this.field_71456_v.func_175187_g().func_175260_a(lvt_1_4_);
                              } else {
                                 this.field_71439_g.field_71071_by.field_70461_c = lvt_1_4_;
                              }
                           }
                        }

                        boolean lvt_1_6_ = this.field_71474_y.field_74343_n != EntityPlayer.EnumChatVisibility.HIDDEN;
                        ...
                        while(this.field_71474_y.field_74321_H.func_151468_f() && lvt_1_6_) {
                           this.func_147108_a(new GuiChat());
                        }

                        if (this.field_71462_r == null && this.field_71474_y.field_151447_Z.func_151468_f() && lvt_1_6_) {
                           this.func_147108_a(new GuiChat("/"));
                        }

                        if (this.field_71439_g.func_71039_bw()) {
                           if (!this.field_71474_y.field_74316_C.func_151470_d()) {
                        ...
                        if (this.field_71474_y.field_74316_C.func_151470_d() && this.field_71467_ac == 0 && !this.field_71439_g.func_71039_bw()) {
                           this.func_147121_ag();
                        }

                        this.func_147115_a(this.field_71462_r == null && this.field_71474_y.field_74322_I.func_151470_d() && this.field_71415_G);
                        break label504;
                     }

                     lvt_1_4_ = Keyboard.getEventKey() == 0 ? Keyboard.getEventCharacter() + 256 : Keyboard.getEventKey();
                     KeyBinding.func_74510_a(lvt_1_4_, Keyboard.getEventKeyState());
                     if (Keyboard.getEventKeyState()) {
                        KeyBinding.func_74507_a(lvt_1_4_);
                     }
                  ...
                  if (lvt_1_4_ == 62 && this.field_71460_t != null) {
                  ...
                  if (this.field_71462_r != null) {
                     ...
                     if (lvt_1_4_ == 32 && Keyboard.isKeyDown(61) && this.field_71456_v != null) {
                        this.field_71456_v.func_146158_b().func_146231_a();
                     }
                     ...
                     if (lvt_1_4_ == 59) {
                        this.field_71474_y.field_74320_O = !this.field_71474_y.field_74320_O;
                     }

                     if (lvt_1_4_ == 61) {
                        this.field_71474_y.field_74329_Q = !this.field_71474_y.field_74329_Q;
                        this.field_71474_y.field_181657_aC = GuiScreen.func_146272_n();
                        this.field_71474_y.field_74332_R = GuiScreen.func_175283_s();
                     }

                     if (this.field_71474_y.field_151458_ab.func_151468_f()) {
                        ++this.field_71474_y.field_74330_P;
                        if (this.field_71474_y.field_74330_P > 2) {
                           this.field_71474_y.field_74330_P = 0;
                        }

                        if (this.field_71474_y.field_74330_P == 0) {
                           this.field_71460_t.func_175066_a(this.func_175606_aa());
                        } else if (this.field_71474_y.field_74330_P == 1) {
                     ...
                     if (this.field_71474_y.field_152395_am.func_151468_f()) {
                        this.field_71474_y.field_74325_U = !this.field_71474_y.field_74325_U;
                     }
                  }
               } while(!this.field_71474_y.field_74329_Q);
            } while(!this.field_71474_y.field_181657_aC);
      ...
      if (this.field_71441_e != null) {
         if (!this.field_71445_n) {
            ...
            try {
               ...
               lvt_2_5_ = CrashReport.func_85055_a(var8, "Exception in world tick");
               if (this.field_71441_e == null) {
                  lvt_3_3_ = lvt_2_5_.func_85058_a("Affected level");
                  lvt_3_3_.func_71507_a("Problem", "Level is null!");
               } else {
                  this.field_71441_e.func_72914_a(lvt_2_5_);
               }
   ...
   public void func_71371_a(String p_71371_1_, String p_71371_2_, WorldSettings p_71371_3_) {
      this.func_71403_a((WorldClient)null);
      System.gc();
      ISaveHandler lvt_4_1_ = this.field_71469_aa.func_75804_a(p_71371_1_, false);
      WorldInfo lvt_5_1_ = lvt_4_1_.func_75757_d();
      if (lvt_5_1_ == null && p_71371_3_ != null) {
         lvt_5_1_ = new WorldInfo(p_71371_3_, p_71371_1_);
         lvt_4_1_.func_75761_a(lvt_5_1_);
      }

      if (p_71371_3_ == null) {
         p_71371_3_ = new WorldSettings(lvt_5_1_);
      }
      ...
      try {
         ...
         CrashReport lvt_7_1_ = CrashReport.func_85055_a(var10, "Starting integrated server");
         CrashReportCategory lvt_8_1_ = lvt_7_1_.func_85058_a("Starting integrated server");
         lvt_8_1_.func_71507_a("Level ID", p_71371_1_);
         lvt_8_1_.func_71507_a("Level Name", p_71371_2_);
      ...
      while(!this.field_71437_Z.func_71200_ad()) {
         String lvt_6_2_ = this.field_71437_Z.func_71195_b_();
         if (lvt_6_2_ != null) {
            this.field_71461_s.func_73719_c(I18n.func_135052_a(lvt_6_2_));
         } else {
      ...
      this.func_147108_a((GuiScreen)null);
      SocketAddress lvt_6_3_ = this.field_71437_Z.func_147137_ag().func_151270_a();
      NetworkManager lvt_7_2_ = NetworkManager.func_150722_a(lvt_6_3_);
      lvt_7_2_.func_150719_a(new NetHandlerLoginClient(lvt_7_2_, this, (GuiScreen)null));
      lvt_7_2_.func_179290_a(new C00Handshake(47, lvt_6_3_.toString(), 0, EnumConnectionState.LOGIN));
      lvt_7_2_.func_179290_a(new C00PacketLoginStart(this.func_110432_I().func_148256_e()));
      this.field_71453_ak = lvt_7_2_;
   }
   ...
   public void func_71353_a(WorldClient p_71353_1_, String p_71353_2_) {
      if (p_71353_1_ == null) {
         NetHandlerPlayClient lvt_3_1_ = this.func_147114_u();
         if (lvt_3_1_ != null) {
            lvt_3_1_.func_147296_c();
         }
   ...
   public void func_71354_a(int p_71354_1_) {
      ...
      if (this.field_71439_g != null) {
         lvt_2_1_ = this.field_71439_g.func_145782_y();
         this.field_71441_e.func_72900_e(this.field_71439_g);
         lvt_3_1_ = this.field_71439_g.func_142021_k();
      }

      this.field_175622_Z = null;
      EntityPlayerSP lvt_4_1_ = this.field_71439_g;
      ...
      this.field_71439_g.func_70096_w().func_75687_a(lvt_4_1_.func_70096_w().func_75685_c());
      this.field_71439_g.field_71093_bK = p_71354_1_;
      this.field_175622_Z = this.field_71439_g;
      this.field_71439_g.func_70065_x();
      this.field_71439_g.func_175158_f(lvt_3_1_);
      this.field_71441_e.func_72838_d(this.field_71439_g);
      this.field_71442_b.func_78745_b(this.field_71439_g);
      this.field_71439_g.field_71158_b = new MovementInputFromOptions(this.field_71474_y);
      this.field_71439_g.func_145769_d(lvt_2_1_);
      this.field_71442_b.func_78748_a(this.field_71439_g);
      this.field_71439_g.func_175150_k(lvt_4_1_.func_175140_cp());
   ...
   public static boolean func_71382_s() {
      return field_71432_P == null || !field_71432_P.field_71474_y.field_74320_O;
   }
   ...
   private void func_147112_ai() {
      if (this.field_71476_x != null) {
         boolean lvt_1_1_ = this.field_71439_g.field_71075_bZ.field_75098_d;
         int lvt_3_1_ = 0;
         ...
         if (this.field_71476_x.field_72313_a == MovingObjectPosition.MovingObjectType.BLOCK) {
            BlockPos lvt_6_1_ = this.field_71476_x.func_178782_a();
            Block lvt_7_1_ = this.field_71441_e.func_180495_p(lvt_6_1_).func_177230_c();
            if (lvt_7_1_.func_149688_o() == Material.field_151579_a) {
               return;
            }

            lvt_2_14_ = lvt_7_1_.func_180665_b(this.field_71441_e, lvt_6_1_);
            if (lvt_2_14_ == null) {
               return;
            }

            if (lvt_1_1_ && GuiScreen.func_146271_m()) {
               lvt_5_1_ = this.field_71441_e.func_175625_s(lvt_6_1_);
            }

            Block lvt_8_1_ = lvt_2_14_ instanceof ItemBlock && !lvt_7_1_.func_149648_K() ? Block.func_149634_a((Item)lvt_2_14_) : lvt_7_1_;
            lvt_3_1_ = lvt_8_1_.func_176222_j(this.field_71441_e, lvt_6_1_);
            lvt_4_1_ = ((Item)lvt_2_14_).func_77614_k();
         } else {
            if (this.field_71476_x.field_72313_a != MovingObjectPosition.MovingObjectType.ENTITY || this.field_71476_x.field_72308_g == null || !lvt_1_1_) {
               return;
            }

            if (this.field_71476_x.field_72308_g instanceof EntityPainting) {
               lvt_2_14_ = Items.field_151159_an;
            } else if (this.field_71476_x.field_72308_g instanceof EntityLeashKnot) {
               lvt_2_14_ = Items.field_151058_ca;
            } else if (this.field_71476_x.field_72308_g instanceof EntityItemFrame) {
               EntityItemFrame lvt_6_2_ = (EntityItemFrame)this.field_71476_x.field_72308_g;
               lvt_7_2_ = lvt_6_2_.func_82335_i();
               if (lvt_7_2_ == null) {
                  lvt_2_14_ = Items.field_151160_bD;
               } else {
                  lvt_2_14_ = lvt_7_2_.func_77973_b();
                  lvt_3_1_ = lvt_7_2_.func_77960_j();
                  lvt_4_1_ = true;
               }
            } else if (this.field_71476_x.field_72308_g instanceof EntityMinecart) {
               EntityMinecart lvt_6_3_ = (EntityMinecart)this.field_71476_x.field_72308_g;
               switch(lvt_6_3_.func_180456_s()) {
               case FURNACE:
                  lvt_2_14_ = Items.field_151109_aJ;
                  break;
               case CHEST:
                  lvt_2_14_ = Items.field_151108_aI;
                  break;
               case TNT:
                  lvt_2_14_ = Items.field_151142_bV;
                  break;
               case HOPPER:
                  lvt_2_14_ = Items.field_151140_bW;
                  break;
               case COMMAND_BLOCK:
                  lvt_2_14_ = Items.field_151095_cc;
                  break;
               default:
                  lvt_2_14_ = Items.field_151143_au;
               }
            } else if (this.field_71476_x.field_72308_g instanceof EntityBoat) {
               lvt_2_14_ = Items.field_151124_az;
            } else if (this.field_71476_x.field_72308_g instanceof EntityArmorStand) {
               lvt_2_14_ = Items.field_179565_cj;
            } else {
               lvt_2_14_ = Items.field_151063_bx;
               lvt_3_1_ = EntityList.func_75619_a(this.field_71476_x.field_72308_g);
               lvt_4_1_ = true;
               if (!EntityList.field_75627_a.containsKey(lvt_3_1_)) {
                  return;
               }
            }
         }

         InventoryPlayer lvt_6_4_ = this.field_71439_g.field_71071_by;
         if (lvt_5_1_ == null) {
            lvt_6_4_.func_146030_a((Item)lvt_2_14_, lvt_3_1_, lvt_4_1_, lvt_1_1_);
         } else {
            lvt_7_2_ = this.func_181036_a((Item)lvt_2_14_, lvt_3_1_, lvt_5_1_);
            lvt_6_4_.func_70299_a(lvt_6_4_.field_70461_c, lvt_7_2_);
         }

         if (lvt_1_1_) {
            int lvt_7_4_ = this.field_71439_g.field_71069_bz.field_75151_b.size() - 9 + lvt_6_4_.field_70461_c;
            this.field_71442_b.func_78761_a(lvt_6_4_.func_70301_a(lvt_6_4_.field_70461_c), lvt_7_4_);
         }
   ...
   private ItemStack func_181036_a(Item p_181036_1_, int p_181036_2_, TileEntity p_181036_3_) {
      ItemStack lvt_4_1_ = new ItemStack(p_181036_1_, 1, p_181036_2_);
      NBTTagCompound lvt_5_1_ = new NBTTagCompound();
      p_181036_3_.func_145841_b(lvt_5_1_);
      NBTTagCompound lvt_6_2_;
      if (p_181036_1_ == Items.field_151144_bL && lvt_5_1_.func_74764_b("Owner")) {
         lvt_6_2_ = lvt_5_1_.func_74775_l("Owner");
         NBTTagCompound lvt_7_1_ = new NBTTagCompound();
         lvt_7_1_.func_74782_a("SkullOwner", lvt_6_2_);
         lvt_4_1_.func_77982_d(lvt_7_1_);
         return lvt_4_1_;
      } else {
         lvt_4_1_.func_77983_a("BlockEntityTag", lvt_5_1_);
         lvt_6_2_ = new NBTTagCompound();
         NBTTagList lvt_7_2_ = new NBTTagList();
         lvt_7_2_.func_74742_a(new NBTTagString("(+NBT)"));
         lvt_6_2_.func_74782_a("Lore", lvt_7_2_);
         lvt_4_1_.func_77983_a("display", lvt_6_2_);
         return lvt_4_1_;
      }
   }
   ...
   public CrashReport func_71396_d(CrashReport p_71396_1_) {
      ...
      p_71396_1_.func_85056_g().func_71500_a("Resource Packs", new Callable<String>() {
         public String call() throws Exception {
            ...
            Iterator lvt_2_1_ = Minecraft.this.field_71474_y.field_151453_l.iterator();
            ...
            while(lvt_2_1_.hasNext()) {
               ...
               if (Minecraft.this.field_71474_y.field_183018_l.contains(lvt_3_1_)) {
   ...
   public void func_70000_a(PlayerUsageSnooper p_70000_1_) {
      ...
      p_70000_1_.func_152768_a("endianness", lvt_2_1_);
      p_70000_1_.func_152768_a("resource_packs", this.field_110448_aq.func_110613_c().size());
      int lvt_3_1_ = 0;
      Iterator lvt_4_1_ = this.field_110448_aq.func_110613_c().iterator();

      while(lvt_4_1_.hasNext()) {
         ResourcePackRepository.Entry lvt_5_1_ = (ResourcePackRepository.Entry)lvt_4_1_.next();
         p_70000_1_.func_152768_a("resource_pack[" + lvt_3_1_++ + "]", lvt_5_1_.func_110515_d());
      }
   ...
   public void func_70001_b(PlayerUsageSnooper p_70001_1_) {
      ...
      p_70001_1_.func_152767_b("gl_caps[ARB_arrays_of_arrays]", lvt_2_1_.GL_ARB_arrays_of_arrays);
      p_70001_1_.func_152767_b("gl_caps[ARB_base_instance]", lvt_2_1_.GL_ARB_base_instance);
      p_70001_1_.func_152767_b("gl_caps[ARB_blend_func_extended]", lvt_2_1_.GL_ARB_blend_func_extended);
      p_70001_1_.func_152767_b("gl_caps[ARB_clear_buffer_object]", lvt_2_1_.GL_ARB_clear_buffer_object);
      p_70001_1_.func_152767_b("gl_caps[ARB_color_buffer_float]", lvt_2_1_.GL_ARB_color_buffer_float);
      p_70001_1_.func_152767_b("gl_caps[ARB_compatibility]", lvt_2_1_.GL_ARB_compatibility);
      p_70001_1_.func_152767_b("gl_caps[ARB_compressed_texture_pixel_storage]", lvt_2_1_.GL_ARB_compressed_texture_pixel_storage);
      p_70001_1_.func_152767_b("gl_caps[ARB_compute_shader]", lvt_2_1_.GL_ARB_compute_shader);
      p_70001_1_.func_152767_b("gl_caps[ARB_copy_buffer]", lvt_2_1_.GL_ARB_copy_buffer);
      p_70001_1_.func_152767_b("gl_caps[ARB_copy_image]", lvt_2_1_.GL_ARB_copy_image);
      p_70001_1_.func_152767_b("gl_caps[ARB_depth_buffer_float]", lvt_2_1_.GL_ARB_depth_buffer_float);
      p_70001_1_.func_152767_b("gl_caps[ARB_compute_shader]", lvt_2_1_.GL_ARB_compute_shader);
      p_70001_1_.func_152767_b("gl_caps[ARB_copy_buffer]", lvt_2_1_.GL_ARB_copy_buffer);
      p_70001_1_.func_152767_b("gl_caps[ARB_copy_image]", lvt_2_1_.GL_ARB_copy_image);
      p_70001_1_.func_152767_b("gl_caps[ARB_depth_buffer_float]", lvt_2_1_.GL_ARB_depth_buffer_float);
      p_70001_1_.func_152767_b("gl_caps[ARB_depth_clamp]", lvt_2_1_.GL_ARB_depth_clamp);
      p_70001_1_.func_152767_b("gl_caps[ARB_depth_texture]", lvt_2_1_.GL_ARB_depth_texture);
      p_70001_1_.func_152767_b("gl_caps[ARB_draw_buffers]", lvt_2_1_.GL_ARB_draw_buffers);
      p_70001_1_.func_152767_b("gl_caps[ARB_draw_buffers_blend]", lvt_2_1_.GL_ARB_draw_buffers_blend);
      p_70001_1_.func_152767_b("gl_caps[ARB_draw_elements_base_vertex]", lvt_2_1_.GL_ARB_draw_elements_base_vertex);
      p_70001_1_.func_152767_b("gl_caps[ARB_draw_indirect]", lvt_2_1_.GL_ARB_draw_indirect);
      p_70001_1_.func_152767_b("gl_caps[ARB_draw_instanced]", lvt_2_1_.GL_ARB_draw_instanced);
      p_70001_1_.func_152767_b("gl_caps[ARB_explicit_attrib_location]", lvt_2_1_.GL_ARB_explicit_attrib_location);
      p_70001_1_.func_152767_b("gl_caps[ARB_explicit_uniform_location]", lvt_2_1_.GL_ARB_explicit_uniform_location);
      p_70001_1_.func_152767_b("gl_caps[ARB_fragment_layer_viewport]", lvt_2_1_.GL_ARB_fragment_layer_viewport);
      p_70001_1_.func_152767_b("gl_caps[ARB_fragment_program]", lvt_2_1_.GL_ARB_fragment_program);
      p_70001_1_.func_152767_b("gl_caps[ARB_fragment_shader]", lvt_2_1_.GL_ARB_fragment_shader);
      p_70001_1_.func_152767_b("gl_caps[ARB_fragment_program_shadow]", lvt_2_1_.GL_ARB_fragment_program_shadow);
      p_70001_1_.func_152767_b("gl_caps[ARB_framebuffer_object]", lvt_2_1_.GL_ARB_framebuffer_object);
      p_70001_1_.func_152767_b("gl_caps[ARB_framebuffer_sRGB]", lvt_2_1_.GL_ARB_framebuffer_sRGB);
      p_70001_1_.func_152767_b("gl_caps[ARB_geometry_shader4]", lvt_2_1_.GL_ARB_geometry_shader4);
      p_70001_1_.func_152767_b("gl_caps[ARB_gpu_shader5]", lvt_2_1_.GL_ARB_gpu_shader5);
      p_70001_1_.func_152767_b("gl_caps[ARB_half_float_pixel]", lvt_2_1_.GL_ARB_half_float_pixel);
      p_70001_1_.func_152767_b("gl_caps[ARB_half_float_vertex]", lvt_2_1_.GL_ARB_half_float_vertex);
      p_70001_1_.func_152767_b("gl_caps[ARB_instanced_arrays]", lvt_2_1_.GL_ARB_instanced_arrays);
      p_70001_1_.func_152767_b("gl_caps[ARB_map_buffer_alignment]", lvt_2_1_.GL_ARB_map_buffer_alignment);
      p_70001_1_.func_152767_b("gl_caps[ARB_map_buffer_range]", lvt_2_1_.GL_ARB_map_buffer_range);
      p_70001_1_.func_152767_b("gl_caps[ARB_multisample]", lvt_2_1_.GL_ARB_multisample);
      p_70001_1_.func_152767_b("gl_caps[ARB_multitexture]", lvt_2_1_.GL_ARB_multitexture);
      p_70001_1_.func_152767_b("gl_caps[ARB_occlusion_query2]", lvt_2_1_.GL_ARB_occlusion_query2);
      p_70001_1_.func_152767_b("gl_caps[ARB_pixel_buffer_object]", lvt_2_1_.GL_ARB_pixel_buffer_object);
      p_70001_1_.func_152767_b("gl_caps[ARB_seamless_cube_map]", lvt_2_1_.GL_ARB_seamless_cube_map);
      p_70001_1_.func_152767_b("gl_caps[ARB_shader_objects]", lvt_2_1_.GL_ARB_shader_objects);
      p_70001_1_.func_152767_b("gl_caps[ARB_shader_stencil_export]", lvt_2_1_.GL_ARB_shader_stencil_export);
      p_70001_1_.func_152767_b("gl_caps[ARB_shader_texture_lod]", lvt_2_1_.GL_ARB_shader_texture_lod);
      p_70001_1_.func_152767_b("gl_caps[ARB_shadow]", lvt_2_1_.GL_ARB_shadow);
      p_70001_1_.func_152767_b("gl_caps[ARB_shadow_ambient]", lvt_2_1_.GL_ARB_shadow_ambient);
      p_70001_1_.func_152767_b("gl_caps[ARB_stencil_texturing]", lvt_2_1_.GL_ARB_stencil_texturing);
      p_70001_1_.func_152767_b("gl_caps[ARB_sync]", lvt_2_1_.GL_ARB_sync);
      p_70001_1_.func_152767_b("gl_caps[ARB_tessellation_shader]", lvt_2_1_.GL_ARB_tessellation_shader);
      p_70001_1_.func_152767_b("gl_caps[ARB_texture_border_clamp]", lvt_2_1_.GL_ARB_texture_border_clamp);
      p_70001_1_.func_152767_b("gl_caps[ARB_texture_buffer_object]", lvt_2_1_.GL_ARB_texture_buffer_object);
      p_70001_1_.func_152767_b("gl_caps[ARB_texture_cube_map]", lvt_2_1_.GL_ARB_texture_cube_map);
      p_70001_1_.func_152767_b("gl_caps[ARB_texture_cube_map_array]", lvt_2_1_.GL_ARB_texture_cube_map_array);
      p_70001_1_.func_152767_b("gl_caps[ARB_texture_non_power_of_two]", lvt_2_1_.GL_ARB_texture_non_power_of_two);
      p_70001_1_.func_152767_b("gl_caps[ARB_uniform_buffer_object]", lvt_2_1_.GL_ARB_uniform_buffer_object);
      p_70001_1_.func_152767_b("gl_caps[ARB_vertex_blend]", lvt_2_1_.GL_ARB_vertex_blend);
      p_70001_1_.func_152767_b("gl_caps[ARB_vertex_buffer_object]", lvt_2_1_.GL_ARB_vertex_buffer_object);
      p_70001_1_.func_152767_b("gl_caps[ARB_vertex_program]", lvt_2_1_.GL_ARB_vertex_program);
      p_70001_1_.func_152767_b("gl_caps[ARB_vertex_shader]", lvt_2_1_.GL_ARB_vertex_shader);
      p_70001_1_.func_152767_b("gl_caps[EXT_bindable_uniform]", lvt_2_1_.GL_EXT_bindable_uniform);
      p_70001_1_.func_152767_b("gl_caps[EXT_blend_equation_separate]", lvt_2_1_.GL_EXT_blend_equation_separate);
      p_70001_1_.func_152767_b("gl_caps[EXT_blend_func_separate]", lvt_2_1_.GL_EXT_blend_func_separate);
      p_70001_1_.func_152767_b("gl_caps[EXT_blend_minmax]", lvt_2_1_.GL_EXT_blend_minmax);
      p_70001_1_.func_152767_b("gl_caps[EXT_blend_subtract]", lvt_2_1_.GL_EXT_blend_subtract);
      p_70001_1_.func_152767_b("gl_caps[EXT_draw_instanced]", lvt_2_1_.GL_EXT_draw_instanced);
      p_70001_1_.func_152767_b("gl_caps[EXT_framebuffer_multisample]", lvt_2_1_.GL_EXT_framebuffer_multisample);
      p_70001_1_.func_152767_b("gl_caps[EXT_framebuffer_object]", lvt_2_1_.GL_EXT_framebuffer_object);
      p_70001_1_.func_152767_b("gl_caps[EXT_framebuffer_sRGB]", lvt_2_1_.GL_EXT_framebuffer_sRGB);
      p_70001_1_.func_152767_b("gl_caps[EXT_geometry_shader4]", lvt_2_1_.GL_EXT_geometry_shader4);
      p_70001_1_.func_152767_b("gl_caps[EXT_gpu_program_parameters]", lvt_2_1_.GL_EXT_gpu_program_parameters);
      p_70001_1_.func_152767_b("gl_caps[EXT_gpu_shader4]", lvt_2_1_.GL_EXT_gpu_shader4);
      p_70001_1_.func_152767_b("gl_caps[EXT_multi_draw_arrays]", lvt_2_1_.GL_EXT_multi_draw_arrays);
      p_70001_1_.func_152767_b("gl_caps[EXT_packed_depth_stencil]", lvt_2_1_.GL_EXT_packed_depth_stencil);
      p_70001_1_.func_152767_b("gl_caps[EXT_paletted_texture]", lvt_2_1_.GL_EXT_paletted_texture);
      p_70001_1_.func_152767_b("gl_caps[EXT_rescale_normal]", lvt_2_1_.GL_EXT_rescale_normal);
      p_70001_1_.func_152767_b("gl_caps[EXT_separate_shader_objects]", lvt_2_1_.GL_EXT_separate_shader_objects);
      p_70001_1_.func_152767_b("gl_caps[EXT_shader_image_load_store]", lvt_2_1_.GL_EXT_shader_image_load_store);
      p_70001_1_.func_152767_b("gl_caps[EXT_shadow_funcs]", lvt_2_1_.GL_EXT_shadow_funcs);
      p_70001_1_.func_152767_b("gl_caps[EXT_shared_texture_palette]", lvt_2_1_.GL_EXT_shared_texture_palette);
      p_70001_1_.func_152767_b("gl_caps[EXT_stencil_clear_tag]", lvt_2_1_.GL_EXT_stencil_clear_tag);
      p_70001_1_.func_152767_b("gl_caps[EXT_stencil_two_side]", lvt_2_1_.GL_EXT_stencil_two_side);
      p_70001_1_.func_152767_b("gl_caps[EXT_stencil_wrap]", lvt_2_1_.GL_EXT_stencil_wrap);
      p_70001_1_.func_152767_b("gl_caps[EXT_texture_3d]", lvt_2_1_.GL_EXT_texture_3d);
      p_70001_1_.func_152767_b("gl_caps[EXT_texture_array]", lvt_2_1_.GL_EXT_texture_array);
      p_70001_1_.func_152767_b("gl_caps[EXT_texture_buffer_object]", lvt_2_1_.GL_EXT_texture_buffer_object);
      p_70001_1_.func_152767_b("gl_caps[EXT_texture_integer]", lvt_2_1_.GL_EXT_texture_integer);
      p_70001_1_.func_152767_b("gl_caps[EXT_texture_lod_bias]", lvt_2_1_.GL_EXT_texture_lod_bias);
      p_70001_1_.func_152767_b("gl_caps[EXT_texture_sRGB]", lvt_2_1_.GL_EXT_texture_sRGB);
      p_70001_1_.func_152767_b("gl_caps[EXT_vertex_shader]", lvt_2_1_.GL_EXT_vertex_shader);
      p_70001_1_.func_152767_b("gl_caps[EXT_vertex_weighting]", lvt_2_1_.GL_EXT_vertex_weighting);
   ...
   public static int func_71369_N() {
      for(int lvt_0_1_ = 16384; lvt_0_1_ > 0; lvt_0_1_ >>= 1) {
         GL11.glTexImage2D(32868, 0, 6408, lvt_0_1_, lvt_0_1_, 0, 6408, 5121, (ByteBuffer)((ByteBuffer)null));
         int lvt_1_1_ = GL11.glGetTexLevelParameteri(32868, 0, 4096);
         if (lvt_1_1_ != 0) {
            return lvt_0_1_;
         }
      }
   ...
   public static void func_71363_D() {
      if (field_71432_P != null) {
         IntegratedServer lvt_0_1_ = field_71432_P.func_71401_C();
         if (lvt_0_1_ != null) {
            lvt_0_1_.func_71260_j();
         }
   ...
   public PropertyMap func_181037_M() {
      if (this.field_181038_N.isEmpty()) {
         GameProfile lvt_1_1_ = this.func_152347_ac().fillProfileProperties(this.field_71449_j.func_148256_e(), false);
         this.field_181038_N.putAll(lvt_1_1_.getProperties());
      }
   ...
   public void func_152348_aa() {
      ...
      if (lvt_1_1_ != 0 && !Keyboard.isRepeatEvent()) {
         if (!(this.field_71462_r instanceof GuiControls) || ((GuiControls)this.field_71462_r).field_152177_g <= func_71386_F() - 20L) {
            if (Keyboard.getEventKeyState()) {
               if (lvt_1_1_ == this.field_71474_y.field_152397_ao.func_151463_i()) {
               ...
               } else if (lvt_1_1_ == this.field_71474_y.field_152398_ap.func_151463_i()) {
                  if (this.func_152346_Z().func_152934_n()) {
               ...
               } else if (lvt_1_1_ == this.field_71474_y.field_152399_aq.func_151463_i()) {
                  if (this.func_152346_Z().func_152934_n()) {
                     this.func_152346_Z().func_152931_p();
                  }
               } else if (lvt_1_1_ == this.field_71474_y.field_151456_ac.func_151463_i()) {
                  this.field_152353_at.func_152910_a(true);
               } else if (lvt_1_1_ == this.field_71474_y.field_178883_an.func_151463_i()) {
                  this.func_71352_k();
               } else if (lvt_1_1_ == this.field_71474_y.field_151457_aa.func_151463_i()) {
   ...
   public <V> ListenableFuture<V> func_152343_a(Callable<V> p_152343_1_) {
      ...
      if (!this.func_152345_ab()) {
         ListenableFutureTask<V> lvt_2_1_ = ListenableFutureTask.create(p_152343_1_);
         synchronized(this.field_152351_aB) {
            this.field_152351_aB.add(lvt_2_1_);
            return lvt_2_1_;
         }
      } else {
         try {
   ...
   public static Map<String, String> func_175596_ai() {
      ...
      lvt_0_1_.put("X-Minecraft-Username", func_71410_x().func_110432_I().func_111285_a());
      lvt_0_1_.put("X-Minecraft-UUID", func_71410_x().func_110432_I().func_148255_b());
   ...
   static {
      ...
      field_110445_I = Lists.newArrayList((Object[])(new DisplayMode(2560, 1600), new DisplayMode(2880, 1800)));
   }
}
