      ...
      if (!this.field_73725_b.field_71425_J) {
         ...
         if (i - this.field_73723_d >= 100L) {
            ...
            if (Reflector.FMLClientHandler_handleLoadingScreen.exists()) {
               Object fch = Reflector.call(Reflector.FMLClientHandler_instance);
               if (fch != null) {
                  render = !Reflector.callBoolean(fch, Reflector.FMLClientHandler_handleLoadingScreen, scaledresolution);
               }
            }
            ...
            if (render) {
               ...
               if (scr != null) {
                  scr.drawBackground(scaledresolution.func_78326_a(), scaledresolution.func_78328_b());
               } else {
                  ...
                  vertexbuffer.func_181662_b(0.0D, (double)l, 0.0D).func_181673_a(0.0D, (double)((float)l / f)).func_181669_b(64, 64, 64, 255).func_181675_d();
                  vertexbuffer.func_181662_b((double)k, (double)l, 0.0D).func_181673_a((double)((float)k / f), (double)((float)l / f)).func_181669_b(64, 64, 64, 255).func_181675_d();
                  vertexbuffer.func_181662_b((double)k, 0.0D, 0.0D).func_181673_a((double)((float)k / f), 0.0D).func_181669_b(64, 64, 64, 255).func_181675_d();
                  vertexbuffer.func_181662_b(0.0D, 0.0D, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(64, 64, 64, 255).func_181675_d();
               ...
               if (p_73718_1_ >= 0) {
                  ...
                  vertexbuffer.func_181662_b((double)k1, (double)(l1 + j1), 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
                  vertexbuffer.func_181662_b((double)(k1 + i1), (double)(l1 + j1), 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
                  vertexbuffer.func_181662_b((double)(k1 + i1), (double)l1, 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
                  vertexbuffer.func_181662_b((double)k1, (double)l1, 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
                  vertexbuffer.func_181662_b((double)k1, (double)(l1 + j1), 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
                  vertexbuffer.func_181662_b((double)(k1 + p_73718_1_), (double)(l1 + j1), 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
