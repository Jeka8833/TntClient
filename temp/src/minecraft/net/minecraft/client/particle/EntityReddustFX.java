...
public class EntityReddustFX extends EntityFX {
   ...
   protected EntityReddustFX(World p_i46350_1_, double p_i46350_2_, double p_i46350_4_, double p_i46350_6_, float p_i46350_8_, float p_i46350_9_, float p_i46350_10_, float p_i46350_11_) {
      ...
      float lvt_12_1_ = (float)Math.random() * 0.4F + 0.6F;
      this.field_70552_h = ((float)(Math.random() * 0.20000000298023224D) + 0.8F) * p_i46350_9_ * lvt_12_1_;
      this.field_70553_i = ((float)(Math.random() * 0.20000000298023224D) + 0.8F) * p_i46350_10_ * lvt_12_1_;
      this.field_70551_j = ((float)(Math.random() * 0.20000000298023224D) + 0.8F) * p_i46350_11_ * lvt_12_1_;
   ...
   public void func_180434_a(WorldRenderer p_180434_1_, Entity p_180434_2_, float p_180434_3_, float p_180434_4_, float p_180434_5_, float p_180434_6_, float p_180434_7_, float p_180434_8_) {
      ...
      this.field_70544_f = this.field_70570_a * lvt_9_1_;
