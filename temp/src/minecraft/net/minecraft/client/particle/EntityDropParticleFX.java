...
public class EntityDropParticleFX extends EntityFX {
   ...
   public void func_70071_h_() {
      ...
      Material lvt_3_1_ = lvt_2_1_.func_177230_c().func_149688_o();
      if (lvt_3_1_.func_76224_d() || lvt_3_1_.func_76220_a()) {
         double lvt_4_1_ = 0.0D;
         if (lvt_2_1_.func_177230_c() instanceof BlockLiquid) {
            lvt_4_1_ = (double)BlockLiquid.func_149801_b((Integer)lvt_2_1_.func_177229_b(BlockLiquid.field_176367_b));
         }

         double lvt_6_1_ = (double)(MathHelper.func_76128_c(this.field_70163_u) + 1) - lvt_4_1_;
         if (this.field_70163_u < lvt_6_1_) {
            this.func_70106_y();
         }
      }
