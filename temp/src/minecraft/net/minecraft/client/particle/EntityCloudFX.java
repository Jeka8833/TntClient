...
public class EntityCloudFX extends EntityFX {
   ...
   protected EntityCloudFX(World p_i1221_1_, double p_i1221_2_, double p_i1221_4_, double p_i1221_6_, double p_i1221_8_, double p_i1221_10_, double p_i1221_12_) {
      ...
      this.field_70544_f *= lvt_14_1_;
      this.field_70569_a = this.field_70544_f;
      this.field_70547_e = (int)(8.0D / (Math.random() * 0.8D + 0.3D));
      this.field_70547_e = (int)((float)this.field_70547_e * lvt_14_1_);
      this.field_70145_X = false;
   }

   public void func_180434_a(WorldRenderer p_180434_1_, Entity p_180434_2_, float p_180434_3_, float p_180434_4_, float p_180434_5_, float p_180434_6_, float p_180434_7_, float p_180434_8_) {
      float lvt_9_1_ = ((float)this.field_70546_d + p_180434_3_) / (float)this.field_70547_e * 32.0F;
      lvt_9_1_ = MathHelper.func_76131_a(lvt_9_1_, 0.0F, 1.0F);
      this.field_70544_f = this.field_70569_a * lvt_9_1_;
   ...
   public void func_70071_h_() {
      ...
      EntityPlayer lvt_1_1_ = this.field_70170_p.func_72890_a(this, 2.0D);
      if (lvt_1_1_ != null && this.field_70163_u > lvt_1_1_.func_174813_aQ().field_72338_b) {
         this.field_70163_u += (lvt_1_1_.func_174813_aQ().field_72338_b - this.field_70163_u) * 0.2D;
         this.field_70181_x += (lvt_1_1_.field_70181_x - this.field_70181_x) * 0.2D;
