...
public class EntityFlameFX extends EntityFX {
   ...
   public void func_180434_a(WorldRenderer p_180434_1_, Entity p_180434_2_, float p_180434_3_, float p_180434_4_, float p_180434_5_, float p_180434_6_, float p_180434_7_, float p_180434_8_) {
      ...
      this.field_70544_f = this.field_70562_a * (1.0F - lvt_9_1_ * lvt_9_1_ * 0.5F);
      super.func_180434_a(p_180434_1_, p_180434_2_, p_180434_3_, p_180434_4_, p_180434_5_, p_180434_6_, p_180434_7_, p_180434_8_);
   }

   public int func_70070_b(float p_70070_1_) {
      float lvt_2_1_ = ((float)this.field_70546_d + p_70070_1_) / (float)this.field_70547_e;
   ...
   public float func_70013_c(float p_70013_1_) {
      float lvt_2_1_ = ((float)this.field_70546_d + p_70013_1_) / (float)this.field_70547_e;
      lvt_2_1_ = MathHelper.func_76131_a(lvt_2_1_, 0.0F, 1.0F);
      float lvt_3_1_ = super.func_70013_c(p_70013_1_);
