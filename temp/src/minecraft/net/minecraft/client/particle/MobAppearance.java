...
public class MobAppearance extends EntityFX {
   ...
   public void func_70071_h_() {
      ...
      if (this.field_174844_a == null) {
         EntityGuardian lvt_1_1_ = new EntityGuardian(this.field_70170_p);
         lvt_1_1_.func_175465_cm();
         this.field_174844_a = lvt_1_1_;
      }
   ...
   public void func_180434_a(WorldRenderer p_180434_1_, Entity p_180434_2_, float p_180434_3_, float p_180434_4_, float p_180434_5_, float p_180434_6_, float p_180434_7_, float p_180434_8_) {
      if (this.field_174844_a != null) {
         RenderManager lvt_9_1_ = Minecraft.func_71410_x().func_175598_ae();
         lvt_9_1_.func_178628_a(EntityFX.field_70556_an, EntityFX.field_70554_ao, EntityFX.field_70555_ap);
         float lvt_10_1_ = 0.42553192F;
         float lvt_11_1_ = ((float)this.field_70546_d + p_180434_3_) / (float)this.field_70547_e;
         GlStateManager.func_179132_a(true);
         GlStateManager.func_179147_l();
         GlStateManager.func_179126_j();
         GlStateManager.func_179112_b(770, 771);
         float lvt_12_1_ = 240.0F;
         OpenGlHelper.func_77475_a(OpenGlHelper.field_77476_b, lvt_12_1_, lvt_12_1_);
         GlStateManager.func_179094_E();
         float lvt_13_1_ = 0.05F + 0.5F * MathHelper.func_76126_a(lvt_11_1_ * 3.1415927F);
         GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, lvt_13_1_);
         GlStateManager.func_179109_b(0.0F, 1.8F, 0.0F);
         GlStateManager.func_179114_b(180.0F - p_180434_2_.field_70177_z, 0.0F, 1.0F, 0.0F);
         GlStateManager.func_179114_b(60.0F - 150.0F * lvt_11_1_ - p_180434_2_.field_70125_A, 1.0F, 0.0F, 0.0F);
         ...
         lvt_9_1_.func_147940_a(this.field_174844_a, 0.0D, 0.0D, 0.0D, 0.0F, p_180434_3_);
