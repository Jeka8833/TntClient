...
public class EffectRenderer {
   ...
   public EntityFX func_178927_a(int p_178927_1_, double p_178927_2_, double p_178927_4_, double p_178927_6_, double p_178927_8_, double p_178927_10_, double p_178927_12_, int... p_178927_14_) {
      IParticleFactory iparticlefactory = (IParticleFactory)this.field_178932_g.get(p_178927_1_);
   ...
   public void func_78868_a() {
      ...
      Iterator i$ = this.field_178933_d.iterator();

      while(i$.hasNext()) {
         EntityParticleEmitter entityparticleemitter = (EntityParticleEmitter)i$.next();
   ...
   private void func_178925_a(List<EntityFX> p_178925_1_) {
      ...
      int countLeft = p_178925_1_.size();

      int countToRemove;
      for(countToRemove = 0; countToRemove < p_178925_1_.size(); ++countToRemove) {
         EntityFX entityfx = (EntityFX)p_178925_1_.get(countToRemove);
      ...
      if (countLeft > 0) {
         countToRemove = countLeft;

         for(Iterator it = p_178925_1_.iterator(); it.hasNext() && countToRemove > 0; --countToRemove) {
   ...
   private void func_178923_d(final EntityFX p_178923_1_) {
      try {
         ...
         CrashReport crashreport = CrashReport.func_85055_a(var6, "Ticking Particle");
         ...
         for(int j = 0; j < 2; ++j) {
            if (!this.field_78876_b[i][j].isEmpty()) {
               ...
               for(int k = 0; k < this.field_78876_b[i][j].size(); ++k) {
                  ...
                  try {
                     entityfx.func_180434_a(vertexbuffer, p_78874_1_, p_78874_2_, f, f4, f1, f2, f3);
                  } catch (Throwable var18) {
                     CrashReport crashreport = CrashReport.func_85055_a(var18, "Rendering Particle");
      ...
      for(int i = 0; i < 2; ++i) {
         ...
         if (!list.isEmpty()) {
            ...
            for(int j = 0; j < list.size(); ++j) {
               ...
               entityfx.func_180434_a(vertexbuffer, p_78872_1_, p_78872_2_, f1, f5, f2, f3, f4);
            }
         }
      }
   ...
   public void func_180533_a(BlockPos p_180533_1_, IBlockState p_180533_2_) {
      ...
      if (Reflector.ForgeBlock_addDestroyEffects.exists() && Reflector.ForgeBlock_isAir.exists()) {
         ...
         notAir = !Reflector.callBoolean(block, Reflector.ForgeBlock_isAir, this.field_78878_a, p_180533_1_) && !Reflector.callBoolean(block, Reflector.ForgeBlock_addDestroyEffects, this.field_78878_a, p_180533_1_, this);
      } else {
   ...
   public void addBlockHitEffects(BlockPos p_addBlockHitEffects_1_, MovingObjectPosition p_addBlockHitEffects_2_) {
      IBlockState state = this.field_78878_a.func_180495_p(p_addBlockHitEffects_1_);
      if (state != null) {
         boolean blockAddHitEffects = Reflector.callBoolean(state.func_177230_c(), Reflector.ForgeBlock_addHitEffects, this.field_78878_a, p_addBlockHitEffects_2_, this);
