...
public class EntitySpellParticleFX extends EntityFX {
   ...
   public static class InstantFactory implements IParticleFactory {
      public EntityFX func_178902_a(int p_178902_1_, World p_178902_2_, double p_178902_3_, double p_178902_5_, double p_178902_7_, double p_178902_9_, double p_178902_11_, double p_178902_13_, int... p_178902_15_) {
         EntityFX lvt_16_1_ = new EntitySpellParticleFX(p_178902_2_, p_178902_3_, p_178902_5_, p_178902_7_, p_178902_9_, p_178902_11_, p_178902_13_);
         ((EntitySpellParticleFX)lvt_16_1_).func_70589_b(144);
         return lvt_16_1_;
      }
   }
   ...
   public static class WitchFactory implements IParticleFactory {
      public EntityFX func_178902_a(int p_178902_1_, World p_178902_2_, double p_178902_3_, double p_178902_5_, double p_178902_7_, double p_178902_9_, double p_178902_11_, double p_178902_13_, int... p_178902_15_) {
         EntityFX lvt_16_1_ = new EntitySpellParticleFX(p_178902_2_, p_178902_3_, p_178902_5_, p_178902_7_, p_178902_9_, p_178902_11_, p_178902_13_);
         ((EntitySpellParticleFX)lvt_16_1_).func_70589_b(144);
         float lvt_17_1_ = p_178902_2_.field_73012_v.nextFloat() * 0.5F + 0.35F;
         lvt_16_1_.func_70538_b(1.0F * lvt_17_1_, 0.0F * lvt_17_1_, 1.0F * lvt_17_1_);
         return lvt_16_1_;
      }
   }
   ...
   public static class AmbientMobFactory implements IParticleFactory {
      public EntityFX func_178902_a(int p_178902_1_, World p_178902_2_, double p_178902_3_, double p_178902_5_, double p_178902_7_, double p_178902_9_, double p_178902_11_, double p_178902_13_, int... p_178902_15_) {
         EntityFX lvt_16_1_ = new EntitySpellParticleFX(p_178902_2_, p_178902_3_, p_178902_5_, p_178902_7_, p_178902_9_, p_178902_11_, p_178902_13_);
         lvt_16_1_.func_82338_g(0.15F);
         lvt_16_1_.func_70538_b((float)p_178902_9_, (float)p_178902_11_, (float)p_178902_13_);
         return lvt_16_1_;
      }
   }
