...
public class EntityHugeExplodeFX extends EntityFX {
   ...
   public void func_70071_h_() {
      for(int lvt_1_1_ = 0; lvt_1_1_ < 6; ++lvt_1_1_) {
         double lvt_2_1_ = this.field_70165_t + (this.field_70146_Z.nextDouble() - this.field_70146_Z.nextDouble()) * 4.0D;
         double lvt_4_1_ = this.field_70163_u + (this.field_70146_Z.nextDouble() - this.field_70146_Z.nextDouble()) * 4.0D;
         double lvt_6_1_ = this.field_70161_v + (this.field_70146_Z.nextDouble() - this.field_70146_Z.nextDouble()) * 4.0D;
         this.field_70170_p.func_175688_a(EnumParticleTypes.EXPLOSION_LARGE, lvt_2_1_, lvt_4_1_, lvt_6_1_, (double)((float)this.field_70579_a / (float)this.field_70580_aq), 0.0D, 0.0D);
      }
