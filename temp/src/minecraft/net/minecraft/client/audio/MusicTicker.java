...
public class MusicTicker implements ITickable {
   ...
   public void func_73660_a() {
      MusicTicker.MusicType lvt_1_1_ = this.field_147677_b.func_147109_W();
      if (this.field_147678_c != null) {
         if (!lvt_1_1_.func_148635_a().equals(this.field_147678_c.func_147650_b())) {
            this.field_147677_b.func_147118_V().func_147683_b(this.field_147678_c);
            this.field_147676_d = MathHelper.func_76136_a(this.field_147679_a, 0, lvt_1_1_.func_148634_b() / 2);
         }

         if (!this.field_147677_b.func_147118_V().func_147692_c(this.field_147678_c)) {
            this.field_147678_c = null;
            this.field_147676_d = Math.min(MathHelper.func_76136_a(this.field_147679_a, lvt_1_1_.func_148634_b(), lvt_1_1_.func_148633_c()), this.field_147676_d);
         }
      }

      if (this.field_147678_c == null && this.field_147676_d-- <= 0) {
         this.func_181558_a(lvt_1_1_);
      }
