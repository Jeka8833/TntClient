...
public class MovingSoundMinecartRiding extends MovingSound {
   ...
   public void func_73660_a() {
      if (!this.field_147671_l.field_70128_L && this.field_147672_k.func_70115_ae() && this.field_147672_k.field_70154_o == this.field_147671_l) {
         float lvt_1_1_ = MathHelper.func_76133_a(this.field_147671_l.field_70159_w * this.field_147671_l.field_70159_w + this.field_147671_l.field_70179_y * this.field_147671_l.field_70179_y);
         if ((double)lvt_1_1_ >= 0.01D) {
            this.field_147662_b = 0.0F + MathHelper.func_76131_a(lvt_1_1_, 0.0F, 1.0F) * 0.75F;
         } else {
