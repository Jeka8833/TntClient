...
public class IngestServerTester {
   ...
   public void func_176004_j() {
      if (this.field_153047_e == IngestServerTester.IngestTestState.Uninitalized) {
         ...
         for(int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_; ++lvt_2_1_) {
            FrameBuffer lvt_3_1_ = this.field_153045_c.allocateFrameBuffer(this.field_153052_j.outputWidth * this.field_153052_j.outputHeight * 4);
            if (!lvt_3_1_.getIsValid()) {
               this.func_153031_o();
               this.func_153034_a(IngestServerTester.IngestTestState.Failed);
               return;
            }

            this.field_153055_m.add(lvt_3_1_);
            this.field_153045_c.randomizeFrameBuffer(lvt_3_1_);
         }
   ...
   protected boolean func_153036_a(IngestServer p_153036_1_) {
      ...
      ErrorCode lvt_2_1_ = this.field_153045_c.start(this.field_153052_j, this.field_153053_k, p_153036_1_, StartFlags.TTV_Start_BandwidthTest, true);
   ...
   protected void func_153035_b(IngestServer p_153035_1_) {
      if (this.field_176008_y) {
         ...
         ErrorCode lvt_2_1_ = this.field_153045_c.stop(true);
         if (ErrorCode.failed(lvt_2_1_)) {
            this.field_176005_A.stopCallback(ErrorCode.TTV_EC_SUCCESS);
            System.out.println("Stop failed: " + lvt_2_1_.toString());
         }
   ...
   protected void func_153038_n() {
      float lvt_1_1_ = (float)this.func_153037_m();
      switch(this.field_153047_e) {
      case Starting:
      case ConnectingToServer:
      case Uninitalized:
      ...
      case Cancelling:
      default:
         this.field_153066_x = lvt_1_1_ / (float)this.field_153048_f;
      }
   ...
   protected boolean func_153029_c(IngestServer p_153029_1_) {
      if (!this.field_153061_s && !this.field_153060_r && this.func_153037_m() < this.field_153048_f) {
         if (!this.field_176008_y && !this.field_176007_z) {
            ErrorCode lvt_2_1_ = this.field_153045_c.submitVideoFrame((FrameBuffer)this.field_153055_m.get(this.field_153063_u));
            if (ErrorCode.failed(lvt_2_1_)) {
               this.field_153056_n = false;
               this.func_153034_a(IngestServerTester.IngestTestState.DoneTestingServer);
               return false;
               ...
               if (this.field_153051_i == RTMPState.SendVideo) {
                  ...
                  long lvt_3_1_ = this.func_153037_m();
                  if (lvt_3_1_ > 0L && this.field_153050_h > this.field_153064_v) {
   ...
   protected void func_153031_o() {
      ...
      if (this.field_153055_m != null) {
         for(int lvt_1_1_ = 0; lvt_1_1_ < this.field_153055_m.size(); ++lvt_1_1_) {
            ((FrameBuffer)this.field_153055_m.get(lvt_1_1_)).free();
         }
