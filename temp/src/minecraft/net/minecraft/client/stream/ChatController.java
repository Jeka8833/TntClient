...
public class ChatController {
   ...
   public boolean func_175990_d(String p_175990_1_) {
      if (!this.field_175998_i.containsKey(p_175990_1_)) {
         ...
         ChatController.ChatChannelListener lvt_2_1_ = (ChatController.ChatChannelListener)this.field_175998_i.get(p_175990_1_);
         return lvt_2_1_.func_176040_a() == ChatController.EnumChannelState.Connected;
      }
   }
   ...
   public ChatController.EnumChannelState func_175989_e(String p_175989_1_) {
      if (!this.field_175998_i.containsKey(p_175989_1_)) {
         ...
         ChatController.ChatChannelListener lvt_2_1_ = (ChatController.ChatChannelListener)this.field_175998_i.get(p_175989_1_);
         return lvt_2_1_.func_176040_a();
      }
   }
      ...
      this.field_175999_p = new IChatAPIListener() {
         ...
         public void chatShutdownCallback(ErrorCode p_chatShutdownCallback_1_) {
            if (ErrorCode.succeeded(p_chatShutdownCallback_1_)) {
               ErrorCode lvt_2_1_ = ChatController.this.field_175992_e.shutdown();
               if (ErrorCode.failed(lvt_2_1_)) {
                  String lvt_3_1_ = ErrorCode.getString(lvt_2_1_);
                  ChatController.this.func_152995_h(String.format("Error shutting down the Twitch sdk: %s", lvt_3_1_));
               }
   ...
   public boolean func_175984_n() {
      if (this.field_153011_i != ChatController.ChatState.Uninitialized) {
         ...
         ErrorCode lvt_1_1_ = this.field_175992_e.initialize(this.field_153006_d, (String)null);
         if (ErrorCode.failed(lvt_1_1_)) {
            ...
            this.func_152995_h(String.format("Error initializing Twitch sdk: %s", lvt_2_1_));
            return false;
         } else {
            this.field_175995_l = this.field_175997_k;
            HashSet<ChatTokenizationOption> lvt_2_2_ = new HashSet();
            switch(this.field_175997_k) {
            case None:
               lvt_2_2_.add(ChatTokenizationOption.TTV_CHAT_TOKENIZATION_OPTION_NONE);
               break;
            case Url:
               lvt_2_2_.add(ChatTokenizationOption.TTV_CHAT_TOKENIZATION_OPTION_EMOTICON_URLS);
               break;
            case TextureAtlas:
               lvt_2_2_.add(ChatTokenizationOption.TTV_CHAT_TOKENIZATION_OPTION_EMOTICON_TEXTURES);
            }

            lvt_1_1_ = this.field_153008_f.initialize(lvt_2_2_, this.field_175999_p);
            if (ErrorCode.failed(lvt_1_1_)) {
               this.field_175992_e.shutdown();
               this.func_175985_a(ChatController.ChatState.Uninitialized);
               String lvt_3_1_ = ErrorCode.getString(lvt_1_1_);
               this.func_152995_h(String.format("Error initializing Twitch chat: %s", lvt_3_1_));
               return false;
            } else {
   ...
   protected boolean func_175987_a(String p_175987_1_, boolean p_175987_2_) {
      if (this.field_153011_i != ChatController.ChatState.Initialized) {
         ...
         ChatController.ChatChannelListener lvt_3_1_ = new ChatController.ChatChannelListener(p_175987_1_);
         this.field_175998_i.put(p_175987_1_, lvt_3_1_);
         boolean lvt_4_1_ = lvt_3_1_.func_176038_a(p_175987_2_);
         if (!lvt_4_1_) {
   ...
   public boolean func_175991_l(String p_175991_1_) {
      if (this.field_153011_i != ChatController.ChatState.Initialized) {
         ...
         ChatController.ChatChannelListener lvt_2_1_ = (ChatController.ChatChannelListener)this.field_175998_i.get(p_175991_1_);
         return lvt_2_1_.func_176034_g();
      }
   }
   ...
   public boolean func_152993_m() {
      if (this.field_153011_i != ChatController.ChatState.Initialized) {
         ...
         ErrorCode lvt_1_1_ = this.field_153008_f.shutdown();
         if (ErrorCode.failed(lvt_1_1_)) {
            String lvt_2_1_ = ErrorCode.getString(lvt_1_1_);
            this.func_152995_h(String.format("Error shutting down chat: %s", lvt_2_1_));
            return false;
         } else {
            this.func_152996_t();
   ...
   public void func_152997_n() {
      if (this.field_153011_i != ChatController.ChatState.Uninitialized) {
         ErrorCode lvt_1_1_ = this.field_153008_f.flushEvents();
         if (ErrorCode.failed(lvt_1_1_)) {
            String lvt_2_1_ = ErrorCode.getString(lvt_1_1_);
            this.func_152995_h(String.format("Error flushing chat events: %s", lvt_2_1_));
         }
   ...
   public boolean func_175986_a(String p_175986_1_, String p_175986_2_) {
      if (this.field_153011_i != ChatController.ChatState.Initialized) {
         ...
         ChatController.ChatChannelListener lvt_3_1_ = (ChatController.ChatChannelListener)this.field_175998_i.get(p_175986_1_);
         return lvt_3_1_.func_176037_b(p_175986_2_);
      }
   }
   ...
   protected void func_153001_r() {
      if (this.field_175995_l != ChatController.EnumEmoticonMode.None) {
         if (this.field_175996_m == null) {
            ErrorCode lvt_1_1_ = this.field_153008_f.downloadEmoticonData();
            if (ErrorCode.failed(lvt_1_1_)) {
               String lvt_2_1_ = ErrorCode.getString(lvt_1_1_);
               this.func_152995_h(String.format("Error trying to download emoticon data: %s", lvt_2_1_));
            }
         }
   ...
   protected void func_152988_s() {
      if (this.field_175996_m == null) {
         ...
         ErrorCode lvt_1_1_ = this.field_153008_f.getEmoticonData(this.field_175996_m);
         if (ErrorCode.succeeded(lvt_1_1_)) {
            try {
               if (this.field_153003_a != null) {
            ...
            this.func_152995_h("Error preparing emoticon data: " + ErrorCode.getString(lvt_1_1_));
         }
   ...
   protected void func_152996_t() {
      if (this.field_175996_m != null) {
         ErrorCode lvt_1_1_ = this.field_153008_f.clearEmoticonData();
         if (ErrorCode.succeeded(lvt_1_1_)) {
            this.field_175996_m = null;
            ...
            this.func_152995_h("Error clearing emoticon data: " + ErrorCode.getString(lvt_1_1_));
         }
   ...
   public class ChatChannelListener implements IChatChannelListener {
      ...
      public boolean func_176038_a(boolean p_176038_1_) {
         ...
         ErrorCode lvt_2_1_ = ErrorCode.TTV_EC_SUCCESS;
         if (p_176038_1_) {
            lvt_2_1_ = ChatController.this.field_153008_f.connectAnonymous(this.field_176048_a, this);
         } else {
            lvt_2_1_ = ChatController.this.field_153008_f.connect(this.field_176048_a, ChatController.this.field_153004_b, ChatController.this.field_153012_j.data, this);
         }

         if (ErrorCode.failed(lvt_2_1_)) {
            String lvt_3_1_ = ErrorCode.getString(lvt_2_1_);
            ChatController.this.func_152995_h(String.format("Error connecting: %s", lvt_3_1_));
      ...
      public boolean func_176034_g() {
         ...
         case Connected:
         case Connecting:
            ErrorCode lvt_1_1_ = ChatController.this.field_153008_f.disconnect(this.field_176048_a);
            if (ErrorCode.failed(lvt_1_1_)) {
               String lvt_2_1_ = ErrorCode.getString(lvt_1_1_);
               ChatController.this.func_152995_h(String.format("Error disconnecting: %s", lvt_2_1_));
               return false;
            }
      ...
      public void func_176032_a(String p_176032_1_) {
         if (ChatController.this.field_175995_l == ChatController.EnumEmoticonMode.None) {
            ...
            ListIterator lvt_2_2_;
            if (this.field_176045_e.size() > 0) {
               lvt_2_2_ = this.field_176045_e.listIterator();

               while(lvt_2_2_.hasNext()) {
                  ChatRawMessage lvt_3_1_ = (ChatRawMessage)lvt_2_2_.next();
                  if (lvt_3_1_.userName.equals(p_176032_1_)) {
                     lvt_2_2_.remove();
                  }
               }
            }
            ...
            if (this.field_176042_f.size() > 0) {
               lvt_2_2_ = this.field_176042_f.listIterator();

               while(lvt_2_2_.hasNext()) {
                  ChatTokenizedMessage lvt_3_2_ = (ChatTokenizedMessage)lvt_2_2_.next();
                  if (lvt_3_2_.displayName.equals(p_176032_1_)) {
                     lvt_2_2_.remove();
                  }
               }
            }
      ...
      public boolean func_176037_b(String p_176037_1_) {
         if (this.field_176047_c != ChatController.EnumChannelState.Connected) {
            ...
            ErrorCode lvt_2_1_ = ChatController.this.field_153008_f.sendMessage(this.field_176048_a, p_176037_1_);
            if (ErrorCode.failed(lvt_2_1_)) {
               String lvt_3_1_ = ErrorCode.getString(lvt_2_1_);
               ChatController.this.func_152995_h(String.format("Error sending chat message: %s", lvt_3_1_));
               return false;
            } else {
               return true;
            }
      ...
      protected void func_176041_h() {
         if (ChatController.this.field_175995_l != ChatController.EnumEmoticonMode.None) {
            if (this.field_176043_g == null) {
               ErrorCode lvt_1_1_ = ChatController.this.field_153008_f.downloadBadgeData(this.field_176048_a);
               if (ErrorCode.failed(lvt_1_1_)) {
                  String lvt_2_1_ = ErrorCode.getString(lvt_1_1_);
                  ChatController.this.func_152995_h(String.format("Error trying to download badge data: %s", lvt_2_1_));
               }
            }
      ...
      protected void func_176039_i() {
         if (this.field_176043_g == null) {
            ...
            ErrorCode lvt_1_1_ = ChatController.this.field_153008_f.getBadgeData(this.field_176048_a, this.field_176043_g);
            if (ErrorCode.succeeded(lvt_1_1_)) {
               try {
                  if (ChatController.this.field_153003_a != null) {
               ...
               ChatController.this.func_152995_h("Error preparing badge data: " + ErrorCode.getString(lvt_1_1_));
            }
      ...
      protected void func_176033_j() {
         if (this.field_176043_g != null) {
            ErrorCode lvt_1_1_ = ChatController.this.field_153008_f.clearBadgeData(this.field_176048_a);
            if (ErrorCode.succeeded(lvt_1_1_)) {
               this.field_176043_g = null;
               ...
               ChatController.this.func_152995_h("Error releasing badge data: " + ErrorCode.getString(lvt_1_1_));
            }
      ...
      public void chatChannelUserChangeCallback(String p_chatChannelUserChangeCallback_1_, ChatUserInfo[] p_chatChannelUserChangeCallback_2_, ChatUserInfo[] p_chatChannelUserChangeCallback_3_, ChatUserInfo[] p_chatChannelUserChangeCallback_4_) {
         int lvt_5_3_;
         int lvt_6_2_;
         for(lvt_5_3_ = 0; lvt_5_3_ < p_chatChannelUserChangeCallback_3_.length; ++lvt_5_3_) {
            lvt_6_2_ = this.field_176044_d.indexOf(p_chatChannelUserChangeCallback_3_[lvt_5_3_]);
            if (lvt_6_2_ >= 0) {
               this.field_176044_d.remove(lvt_6_2_);
            }
         }

         for(lvt_5_3_ = 0; lvt_5_3_ < p_chatChannelUserChangeCallback_4_.length; ++lvt_5_3_) {
            lvt_6_2_ = this.field_176044_d.indexOf(p_chatChannelUserChangeCallback_4_[lvt_5_3_]);
            if (lvt_6_2_ >= 0) {
               this.field_176044_d.remove(lvt_6_2_);
            }

            this.field_176044_d.add(p_chatChannelUserChangeCallback_4_[lvt_5_3_]);
         }

         for(lvt_5_3_ = 0; lvt_5_3_ < p_chatChannelUserChangeCallback_2_.length; ++lvt_5_3_) {
            this.field_176044_d.add(p_chatChannelUserChangeCallback_2_[lvt_5_3_]);
         }
      ...
      public void chatChannelRawMessageCallback(String p_chatChannelRawMessageCallback_1_, ChatRawMessage[] p_chatChannelRawMessageCallback_2_) {
         for(int lvt_3_1_ = 0; lvt_3_1_ < p_chatChannelRawMessageCallback_2_.length; ++lvt_3_1_) {
            this.field_176045_e.addLast(p_chatChannelRawMessageCallback_2_[lvt_3_1_]);
         }
      ...
      public void chatChannelTokenizedMessageCallback(String p_chatChannelTokenizedMessageCallback_1_, ChatTokenizedMessage[] p_chatChannelTokenizedMessageCallback_2_) {
         for(int lvt_3_1_ = 0; lvt_3_1_ < p_chatChannelTokenizedMessageCallback_2_.length; ++lvt_3_1_) {
            this.field_176042_f.addLast(p_chatChannelTokenizedMessageCallback_2_[lvt_3_1_]);
         }
