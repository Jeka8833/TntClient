...
public class TileEntitySkull extends TileEntity {
   ...
   public void func_145841_b(NBTTagCompound p_145841_1_) {
      ...
      if (this.field_152110_j != null) {
         ...
         NBTUtil.func_180708_a(lvt_2_1_, this.field_152110_j);
         p_145841_1_.func_74782_a("Owner", lvt_2_1_);
      }
   ...
   public void func_145839_a(NBTTagCompound p_145839_1_) {
      ...
      if (this.field_145908_a == 3) {
         if (p_145839_1_.func_150297_b("Owner", 10)) {
            ...
            String lvt_2_1_ = p_145839_1_.func_74779_i("ExtraType");
            if (!StringUtils.func_151246_b(lvt_2_1_)) {
               this.field_152110_j = new GameProfile((UUID)null, lvt_2_1_);
               this.func_152109_d();
            }
         }
      }
   ...
   public Packet func_145844_m() {
      ...
      return new S35PacketUpdateTileEntity(this.field_174879_c, 4, lvt_1_1_);
   }
   ...
   public static GameProfile func_174884_b(GameProfile p_174884_0_) {
      if (p_174884_0_ != null && !StringUtils.func_151246_b(p_174884_0_.getName())) {
         if (p_174884_0_.isComplete() && p_174884_0_.getProperties().containsKey("textures")) {
            ...
            GameProfile lvt_1_1_ = MinecraftServer.func_71276_C().func_152358_ax().func_152655_a(p_174884_0_.getName());
            if (lvt_1_1_ == null) {
               return p_174884_0_;
            } else {
               Property lvt_2_1_ = (Property)Iterables.getFirst(lvt_1_1_.getProperties().get("textures"), (Object)null);
               if (lvt_2_1_ == null) {
                  lvt_1_1_ = MinecraftServer.func_71276_C().func_147130_as().fillProfileProperties(lvt_1_1_, true);
               }
