...
public class TileEntityBanner extends TileEntity {
   ...
   public void func_175112_a(ItemStack p_175112_1_) {
      ...
      if (p_175112_1_.func_77942_o() && p_175112_1_.func_77978_p().func_150297_b("BlockEntityTag", 10)) {
         NBTTagCompound lvt_2_1_ = p_175112_1_.func_77978_p().func_74775_l("BlockEntityTag");
         if (lvt_2_1_.func_74764_b("Patterns")) {
            this.field_175118_f = (NBTTagList)lvt_2_1_.func_150295_c("Patterns", 10).func_74737_b();
         }

         if (lvt_2_1_.func_150297_b("Base", 99)) {
            this.field_175120_a = lvt_2_1_.func_74762_e("Base");
         } else {
   ...
   public Packet func_145844_m() {
      ...
      return new S35PacketUpdateTileEntity(this.field_174879_c, 6, lvt_1_1_);
   }
   ...
   public static int func_175111_b(ItemStack p_175111_0_) {
      NBTTagCompound lvt_1_1_ = p_175111_0_.func_179543_a("BlockEntityTag", false);
      return lvt_1_1_ != null && lvt_1_1_.func_74764_b("Base") ? lvt_1_1_.func_74762_e("Base") : p_175111_0_.func_77960_j();
   }

   public static int func_175113_c(ItemStack p_175113_0_) {
      NBTTagCompound lvt_1_1_ = p_175113_0_.func_179543_a("BlockEntityTag", false);
      return lvt_1_1_ != null && lvt_1_1_.func_74764_b("Patterns") ? lvt_1_1_.func_150295_c("Patterns", 10).func_74745_c() : 0;
   }
      ...
      if (this.field_175122_h == null || this.field_175123_i == null || this.field_175121_j == null) {
         if (!this.field_175119_g) {
            ...
            if (this.field_175118_f != null) {
               for(int lvt_1_1_ = 0; lvt_1_1_ < this.field_175118_f.func_74745_c(); ++lvt_1_1_) {
                  NBTTagCompound lvt_2_1_ = this.field_175118_f.func_150305_b(lvt_1_1_);
                  TileEntityBanner.EnumBannerPattern lvt_3_1_ = TileEntityBanner.EnumBannerPattern.func_177268_a(lvt_2_1_.func_74779_i("Pattern"));
                  if (lvt_3_1_ != null) {
                     this.field_175122_h.add(lvt_3_1_);
                     int lvt_4_1_ = lvt_2_1_.func_74762_e("Color");
                     this.field_175123_i.add(EnumDyeColor.func_176766_a(lvt_4_1_));
                     this.field_175121_j = this.field_175121_j + lvt_3_1_.func_177273_b() + lvt_4_1_;
                  }
               }
            }
   ...
   public static void func_175117_e(ItemStack p_175117_0_) {
      NBTTagCompound lvt_1_1_ = p_175117_0_.func_179543_a("BlockEntityTag", false);
      if (lvt_1_1_ != null && lvt_1_1_.func_150297_b("Patterns", 9)) {
         NBTTagList lvt_2_1_ = lvt_1_1_.func_150295_c("Patterns", 10);
         if (lvt_2_1_.func_74745_c() > 0) {
            lvt_2_1_.func_74744_a(lvt_2_1_.func_74745_c() - 1);
   ...
   public static enum EnumBannerPattern {
      ...
      public static TileEntityBanner.EnumBannerPattern func_177268_a(String p_177268_0_) {
         TileEntityBanner.EnumBannerPattern[] lvt_1_1_ = values();
         int lvt_2_1_ = lvt_1_1_.length;

         for(int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_) {
            TileEntityBanner.EnumBannerPattern lvt_4_1_ = lvt_1_1_[lvt_3_1_];
            if (lvt_4_1_.field_177285_O.equals(p_177268_0_)) {
               return lvt_4_1_;
            }
         }
