      ...
      if (this.field_145850_b != null) {
         ...
         p_145828_1_.func_71500_a("Actual block type", new Callable<String>() {
            public String call() throws Exception {
               ...
               try {
                  return String.format("ID #%d (%s // %s)", lvt_1_1_, Block.func_149729_e(lvt_1_1_).func_149739_a(), Block.func_149729_e(lvt_1_1_).getClass().getCanonicalName());
         ...
         p_145828_1_.func_71500_a("Actual block data value", new Callable<String>() {
            public String call() throws Exception {
               ...
               if (lvt_2_1_ < 0) {
                  ...
                  String lvt_3_1_ = String.format("%4s", Integer.toBinaryString(lvt_2_1_)).replace(" ", "0");
                  return String.format("%1$d / 0x%1$X / 0b%2$s", lvt_2_1_, lvt_3_1_);
               }
            }
         });
      }
