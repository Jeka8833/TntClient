...
public class TileEntityNote extends TileEntity {
   ...
   public void func_175108_a(World p_175108_1_, BlockPos p_175108_2_) {
      if (p_175108_1_.func_180495_p(p_175108_2_.func_177984_a()).func_177230_c().func_149688_o() == Material.field_151579_a) {
         Material lvt_3_1_ = p_175108_1_.func_180495_p(p_175108_2_.func_177977_b()).func_177230_c().func_149688_o();
         int lvt_4_1_ = 0;
         if (lvt_3_1_ == Material.field_151576_e) {
            lvt_4_1_ = 1;
         }

         if (lvt_3_1_ == Material.field_151595_p) {
            lvt_4_1_ = 2;
         }

         if (lvt_3_1_ == Material.field_151592_s) {
            lvt_4_1_ = 3;
         }

         if (lvt_3_1_ == Material.field_151575_d) {
            lvt_4_1_ = 4;
         }

         p_175108_1_.func_175641_c(p_175108_2_, Blocks.field_150323_B, lvt_4_1_, this.field_145879_a);
      }
   }
}
