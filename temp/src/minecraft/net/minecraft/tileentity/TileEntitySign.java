...
public class TileEntitySign extends TileEntity {
   ...
   public void func_145841_b(NBTTagCompound p_145841_1_) {
      ...
      for(int lvt_2_1_ = 0; lvt_2_1_ < 4; ++lvt_2_1_) {
         String lvt_3_1_ = IChatComponent.Serializer.func_150696_a(this.field_145915_a[lvt_2_1_]);
         p_145841_1_.func_74778_a("Text" + (lvt_2_1_ + 1), lvt_3_1_);
      }
   ...
   public void func_145839_a(NBTTagCompound p_145839_1_) {
      ...
      for(int lvt_3_1_ = 0; lvt_3_1_ < 4; ++lvt_3_1_) {
         String lvt_4_1_ = p_145839_1_.func_74779_i("Text" + (lvt_3_1_ + 1));

         try {
            IChatComponent lvt_5_1_ = IChatComponent.Serializer.func_150699_a(lvt_4_1_);

            try {
               this.field_145915_a[lvt_3_1_] = ChatComponentProcessor.func_179985_a(lvt_2_1_, lvt_5_1_, (Entity)null);
            } catch (CommandException var7) {
               this.field_145915_a[lvt_3_1_] = lvt_5_1_;
            }
         } catch (JsonParseException var8) {
            this.field_145915_a[lvt_3_1_] = new ChatComponentText(lvt_4_1_);
         }
      }
   ...
   public Packet func_145844_m() {
      ...
      System.arraycopy(this.field_145915_a, 0, lvt_1_1_, 0, 4);
      return new S33PacketUpdateSign(this.field_145850_b, this.field_174879_c, lvt_1_1_);
   }
   ...
   public boolean func_174882_b(final EntityPlayer p_174882_1_) {
      ...
      for(int lvt_3_1_ = 0; lvt_3_1_ < this.field_145915_a.length; ++lvt_3_1_) {
         ChatStyle lvt_4_1_ = this.field_145915_a[lvt_3_1_] == null ? null : this.field_145915_a[lvt_3_1_].func_150256_b();
         if (lvt_4_1_ != null && lvt_4_1_.func_150235_h() != null) {
            ClickEvent lvt_5_1_ = lvt_4_1_.func_150235_h();
            if (lvt_5_1_.func_150669_a() == ClickEvent.Action.RUN_COMMAND) {
               MinecraftServer.func_71276_C().func_71187_D().func_71556_a(lvt_2_1_, lvt_5_1_.func_150668_b());
            }
         }
      }
