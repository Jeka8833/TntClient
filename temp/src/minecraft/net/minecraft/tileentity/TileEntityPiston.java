...
public class TileEntityPiston extends TileEntity implements ITickable {
   ...
   private void func_145863_a(float p_145863_1_, float p_145863_2_) {
      ...
      AxisAlignedBB lvt_3_1_ = Blocks.field_180384_M.func_176424_a(this.field_145850_b, this.field_174879_c, this.field_174932_a, p_145863_1_, this.field_174931_f);
      if (lvt_3_1_ != null) {
         List<Entity> lvt_4_1_ = this.field_145850_b.func_72839_b((Entity)null, lvt_3_1_);
         if (!lvt_4_1_.isEmpty()) {
            this.field_174933_k.addAll(lvt_4_1_);
            Iterator lvt_5_1_ = this.field_174933_k.iterator();
            ...
            while(true) {
               while(lvt_5_1_.hasNext()) {
                  ...
                  if (this.field_174932_a.func_177230_c() == Blocks.field_180399_cE && this.field_145875_k) {
                     ...
                     case X:
                        lvt_6_1_.field_70159_w = (double)this.field_174931_f.func_82601_c();
                        break;
                     case Y:
                        lvt_6_1_.field_70181_x = (double)this.field_174931_f.func_96559_d();
                        break;
                     case Z:
                        lvt_6_1_.field_70179_y = (double)this.field_174931_f.func_82599_e();
                     }
                  } else {
                     lvt_6_1_.func_70091_d((double)(p_145863_2_ * (float)this.field_174931_f.func_82601_c()), (double)(p_145863_2_ * (float)this.field_174931_f.func_96559_d()), (double)(p_145863_2_ * (float)this.field_174931_f.func_82599_e()));
                  }
               }
