...
public class BlockPos extends Vec3i {
   ...
   public static BlockPos func_177969_a(long p_177969_0_) {
      int lvt_2_1_ = (int)(p_177969_0_ << 64 - field_177988_g - field_177990_b >> 64 - field_177990_b);
      int lvt_3_1_ = (int)(p_177969_0_ << 64 - field_177987_f - field_177989_d >> 64 - field_177989_d);
      int lvt_4_1_ = (int)(p_177969_0_ << 64 - field_177991_c >> 64 - field_177991_c);
   ...
   public static Iterable<BlockPos> func_177980_a(BlockPos p_177980_0_, BlockPos p_177980_1_) {
      final BlockPos lvt_2_1_ = new BlockPos(Math.min(p_177980_0_.func_177958_n(), p_177980_1_.func_177958_n()), Math.min(p_177980_0_.func_177956_o(), p_177980_1_.func_177956_o()), Math.min(p_177980_0_.func_177952_p(), p_177980_1_.func_177952_p()));
      final BlockPos lvt_3_1_ = new BlockPos(Math.max(p_177980_0_.func_177958_n(), p_177980_1_.func_177958_n()), Math.max(p_177980_0_.func_177956_o(), p_177980_1_.func_177956_o()), Math.max(p_177980_0_.func_177952_p(), p_177980_1_.func_177952_p()));
            ...
            return new AbstractIterator<BlockPos>() {
               ...
               protected BlockPos computeNext() {
                  if (this.field_179309_b == null) {
                     this.field_179309_b = lvt_2_1_;
                     return this.field_179309_b;
                  } else if (this.field_179309_b.equals(lvt_3_1_)) {
                     return (BlockPos)this.endOfData();
                  } else {
                     int lvt_1_1_ = this.field_179309_b.func_177958_n();
                     int lvt_2_1_x = this.field_179309_b.func_177956_o();
                     int lvt_3_1_x = this.field_179309_b.func_177952_p();
                     if (lvt_1_1_ < lvt_3_1_.func_177958_n()) {
                        ++lvt_1_1_;
                     } else if (lvt_2_1_x < lvt_3_1_.func_177956_o()) {
                        lvt_1_1_ = lvt_2_1_.func_177958_n();
                        ++lvt_2_1_x;
                     } else if (lvt_3_1_x < lvt_3_1_.func_177952_p()) {
                        lvt_1_1_ = lvt_2_1_.func_177958_n();
                        lvt_2_1_x = lvt_2_1_.func_177956_o();
                        ++lvt_3_1_x;
                     }

                     this.field_179309_b = new BlockPos(lvt_1_1_, lvt_2_1_x, lvt_3_1_x);
                     return this.field_179309_b;
                  }
               }
            };
   ...
   public static Iterable<BlockPos.MutableBlockPos> func_177975_b(BlockPos p_177975_0_, BlockPos p_177975_1_) {
      final BlockPos lvt_2_1_ = new BlockPos(Math.min(p_177975_0_.func_177958_n(), p_177975_1_.func_177958_n()), Math.min(p_177975_0_.func_177956_o(), p_177975_1_.func_177956_o()), Math.min(p_177975_0_.func_177952_p(), p_177975_1_.func_177952_p()));
      final BlockPos lvt_3_1_ = new BlockPos(Math.max(p_177975_0_.func_177958_n(), p_177975_1_.func_177958_n()), Math.max(p_177975_0_.func_177956_o(), p_177975_1_.func_177956_o()), Math.max(p_177975_0_.func_177952_p(), p_177975_1_.func_177952_p()));
            ...
            return new AbstractIterator<BlockPos.MutableBlockPos>() {
               ...
               protected BlockPos.MutableBlockPos computeNext() {
                  if (this.field_179314_b == null) {
                     this.field_179314_b = new BlockPos.MutableBlockPos(lvt_2_1_.func_177958_n(), lvt_2_1_.func_177956_o(), lvt_2_1_.func_177952_p());
                     return this.field_179314_b;
                  } else if (this.field_179314_b.equals(lvt_3_1_)) {
                     return (BlockPos.MutableBlockPos)this.endOfData();
                  } else {
                     int lvt_1_1_ = this.field_179314_b.func_177958_n();
                     int lvt_2_1_x = this.field_179314_b.func_177956_o();
                     int lvt_3_1_x = this.field_179314_b.func_177952_p();
                     if (lvt_1_1_ < lvt_3_1_.func_177958_n()) {
                        ++lvt_1_1_;
                     } else if (lvt_2_1_x < lvt_3_1_.func_177956_o()) {
                        lvt_1_1_ = lvt_2_1_.func_177958_n();
                     ...
                     this.field_179314_b.field_177997_b = lvt_1_1_;
                     this.field_179314_b.field_177998_c = lvt_2_1_x;
                     this.field_179314_b.field_177996_d = lvt_3_1_x;
                     return this.field_179314_b;
                  }
               }
            };
