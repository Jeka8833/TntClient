...
public enum EnumChatFormatting {
   ...
   public static EnumChatFormatting func_175744_a(int p_175744_0_) {
      if (p_175744_0_ < 0) {
         ...
         for(int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_) {
            ...
            if (lvt_4_1_.func_175746_b() == p_175744_0_) {
               return lvt_4_1_;
            }
         }
   ...
   public static Collection<String> func_96296_a(boolean p_96296_0_, boolean p_96296_1_) {
      ...
      for(int lvt_5_1_ = 0; lvt_5_1_ < lvt_4_1_; ++lvt_5_1_) {
         ...
         if ((!lvt_6_1_.func_96302_c() || p_96296_0_) && (!lvt_6_1_.func_96301_b() || p_96296_1_)) {
            lvt_2_1_.add(lvt_6_1_.func_96297_d());
         }
      }
   ...
   static {
      ...
      for(int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_; ++lvt_2_1_) {
         ...
         field_96331_x.put(func_175745_c(lvt_3_1_.field_175748_y), lvt_3_1_);
      }
