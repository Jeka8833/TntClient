...
public class MathHelper {
   ...
   public static float func_76126_a(float p_76126_0_) {
      return fastMath ? SIN_TABLE_FAST[(int)(p_76126_0_ * radToIndex) & 4095] : field_76144_a[(int)(p_76126_0_ * 10430.378F) & '\uffff'];
   }

   public static float func_76134_b(float p_76134_0_) {
      return fastMath ? SIN_TABLE_FAST[(int)(p_76134_0_ * radToIndex + 1024.0F) & 4095] : field_76144_a[(int)(p_76134_0_ * 10430.378F + 16384.0F) & '\uffff'];
   }
   ...
   static {
      int j;
      for(j = 0; j < 65536; ++j) {
         field_76144_a[j] = (float)Math.sin((double)j * 3.141592653589793D * 2.0D / 65536.0D);
      }

      for(j = 0; j < SIN_TABLE_FAST.length; ++j) {
         SIN_TABLE_FAST[j] = MathUtils.roundToFloat(Math.sin((double)j * 3.141592653589793D * 2.0D / 4096.0D));
      }
