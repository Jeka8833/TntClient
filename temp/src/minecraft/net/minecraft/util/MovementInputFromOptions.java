...
public class MovementInputFromOptions extends MovementInput {
   ...
   public void func_78898_a() {
      ...
      if (this.field_78903_e.field_74314_A.func_151470_d()) {
         --this.field_78902_a;
      }

      this.field_78901_c = this.field_78903_e.field_74311_E.func_151470_d();
      this.field_78899_d = this.field_78903_e.field_151444_V.func_151470_d();
