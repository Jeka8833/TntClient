   ...
   public static class ArmoredMob implements Predicate<Entity> {
      ...
      public boolean apply(Entity p_apply_1_) {
         if (!p_apply_1_.func_70089_S()) {
            ...
            if (lvt_2_1_.func_71124_b(EntityLiving.func_82159_b(this.field_96567_c)) != null) {
               return false;
            } else if (lvt_2_1_ instanceof EntityLiving) {
               return ((EntityLiving)lvt_2_1_).func_98052_bS();
            } else if (lvt_2_1_ instanceof EntityArmorStand) {
               return true;
            } else {
