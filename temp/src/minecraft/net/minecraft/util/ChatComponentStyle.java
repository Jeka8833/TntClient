...
public abstract class ChatComponentStyle implements IChatComponent {
   ...
   public IChatComponent func_150255_a(ChatStyle p_150255_1_) {
      ...
      Iterator lvt_2_1_ = this.field_150264_a.iterator();
   ...
   public ChatStyle func_150256_b() {
      if (this.field_150263_b == null) {
         ...
         Iterator lvt_1_1_ = this.field_150264_a.iterator();

         while(lvt_1_1_.hasNext()) {
            IChatComponent lvt_2_1_ = (IChatComponent)lvt_1_1_.next();
            lvt_2_1_.func_150256_b().func_150221_a(this.field_150263_b);
         }
      }
   ...
   public final String func_150254_d() {
      ...
      while(lvt_2_1_.hasNext()) {
         IChatComponent lvt_3_1_ = (IChatComponent)lvt_2_1_.next();
         lvt_1_1_.append(lvt_3_1_.func_150256_b().func_150218_j());
         lvt_1_1_.append(lvt_3_1_.func_150261_e());
   ...
   public static Iterator<IChatComponent> func_150262_a(Iterable<IChatComponent> p_150262_0_) {
      Iterator<IChatComponent> lvt_1_1_ = Iterators.concat(Iterators.transform(p_150262_0_.iterator(), new Function<IChatComponent, Iterator<IChatComponent>>() {
      ...
      lvt_1_1_ = Iterators.transform(lvt_1_1_, new Function<IChatComponent, IChatComponent>() {
         public IChatComponent apply(IChatComponent p_apply_1_) {
            IChatComponent lvt_2_1_ = p_apply_1_.func_150259_f();
            lvt_2_1_.func_150255_a(lvt_2_1_.func_150256_b().func_150206_m());
            return lvt_2_1_;
         }
      });
      return lvt_1_1_;
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         return this.field_150264_a.equals(lvt_2_1_.field_150264_a) && this.func_150256_b().equals(lvt_2_1_.func_150256_b());
      }
   }
