...
public class Vec3i implements Comparable<Vec3i> {
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         if (this.func_177958_n() != lvt_2_1_.func_177958_n()) {
            return false;
         } else if (this.func_177956_o() != lvt_2_1_.func_177956_o()) {
            return false;
         } else {
            return this.func_177952_p() == lvt_2_1_.func_177952_p();
         }
      }
   }
   ...
   public double func_177954_c(double p_177954_1_, double p_177954_3_, double p_177954_5_) {
      double lvt_7_1_ = (double)this.func_177958_n() - p_177954_1_;
      double lvt_9_1_ = (double)this.func_177956_o() - p_177954_3_;
      double lvt_11_1_ = (double)this.func_177952_p() - p_177954_5_;
   ...
   public double func_177957_d(double p_177957_1_, double p_177957_3_, double p_177957_5_) {
      double lvt_7_1_ = (double)this.func_177958_n() + 0.5D - p_177957_1_;
      double lvt_9_1_ = (double)this.func_177956_o() + 0.5D - p_177957_3_;
      double lvt_11_1_ = (double)this.func_177952_p() + 0.5D - p_177957_5_;
      return lvt_7_1_ * lvt_7_1_ + lvt_9_1_ * lvt_9_1_ + lvt_11_1_ * lvt_11_1_;
   }
   ...
   public String toString() {
      return Objects.toStringHelper((Object)this).add("x", this.func_177958_n()).add("y", this.func_177956_o()).add("z", this.func_177952_p()).toString();
   }
}
