...
public class Vec4b {
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         Vec4b lvt_2_1_ = (Vec4b)p_equals_1_;
         if (this.field_176117_a != lvt_2_1_.field_176117_a) {
            return false;
         } else if (this.field_176114_d != lvt_2_1_.field_176114_d) {
            return false;
         } else if (this.field_176115_b != lvt_2_1_.field_176115_b) {
            return false;
         } else {
            return this.field_176116_c == lvt_2_1_.field_176116_c;
         }
      }
   }

   public int hashCode() {
      int lvt_1_1_ = this.field_176117_a;
      int lvt_1_1_ = 31 * lvt_1_1_ + this.field_176115_b;
      lvt_1_1_ = 31 * lvt_1_1_ + this.field_176116_c;
      lvt_1_1_ = 31 * lvt_1_1_ + this.field_176114_d;
      return lvt_1_1_;
   }
}
