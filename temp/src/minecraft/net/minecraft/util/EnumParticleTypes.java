...
public enum EnumParticleTypes {
   ...
   static {
      ...
      EnumParticleTypes[] lvt_1_1_ = values();
      int lvt_2_1_ = lvt_1_1_.length;

      for(int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_) {
         EnumParticleTypes lvt_4_1_ = lvt_1_1_[lvt_3_1_];
         field_179365_U.put(lvt_4_1_.func_179348_c(), lvt_4_1_);
         if (!lvt_4_1_.func_179346_b().endsWith("_")) {
            lvt_0_1_.add(lvt_4_1_.func_179346_b());
         }
      }

      field_179368_V = (String[])lvt_0_1_.toArray(new String[lvt_0_1_.size()]);
   }
}
