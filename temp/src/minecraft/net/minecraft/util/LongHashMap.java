...
public class LongHashMap<V> {
   ...
   public V func_76164_a(long p_76164_1_) {
      ...
      for(LongHashMap.Entry entry = this.field_76169_a[func_76158_a(i, this.field_180201_c)]; entry != null; entry = entry.field_76149_c) {
   ...
   public void func_76163_a(long p_76163_1_, V p_76163_3_) {
      ...
      for(LongHashMap.Entry entry = this.field_76169_a[j]; entry != null; entry = entry.field_76149_c) {
   ...
   private void func_76153_b(int p_76153_1_) {
      ...
      if (i == 1073741824) {
         ...
         this.getClass();
         this.field_76168_c = (int)(var10001 * 0.75F);
      }
   ...
   public double getKeyDistribution() {
      ...
      for(int i = 0; i < this.field_76169_a.length; ++i) {
         if (this.field_76169_a[i] != null) {
            ++countValid;
         }
      }

      return 1.0D * (double)countValid / (double)this.field_76167_b;
   }
