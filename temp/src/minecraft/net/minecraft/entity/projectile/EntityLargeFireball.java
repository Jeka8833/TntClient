...
public class EntityLargeFireball extends EntityFireball {
   ...
   protected void func_70227_a(MovingObjectPosition p_70227_1_) {
      if (!this.field_70170_p.field_72995_K) {
         ...
         boolean lvt_2_1_ = this.field_70170_p.func_82736_K().func_82766_b("mobGriefing");
         this.field_70170_p.func_72885_a((Entity)null, this.field_70165_t, this.field_70163_u, this.field_70161_v, (float)this.field_92057_e, lvt_2_1_, lvt_2_1_);
         this.func_70106_y();
      }
