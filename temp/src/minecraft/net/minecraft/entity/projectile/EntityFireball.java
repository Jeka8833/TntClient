...
public abstract class EntityFireball extends Entity {
   ...
   public EntityFireball(World p_i1760_1_, double p_i1760_2_, double p_i1760_4_, double p_i1760_6_, double p_i1760_8_, double p_i1760_10_, double p_i1760_12_) {
      ...
      double lvt_14_1_ = (double)MathHelper.func_76133_a(p_i1760_8_ * p_i1760_8_ + p_i1760_10_ * p_i1760_10_ + p_i1760_12_ * p_i1760_12_);
      this.field_70232_b = p_i1760_8_ / lvt_14_1_ * 0.1D;
      this.field_70233_c = p_i1760_10_ / lvt_14_1_ * 0.1D;
      this.field_70230_d = p_i1760_12_ / lvt_14_1_ * 0.1D;
   }
   ...
   public EntityFireball(World p_i1761_1_, EntityLivingBase p_i1761_2_, double p_i1761_3_, double p_i1761_5_, double p_i1761_7_) {
      ...
      double lvt_9_1_ = (double)MathHelper.func_76133_a(p_i1761_3_ * p_i1761_3_ + p_i1761_5_ * p_i1761_5_ + p_i1761_7_ * p_i1761_7_);
      this.field_70232_b = p_i1761_3_ / lvt_9_1_ * 0.1D;
      this.field_70233_c = p_i1761_5_ / lvt_9_1_ * 0.1D;
      this.field_70230_d = p_i1761_7_ / lvt_9_1_ * 0.1D;
   }
   ...
   public void func_70071_h_() {
      if (this.field_70170_p.field_72995_K || (this.field_70235_a == null || !this.field_70235_a.field_70128_L) && this.field_70170_p.func_175667_e(new BlockPos(this))) {
         ...
         for(int lvt_8_1_ = 0; lvt_8_1_ < lvt_5_1_.size(); ++lvt_8_1_) {
            ...
            if (lvt_9_1_.func_70067_L() && (!lvt_9_1_.func_70028_i(this.field_70235_a) || this.field_70234_an >= 25)) {
               ...
               MovingObjectPosition lvt_12_1_ = lvt_11_1_.func_72327_a(lvt_1_1_, lvt_2_1_);
               if (lvt_12_1_ != null) {
                  double lvt_13_1_ = lvt_1_1_.func_72436_e(lvt_12_1_.field_72307_f);
         ...
         for(this.field_70125_A = (float)(MathHelper.func_181159_b((double)lvt_8_2_, this.field_70181_x) * 180.0D / 3.1415927410125732D) - 90.0F; this.field_70125_A - this.field_70127_C < -180.0F; this.field_70127_C -= 360.0F) {
         }
         ...
         float lvt_9_2_ = this.func_82341_c();
         if (this.func_70090_H()) {
            for(int lvt_10_2_ = 0; lvt_10_2_ < 4; ++lvt_10_2_) {
               float lvt_11_2_ = 0.25F;
               this.field_70170_p.func_175688_a(EnumParticleTypes.WATER_BUBBLE, this.field_70165_t - this.field_70159_w * (double)lvt_11_2_, this.field_70163_u - this.field_70181_x * (double)lvt_11_2_, this.field_70161_v - this.field_70179_y * (double)lvt_11_2_, this.field_70159_w, this.field_70181_x, this.field_70179_y);
            }
   ...
   public void func_70014_b(NBTTagCompound p_70014_1_) {
      ...
      ResourceLocation lvt_2_1_ = (ResourceLocation)Block.field_149771_c.func_177774_c(this.field_145796_h);
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      if (p_70037_1_.func_150297_b("direction", 9)) {
         NBTTagList lvt_2_1_ = p_70037_1_.func_150295_c("direction", 6);
         this.field_70159_w = lvt_2_1_.func_150309_d(0);
         this.field_70181_x = lvt_2_1_.func_150309_d(1);
         this.field_70179_y = lvt_2_1_.func_150309_d(2);
      } else {
         this.func_70106_y();
      }
   ...
   public boolean func_70097_a(DamageSource p_70097_1_, float p_70097_2_) {
      if (this.func_180431_b(p_70097_1_)) {
         ...
         if (p_70097_1_.func_76346_g() != null) {
            Vec3 lvt_3_1_ = p_70097_1_.func_76346_g().func_70040_Z();
            if (lvt_3_1_ != null) {
               this.field_70159_w = lvt_3_1_.field_72450_a;
               this.field_70181_x = lvt_3_1_.field_72448_b;
               this.field_70179_y = lvt_3_1_.field_72449_c;
