   ...
   protected void func_70227_a(MovingObjectPosition p_70227_1_) {
      if (!this.field_70170_p.field_72995_K) {
         ...
         if (p_70227_1_.field_72308_g != null) {
            lvt_2_2_ = p_70227_1_.field_72308_g.func_70097_a(DamageSource.func_76362_a(this, this.field_70235_a), 5.0F);
            if (lvt_2_2_) {
            ...
            if (this.field_70235_a != null && this.field_70235_a instanceof EntityLiving) {
               lvt_2_2_ = this.field_70170_p.func_82736_K().func_82766_b("mobGriefing");
            }

            if (lvt_2_2_) {
               BlockPos lvt_3_1_ = p_70227_1_.func_178782_a().func_177972_a(p_70227_1_.field_178784_b);
               if (this.field_70170_p.func_175623_d(lvt_3_1_)) {
                  this.field_70170_p.func_175656_a(lvt_3_1_, Blocks.field_150480_ab.func_176223_P());
               }
            }
         }
