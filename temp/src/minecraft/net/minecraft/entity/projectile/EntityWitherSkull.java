...
public class EntityWitherSkull extends EntityFireball {
   ...
   public float func_180428_a(Explosion p_180428_1_, World p_180428_2_, BlockPos p_180428_3_, IBlockState p_180428_4_) {
      float lvt_5_1_ = super.func_180428_a(p_180428_1_, p_180428_2_, p_180428_3_, p_180428_4_);
      Block lvt_6_1_ = p_180428_4_.func_177230_c();
      if (this.func_82342_d() && EntityWither.func_181033_a(lvt_6_1_)) {
      ...
      if (!this.field_70170_p.field_72995_K) {
         if (p_70227_1_.field_72308_g != null) {
            ...
            if (p_70227_1_.field_72308_g instanceof EntityLivingBase) {
               ...
               if (lvt_2_1_ > 0) {
                  ((EntityLivingBase)p_70227_1_.field_72308_g).func_70690_d(new PotionEffect(Potion.field_82731_v.field_76415_H, 20 * lvt_2_1_, 1));
               }
            }
         }
