...
public abstract class EntityAgeable extends EntityCreature {
   ...
   public boolean func_70085_c(EntityPlayer p_70085_1_) {
      ...
      if (lvt_2_1_ != null && lvt_2_1_.func_77973_b() == Items.field_151063_bx) {
         if (!this.field_70170_p.field_72995_K) {
            Class<? extends Entity> lvt_3_1_ = EntityList.func_90035_a(lvt_2_1_.func_77960_j());
            if (lvt_3_1_ != null && this.getClass() == lvt_3_1_) {
               EntityAgeable lvt_4_1_ = this.func_90011_a(this);
               if (lvt_4_1_ != null) {
                  lvt_4_1_.func_70873_a(-24000);
                  lvt_4_1_.func_70012_b(this.field_70165_t, this.field_70163_u, this.field_70161_v, 0.0F, 0.0F);
                  this.field_70170_p.func_72838_d(lvt_4_1_);
                  if (lvt_2_1_.func_82837_s()) {
                     lvt_4_1_.func_96094_a(lvt_2_1_.func_82833_r());
                  }
   ...
   public void func_175501_a(int p_175501_1_, boolean p_175501_2_) {
      int lvt_3_1_ = this.func_70874_b();
   ...
   public void func_70873_a(int p_70873_1_) {
      this.field_70180_af.func_75692_b(12, (byte)MathHelper.func_76125_a(p_70873_1_, -1, 1));
   ...
   public void func_70636_d() {
      ...
      if (this.field_70170_p.field_72995_K) {
         ...
         int lvt_1_1_ = this.func_70874_b();
         if (lvt_1_1_ < 0) {
            ++lvt_1_1_;
            this.func_70873_a(lvt_1_1_);
            if (lvt_1_1_ == 0) {
               this.func_175500_n();
            }
         } else if (lvt_1_1_ > 0) {
   ...
   protected final void func_70105_a(float p_70105_1_, float p_70105_2_) {
      boolean lvt_3_1_ = this.field_98056_d > 0.0F;
