...
public class EntityLookHelper {
   ...
   public void func_75649_a() {
      ...
      if (this.field_75655_d) {
         ...
         double lvt_1_1_ = this.field_75656_e - this.field_75659_a.field_70165_t;
         double lvt_3_1_ = this.field_75653_f - (this.field_75659_a.field_70163_u + (double)this.field_75659_a.func_70047_e());
         double lvt_5_1_ = this.field_75654_g - this.field_75659_a.field_70161_v;
         double lvt_7_1_ = (double)MathHelper.func_76133_a(lvt_1_1_ * lvt_1_1_ + lvt_5_1_ * lvt_5_1_);
         float lvt_9_1_ = (float)(MathHelper.func_181159_b(lvt_5_1_, lvt_1_1_) * 180.0D / 3.1415927410125732D) - 90.0F;
         float lvt_10_1_ = (float)(-(MathHelper.func_181159_b(lvt_3_1_, lvt_7_1_) * 180.0D / 3.1415927410125732D));
         this.field_75659_a.field_70125_A = this.func_75652_a(this.field_75659_a.field_70125_A, lvt_10_1_, this.field_75658_c);
         this.field_75659_a.field_70759_as = this.func_75652_a(this.field_75659_a.field_70759_as, lvt_9_1_, this.field_75657_b);
      } else {
      ...
      float lvt_1_2_ = MathHelper.func_76142_g(this.field_75659_a.field_70759_as - this.field_75659_a.field_70761_aq);
   ...
   private float func_75652_a(float p_75652_1_, float p_75652_2_, float p_75652_3_) {
      float lvt_4_1_ = MathHelper.func_76142_g(p_75652_2_ - p_75652_1_);
