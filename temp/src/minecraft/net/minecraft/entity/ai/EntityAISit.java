...
public class EntityAISit extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      if (!this.field_75272_a.func_70909_n()) {
         ...
         EntityLivingBase lvt_1_1_ = this.field_75272_a.func_70902_q();
         if (lvt_1_1_ == null) {
            return true;
         } else {
            return this.field_75272_a.func_70068_e(lvt_1_1_) < 144.0D && lvt_1_1_.func_70643_av() != null ? false : this.field_75271_b;
         }
      }
   }
