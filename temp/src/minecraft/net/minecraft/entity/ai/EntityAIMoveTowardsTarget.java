...
public class EntityAIMoveTowardsTarget extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      ...
      if (this.field_75429_b == null) {
         ...
         Vec3 lvt_1_1_ = RandomPositionGenerator.func_75464_a(this.field_75431_a, 16, 7, new Vec3(this.field_75429_b.field_70165_t, this.field_75429_b.field_70163_u, this.field_75429_b.field_70161_v));
         if (lvt_1_1_ == null) {
            return false;
         } else {
            this.field_75430_c = lvt_1_1_.field_72450_a;
            this.field_75427_d = lvt_1_1_.field_72448_b;
            this.field_75428_e = lvt_1_1_.field_72449_c;
            return true;
         }
      }
   }
