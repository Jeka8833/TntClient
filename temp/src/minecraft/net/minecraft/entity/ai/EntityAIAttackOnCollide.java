...
public class EntityAIAttackOnCollide extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      EntityLivingBase lvt_1_1_ = this.field_75441_b.func_70638_az();
      if (lvt_1_1_ == null) {
         return false;
      } else if (!lvt_1_1_.func_70089_S()) {
         return false;
      } else if (this.field_75444_h != null && !this.field_75444_h.isAssignableFrom(lvt_1_1_.getClass())) {
         return false;
      } else {
         this.field_75438_g = this.field_75441_b.func_70661_as().func_75494_a(lvt_1_1_);
   ...
   public boolean func_75253_b() {
      ...
      if (lvt_1_1_ == null) {
         ...
         return this.field_75441_b.func_180485_d(new BlockPos(lvt_1_1_));
      }
   }
   ...
   public void func_75246_d() {
      EntityLivingBase lvt_1_1_ = this.field_75441_b.func_70638_az();
      this.field_75441_b.func_70671_ap().func_75651_a(lvt_1_1_, 30.0F, 30.0F);
      double lvt_2_1_ = this.field_75441_b.func_70092_e(lvt_1_1_.field_70165_t, lvt_1_1_.func_174813_aQ().field_72338_b, lvt_1_1_.field_70161_v);
      double lvt_4_1_ = this.func_179512_a(lvt_1_1_);
      --this.field_75445_i;
      if ((this.field_75437_f || this.field_75441_b.func_70635_at().func_75522_a(lvt_1_1_)) && this.field_75445_i <= 0 && (this.field_151497_i == 0.0D && this.field_151495_j == 0.0D && this.field_151496_k == 0.0D || lvt_1_1_.func_70092_e(this.field_151497_i, this.field_151495_j, this.field_151496_k) >= 1.0D || this.field_75441_b.func_70681_au().nextFloat() < 0.05F)) {
         this.field_151497_i = lvt_1_1_.field_70165_t;
         this.field_151495_j = lvt_1_1_.func_174813_aQ().field_72338_b;
         this.field_151496_k = lvt_1_1_.field_70161_v;
         ...
         if (!this.field_75441_b.func_70661_as().func_75497_a(lvt_1_1_, this.field_75440_e)) {
            this.field_75445_i += 15;
         }
      }

      this.field_75439_d = Math.max(this.field_75439_d - 1, 0);
      if (lvt_2_1_ <= lvt_4_1_ && this.field_75439_d <= 0) {
         this.field_75439_d = 20;
         if (this.field_75441_b.func_70694_bm() != null) {
            this.field_75441_b.func_71038_i();
         }

         this.field_75441_b.func_70652_k(lvt_1_1_);
      }
