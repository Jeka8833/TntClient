...
public class EntityAIVillagerMate extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      if (this.field_75450_b.func_70874_b() != 0) {
         ...
         if (this.field_75452_a == null) {
            ...
            Entity lvt_1_1_ = this.field_75448_d.func_72857_a(EntityVillager.class, this.field_75450_b.func_174813_aQ().func_72314_b(8.0D, 3.0D, 8.0D), this.field_75450_b);
            if (lvt_1_1_ == null) {
               return false;
            } else {
               this.field_75451_c = (EntityVillager)lvt_1_1_;
   ...
   private boolean func_75446_f() {
      if (!this.field_75452_a.func_82686_i()) {
         ...
         int lvt_1_1_ = (int)((double)((float)this.field_75452_a.func_75567_c()) * 0.35D);
         return this.field_75452_a.func_75562_e() < lvt_1_1_;
      }
   }

   private void func_75447_i() {
      EntityVillager lvt_1_1_ = this.field_75450_b.func_90011_a(this.field_75451_c);
      ...
      lvt_1_1_.func_70012_b(this.field_75450_b.field_70165_t, this.field_75450_b.field_70163_u, this.field_75450_b.field_70161_v, 0.0F, 0.0F);
      this.field_75448_d.func_72838_d(lvt_1_1_);
      this.field_75448_d.func_72960_a(lvt_1_1_, (byte)12);
   }
}
