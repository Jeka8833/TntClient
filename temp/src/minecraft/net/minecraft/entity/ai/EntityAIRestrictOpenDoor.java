...
public class EntityAIRestrictOpenDoor extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      if (this.field_75275_a.field_70170_p.func_72935_r()) {
         ...
         BlockPos lvt_1_1_ = new BlockPos(this.field_75275_a);
         Village lvt_2_1_ = this.field_75275_a.field_70170_p.func_175714_ae().func_176056_a(lvt_1_1_, 16);
         if (lvt_2_1_ == null) {
            return false;
         } else {
            this.field_75274_b = lvt_2_1_.func_179865_b(lvt_1_1_);
            if (this.field_75274_b == null) {
               return false;
            } else {
               return (double)this.field_75274_b.func_179846_b(lvt_1_1_) < 2.25D;
            }
         }
      }
   }
