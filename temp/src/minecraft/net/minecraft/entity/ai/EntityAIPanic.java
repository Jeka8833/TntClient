...
public class EntityAIPanic extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      if (this.field_75267_a.func_70643_av() == null && !this.field_75267_a.func_70027_ad()) {
         ...
         Vec3 lvt_1_1_ = RandomPositionGenerator.func_75463_a(this.field_75267_a, 5, 4);
         if (lvt_1_1_ == null) {
            return false;
         } else {
            this.field_75266_c = lvt_1_1_.field_72450_a;
            this.field_75263_d = lvt_1_1_.field_72448_b;
            this.field_75264_e = lvt_1_1_.field_72449_c;
            return true;
         }
      }
   }
