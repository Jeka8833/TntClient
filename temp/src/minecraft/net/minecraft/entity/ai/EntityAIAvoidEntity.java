...
public class EntityAIAvoidEntity<T extends Entity> extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      List<T> lvt_1_1_ = this.field_75380_a.field_70170_p.func_175647_a(this.field_181064_i, this.field_75380_a.func_174813_aQ().func_72314_b((double)this.field_179508_f, 3.0D, (double)this.field_179508_f), Predicates.and(EntitySelectors.field_180132_d, this.field_179509_a, this.field_179510_i));
      if (lvt_1_1_.isEmpty()) {
         return false;
      } else {
         ...
         if (lvt_2_1_ == null) {
            return false;
         } else if (this.field_75376_d.func_70092_e(lvt_2_1_.field_72450_a, lvt_2_1_.field_72448_b, lvt_2_1_.field_72449_c) < this.field_75376_d.func_70068_e(this.field_75380_a)) {
            return false;
         } else {
            this.field_75374_f = this.field_75375_g.func_75488_a(lvt_2_1_.field_72450_a, lvt_2_1_.field_72448_b, lvt_2_1_.field_72449_c);
            if (this.field_75374_f == null) {
               return false;
            } else {
               return this.field_75374_f.func_75880_b(lvt_2_1_);
            }
         }
      }
   }
