...
public class EntityAIBeg extends EntityAIBase {
   ...
   private boolean func_75382_a(EntityPlayer p_75382_1_) {
      ItemStack lvt_2_1_ = p_75382_1_.field_71071_by.func_70448_g();
      if (lvt_2_1_ == null) {
         return false;
      } else {
         return !this.field_75387_a.func_70909_n() && lvt_2_1_.func_77973_b() == Items.field_151103_aS ? true : this.field_75387_a.func_70877_b(lvt_2_1_);
      }
   }
}
