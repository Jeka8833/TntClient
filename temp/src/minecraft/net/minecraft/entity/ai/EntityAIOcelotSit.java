...
public class EntityAIOcelotSit extends EntityAIMoveToBlock {
   ...
   protected boolean func_179488_a(World p_179488_1_, BlockPos p_179488_2_) {
      if (!p_179488_1_.func_175623_d(p_179488_2_.func_177984_a())) {
         ...
         IBlockState lvt_3_1_ = p_179488_1_.func_180495_p(p_179488_2_);
         Block lvt_4_1_ = lvt_3_1_.func_177230_c();
         if (lvt_4_1_ == Blocks.field_150486_ae) {
            TileEntity lvt_5_1_ = p_179488_1_.func_175625_s(p_179488_2_);
            if (lvt_5_1_ instanceof TileEntityChest && ((TileEntityChest)lvt_5_1_).field_145987_o < 1) {
               return true;
            }
         } else {
            if (lvt_4_1_ == Blocks.field_150470_am) {
               return true;
            }

            if (lvt_4_1_ == Blocks.field_150324_C && lvt_3_1_.func_177229_b(BlockBed.field_176472_a) != BlockBed.EnumPartType.HEAD) {
               return true;
            }
         }
