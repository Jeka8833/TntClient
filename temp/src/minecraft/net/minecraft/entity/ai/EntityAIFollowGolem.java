...
public class EntityAIFollowGolem extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      if (this.field_75294_a.func_70874_b() >= 0) {
         ...
         List<EntityIronGolem> lvt_1_1_ = this.field_75294_a.field_70170_p.func_72872_a(EntityIronGolem.class, this.field_75294_a.func_174813_aQ().func_72314_b(6.0D, 2.0D, 6.0D));
         if (lvt_1_1_.isEmpty()) {
            return false;
         } else {
            ...
            while(lvt_2_1_.hasNext()) {
               EntityIronGolem lvt_3_1_ = (EntityIronGolem)lvt_2_1_.next();
               if (lvt_3_1_.func_70853_p() > 0) {
                  this.field_75292_b = lvt_3_1_;
                  break;
               }
            }
