...
public class EntityAIDefendVillage extends EntityAITarget {
   ...
   public boolean func_75250_a() {
      Village lvt_1_1_ = this.field_75305_a.func_70852_n();
      if (lvt_1_1_ == null) {
         return false;
      } else {
         this.field_75304_b = lvt_1_1_.func_75571_b(this.field_75305_a);
         if (this.field_75304_b instanceof EntityCreeper) {
            ...
            if (this.field_75299_d.func_70681_au().nextInt(20) == 0) {
               this.field_75304_b = lvt_1_1_.func_82685_c(this.field_75305_a);
