...
public class AttributeModifier {
   ...
   public AttributeModifier(UUID p_i1606_1_, String p_i1606_2_, double p_i1606_3_, int p_i1606_5_) {
      ...
      Validate.notEmpty((CharSequence)p_i1606_2_, "Modifier name cannot be empty");
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         if (this.field_111170_d != null) {
            if (!this.field_111170_d.equals(lvt_2_1_.field_111170_d)) {
               return false;
            }
         } else if (lvt_2_1_.field_111170_d != null) {
            return false;
         }
