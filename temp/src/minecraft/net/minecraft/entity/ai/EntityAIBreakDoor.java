...
public class EntityAIBreakDoor extends EntityAIDoorInteract {
   ...
   public boolean func_75253_b() {
      double lvt_1_1_ = this.field_75356_a.func_174818_b(this.field_179507_b);
      boolean var3;
      if (this.field_75359_i <= 240) {
         BlockDoor var10000 = this.field_151504_e;
         if (!BlockDoor.func_176514_f(this.field_75356_a.field_70170_p, this.field_179507_b) && lvt_1_1_ < 4.0D) {
            var3 = true;
            return var3;
         }
      }
   ...
   public void func_75246_d() {
      ...
      ++this.field_75359_i;
      int lvt_1_1_ = (int)((float)this.field_75359_i / 240.0F * 10.0F);
      if (lvt_1_1_ != this.field_75358_j) {
         this.field_75356_a.field_70170_p.func_175715_c(this.field_75356_a.func_145782_y(), this.field_179507_b, lvt_1_1_);
         this.field_75358_j = lvt_1_1_;
      }
