...
public abstract class EntityCreature extends EntityLiving {
   ...
   protected void func_110159_bB() {
      ...
      if (this.func_110167_bD() && this.func_110166_bE() != null && this.func_110166_bE().field_70170_p == this.field_70170_p) {
         ...
         this.func_175449_a(new BlockPos((int)lvt_1_1_.field_70165_t, (int)lvt_1_1_.field_70163_u, (int)lvt_1_1_.field_70161_v), 5);
         ...
         if (lvt_2_1_ > 4.0F) {
            this.func_70661_as().func_75497_a(lvt_1_1_, 1.0D);
         }

         if (lvt_2_1_ > 6.0F) {
            double lvt_3_1_ = (lvt_1_1_.field_70165_t - this.field_70165_t) / (double)lvt_2_1_;
            double lvt_5_1_ = (lvt_1_1_.field_70163_u - this.field_70163_u) / (double)lvt_2_1_;
            double lvt_7_1_ = (lvt_1_1_.field_70161_v - this.field_70161_v) / (double)lvt_2_1_;
            this.field_70159_w += lvt_3_1_ * Math.abs(lvt_3_1_) * 0.4D;
            this.field_70181_x += lvt_5_1_ * Math.abs(lvt_5_1_) * 0.4D;
            this.field_70179_y += lvt_7_1_ * Math.abs(lvt_7_1_) * 0.4D;
         }
