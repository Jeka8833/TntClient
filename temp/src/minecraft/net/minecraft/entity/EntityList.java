...
public class EntityList {
   ...
   private static void func_75618_a(Class<? extends Entity> p_75618_0_, String p_75618_1_, int p_75618_2_) {
      if (field_75625_b.containsKey(p_75618_1_)) {
      ...
      } else if (field_75623_d.containsKey(p_75618_2_)) {
         ...
         field_75623_d.put(p_75618_2_, p_75618_0_);
         field_75624_e.put(p_75618_0_, p_75618_2_);
         field_180126_g.put(p_75618_1_, p_75618_2_);
      }
   }
   ...
   private static void func_75614_a(Class<? extends Entity> p_75614_0_, String p_75614_1_, int p_75614_2_, int p_75614_3_, int p_75614_4_) {
      ...
      field_75627_a.put(p_75614_2_, new EntityList.EntityEggInfo(p_75614_2_, p_75614_3_, p_75614_4_));
   }
   ...
   public static Entity func_75620_a(String p_75620_0_, World p_75620_1_) {
      ...
      try {
         Class<? extends Entity> lvt_3_1_ = (Class)field_75625_b.get(p_75620_0_);
         if (lvt_3_1_ != null) {
            lvt_2_1_ = (Entity)lvt_3_1_.getConstructor(World.class).newInstance(p_75620_1_);
         }
   ...
   public static Entity func_75615_a(NBTTagCompound p_75615_0_, World p_75615_1_) {
      ...
      try {
         Class<? extends Entity> lvt_3_1_ = (Class)field_75625_b.get(p_75615_0_.func_74779_i("id"));
         if (lvt_3_1_ != null) {
            lvt_2_1_ = (Entity)lvt_3_1_.getConstructor(World.class).newInstance(p_75615_1_);
         }
      } catch (Exception var4) {
         var4.printStackTrace();
      }
      ...
      if (lvt_2_1_ != null) {
         lvt_2_1_.func_70020_e(p_75615_0_);
      } else {
   ...
   public static Entity func_75616_a(int p_75616_0_, World p_75616_1_) {
      ...
      try {
         Class<? extends Entity> lvt_3_1_ = func_90035_a(p_75616_0_);
         if (lvt_3_1_ != null) {
            lvt_2_1_ = (Entity)lvt_3_1_.getConstructor(World.class).newInstance(p_75616_1_);
         }
      } catch (Exception var4) {
         var4.printStackTrace();
      }
   ...
   public static int func_75619_a(Entity p_75619_0_) {
      Integer lvt_1_1_ = (Integer)field_75624_e.get(p_75619_0_.getClass());
      return lvt_1_1_ == null ? 0 : lvt_1_1_;
   }

   public static Class<? extends Entity> func_90035_a(int p_90035_0_) {
      return (Class)field_75623_d.get(p_90035_0_);
   }
   ...
   public static int func_180122_a(String p_180122_0_) {
      Integer lvt_1_1_ = (Integer)field_180126_g.get(p_180122_0_);
      return lvt_1_1_ == null ? 90 : lvt_1_1_;
   }
   ...
   public static List<String> func_180124_b() {
      Set<String> lvt_0_1_ = field_75625_b.keySet();
      List<String> lvt_1_1_ = Lists.newArrayList();
      Iterator lvt_2_1_ = lvt_0_1_.iterator();

      while(lvt_2_1_.hasNext()) {
         String lvt_3_1_ = (String)lvt_2_1_.next();
         Class<? extends Entity> lvt_4_1_ = (Class)field_75625_b.get(lvt_3_1_);
         if ((lvt_4_1_.getModifiers() & 1024) != 1024) {
            lvt_1_1_.add(lvt_3_1_);
         }
      }

      lvt_1_1_.add("LightningBolt");
      return lvt_1_1_;
   }

   public static boolean func_180123_a(Entity p_180123_0_, String p_180123_1_) {
      String lvt_2_1_ = func_75621_b(p_180123_0_);
      if (lvt_2_1_ == null && p_180123_0_ instanceof EntityPlayer) {
         lvt_2_1_ = "Player";
      } else if (lvt_2_1_ == null && p_180123_0_ instanceof EntityLightningBolt) {
         lvt_2_1_ = "LightningBolt";
      }

      return p_180123_1_.equals(lvt_2_1_);
   }
