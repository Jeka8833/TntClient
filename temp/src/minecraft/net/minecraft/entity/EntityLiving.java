...
public abstract class EntityLiving extends EntityLivingBase {
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      if (p_70037_1_.func_150297_b("Equipment", 9)) {
         nbttaglist1 = p_70037_1_.func_150295_c("Equipment", 10);

         for(j = 0; j < this.field_82182_bS.length; ++j) {
            this.field_82182_bS[j] = ItemStack.func_77949_a(nbttaglist1.func_150305_b(j));
         }
      }

      if (p_70037_1_.func_150297_b("DropChances", 9)) {
         nbttaglist1 = p_70037_1_.func_150295_c("DropChances", 5);

         for(j = 0; j < nbttaglist1.func_74745_c(); ++j) {
   ...
   public void func_70636_d() {
      ...
      if (!this.field_70170_p.field_72995_K && this.func_98052_bS() && !this.field_70729_aU && this.field_70170_p.func_82736_K().func_82766_b("mobGriefing")) {
         Iterator i$ = this.field_70170_p.func_72872_a(EntityItem.class, this.func_174813_aQ().func_72314_b(1.0D, 0.0D, 1.0D)).iterator();

         while(i$.hasNext()) {
            EntityItem entityitem = (EntityItem)i$.next();
   ...
   protected void func_70623_bb() {
      ...
      } else if ((this.field_70708_bq & 31) == 31 && (result = Reflector.call(Reflector.ForgeEventFactory_canEntityDespawn, this)) != Result_DEFAULT) {
   ...
   private void func_110165_bF() {
      if (this.field_110169_bv && this.field_110170_bx != null) {
         if (this.field_110170_bx.func_150297_b("UUIDMost", 4) && this.field_110170_bx.func_150297_b("UUIDLeast", 4)) {
            ...
            Iterator i$ = this.field_70170_p.func_72872_a(EntityLivingBase.class, this.func_174813_aQ().func_72314_b(10.0D, 10.0D, 10.0D)).iterator();

            while(i$.hasNext()) {
               EntityLivingBase entitylivingbase = (EntityLivingBase)i$.next();
   ...
   public void func_94061_f(boolean p_94061_1_) {
      this.field_70180_af.func_75692_b(15, (byte)(p_94061_1_ ? 1 : 0));
   }
   ...
   private boolean canSkipUpdate() {
      if (this.func_70631_g_()) {
         ...
         if (world == null) {
            ...
            Entity player = (Entity)world.field_73010_i.get(0);
            double dx = Math.max(Math.abs(this.field_70165_t - player.field_70165_t) - 16.0D, 0.0D);
            double dz = Math.max(Math.abs(this.field_70161_v - player.field_70161_v) - 16.0D, 0.0D);
            double distSq = dx * dx + dz * dz;
            return !this.func_70112_a(distSq);
         }
      }
   }
