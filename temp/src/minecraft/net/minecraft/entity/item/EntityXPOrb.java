...
public class EntityXPOrb extends Entity {
   ...
   public int func_70070_b(float p_70070_1_) {
      ...
      int lvt_3_1_ = super.func_70070_b(p_70070_1_);
   ...
   public void func_70071_h_() {
      ...
      double lvt_1_1_ = 8.0D;
      if (this.field_80002_g < this.field_70533_a - 20 + this.func_145782_y() % 100) {
         if (this.field_80001_f == null || this.field_80001_f.func_70068_e(this) > lvt_1_1_ * lvt_1_1_) {
            this.field_80001_f = this.field_70170_p.func_72890_a(this, lvt_1_1_);
         }
      ...
      if (this.field_80001_f != null) {
         double lvt_3_1_ = (this.field_80001_f.field_70165_t - this.field_70165_t) / lvt_1_1_;
         double lvt_5_1_ = (this.field_80001_f.field_70163_u + (double)this.field_80001_f.func_70047_e() - this.field_70163_u) / lvt_1_1_;
         double lvt_7_1_ = (this.field_80001_f.field_70161_v - this.field_70161_v) / lvt_1_1_;
         double lvt_9_1_ = Math.sqrt(lvt_3_1_ * lvt_3_1_ + lvt_5_1_ * lvt_5_1_ + lvt_7_1_ * lvt_7_1_);
         double lvt_11_1_ = 1.0D - lvt_9_1_;
         if (lvt_11_1_ > 0.0D) {
            lvt_11_1_ *= lvt_11_1_;
            this.field_70159_w += lvt_3_1_ / lvt_9_1_ * lvt_11_1_ * 0.1D;
            this.field_70181_x += lvt_5_1_ / lvt_9_1_ * lvt_11_1_ * 0.1D;
            this.field_70179_y += lvt_7_1_ / lvt_9_1_ * lvt_11_1_ * 0.1D;
         }
      }

      this.func_70091_d(this.field_70159_w, this.field_70181_x, this.field_70179_y);
      float lvt_3_2_ = 0.98F;
      if (this.field_70122_E) {
         lvt_3_2_ = this.field_70170_p.func_180495_p(new BlockPos(MathHelper.func_76128_c(this.field_70165_t), MathHelper.func_76128_c(this.func_174813_aQ().field_72338_b) - 1, MathHelper.func_76128_c(this.field_70161_v))).func_177230_c().field_149765_K * 0.98F;
      }

      this.field_70159_w *= (double)lvt_3_2_;
      this.field_70181_x *= 0.9800000190734863D;
      this.field_70179_y *= (double)lvt_3_2_;
      if (this.field_70122_E) {
