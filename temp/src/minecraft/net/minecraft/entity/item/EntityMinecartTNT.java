...
public class EntityMinecartTNT extends EntityMinecart {
   ...
   public void func_70071_h_() {
      ...
      if (this.field_70123_F) {
         double lvt_1_1_ = this.field_70159_w * this.field_70159_w + this.field_70179_y * this.field_70179_y;
         if (lvt_1_1_ >= 0.009999999776482582D) {
            this.func_94103_c(lvt_1_1_);
         }
      }
   ...
   public boolean func_70097_a(DamageSource p_70097_1_, float p_70097_2_) {
      ...
      if (lvt_3_1_ instanceof EntityArrow) {
         ...
         if (lvt_4_1_.func_70027_ad()) {
            this.func_94103_c(lvt_4_1_.field_70159_w * lvt_4_1_.field_70159_w + lvt_4_1_.field_70181_x * lvt_4_1_.field_70181_x + lvt_4_1_.field_70179_y * lvt_4_1_.field_70179_y);
         }
      }
   ...
   protected void func_94103_c(double p_94103_1_) {
      if (!this.field_70170_p.field_72995_K) {
         ...
         this.field_70170_p.func_72876_a(this, this.field_70165_t, this.field_70163_u, this.field_70161_v, (float)(4.0D + this.field_70146_Z.nextDouble() * 1.5D * lvt_3_1_), true);
         this.func_70106_y();
      }
   ...
   public void func_180430_e(float p_180430_1_, float p_180430_2_) {
      if (p_180430_1_ >= 3.0F) {
         float lvt_3_1_ = p_180430_1_ / 10.0F;
         this.func_94103_c((double)(lvt_3_1_ * lvt_3_1_));
      }
