...
public class EntityExpBottle extends EntityThrowable {
   ...
   protected void func_70184_a(MovingObjectPosition p_70184_1_) {
      if (!this.field_70170_p.field_72995_K) {
         ...
         int lvt_2_1_ = 3 + this.field_70170_p.field_73012_v.nextInt(5) + this.field_70170_p.field_73012_v.nextInt(5);

         while(lvt_2_1_ > 0) {
            int lvt_3_1_ = EntityXPOrb.func_70527_a(lvt_2_1_);
            lvt_2_1_ -= lvt_3_1_;
            this.field_70170_p.func_72838_d(new EntityXPOrb(this.field_70170_p, this.field_70165_t, this.field_70163_u, this.field_70161_v, lvt_3_1_));
         }
