...
public class EntityItemFrame extends EntityHanging {
   ...
   public void func_146065_b(Entity p_146065_1_, boolean p_146065_2_) {
      if (this.field_70170_p.func_82736_K().func_82766_b("doEntityDrops")) {
         ItemStack lvt_3_1_ = this.func_82335_i();
         if (p_146065_1_ instanceof EntityPlayer) {
            EntityPlayer lvt_4_1_ = (EntityPlayer)p_146065_1_;
            if (lvt_4_1_.field_71075_bZ.field_75098_d) {
               this.func_110131_b(lvt_3_1_);
               return;
            }
         }
         ...
         if (lvt_3_1_ != null && this.field_70146_Z.nextFloat() < this.field_82337_e) {
            lvt_3_1_ = lvt_3_1_.func_77946_l();
            this.func_110131_b(lvt_3_1_);
            this.func_70099_a(lvt_3_1_, 0.0F);
         }
   ...
   private void func_110131_b(ItemStack p_110131_1_) {
      if (p_110131_1_ != null) {
         if (p_110131_1_.func_77973_b() == Items.field_151098_aY) {
            MapData lvt_2_1_ = ((ItemMap)p_110131_1_.func_77973_b()).func_77873_a(p_110131_1_, this.field_70170_p);
            lvt_2_1_.field_76203_h.remove("frame-" + this.func_145782_y());
         }
   ...
   private void func_174865_a(int p_174865_1_, boolean p_174865_2_) {
      this.func_70096_w().func_75692_b(9, (byte)(p_174865_1_ % 8));
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      if (lvt_2_1_ != null && !lvt_2_1_.func_82582_d()) {
         this.func_174864_a(ItemStack.func_77949_a(lvt_2_1_), false);
   ...
   public boolean func_130002_c(EntityPlayer p_130002_1_) {
      if (this.func_82335_i() == null) {
         ...
         if (lvt_2_1_ != null && !this.field_70170_p.field_72995_K) {
            this.func_82334_a(lvt_2_1_);
