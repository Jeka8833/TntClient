...
public class EntityItem extends Entity {
   ...
   public void func_70071_h_() {
      if (this.func_92059_d() == null) {
         ...
         boolean lvt_1_1_ = (int)this.field_70169_q != (int)this.field_70165_t || (int)this.field_70167_r != (int)this.field_70163_u || (int)this.field_70166_s != (int)this.field_70161_v;
         if (lvt_1_1_ || this.field_70173_aa % 25 == 0) {
         ...
         if (this.field_70122_E) {
            lvt_2_1_ = this.field_70170_p.func_180495_p(new BlockPos(MathHelper.func_76128_c(this.field_70165_t), MathHelper.func_76128_c(this.func_174813_aQ().field_72338_b) - 1, MathHelper.func_76128_c(this.field_70161_v))).func_177230_c().field_149765_K * 0.98F;
         }

         this.field_70159_w *= (double)lvt_2_1_;
         this.field_70181_x *= 0.9800000190734863D;
         this.field_70179_y *= (double)lvt_2_1_;
         if (this.field_70122_E) {
   ...
   private void func_85054_d() {
      Iterator lvt_1_1_ = this.field_70170_p.func_72872_a(EntityItem.class, this.func_174813_aQ().func_72314_b(0.5D, 0.0D, 0.5D)).iterator();

      while(lvt_1_1_.hasNext()) {
         EntityItem lvt_2_1_ = (EntityItem)lvt_1_1_.next();
         this.func_70289_a(lvt_2_1_);
      }
   ...
   private boolean func_70289_a(EntityItem p_70289_1_) {
      if (p_70289_1_ == this) {
         ...
         ItemStack lvt_2_1_ = this.func_92059_d();
         ItemStack lvt_3_1_ = p_70289_1_.func_92059_d();
         if (this.field_145804_b != 32767 && p_70289_1_.field_145804_b != 32767) {
            if (this.field_70292_b != -32768 && p_70289_1_.field_70292_b != -32768) {
               if (lvt_3_1_.func_77973_b() != lvt_2_1_.func_77973_b()) {
                  return false;
               } else if (lvt_3_1_.func_77942_o() ^ lvt_2_1_.func_77942_o()) {
                  return false;
               } else if (lvt_3_1_.func_77942_o() && !lvt_3_1_.func_77978_p().equals(lvt_2_1_.func_77978_p())) {
                  return false;
               } else if (lvt_3_1_.func_77973_b() == null) {
                  return false;
               } else if (lvt_3_1_.func_77973_b().func_77614_k() && lvt_3_1_.func_77960_j() != lvt_2_1_.func_77960_j()) {
                  return false;
               } else if (lvt_3_1_.field_77994_a < lvt_2_1_.field_77994_a) {
                  return p_70289_1_.func_70289_a(this);
               } else if (lvt_3_1_.field_77994_a + lvt_2_1_.field_77994_a > lvt_3_1_.func_77976_d()) {
                  return false;
               } else {
                  lvt_3_1_.field_77994_a += lvt_2_1_.field_77994_a;
                  ...
                  p_70289_1_.func_92058_a(lvt_3_1_);
                  this.func_70106_y();
                  return true;
               }
            } else {
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      NBTTagCompound lvt_2_1_ = p_70037_1_.func_74775_l("Item");
      this.func_92058_a(ItemStack.func_77949_a(lvt_2_1_));
      if (this.func_92059_d() == null) {
         this.func_70106_y();
      }
   ...
   public void func_70100_b_(EntityPlayer p_70100_1_) {
      if (!this.field_70170_p.field_72995_K) {
         ItemStack lvt_2_1_ = this.func_92059_d();
         int lvt_3_1_ = lvt_2_1_.field_77994_a;
         if (this.field_145804_b == 0 && (this.field_145802_g == null || 6000 - this.field_70292_b <= 200 || this.field_145802_g.equals(p_70100_1_.func_70005_c_())) && p_70100_1_.field_71071_by.func_70441_a(lvt_2_1_)) {
            if (lvt_2_1_.func_77973_b() == Item.func_150898_a(Blocks.field_150364_r)) {
               p_70100_1_.func_71029_a(AchievementList.field_76005_g);
            }

            if (lvt_2_1_.func_77973_b() == Item.func_150898_a(Blocks.field_150363_s)) {
               p_70100_1_.func_71029_a(AchievementList.field_76005_g);
            }

            if (lvt_2_1_.func_77973_b() == Items.field_151116_aA) {
               p_70100_1_.func_71029_a(AchievementList.field_76022_t);
            }

            if (lvt_2_1_.func_77973_b() == Items.field_151045_i) {
               p_70100_1_.func_71029_a(AchievementList.field_76019_w);
            }

            if (lvt_2_1_.func_77973_b() == Items.field_151072_bj) {
               p_70100_1_.func_71029_a(AchievementList.field_76027_z);
            }

            if (lvt_2_1_.func_77973_b() == Items.field_151045_i && this.func_145800_j() != null) {
               EntityPlayer lvt_4_1_ = this.field_70170_p.func_72924_a(this.func_145800_j());
               if (lvt_4_1_ != null && lvt_4_1_ != p_70100_1_) {
                  lvt_4_1_.func_71029_a(AchievementList.field_150966_x);
               }
            }
            ...
            p_70100_1_.func_71001_a(this, lvt_3_1_);
   ...
   public ItemStack func_92059_d() {
      ItemStack lvt_1_1_ = this.func_70096_w().func_82710_f(10);
      if (lvt_1_1_ == null) {
