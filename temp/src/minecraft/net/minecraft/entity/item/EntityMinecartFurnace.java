...
public class EntityMinecartFurnace extends EntityMinecart {
   ...
   protected void func_180460_a(BlockPos p_180460_1_, IBlockState p_180460_2_) {
      ...
      double lvt_3_1_ = this.field_94111_a * this.field_94111_a + this.field_94109_b * this.field_94109_b;
      if (lvt_3_1_ > 1.0E-4D && this.field_70159_w * this.field_70159_w + this.field_70179_y * this.field_70179_y > 0.001D) {
         lvt_3_1_ = (double)MathHelper.func_76133_a(lvt_3_1_);
         this.field_94111_a /= lvt_3_1_;
         this.field_94109_b /= lvt_3_1_;
         if (this.field_94111_a * this.field_70159_w + this.field_94109_b * this.field_70179_y < 0.0D) {
            ...
            double lvt_5_1_ = lvt_3_1_ / this.func_174898_m();
            this.field_94111_a *= lvt_5_1_;
            this.field_94109_b *= lvt_5_1_;
         }
      }
   ...
   protected void func_94101_h() {
      double lvt_1_1_ = this.field_94111_a * this.field_94111_a + this.field_94109_b * this.field_94109_b;
      if (lvt_1_1_ > 1.0E-4D) {
         lvt_1_1_ = (double)MathHelper.func_76133_a(lvt_1_1_);
         this.field_94111_a /= lvt_1_1_;
         this.field_94109_b /= lvt_1_1_;
         double lvt_3_1_ = 1.0D;
         this.field_70159_w *= 0.800000011920929D;
         this.field_70181_x *= 0.0D;
         this.field_70179_y *= 0.800000011920929D;
         this.field_70159_w += this.field_94111_a * lvt_3_1_;
         this.field_70179_y += this.field_94109_b * lvt_3_1_;
      } else {
   ...
   public boolean func_130002_c(EntityPlayer p_130002_1_) {
      ...
      if (lvt_2_1_ != null && lvt_2_1_.func_77973_b() == Items.field_151044_h) {
         if (!p_130002_1_.field_71075_bZ.field_75098_d && --lvt_2_1_.field_77994_a == 0) {
