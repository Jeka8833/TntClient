...
public abstract class EntityMinecartContainer extends EntityMinecart implements ILockableContainer {
   ...
   public ItemStack func_70298_a(int p_70298_1_, int p_70298_2_) {
      if (this.field_94113_a[p_70298_1_] != null) {
         ...
         if (this.field_94113_a[p_70298_1_].field_77994_a <= p_70298_2_) {
            lvt_3_2_ = this.field_94113_a[p_70298_1_];
            this.field_94113_a[p_70298_1_] = null;
            return lvt_3_2_;
         } else {
            lvt_3_2_ = this.field_94113_a[p_70298_1_].func_77979_a(p_70298_2_);
   ...
   public ItemStack func_70304_b(int p_70304_1_) {
      if (this.field_94113_a[p_70304_1_] != null) {
         ItemStack lvt_2_1_ = this.field_94113_a[p_70304_1_];
   ...
   protected void func_70014_b(NBTTagCompound p_70014_1_) {
      ...
      for(int lvt_3_1_ = 0; lvt_3_1_ < this.field_94113_a.length; ++lvt_3_1_) {
         if (this.field_94113_a[lvt_3_1_] != null) {
            NBTTagCompound lvt_4_1_ = new NBTTagCompound();
            lvt_4_1_.func_74774_a("Slot", (byte)lvt_3_1_);
            this.field_94113_a[lvt_3_1_].func_77955_b(lvt_4_1_);
   ...
   protected void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      NBTTagList lvt_2_1_ = p_70037_1_.func_150295_c("Items", 10);
      ...
      for(int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_.func_74745_c(); ++lvt_3_1_) {
         ...
         if (lvt_5_1_ >= 0 && lvt_5_1_ < this.field_94113_a.length) {
            this.field_94113_a[lvt_5_1_] = ItemStack.func_77949_a(lvt_4_1_);
         }
      }
   ...
   protected void func_94101_h() {
      int lvt_1_1_ = 15 - Container.func_94526_b(this);
      float lvt_2_1_ = 0.98F + (float)lvt_1_1_ * 0.001F;
   ...
   public void func_174888_l() {
      for(int lvt_1_1_ = 0; lvt_1_1_ < this.field_94113_a.length; ++lvt_1_1_) {
         this.field_94113_a[lvt_1_1_] = null;
      }
