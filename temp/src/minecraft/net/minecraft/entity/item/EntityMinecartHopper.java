...
public class EntityMinecartHopper extends EntityMinecartContainer implements IHopper {
   ...
   public void func_96095_a(int p_96095_1_, int p_96095_2_, int p_96095_3_, boolean p_96095_4_) {
      ...
      if (lvt_5_1_ != this.func_96111_ay()) {
         this.func_96110_f(lvt_5_1_);
      }
   ...
   public void func_70071_h_() {
      ...
      if (!this.field_70170_p.field_72995_K && this.func_70089_S() && this.func_96111_ay()) {
         ...
         if (lvt_1_1_.equals(this.field_174900_c)) {
            --this.field_98044_b;
         } else {
            this.func_98042_n(0);
         }
   ...
   public boolean func_96112_aD() {
      if (TileEntityHopper.func_145891_a(this)) {
         ...
         List<EntityItem> lvt_1_1_ = this.field_70170_p.func_175647_a(EntityItem.class, this.func_174813_aQ().func_72314_b(0.25D, 0.0D, 0.25D), EntitySelectors.field_94557_a);
         if (lvt_1_1_.size() > 0) {
            TileEntityHopper.func_145898_a(this, (EntityItem)lvt_1_1_.get(0));
         }
