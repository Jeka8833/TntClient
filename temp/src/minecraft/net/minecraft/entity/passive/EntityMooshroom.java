...
public class EntityMooshroom extends EntityCow {
   ...
   public boolean func_70085_c(EntityPlayer p_70085_1_) {
      ...
      if (lvt_2_1_ != null && lvt_2_1_.func_77973_b() == Items.field_151054_z && this.func_70874_b() >= 0) {
         if (lvt_2_1_.field_77994_a == 1) {
      ...
      if (lvt_2_1_ != null && lvt_2_1_.func_77973_b() == Items.field_151097_aZ && this.func_70874_b() >= 0) {
         this.func_70106_y();
         ...
         if (!this.field_70170_p.field_72995_K) {
            EntityCow lvt_3_1_ = new EntityCow(this.field_70170_p);
            lvt_3_1_.func_70012_b(this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70177_z, this.field_70125_A);
            lvt_3_1_.func_70606_j(this.func_110143_aJ());
            lvt_3_1_.field_70761_aq = this.field_70761_aq;
            if (this.func_145818_k_()) {
               lvt_3_1_.func_96094_a(this.func_95999_t());
            }
