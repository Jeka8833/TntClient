...
public abstract class EntityAnimal extends EntityAgeable implements IAnimals {
   ...
   public boolean func_70601_bi() {
      ...
      return this.field_70170_p.func_180495_p(lvt_4_1_.func_177977_b()).func_177230_c() == this.field_175506_bl && this.field_70170_p.func_175699_k(lvt_4_1_) > 8 && super.func_70601_bi();
   }
   ...
   public boolean func_70085_c(EntityPlayer p_70085_1_) {
      ...
      if (lvt_2_1_ != null) {
         if (this.func_70877_b(lvt_2_1_) && this.func_70874_b() == 0 && this.field_70881_d <= 0) {
            this.func_175505_a(p_70085_1_, lvt_2_1_);
            this.func_146082_f(p_70085_1_);
            return true;
         }

         if (this.func_70631_g_() && this.func_70877_b(lvt_2_1_)) {
            this.func_175505_a(p_70085_1_, lvt_2_1_);
