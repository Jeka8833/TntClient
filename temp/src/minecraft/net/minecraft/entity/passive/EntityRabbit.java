...
public class EntityRabbit extends EntityAnimal {
   ...
   public void func_70619_bc() {
      ...
      if (this.field_70122_E) {
         ...
         if (this.func_175531_cl() == 99 && this.field_175538_bq == 0) {
            EntityLivingBase lvt_1_1_ = this.func_70638_az();
            if (lvt_1_1_ != null && this.func_70068_e(lvt_1_1_) < 16.0D) {
               this.func_175533_a(lvt_1_1_.field_70165_t, lvt_1_1_.field_70161_v);
               this.field_70765_h.func_75642_a(lvt_1_1_.field_70165_t, lvt_1_1_.field_70163_u, lvt_1_1_.field_70161_v, this.field_70765_h.func_75638_b());
               this.func_175524_b(EntityRabbit.EnumMoveType.ATTACK);
               this.field_175537_bp = true;
            }
         }

         EntityRabbit.RabbitJumpHelper lvt_1_2_ = (EntityRabbit.RabbitJumpHelper)this.field_70767_i;
         if (!lvt_1_2_.func_180067_c()) {
            if (this.field_70765_h.func_75640_a() && this.field_175538_bq == 0) {
               PathEntity lvt_2_1_ = this.field_70699_by.func_75505_d();
               Vec3 lvt_3_1_ = new Vec3(this.field_70765_h.func_179917_d(), this.field_70765_h.func_179919_e(), this.field_70765_h.func_179918_f());
               if (lvt_2_1_ != null && lvt_2_1_.func_75873_e() < lvt_2_1_.func_75874_d()) {
                  lvt_3_1_ = lvt_2_1_.func_75878_a(this);
               }

               this.func_175533_a(lvt_3_1_.field_72450_a, lvt_3_1_.field_72449_c);
               this.func_175524_b(this.field_175542_br);
            }
         } else if (!lvt_1_2_.func_180065_d()) {
            this.func_175518_cr();
         }
      }
   ...
   protected void func_70628_a(boolean p_70628_1_, int p_70628_2_) {
      ...
      int lvt_4_2_;
      for(lvt_4_2_ = 0; lvt_4_2_ < lvt_3_1_; ++lvt_4_2_) {
         this.func_145779_a(Items.field_179555_bs, 1);
      }

      lvt_3_1_ = this.field_70146_Z.nextInt(2);
   ...
   public EntityRabbit func_90011_a(EntityAgeable p_90011_1_) {
      EntityRabbit lvt_2_1_ = new EntityRabbit(this.field_70170_p);
      if (p_90011_1_ instanceof EntityRabbit) {
         lvt_2_1_.func_175529_r(this.field_70146_Z.nextBoolean() ? this.func_175531_cl() : ((EntityRabbit)p_90011_1_).func_175531_cl());
      }
   ...
   public void func_175529_r(int p_175529_1_) {
      ...
      this.field_70180_af.func_75692_b(18, (byte)p_175529_1_);
   }

   public IEntityLivingData func_180482_a(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_) {
      IEntityLivingData p_180482_2_ = super.func_180482_a(p_180482_1_, p_180482_2_);
      int lvt_3_1_ = this.field_70146_Z.nextInt(6);
      boolean lvt_4_1_ = false;
      if (p_180482_2_ instanceof EntityRabbit.RabbitTypeData) {
         lvt_3_1_ = ((EntityRabbit.RabbitTypeData)p_180482_2_).field_179427_a;
         lvt_4_1_ = true;
      } else {
         p_180482_2_ = new EntityRabbit.RabbitTypeData(lvt_3_1_);
      }

      this.func_175529_r(lvt_3_1_);
      if (lvt_4_1_) {
   ...
   static class AIRaidFarm extends EntityAIMoveToBlock {
      ...
      public void func_75246_d() {
         ...
         if (this.func_179487_f()) {
            World lvt_1_1_ = this.field_179500_c.field_70170_p;
            ...
            if (this.field_179499_e && lvt_4_1_ instanceof BlockCarrot && (Integer)lvt_3_1_.func_177229_b(BlockCarrot.field_176488_a) == 7) {
               lvt_1_1_.func_180501_a(lvt_2_1_, Blocks.field_150350_a.func_176223_P(), 2);
      ...
      protected boolean func_179488_a(World p_179488_1_, BlockPos p_179488_2_) {
         ...
         if (lvt_3_1_ == Blocks.field_150458_ak) {
            ...
            if (lvt_3_1_ instanceof BlockCarrot && (Integer)lvt_4_1_.func_177229_b(BlockCarrot.field_176488_a) == 7 && this.field_179498_d && !this.field_179499_e) {
