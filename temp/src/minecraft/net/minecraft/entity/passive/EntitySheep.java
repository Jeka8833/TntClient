...
public class EntitySheep extends EntityAnimal {
   ...
   protected void func_70628_a(boolean p_70628_1_, int p_70628_2_) {
      ...
      int lvt_3_1_ = this.field_70146_Z.nextInt(2) + 1 + this.field_70146_Z.nextInt(1 + p_70628_2_);
   ...
   public float func_70890_k(float p_70890_1_) {
      if (this.field_70899_e > 4 && this.field_70899_e <= 36) {
         float lvt_2_1_ = ((float)(this.field_70899_e - 4) - p_70890_1_) / 32.0F;
         return 0.62831855F + 0.21991149F * MathHelper.func_76126_a(lvt_2_1_ * 28.7F);
      } else {
   ...
   public boolean func_70085_c(EntityPlayer p_70085_1_) {
      ...
      if (lvt_2_1_ != null && lvt_2_1_.func_77973_b() == Items.field_151097_aZ && !this.func_70892_o() && !this.func_70631_g_()) {
         if (!this.field_70170_p.field_72995_K) {
            this.func_70893_e(true);
            int lvt_3_1_ = 1 + this.field_70146_Z.nextInt(3);

            for(int lvt_4_1_ = 0; lvt_4_1_ < lvt_3_1_; ++lvt_4_1_) {
               EntityItem lvt_5_1_ = this.func_70099_a(new ItemStack(Item.func_150898_a(Blocks.field_150325_L), 1, this.func_175509_cj().func_176765_a()), 1.0F);
               lvt_5_1_.field_70181_x += (double)(this.field_70146_Z.nextFloat() * 0.05F);
               lvt_5_1_.field_70159_w += (double)((this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.1F);
               lvt_5_1_.field_70179_y += (double)((this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.1F);
            }
         }

         lvt_2_1_.func_77972_a(1, p_70085_1_);
   ...
   public void func_175512_b(EnumDyeColor p_175512_1_) {
      ...
      this.field_70180_af.func_75692_b(16, (byte)(lvt_2_1_ & 240 | p_175512_1_.func_176765_a() & 15));
   }
   ...
   public void func_70893_e(boolean p_70893_1_) {
      byte lvt_2_1_ = this.field_70180_af.func_75683_a(16);
      if (p_70893_1_) {
         this.field_70180_af.func_75692_b(16, (byte)(lvt_2_1_ | 16));
      } else {
         this.field_70180_af.func_75692_b(16, (byte)(lvt_2_1_ & -17));
      }

   }

   public static EnumDyeColor func_175510_a(Random p_175510_0_) {
      int lvt_1_1_ = p_175510_0_.nextInt(100);
      if (lvt_1_1_ < 5) {
   ...
   public EntitySheep func_90011_a(EntityAgeable p_90011_1_) {
      EntitySheep lvt_2_1_ = (EntitySheep)p_90011_1_;
      EntitySheep lvt_3_1_ = new EntitySheep(this.field_70170_p);
      lvt_3_1_.func_175512_b(this.func_175511_a(this, lvt_2_1_));
      return lvt_3_1_;
   }
   ...
   private EnumDyeColor func_175511_a(EntityAnimal p_175511_1_, EntityAnimal p_175511_2_) {
      int lvt_3_1_ = ((EntitySheep)p_175511_1_).func_175509_cj().func_176767_b();
      int lvt_4_1_ = ((EntitySheep)p_175511_2_).func_175509_cj().func_176767_b();
      this.field_90016_e.func_70301_a(0).func_77964_b(lvt_3_1_);
      this.field_90016_e.func_70301_a(1).func_77964_b(lvt_4_1_);
      ItemStack lvt_5_1_ = CraftingManager.func_77594_a().func_82787_a(this.field_90016_e, ((EntitySheep)p_175511_1_).field_70170_p);
      int lvt_6_2_;
      if (lvt_5_1_ != null && lvt_5_1_.func_77973_b() == Items.field_151100_aR) {
         lvt_6_2_ = lvt_5_1_.func_77960_j();
      } else {
         lvt_6_2_ = this.field_70170_p.field_73012_v.nextBoolean() ? lvt_3_1_ : lvt_4_1_;
      }

      return EnumDyeColor.func_176766_a(lvt_6_2_);
   }
