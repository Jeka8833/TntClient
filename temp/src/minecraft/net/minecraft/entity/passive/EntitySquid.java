...
public class EntitySquid extends EntityWaterMob {
   ...
   protected void func_70628_a(boolean p_70628_1_, int p_70628_2_) {
      int lvt_3_1_ = this.field_70146_Z.nextInt(3 + p_70628_2_) + 1;
   ...
   public void func_70636_d() {
      ...
      if (this.field_70171_ac) {
         ...
         if (this.field_70867_h < 3.1415927F) {
            lvt_1_2_ = this.field_70867_h / 3.1415927F;
            this.field_70866_j = MathHelper.func_76126_a(lvt_1_2_ * lvt_1_2_ * 3.1415927F) * 3.1415927F * 0.25F;
            if ((double)lvt_1_2_ > 0.75D) {
         ...
         lvt_1_2_ = MathHelper.func_76133_a(this.field_70159_w * this.field_70159_w + this.field_70179_y * this.field_70179_y);
         ...
         this.field_70861_d += (-((float)MathHelper.func_181159_b((double)lvt_1_2_, this.field_70181_x)) * 180.0F / 3.1415927F - this.field_70861_d) * 0.1F;
      } else {
   ...
   static class AIMoveRandom extends EntityAIBase {
      ...
      public void func_75246_d() {
         int lvt_1_1_ = this.field_179476_a.func_70654_ax();
         if (lvt_1_1_ > 100) {
            ...
            float lvt_2_1_ = this.field_179476_a.func_70681_au().nextFloat() * 3.1415927F * 2.0F;
            float lvt_3_1_ = MathHelper.func_76134_b(lvt_2_1_) * 0.2F;
            float lvt_4_1_ = -0.1F + this.field_179476_a.func_70681_au().nextFloat() * 0.2F;
            float lvt_5_1_ = MathHelper.func_76126_a(lvt_2_1_) * 0.2F;
            this.field_179476_a.func_175568_b(lvt_3_1_, lvt_4_1_, lvt_5_1_);
         }
