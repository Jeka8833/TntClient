...
public class EntityPig extends EntityAnimal {
   ...
   public boolean func_82171_bF() {
      ItemStack lvt_1_1_ = ((EntityPlayer)this.field_70153_n).func_70694_bm();
      return lvt_1_1_ != null && lvt_1_1_.func_77973_b() == Items.field_151146_bM;
   }
   ...
   protected void func_70628_a(boolean p_70628_1_, int p_70628_2_) {
      int lvt_3_1_ = this.field_70146_Z.nextInt(3) + 1 + this.field_70146_Z.nextInt(1 + p_70628_2_);
   ...
   public void func_70077_a(EntityLightningBolt p_70077_1_) {
      if (!this.field_70170_p.field_72995_K && !this.field_70128_L) {
         EntityPigZombie lvt_2_1_ = new EntityPigZombie(this.field_70170_p);
         lvt_2_1_.func_70062_b(0, new ItemStack(Items.field_151010_B));
