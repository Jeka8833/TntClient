...
public class EntityOcelot extends EntityTameable {
   ...
   public void func_70619_bc() {
      if (this.func_70605_aq().func_75640_a()) {
         double lvt_1_1_ = this.func_70605_aq().func_75638_b();
         if (lvt_1_1_ == 0.6D) {
   ...
   public boolean func_70085_c(EntityPlayer p_70085_1_) {
      ...
      } else if (this.field_70914_e.func_75277_f() && lvt_2_1_ != null && lvt_2_1_.func_77973_b() == Items.field_151115_aP && p_70085_1_.func_70068_e(this) < 9.0D) {
   ...
   public EntityOcelot func_90011_a(EntityAgeable p_90011_1_) {
      EntityOcelot lvt_2_1_ = new EntityOcelot(this.field_70170_p);
      if (this.func_70909_n()) {
         lvt_2_1_.func_152115_b(this.func_152113_b());
         lvt_2_1_.func_70903_f(true);
         lvt_2_1_.func_70912_b(this.func_70913_u());
      }
   ...
   public boolean func_70878_b(EntityAnimal p_70878_1_) {
      if (p_70878_1_ == this) {
         ...
         EntityOcelot lvt_2_1_ = (EntityOcelot)p_70878_1_;
         if (!lvt_2_1_.func_70909_n()) {
            return false;
         } else {
            return this.func_70880_s() && lvt_2_1_.func_70880_s();
         }
      }
   }
   ...
   public void func_70912_b(int p_70912_1_) {
      this.field_70180_af.func_75692_b(18, (byte)p_70912_1_);
   }
   ...
   public boolean func_70058_J() {
      if (this.field_70170_p.func_72917_a(this.func_174813_aQ(), this) && this.field_70170_p.func_72945_a(this, this.func_174813_aQ()).isEmpty() && !this.field_70170_p.func_72953_d(this.func_174813_aQ())) {
         ...
         Block lvt_2_1_ = this.field_70170_p.func_180495_p(lvt_1_1_.func_177977_b()).func_177230_c();
         if (lvt_2_1_ == Blocks.field_150349_c || lvt_2_1_.func_149688_o() == Material.field_151584_j) {
            return true;
         }
      }
   ...
   public IEntityLivingData func_180482_a(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_) {
      ...
      if (this.field_70170_p.field_73012_v.nextInt(7) == 0) {
         for(int lvt_3_1_ = 0; lvt_3_1_ < 2; ++lvt_3_1_) {
            EntityOcelot lvt_4_1_ = new EntityOcelot(this.field_70170_p);
            lvt_4_1_.func_70012_b(this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70177_z, 0.0F);
            lvt_4_1_.func_70873_a(-24000);
