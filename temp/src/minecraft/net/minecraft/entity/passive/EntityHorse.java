...
public class EntityHorse extends EntityAnimal implements IInvBasic {
   ...
   public String func_70005_c_() {
      if (this.func_145818_k_()) {
         ...
         int lvt_1_1_ = this.func_110265_bP();
         switch(lvt_1_1_) {
         case 0:
         default:
   ...
   private void func_110208_b(int p_110208_1_, boolean p_110208_2_) {
      ...
      if (p_110208_2_) {
         this.field_70180_af.func_75692_b(16, lvt_3_1_ | p_110208_1_);
      } else {
         this.field_70180_af.func_75692_b(16, lvt_3_1_ & ~p_110208_1_);
      }
   ...
   private int func_110260_d(ItemStack p_110260_1_) {
      if (p_110260_1_ == null) {
         ...
         Item lvt_2_1_ = p_110260_1_.func_77973_b();
         if (lvt_2_1_ == Items.field_151138_bX) {
            return 1;
         } else if (lvt_2_1_ == Items.field_151136_bY) {
            return 2;
         } else {
            return lvt_2_1_ == Items.field_151125_bZ ? 3 : 0;
         }
      }
   }
   ...
   public void func_146086_d(ItemStack p_146086_1_) {
      this.field_70180_af.func_75692_b(22, this.func_110260_d(p_146086_1_));
      this.func_110230_cF();
   }
   ...
   public int func_110198_t(int p_110198_1_) {
      int lvt_2_1_ = MathHelper.func_76125_a(this.func_110252_cg() + p_110198_1_, 0, this.func_110218_cm());
      this.func_110238_s(lvt_2_1_);
      return lvt_2_1_;
   }

   public boolean func_70097_a(DamageSource p_70097_1_, float p_70097_2_) {
      Entity lvt_3_1_ = p_70097_1_.func_76346_g();
      return this.field_70153_n != null && this.field_70153_n.equals(lvt_3_1_) ? false : super.func_70097_a(p_70097_1_, p_70097_2_);
   }
   ...
   public boolean func_110262_ch() {
      ...
      int lvt_2_1_ = MathHelper.func_76128_c(this.field_70161_v);
      this.field_70170_p.func_180494_b(new BlockPos(lvt_1_1_, 0, lvt_2_1_));
      return true;
   }
   ...
   public void func_180430_e(float p_180430_1_, float p_180430_2_) {
      ...
      int lvt_3_1_ = MathHelper.func_76123_f((p_180430_1_ * 0.5F - 3.0F) * p_180430_2_);
      if (lvt_3_1_ > 0) {
         this.func_70097_a(DamageSource.field_76379_h, (float)lvt_3_1_);
         if (this.field_70153_n != null) {
            this.field_70153_n.func_70097_a(DamageSource.field_76379_h, (float)lvt_3_1_);
         }

         Block lvt_4_1_ = this.field_70170_p.func_180495_p(new BlockPos(this.field_70165_t, this.field_70163_u - 0.2D - (double)this.field_70126_B, this.field_70161_v)).func_177230_c();
         if (lvt_4_1_.func_149688_o() != Material.field_151579_a && !this.func_174814_R()) {
            Block.SoundType lvt_5_1_ = lvt_4_1_.field_149762_H;
            this.field_70170_p.func_72956_a(this, lvt_5_1_.func_150498_e(), lvt_5_1_.func_150497_c() * 0.5F, lvt_5_1_.func_150494_d() * 0.75F);
         }
   ...
   private int func_110225_cC() {
      int lvt_1_1_ = this.func_110265_bP();
      return !this.func_110261_ca() || lvt_1_1_ != 1 && lvt_1_1_ != 2 ? 2 : 17;
   }

   private void func_110226_cD() {
      AnimalChest lvt_1_1_ = this.field_110296_bG;
      this.field_110296_bG = new AnimalChest("HorseChest", this.func_110225_cC());
      this.field_110296_bG.func_110133_a(this.func_70005_c_());
      if (lvt_1_1_ != null) {
         lvt_1_1_.func_110132_b(this);
         int lvt_2_1_ = Math.min(lvt_1_1_.func_70302_i_(), this.field_110296_bG.func_70302_i_());

         for(int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_) {
            ItemStack lvt_4_1_ = lvt_1_1_.func_70301_a(lvt_3_1_);
            if (lvt_4_1_ != null) {
               this.field_110296_bG.func_70299_a(lvt_3_1_, lvt_4_1_.func_77946_l());
            }
         }
      }
   ...
   public void func_76316_a(InventoryBasic p_76316_1_) {
      int lvt_2_1_ = this.func_110241_cb();
      boolean lvt_3_1_ = this.func_110257_ck();
      this.func_110232_cE();
      if (this.field_70173_aa > 20) {
         if (lvt_2_1_ == 0 && lvt_2_1_ != this.func_110241_cb()) {
            this.func_85030_a("mob.horse.armor", 0.5F, 1.0F);
         } else if (lvt_2_1_ != this.func_110241_cb()) {
            this.func_85030_a("mob.horse.armor", 0.5F, 1.0F);
         }

         if (!lvt_3_1_ && this.func_110257_ck()) {
   ...
   protected EntityHorse func_110250_a(Entity p_110250_1_, double p_110250_2_) {
      ...
      Entity lvt_6_1_ = null;
      List<Entity> lvt_7_1_ = this.field_70170_p.func_175674_a(p_110250_1_, p_110250_1_.func_174813_aQ().func_72321_a(p_110250_2_, p_110250_2_, p_110250_2_), field_110276_bu);
      Iterator lvt_8_1_ = lvt_7_1_.iterator();

      while(lvt_8_1_.hasNext()) {
         Entity lvt_9_1_ = (Entity)lvt_8_1_.next();
         double lvt_10_1_ = lvt_9_1_.func_70092_e(p_110250_1_.field_70165_t, p_110250_1_.field_70163_u, p_110250_1_.field_70161_v);
         if (lvt_10_1_ < lvt_4_1_) {
            lvt_6_1_ = lvt_9_1_;
            lvt_4_1_ = lvt_10_1_;
         }
      }

      return (EntityHorse)lvt_6_1_;
   }
   ...
   protected String func_70673_aS() {
      ...
      if (lvt_1_1_ == 3) {
         ...
         return lvt_1_1_ != 1 && lvt_1_1_ != 2 ? "mob.horse.death" : "mob.horse.donkey.death";
      }
   }

   protected Item func_146068_u() {
      boolean lvt_1_1_ = this.field_70146_Z.nextInt(4) == 0;
      int lvt_2_1_ = this.func_110265_bP();
      if (lvt_2_1_ == 4) {
         return Items.field_151103_aS;
      } else if (lvt_2_1_ == 3) {
         return lvt_1_1_ ? null : Items.field_151078_bh;
      } else {
   ...
   protected String func_70621_aR() {
      ...
      if (lvt_1_1_ == 3) {
         ...
         return lvt_1_1_ != 1 && lvt_1_1_ != 2 ? "mob.horse.hit" : "mob.horse.donkey.hit";
      }
   }
   ...
   protected String func_70639_aQ() {
      ...
      if (lvt_1_1_ == 3) {
         ...
         return lvt_1_1_ != 1 && lvt_1_1_ != 2 ? "mob.horse.idle" : "mob.horse.donkey.idle";
      }
   }
   ...
   protected String func_110217_cl() {
      ...
      this.func_110220_cK();
      int lvt_1_1_ = this.func_110265_bP();
      if (lvt_1_1_ != 3 && lvt_1_1_ != 4) {
         return lvt_1_1_ != 1 && lvt_1_1_ != 2 ? "mob.horse.angry" : "mob.horse.donkey.angry";
      } else {
         return null;
      }
   }
   ...
   protected void func_180429_a(BlockPos p_180429_1_, Block p_180429_2_) {
      ...
      if (!p_180429_2_.func_149688_o().func_76224_d()) {
         int lvt_4_1_ = this.func_110265_bP();
         if (this.field_70153_n != null && lvt_4_1_ != 1 && lvt_4_1_ != 2) {
            ++this.field_110285_bP;
            if (this.field_110285_bP > 5 && this.field_110285_bP % 3 == 0) {
               this.func_85030_a("mob.horse.gallop", lvt_3_1_.func_150497_c() * 0.15F, lvt_3_1_.func_150494_d());
               if (lvt_4_1_ == 0 && this.field_70146_Z.nextInt(10) == 0) {
                  this.func_85030_a("mob.horse.breathe", lvt_3_1_.func_150497_c() * 0.6F, lvt_3_1_.func_150494_d());
               }
            } else if (this.field_110285_bP <= 5) {
               this.func_85030_a("mob.horse.wood", lvt_3_1_.func_150497_c() * 0.15F, lvt_3_1_.func_150494_d());
            }
         } else if (lvt_3_1_ == Block.field_149766_f) {
            this.func_85030_a("mob.horse.wood", lvt_3_1_.func_150497_c() * 0.15F, lvt_3_1_.func_150494_d());
         } else {
            this.func_85030_a("mob.horse.soft", lvt_3_1_.func_150497_c() * 0.15F, lvt_3_1_.func_150494_d());
         }
      }
   ...
   private void func_110247_cG() {
      ...
      int lvt_1_1_ = this.func_110265_bP();
      int lvt_2_1_ = this.func_110202_bQ();
      int lvt_3_2_;
      if (lvt_1_1_ == 0) {
         lvt_3_2_ = lvt_2_1_ & 255;
         int lvt_4_1_ = (lvt_2_1_ & '\uff00') >> 8;
         if (lvt_3_2_ >= field_110268_bz.length) {
            this.field_175508_bO = false;
            return;
         }

         this.field_110280_bR[0] = field_110268_bz[lvt_3_2_];
         this.field_110286_bQ = this.field_110286_bQ + field_110269_bA[lvt_3_2_];
         if (lvt_4_1_ >= field_110291_bB.length) {
            this.field_175508_bO = false;
            return;
         }

         this.field_110280_bR[1] = field_110291_bB[lvt_4_1_];
         this.field_110286_bQ = this.field_110286_bQ + field_110292_bC[lvt_4_1_];
      } else {
         this.field_110280_bR[0] = "";
         this.field_110286_bQ = this.field_110286_bQ + "_" + lvt_1_1_ + "_";
      }

      lvt_3_2_ = this.func_110241_cb();
      if (lvt_3_2_ >= field_110270_bw.length) {
         this.field_175508_bO = false;
      } else {
         this.field_110280_bR[2] = field_110270_bw[lvt_3_2_];
         this.field_110286_bQ = this.field_110286_bQ + field_110273_bx[lvt_3_2_];
   ...
   public boolean func_70085_c(EntityPlayer p_70085_1_) {
      ...
      if (lvt_2_1_ != null && lvt_2_1_.func_77973_b() == Items.field_151063_bx) {
         ...
         if (lvt_2_1_ != null) {
            ...
            if (this.func_110259_cr()) {
               int lvt_4_1_ = -1;
               if (lvt_2_1_.func_77973_b() == Items.field_151138_bX) {
                  lvt_4_1_ = 1;
               } else if (lvt_2_1_.func_77973_b() == Items.field_151136_bY) {
                  lvt_4_1_ = 2;
               } else if (lvt_2_1_.func_77973_b() == Items.field_151125_bZ) {
                  lvt_4_1_ = 3;
               }
            ...
            if (!lvt_3_1_ && !this.func_110256_cu()) {
               float lvt_4_2_ = 0.0F;
               int lvt_5_1_ = 0;
               int lvt_6_1_ = 0;
               if (lvt_2_1_.func_77973_b() == Items.field_151015_O) {
                  lvt_4_2_ = 2.0F;
                  lvt_5_1_ = 20;
                  lvt_6_1_ = 3;
               } else if (lvt_2_1_.func_77973_b() == Items.field_151102_aT) {
                  lvt_4_2_ = 1.0F;
                  lvt_5_1_ = 30;
                  lvt_6_1_ = 3;
               } else if (Block.func_149634_a(lvt_2_1_.func_77973_b()) == Blocks.field_150407_cf) {
                  lvt_4_2_ = 20.0F;
                  lvt_5_1_ = 180;
               } else if (lvt_2_1_.func_77973_b() == Items.field_151034_e) {
                  lvt_4_2_ = 3.0F;
                  lvt_5_1_ = 60;
                  lvt_6_1_ = 3;
               } else if (lvt_2_1_.func_77973_b() == Items.field_151150_bK) {
                  lvt_4_2_ = 4.0F;
                  lvt_5_1_ = 60;
                  lvt_6_1_ = 5;
               ...
               } else if (lvt_2_1_.func_77973_b() == Items.field_151153_ao) {
                  lvt_4_2_ = 10.0F;
                  lvt_5_1_ = 240;
                  lvt_6_1_ = 10;
                  if (this.func_110248_bS() && this.func_70874_b() == 0) {
               ...
               if (this.func_110143_aJ() < this.func_110138_aP() && lvt_4_2_ > 0.0F) {
                  this.func_70691_i(lvt_4_2_);
                  lvt_3_1_ = true;
               }

               if (!this.func_110228_bR() && lvt_5_1_ > 0) {
                  this.func_110195_a(lvt_5_1_);
                  lvt_3_1_ = true;
               }

               if (lvt_6_1_ > 0 && (lvt_3_1_ || !this.func_110248_bS()) && lvt_6_1_ < this.func_110218_cm()) {
                  lvt_3_1_ = true;
                  this.func_110198_t(lvt_6_1_);
               }
            ...
            if (!this.func_110248_bS() && !lvt_3_1_) {
               if (lvt_2_1_ != null && lvt_2_1_.func_111282_a(p_70085_1_, this)) {
                  return true;
               }
            ...
            if (!lvt_3_1_ && this.func_110229_cs() && !this.func_110261_ca() && lvt_2_1_.func_77973_b() == Item.func_150898_a(Blocks.field_150486_ae)) {
            ...
            if (!lvt_3_1_ && this.func_110253_bW() && !this.func_110257_ck() && lvt_2_1_.func_77973_b() == Items.field_151141_av) {
               this.func_110199_f(p_70085_1_);
               return true;
            }
   ...
   public void func_70636_d() {
      ...
      if (!this.field_70170_p.field_72995_K) {
         ...
         if (this.func_110205_ce() && !this.func_110228_bR() && !this.func_110204_cc()) {
            EntityHorse lvt_1_1_ = this.func_110250_a(this, 16.0D);
            if (lvt_1_1_ != null && this.func_70068_e(lvt_1_1_) > 4.0D) {
               this.field_70699_by.func_75494_a(lvt_1_1_);
            }
         }
      }
   ...
   public void func_110231_cz() {
      this.func_110220_cK();
      String lvt_1_1_ = this.func_110217_cl();
      if (lvt_1_1_ != null) {
   ...
   private void func_110240_a(Entity p_110240_1_, AnimalChest p_110240_2_) {
      if (p_110240_2_ != null && !this.field_70170_p.field_72995_K) {
         for(int lvt_3_1_ = 0; lvt_3_1_ < p_110240_2_.func_70302_i_(); ++lvt_3_1_) {
            ItemStack lvt_4_1_ = p_110240_2_.func_70301_a(lvt_3_1_);
            if (lvt_4_1_ != null) {
   ...
   public void func_70612_e(float p_70612_1_, float p_70612_2_) {
      if (this.field_70153_n != null && this.field_70153_n instanceof EntityLivingBase && this.func_110257_ck()) {
         ...
         if (this.field_110277_bt > 0.0F && !this.func_110246_bZ() && this.field_70122_E) {
            ...
            if (p_70612_2_ > 0.0F) {
               float lvt_3_1_ = MathHelper.func_76126_a(this.field_70177_z * 3.1415927F / 180.0F);
               float lvt_4_1_ = MathHelper.func_76134_b(this.field_70177_z * 3.1415927F / 180.0F);
               this.field_70159_w += (double)(-0.4F * lvt_3_1_ * this.field_110277_bt);
               this.field_70179_y += (double)(0.4F * lvt_4_1_ * this.field_110277_bt);
   ...
   public void func_70014_b(NBTTagCompound p_70014_1_) {
      ...
      if (this.func_110261_ca()) {
         ...
         for(int lvt_3_1_ = 2; lvt_3_1_ < this.field_110296_bG.func_70302_i_(); ++lvt_3_1_) {
            ItemStack lvt_4_1_ = this.field_110296_bG.func_70301_a(lvt_3_1_);
            if (lvt_4_1_ != null) {
               NBTTagCompound lvt_5_1_ = new NBTTagCompound();
               lvt_5_1_.func_74774_a("Slot", (byte)lvt_3_1_);
               lvt_4_1_.func_77955_b(lvt_5_1_);
               lvt_2_1_.func_74742_a(lvt_5_1_);
            }
         }

         p_70014_1_.func_74782_a("Items", lvt_2_1_);
      }
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      if (lvt_2_1_.length() > 0) {
         this.func_152120_b(lvt_2_1_);
      }

      IAttributeInstance lvt_3_2_ = this.func_110140_aT().func_111152_a("Speed");
      if (lvt_3_2_ != null) {
         this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(lvt_3_2_.func_111125_b() * 0.25D);
      }

      if (this.func_110261_ca()) {
         NBTTagList lvt_4_1_ = p_70037_1_.func_150295_c("Items", 10);
         this.func_110226_cD();

         for(int lvt_5_1_ = 0; lvt_5_1_ < lvt_4_1_.func_74745_c(); ++lvt_5_1_) {
            NBTTagCompound lvt_6_1_ = lvt_4_1_.func_150305_b(lvt_5_1_);
            int lvt_7_1_ = lvt_6_1_.func_74771_c("Slot") & 255;
            if (lvt_7_1_ >= 2 && lvt_7_1_ < this.field_110296_bG.func_70302_i_()) {
               this.field_110296_bG.func_70299_a(lvt_7_1_, ItemStack.func_77949_a(lvt_6_1_));
            }
         }
      }
      ...
      if (p_70037_1_.func_150297_b("ArmorItem", 10)) {
         lvt_4_3_ = ItemStack.func_77949_a(p_70037_1_.func_74775_l("ArmorItem"));
         if (lvt_4_3_ != null && func_146085_a(lvt_4_3_.func_77973_b())) {
            this.field_110296_bG.func_70299_a(1, lvt_4_3_);
         }
      }

      if (p_70037_1_.func_150297_b("SaddleItem", 10)) {
         lvt_4_3_ = ItemStack.func_77949_a(p_70037_1_.func_74775_l("SaddleItem"));
         if (lvt_4_3_ != null && lvt_4_3_.func_77973_b() == Items.field_151141_av) {
            this.field_110296_bG.func_70299_a(0, lvt_4_3_);
         }
   ...
   public boolean func_70878_b(EntityAnimal p_70878_1_) {
      if (p_70878_1_ == this) {
         ...
         EntityHorse lvt_2_1_ = (EntityHorse)p_70878_1_;
         if (this.func_110200_cJ() && lvt_2_1_.func_110200_cJ()) {
            int lvt_3_1_ = this.func_110265_bP();
            int lvt_4_1_ = lvt_2_1_.func_110265_bP();
            return lvt_3_1_ == lvt_4_1_ || lvt_3_1_ == 0 && lvt_4_1_ == 1 || lvt_3_1_ == 1 && lvt_4_1_ == 0;
         } else {
            return false;
         }
      }
   ...
   public EntityAgeable func_90011_a(EntityAgeable p_90011_1_) {
      EntityHorse lvt_2_1_ = (EntityHorse)p_90011_1_;
      EntityHorse lvt_3_1_ = new EntityHorse(this.field_70170_p);
      int lvt_4_1_ = this.func_110265_bP();
      int lvt_5_1_ = lvt_2_1_.func_110265_bP();
      int lvt_6_1_ = 0;
      if (lvt_4_1_ == lvt_5_1_) {
         lvt_6_1_ = lvt_4_1_;
      } else if (lvt_4_1_ == 0 && lvt_5_1_ == 1 || lvt_4_1_ == 1 && lvt_5_1_ == 0) {
         lvt_6_1_ = 2;
      }

      if (lvt_6_1_ == 0) {
         int lvt_8_1_ = this.field_70146_Z.nextInt(9);
         int lvt_7_3_;
         if (lvt_8_1_ < 4) {
            lvt_7_3_ = this.func_110202_bQ() & 255;
         } else if (lvt_8_1_ < 8) {
            lvt_7_3_ = lvt_2_1_.func_110202_bQ() & 255;
         } else {
            lvt_7_3_ = this.field_70146_Z.nextInt(7);
         }

         int lvt_9_1_ = this.field_70146_Z.nextInt(5);
         if (lvt_9_1_ < 2) {
            lvt_7_3_ |= this.func_110202_bQ() & '\uff00';
         } else if (lvt_9_1_ < 4) {
            lvt_7_3_ |= lvt_2_1_.func_110202_bQ() & '\uff00';
         } else {
            lvt_7_3_ |= this.field_70146_Z.nextInt(5) << 8 & '\uff00';
         }

         lvt_3_1_.func_110235_q(lvt_7_3_);
      }

      lvt_3_1_.func_110214_p(lvt_6_1_);
      double lvt_7_4_ = this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111125_b() + p_90011_1_.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111125_b() + (double)this.func_110267_cL();
      lvt_3_1_.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(lvt_7_4_ / 3.0D);
      double lvt_9_2_ = this.func_110148_a(field_110271_bv).func_111125_b() + p_90011_1_.func_110148_a(field_110271_bv).func_111125_b() + this.func_110245_cM();
      lvt_3_1_.func_110148_a(field_110271_bv).func_111128_a(lvt_9_2_ / 3.0D);
      double lvt_11_1_ = this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111125_b() + p_90011_1_.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111125_b() + this.func_110203_cN();
      lvt_3_1_.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(lvt_11_1_ / 3.0D);
      return lvt_3_1_;
   }

   public IEntityLivingData func_180482_a(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_) {
      IEntityLivingData p_180482_2_ = super.func_180482_a(p_180482_1_, p_180482_2_);
      int lvt_3_1_ = false;
      int lvt_4_1_ = 0;
      int lvt_3_1_;
      if (p_180482_2_ instanceof EntityHorse.GroupData) {
         lvt_3_1_ = ((EntityHorse.GroupData)p_180482_2_).field_111107_a;
         lvt_4_1_ = ((EntityHorse.GroupData)p_180482_2_).field_111106_b & 255 | this.field_70146_Z.nextInt(5) << 8;
      } else {
         if (this.field_70146_Z.nextInt(10) == 0) {
            lvt_3_1_ = 1;
         } else {
            int lvt_5_1_ = this.field_70146_Z.nextInt(7);
            int lvt_6_1_ = this.field_70146_Z.nextInt(5);
            lvt_3_1_ = 0;
            lvt_4_1_ = lvt_5_1_ | lvt_6_1_ << 8;
         }

         p_180482_2_ = new EntityHorse.GroupData(lvt_3_1_, lvt_4_1_);
      }

      this.func_110214_p(lvt_3_1_);
      this.func_110235_q(lvt_4_1_);
      if (this.field_70146_Z.nextInt(5) == 0) {
         this.func_70873_a(-24000);
      }

      if (lvt_3_1_ != 4 && lvt_3_1_ != 3) {
   ...
   protected void func_110216_r(boolean p_110216_1_) {
      EnumParticleTypes lvt_2_1_ = p_110216_1_ ? EnumParticleTypes.HEART : EnumParticleTypes.SMOKE_NORMAL;
   ...
   public void func_70043_V() {
      ...
      if (this.field_110282_bM > 0.0F) {
         float lvt_1_1_ = MathHelper.func_76126_a(this.field_70761_aq * 3.1415927F / 180.0F);
         float lvt_2_1_ = MathHelper.func_76134_b(this.field_70761_aq * 3.1415927F / 180.0F);
         float lvt_3_1_ = 0.7F * this.field_110282_bM;
         float lvt_4_1_ = 0.15F * this.field_110282_bM;
         this.field_70153_n.func_70107_b(this.field_70165_t + (double)(lvt_3_1_ * lvt_1_1_), this.field_70163_u + this.func_70042_X() + this.field_70153_n.func_70033_W() + (double)lvt_4_1_, this.field_70161_v - (double)(lvt_3_1_ * lvt_2_1_));
   ...
   public boolean func_174820_d(int p_174820_1_, ItemStack p_174820_2_) {
      ...
      int lvt_3_1_ = p_174820_1_ - 400;
      if (lvt_3_1_ >= 0 && lvt_3_1_ < 2 && lvt_3_1_ < this.field_110296_bG.func_70302_i_()) {
         if (lvt_3_1_ == 0 && p_174820_2_ != null && p_174820_2_.func_77973_b() != Items.field_151141_av) {
            return false;
         } else if (lvt_3_1_ != 1 || (p_174820_2_ == null || func_146085_a(p_174820_2_.func_77973_b())) && this.func_110259_cr()) {
            this.field_110296_bG.func_70299_a(lvt_3_1_, p_174820_2_);
            this.func_110232_cE();
            return true;
         } else {
            return false;
         ...
         int lvt_4_1_ = p_174820_1_ - 500 + 2;
         if (lvt_4_1_ >= 2 && lvt_4_1_ < this.field_110296_bG.func_70302_i_()) {
            this.field_110296_bG.func_70299_a(lvt_4_1_, p_174820_2_);
            return true;
         } else {
            return false;
         }
