...
public class EntityBat extends EntityAmbientCreature {
   ...
   protected void func_70619_bc() {
      ...
      BlockPos lvt_2_1_ = lvt_1_1_.func_177984_a();
      if (this.func_82235_h()) {
         if (!this.field_70170_p.func_180495_p(lvt_2_1_).func_177230_c().func_149721_r()) {
            this.func_82236_f(false);
            this.field_70170_p.func_180498_a((EntityPlayer)null, 1015, lvt_1_1_, 0);
         } else {
         ...
         double lvt_3_1_ = (double)this.field_82237_a.func_177958_n() + 0.5D - this.field_70165_t;
         double lvt_5_1_ = (double)this.field_82237_a.func_177956_o() + 0.1D - this.field_70163_u;
         double lvt_7_1_ = (double)this.field_82237_a.func_177952_p() + 0.5D - this.field_70161_v;
         this.field_70159_w += (Math.signum(lvt_3_1_) * 0.5D - this.field_70159_w) * 0.10000000149011612D;
         this.field_70181_x += (Math.signum(lvt_5_1_) * 0.699999988079071D - this.field_70181_x) * 0.10000000149011612D;
         this.field_70179_y += (Math.signum(lvt_7_1_) * 0.5D - this.field_70179_y) * 0.10000000149011612D;
         float lvt_9_1_ = (float)(MathHelper.func_181159_b(this.field_70179_y, this.field_70159_w) * 180.0D / 3.1415927410125732D) - 90.0F;
         float lvt_10_1_ = MathHelper.func_76142_g(lvt_9_1_ - this.field_70177_z);
         this.field_70701_bs = 0.5F;
         this.field_70177_z += lvt_10_1_;
         if (this.field_70146_Z.nextInt(100) == 0 && this.field_70170_p.func_180495_p(lvt_2_1_).func_177230_c().func_149721_r()) {
            this.func_82236_f(true);
         }
      }
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      this.field_70180_af.func_75692_b(16, p_70037_1_.func_74771_c("BatFlags"));
   }
   ...
   public boolean func_70601_bi() {
      BlockPos lvt_1_1_ = new BlockPos(this.field_70165_t, this.func_174813_aQ().field_72338_b, this.field_70161_v);
      if (lvt_1_1_.func_177956_o() >= this.field_70170_p.func_181545_F()) {
         return false;
      } else {
         int lvt_2_1_ = this.field_70170_p.func_175671_l(lvt_1_1_);
         int lvt_3_1_ = 4;
         ...
         return lvt_2_1_ > this.field_70146_Z.nextInt(lvt_3_1_) ? false : super.func_70601_bi();
      }
   }
