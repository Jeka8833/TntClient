...
public class EntitySpider extends EntityMob {
   ...
   public IEntityLivingData func_180482_a(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_) {
      ...
      if (this.field_70170_p.field_73012_v.nextInt(100) == 0) {
         EntitySkeleton lvt_3_1_ = new EntitySkeleton(this.field_70170_p);
         lvt_3_1_.func_70012_b(this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70177_z, 0.0F);
         lvt_3_1_.func_180482_a(p_180482_1_, (IEntityLivingData)null);
         this.field_70170_p.func_72838_d(lvt_3_1_);
         lvt_3_1_.func_70078_a(this);
      }
      ...
      if (p_180482_2_ instanceof EntitySpider.GroupData) {
         int lvt_3_2_ = ((EntitySpider.GroupData)p_180482_2_).field_111105_a;
         if (lvt_3_2_ > 0 && Potion.field_76425_a[lvt_3_2_] != null) {
            this.func_70690_d(new PotionEffect(lvt_3_2_, Integer.MAX_VALUE));
         }
      }
   ...
   static class AISpiderTarget<T extends EntityLivingBase> extends EntityAINearestAttackableTarget {
      ...
      public boolean func_75250_a() {
         float lvt_1_1_ = this.field_75299_d.func_70013_c(1.0F);
         return lvt_1_1_ >= 0.5F ? false : super.func_75250_a();
      }
   }
   ...
   static class AISpiderAttack extends EntityAIAttackOnCollide {
      ...
      public boolean func_75253_b() {
         float lvt_1_1_ = this.field_75441_b.func_70013_c(1.0F);
         if (lvt_1_1_ >= 0.5F && this.field_75441_b.func_70681_au().nextInt(100) == 0) {
   ...
   public static class GroupData implements IEntityLivingData {
      ...
      public void func_111104_a(Random p_111104_1_) {
         int lvt_2_1_ = p_111104_1_.nextInt(5);
         if (lvt_2_1_ <= 1) {
