...
public class EntityIronGolem extends EntityGolem {
   ...
   protected void func_70619_bc() {
      if (--this.field_70858_e <= 0) {
         ...
         if (this.field_70857_d == null) {
            ...
            BlockPos lvt_1_1_ = this.field_70857_d.func_180608_a();
            this.func_175449_a(lvt_1_1_, (int)((float)this.field_70857_d.func_75568_b() * 0.6F));
         }
      }
   ...
   public boolean func_70652_k(Entity p_70652_1_) {
      ...
      boolean lvt_2_1_ = p_70652_1_.func_70097_a(DamageSource.func_76358_a(this), (float)(7 + this.field_70146_Z.nextInt(15)));
      if (lvt_2_1_) {
   ...
   protected void func_70628_a(boolean p_70628_1_, int p_70628_2_) {
      ...
      lvt_4_2_ = 3 + this.field_70146_Z.nextInt(3);
            ...
            public boolean apply(T p_apply_1_) {
               if (p_i45858_6_ != null && !p_i45858_6_.apply(p_apply_1_)) {
                  ...
                  if (p_apply_1_ instanceof EntityPlayer) {
                     double lvt_2_1_ = AINearestAttackableTargetNonCreeper.this.func_111175_f();
                     ...
                     if ((double)p_apply_1_.func_70032_d(p_i45858_1_) > lvt_2_1_) {
                        return false;
                     }
                  }
