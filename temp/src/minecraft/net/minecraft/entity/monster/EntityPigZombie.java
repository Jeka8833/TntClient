...
public class EntityPigZombie extends EntityZombie {
   ...
   protected void func_70619_bc() {
      ...
      if (this.func_175457_ck()) {
         if (!this.func_70631_g_() && !lvt_1_1_.func_180374_a(field_110190_br)) {
            lvt_1_1_.func_111121_a(field_110190_br);
         }

         --this.field_70837_d;
      } else if (lvt_1_1_.func_180374_a(field_110190_br)) {
         lvt_1_1_.func_111124_b(field_110190_br);
      }
      ...
      if (this.field_70837_d > 0 && this.field_175459_bn != null && this.func_70643_av() == null) {
         EntityPlayer lvt_2_1_ = this.field_70170_p.func_152378_a(this.field_175459_bn);
         this.func_70604_c(lvt_2_1_);
         this.field_70717_bb = lvt_2_1_;
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      String lvt_2_1_ = p_70037_1_.func_74779_i("HurtBy");
      if (lvt_2_1_.length() > 0) {
         this.field_175459_bn = UUID.fromString(lvt_2_1_);
         EntityPlayer lvt_3_1_ = this.field_70170_p.func_152378_a(this.field_175459_bn);
         this.func_70604_c(lvt_3_1_);
         if (lvt_3_1_ != null) {
            this.field_70717_bb = lvt_3_1_;
            this.field_70718_bc = this.func_142015_aE();
         }
      }
   ...
   protected void func_70628_a(boolean p_70628_1_, int p_70628_2_) {
      ...
      lvt_3_1_ = this.field_70146_Z.nextInt(2 + p_70628_2_);
