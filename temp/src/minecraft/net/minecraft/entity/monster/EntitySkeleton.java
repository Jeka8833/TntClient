...
public class EntitySkeleton extends EntityMob implements IRangedAttackMob {
   ...
   public void func_70098_U() {
      ...
      if (this.field_70154_o instanceof EntityCreature) {
         EntityCreature lvt_1_1_ = (EntityCreature)this.field_70154_o;
         this.field_70761_aq = lvt_1_1_.field_70761_aq;
      }
   ...
   public void func_70645_a(DamageSource p_70645_1_) {
      ...
      if (p_70645_1_.func_76364_f() instanceof EntityArrow && p_70645_1_.func_76346_g() instanceof EntityPlayer) {
         EntityPlayer lvt_2_1_ = (EntityPlayer)p_70645_1_.func_76346_g();
         double lvt_3_1_ = lvt_2_1_.field_70165_t - this.field_70165_t;
         double lvt_5_1_ = lvt_2_1_.field_70161_v - this.field_70161_v;
         if (lvt_3_1_ * lvt_3_1_ + lvt_5_1_ * lvt_5_1_ >= 2500.0D) {
            lvt_2_1_.func_71029_a(AchievementList.field_76020_v);
         }
   ...
   protected void func_70628_a(boolean p_70628_1_, int p_70628_2_) {
      ...
      if (this.func_82202_m() == 1) {
         lvt_3_3_ = this.field_70146_Z.nextInt(3 + p_70628_2_) - 1;

         for(lvt_4_3_ = 0; lvt_4_3_ < lvt_3_3_; ++lvt_4_3_) {
            this.func_145779_a(Items.field_151044_h, 1);
         }
      } else {
         lvt_3_3_ = this.field_70146_Z.nextInt(3 + p_70628_2_);
   ...
   public IEntityLivingData func_180482_a(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_) {
      ...
      if (this.func_71124_b(4) == null) {
         Calendar lvt_3_1_ = this.field_70170_p.func_83015_S();
         if (lvt_3_1_.get(2) + 1 == 10 && lvt_3_1_.get(5) == 31 && this.field_70146_Z.nextFloat() < 0.25F) {
   ...
   public void func_85036_m() {
      ...
      if (lvt_1_1_ != null && lvt_1_1_.func_77973_b() == Items.field_151031_f) {
         this.field_70714_bg.func_75776_a(4, this.field_85037_d);
      } else {
         this.field_70714_bg.func_75776_a(4, this.field_85038_e);
      }
   ...
   public void func_82196_d(EntityLivingBase p_82196_1_, float p_82196_2_) {
      EntityArrow lvt_3_1_ = new EntityArrow(this.field_70170_p, this, p_82196_1_, 1.6F, (float)(14 - this.field_70170_p.func_175659_aa().func_151525_a() * 4));
      int lvt_4_1_ = EnchantmentHelper.func_77506_a(Enchantment.field_77345_t.field_77352_x, this.func_70694_bm());
      int lvt_5_1_ = EnchantmentHelper.func_77506_a(Enchantment.field_77344_u.field_77352_x, this.func_70694_bm());
      lvt_3_1_.func_70239_b((double)(p_82196_2_ * 2.0F) + this.field_70146_Z.nextGaussian() * 0.25D + (double)((float)this.field_70170_p.func_175659_aa().func_151525_a() * 0.11F));
      if (lvt_4_1_ > 0) {
         lvt_3_1_.func_70239_b(lvt_3_1_.func_70242_d() + (double)lvt_4_1_ * 0.5D + 0.5D);
      }

      if (lvt_5_1_ > 0) {
         lvt_3_1_.func_70240_a(lvt_5_1_);
      }

      if (EnchantmentHelper.func_77506_a(Enchantment.field_77343_v.field_77352_x, this.func_70694_bm()) > 0 || this.func_82202_m() == 1) {
         lvt_3_1_.func_70015_d(100);
      }
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      if (p_70037_1_.func_150297_b("SkeletonType", 99)) {
         int lvt_2_1_ = p_70037_1_.func_74771_c("SkeletonType");
         this.func_82201_a(lvt_2_1_);
      }
