...
public class EntityCreeper extends EntityMob {
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      this.field_70180_af.func_75692_b(17, (byte)(p_70037_1_.func_74767_n("powered") ? 1 : 0));
   ...
   public void func_70071_h_() {
      if (this.func_70089_S()) {
         ...
         int lvt_1_1_ = this.func_70832_p();
         if (lvt_1_1_ > 0 && this.field_70833_d == 0) {
            this.func_85030_a("creeper.primed", 1.0F, 0.5F);
         }

         this.field_70833_d += lvt_1_1_;
   ...
   public void func_70645_a(DamageSource p_70645_1_) {
      ...
      if (p_70645_1_.func_76346_g() instanceof EntitySkeleton) {
         int lvt_2_1_ = Item.func_150891_b(Items.field_151096_cd);
         int lvt_3_1_ = Item.func_150891_b(Items.field_151084_co);
         int lvt_4_1_ = lvt_2_1_ + this.field_70146_Z.nextInt(lvt_3_1_ - lvt_2_1_ + 1);
         this.func_145779_a(Item.func_150899_d(lvt_4_1_), 1);
   ...
   protected boolean func_70085_c(EntityPlayer p_70085_1_) {
      ...
      if (lvt_2_1_ != null && lvt_2_1_.func_77973_b() == Items.field_151033_d) {
   ...
   private void func_146077_cc() {
      if (!this.field_70170_p.field_72995_K) {
         boolean lvt_1_1_ = this.field_70170_p.func_82736_K().func_82766_b("mobGriefing");
         float lvt_2_1_ = this.func_70830_n() ? 2.0F : 1.0F;
         this.field_70170_p.func_72876_a(this, this.field_70165_t, this.field_70163_u, this.field_70161_v, (float)this.field_82226_g * lvt_2_1_, lvt_1_1_);
         this.func_70106_y();
      }
