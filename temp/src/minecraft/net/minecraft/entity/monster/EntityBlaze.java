...
public class EntityBlaze extends EntityMob {
   ...
   protected void func_70619_bc() {
      ...
      if (lvt_1_1_ != null && lvt_1_1_.field_70163_u + (double)lvt_1_1_.func_70047_e() > this.field_70163_u + (double)this.func_70047_e() + (double)this.field_70847_d) {
   ...
   protected void func_70628_a(boolean p_70628_1_, int p_70628_2_) {
      if (p_70628_1_) {
         int lvt_3_1_ = this.field_70146_Z.nextInt(2 + p_70628_2_);
   ...
   public void func_70844_e(boolean p_70844_1_) {
      ...
      this.field_70180_af.func_75692_b(16, lvt_2_1_);
   }
   ...
   static class AIFireballAttack extends EntityAIBase {
      ...
      public boolean func_75250_a() {
         EntityLivingBase lvt_1_1_ = this.field_179469_a.func_70638_az();
      ...
      public void func_75246_d() {
         --this.field_179468_c;
         EntityLivingBase lvt_1_1_ = this.field_179469_a.func_70638_az();
         double lvt_2_1_ = this.field_179469_a.func_70068_e(lvt_1_1_);
         if (lvt_2_1_ < 4.0D) {
            if (this.field_179468_c <= 0) {
               this.field_179468_c = 20;
               this.field_179469_a.func_70652_k(lvt_1_1_);
            }

            this.field_179469_a.func_70605_aq().func_75642_a(lvt_1_1_.field_70165_t, lvt_1_1_.field_70163_u, lvt_1_1_.field_70161_v, 1.0D);
         } else if (lvt_2_1_ < 256.0D) {
            double lvt_4_1_ = lvt_1_1_.field_70165_t - this.field_179469_a.field_70165_t;
            double lvt_6_1_ = lvt_1_1_.func_174813_aQ().field_72338_b + (double)(lvt_1_1_.field_70131_O / 2.0F) - (this.field_179469_a.field_70163_u + (double)(this.field_179469_a.field_70131_O / 2.0F));
            double lvt_8_1_ = lvt_1_1_.field_70161_v - this.field_179469_a.field_70161_v;
            if (this.field_179468_c <= 0) {
               ++this.field_179467_b;
               ...
               if (this.field_179467_b > 1) {
                  float lvt_10_1_ = MathHelper.func_76129_c(MathHelper.func_76133_a(lvt_2_1_)) * 0.5F;
                  ...
                  for(int lvt_11_1_ = 0; lvt_11_1_ < 1; ++lvt_11_1_) {
                     EntitySmallFireball lvt_12_1_ = new EntitySmallFireball(this.field_179469_a.field_70170_p, this.field_179469_a, lvt_4_1_ + this.field_179469_a.func_70681_au().nextGaussian() * (double)lvt_10_1_, lvt_6_1_, lvt_8_1_ + this.field_179469_a.func_70681_au().nextGaussian() * (double)lvt_10_1_);
                     lvt_12_1_.field_70163_u = this.field_179469_a.field_70163_u + (double)(this.field_179469_a.field_70131_O / 2.0F) + 0.5D;
                     this.field_179469_a.field_70170_p.func_72838_d(lvt_12_1_);
                  }
               }
            }

            this.field_179469_a.func_70671_ap().func_75651_a(lvt_1_1_, 10.0F, 10.0F);
         } else {
