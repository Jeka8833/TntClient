...
public class ClickEvent {
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         if (this.field_150671_a != lvt_2_1_.field_150671_a) {
            return false;
         } else {
            if (this.field_150670_b != null) {
               if (!this.field_150670_b.equals(lvt_2_1_.field_150670_b)) {
                  return false;
               }
            } else if (lvt_2_1_.field_150670_b != null) {
               return false;
            }
   ...
   public int hashCode() {
      int lvt_1_1_ = this.field_150671_a.hashCode();
      lvt_1_1_ = 31 * lvt_1_1_ + (this.field_150670_b != null ? this.field_150670_b.hashCode() : 0);
      return lvt_1_1_;
   }
   ...
   public static enum Action {
      ...
      static {
         ClickEvent.Action[] lvt_0_1_ = values();
         int lvt_1_1_ = lvt_0_1_.length;

         for(int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_; ++lvt_2_1_) {
            ClickEvent.Action lvt_3_1_ = lvt_0_1_[lvt_2_1_];
            field_150679_e.put(lvt_3_1_.func_150673_b(), lvt_3_1_);
         }
