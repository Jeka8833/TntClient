...
public class CrashReport {
   ...
   private void func_71504_g() {
      ...
      if (Reflector.FMLCommonHandler_enhanceCrashReport.exists()) {
         ...
         Reflector.callString(instance, Reflector.FMLCommonHandler_enhanceCrashReport, this, this.field_85061_c);
      }
   ...
   public void func_71506_a(StringBuilder p_71506_1_) {
      if ((this.field_85060_g == null || this.field_85060_g.length <= 0) && this.field_71512_c.size() > 0) {
         this.field_85060_g = (StackTraceElement[])((StackTraceElement[])ArrayUtils.subarray((Object[])((CrashReportCategory)this.field_71512_c.get(0)).func_147152_a(), 0, 1));
      }

      if (this.field_85060_g != null && this.field_85060_g.length > 0) {
         p_71506_1_.append("-- Head --\n");
         p_71506_1_.append("Stacktrace:\n");
         StackTraceElement[] arr$ = this.field_85060_g;
         int len$ = arr$.length;
      ...
      Iterator i$ = this.field_71512_c.iterator();

      while(i$.hasNext()) {
         CrashReportCategory crashreportcategory = (CrashReportCategory)i$.next();
   ...
   public String func_71498_d() {
      ...
      if (((Throwable)throwable).getMessage() == null) {
         ...
         ((Throwable)throwable).setStackTrace(this.field_71511_b.getStackTrace());
      }
