...
public class RealmsVertexFormat {
   ...
   public List<RealmsVertexFormatElement> getElements() {
      List<RealmsVertexFormatElement> lvt_1_1_ = new ArrayList();
      Iterator lvt_2_1_ = this.v.func_177343_g().iterator();

      while(lvt_2_1_.hasNext()) {
         VertexFormatElement lvt_3_1_ = (VertexFormatElement)lvt_2_1_.next();
