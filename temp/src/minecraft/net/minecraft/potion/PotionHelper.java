...
public class PotionHelper {
   ...
   public static int func_77911_a(Collection<PotionEffect> p_77911_0_) {
      ...
      if (p_77911_0_ != null && !p_77911_0_.isEmpty()) {
         ...
         float f2 = 0.0F;
         float f3 = 0.0F;
         Iterator i$ = p_77911_0_.iterator();
         ...
         while(true) {
            ...
            } while(!potioneffect.func_180154_f());

            int j = Potion.field_76425_a[potioneffect.func_76456_a()].func_76401_j();
            if (Config.isCustomColors()) {
               j = CustomColors.getPotionColor(potioneffect.func_76456_a(), j);
            }
   ...
   public static boolean func_82817_b(Collection<PotionEffect> p_82817_0_) {
      Iterator i$ = p_82817_0_.iterator();
   ...
   public static int func_77915_a(int p_77915_0_, boolean p_77915_1_) {
      ...
      if (!p_77915_1_) {
         if (field_77925_n.containsKey(integer)) {
            return (Integer)field_77925_n.get(integer);
         } else {
            int i = func_77911_a(func_77917_b(integer, false));
            field_77925_n.put(integer, i);
            return i;
         }
      } else {
         return func_77911_a(func_77917_b(integer, true));
      }
   }
   ...
   private static int func_77912_a(String p_77912_0_, int p_77912_1_, int p_77912_2_, int p_77912_3_) {
      if (p_77912_1_ < p_77912_0_.length() && p_77912_2_ >= 0 && p_77912_1_ < p_77912_2_) {
         ...
         int i2;
         if (i >= 0 && i < p_77912_2_) {
            j = func_77912_a(p_77912_0_, p_77912_1_, i - 1, p_77912_3_);
            if (j > 0) {
               return j;
            } else {
               i2 = func_77912_a(p_77912_0_, i + 1, p_77912_2_, p_77912_3_);
               return i2 > 0 ? i2 : 0;
            }
         } else {
            j = p_77912_0_.indexOf(38, p_77912_1_);
            if (j >= 0 && j < p_77912_2_) {
               i2 = func_77912_a(p_77912_0_, p_77912_1_, j - 1, p_77912_3_);
               if (i2 <= 0) {
                  return 0;
               } else {
   ...
   public static List<PotionEffect> func_77917_b(int p_77917_0_, boolean p_77917_1_) {
      ...
      Potion[] arr$ = Potion.field_76425_a;
      int len$ = arr$.length;

      for(int i$ = 0; i$ < len$; ++i$) {
         Potion potion = arr$[i$];
         if (potion != null && (!potion.func_76395_i() || p_77917_1_)) {
            String s = (String)field_179539_o.get(potion.func_76396_c());
            if (s != null) {
               int i = func_77912_a(s, 0, s.length(), p_77917_0_);
               if (i > 0) {
                  int j = 0;
                  String s1 = (String)field_179540_p.get(potion.func_76396_c());
                  if (s1 != null) {
