...
public class Potion {
   ...
   public void func_180793_a(Entity p_180793_1_, Entity p_180793_2_, EntityLivingBase p_180793_3_, int p_180793_4_, double p_180793_5_) {
      ...
      if ((this.field_76415_H != field_76432_h.field_76415_H || p_180793_3_.func_70662_br()) && (this.field_76415_H != field_76433_i.field_76415_H || !p_180793_3_.func_70662_br())) {
         if (this.field_76415_H == field_76433_i.field_76415_H && !p_180793_3_.func_70662_br() || this.field_76415_H == field_76432_h.field_76415_H && p_180793_3_.func_70662_br()) {
            lvt_7_2_ = (int)(p_180793_5_ * (double)(6 << p_180793_4_) + 0.5D);
            if (p_180793_1_ == null) {
               p_180793_3_.func_70097_a(DamageSource.field_76376_m, (float)lvt_7_2_);
            } else {
               p_180793_3_.func_70097_a(DamageSource.func_76354_b(p_180793_1_, p_180793_2_), (float)lvt_7_2_);
            }
         }
      } else {
         lvt_7_2_ = (int)(p_180793_5_ * (double)(4 << p_180793_4_) + 0.5D);
         p_180793_3_.func_70691_i((float)lvt_7_2_);
      }
   ...
   public boolean func_76397_a(int p_76397_1_, int p_76397_2_) {
      int lvt_3_3_;
      if (this.field_76415_H == field_76428_l.field_76415_H) {
         lvt_3_3_ = 50 >> p_76397_2_;
         if (lvt_3_3_ > 0) {
            return p_76397_1_ % lvt_3_3_ == 0;
         } else {
            return true;
         }
      } else if (this.field_76415_H == field_76436_u.field_76415_H) {
         lvt_3_3_ = 25 >> p_76397_2_;
         if (lvt_3_3_ > 0) {
            return p_76397_1_ % lvt_3_3_ == 0;
         } else {
            return true;
   ...
   public static String func_76389_a(PotionEffect p_76389_0_) {
      if (p_76389_0_.func_100011_g()) {
         ...
         int lvt_1_1_ = p_76389_0_.func_76459_b();
         return StringUtils.func_76337_a(lvt_1_1_);
      }
   }
   ...
   public Potion func_111184_a(IAttribute p_111184_1_, String p_111184_2_, double p_111184_3_, int p_111184_5_) {
      AttributeModifier lvt_6_1_ = new AttributeModifier(UUID.fromString(p_111184_2_), this.func_76393_a(), p_111184_3_, p_111184_5_);
      this.field_111188_I.put(p_111184_1_, lvt_6_1_);
      return this;
   }
   ...
   public void func_111187_a(EntityLivingBase p_111187_1_, BaseAttributeMap p_111187_2_, int p_111187_3_) {
      Iterator lvt_4_1_ = this.field_111188_I.entrySet().iterator();

      while(lvt_4_1_.hasNext()) {
         Entry<IAttribute, AttributeModifier> lvt_5_1_ = (Entry)lvt_4_1_.next();
         IAttributeInstance lvt_6_1_ = p_111187_2_.func_111151_a((IAttribute)lvt_5_1_.getKey());
         if (lvt_6_1_ != null) {
            lvt_6_1_.func_111124_b((AttributeModifier)lvt_5_1_.getValue());
         }
      }
   ...
   public void func_111185_a(EntityLivingBase p_111185_1_, BaseAttributeMap p_111185_2_, int p_111185_3_) {
      ...
      while(lvt_4_1_.hasNext()) {
         Entry<IAttribute, AttributeModifier> lvt_5_1_ = (Entry)lvt_4_1_.next();
         IAttributeInstance lvt_6_1_ = p_111185_2_.func_111151_a((IAttribute)lvt_5_1_.getKey());
         if (lvt_6_1_ != null) {
            AttributeModifier lvt_7_1_ = (AttributeModifier)lvt_5_1_.getValue();
            lvt_6_1_.func_111124_b(lvt_7_1_);
            lvt_6_1_.func_111121_a(new AttributeModifier(lvt_7_1_.func_111167_a(), this.func_76393_a() + " " + p_111185_3_, this.func_111183_a(p_111185_3_, lvt_7_1_), lvt_7_1_.func_111169_c()));
         }
      }
