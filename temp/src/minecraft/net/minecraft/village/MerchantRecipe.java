...
public class MerchantRecipe {
   ...
   public void func_77390_a(NBTTagCompound p_77390_1_) {
      NBTTagCompound lvt_2_1_ = p_77390_1_.func_74775_l("buy");
      this.field_77403_a = ItemStack.func_77949_a(lvt_2_1_);
      NBTTagCompound lvt_3_1_ = p_77390_1_.func_74775_l("sell");
      this.field_77402_c = ItemStack.func_77949_a(lvt_3_1_);
   ...
   public NBTTagCompound func_77395_g() {
      ...
      lvt_1_1_.func_74782_a("buy", this.field_77403_a.func_77955_b(new NBTTagCompound()));
      lvt_1_1_.func_74782_a("sell", this.field_77402_c.func_77955_b(new NBTTagCompound()));
      if (this.field_77401_b != null) {
         lvt_1_1_.func_74782_a("buyB", this.field_77401_b.func_77955_b(new NBTTagCompound()));
      }

      lvt_1_1_.func_74768_a("uses", this.field_77400_d);
      lvt_1_1_.func_74768_a("maxUses", this.field_82786_e);
      lvt_1_1_.func_74757_a("rewardExp", this.field_180323_f);
      return lvt_1_1_;
   }
}
