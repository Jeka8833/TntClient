...
public class InventoryCrafting implements IInventory {
   ...
   public InventoryCrafting(Container p_i1807_1_, int p_i1807_2_, int p_i1807_3_) {
      int lvt_4_1_ = p_i1807_2_ * p_i1807_3_;
      this.field_70466_a = new ItemStack[lvt_4_1_];
   ...
   public ItemStack func_70304_b(int p_70304_1_) {
      if (this.field_70466_a[p_70304_1_] != null) {
         ItemStack lvt_2_1_ = this.field_70466_a[p_70304_1_];
   ...
   public ItemStack func_70298_a(int p_70298_1_, int p_70298_2_) {
      if (this.field_70466_a[p_70298_1_] != null) {
         ...
         if (this.field_70466_a[p_70298_1_].field_77994_a <= p_70298_2_) {
            lvt_3_2_ = this.field_70466_a[p_70298_1_];
            this.field_70466_a[p_70298_1_] = null;
            this.field_70465_c.func_75130_a(this);
            return lvt_3_2_;
         } else {
            lvt_3_2_ = this.field_70466_a[p_70298_1_].func_77979_a(p_70298_2_);
   ...
   public void func_174888_l() {
      for(int lvt_1_1_ = 0; lvt_1_1_ < this.field_70466_a.length; ++lvt_1_1_) {
         this.field_70466_a[lvt_1_1_] = null;
      }
