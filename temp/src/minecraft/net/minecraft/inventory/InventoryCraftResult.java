...
public class InventoryCraftResult implements IInventory {
   ...
   public ItemStack func_70298_a(int p_70298_1_, int p_70298_2_) {
      if (this.field_70467_a[0] != null) {
         ItemStack lvt_3_1_ = this.field_70467_a[0];
   ...
   public ItemStack func_70304_b(int p_70304_1_) {
      if (this.field_70467_a[0] != null) {
         ItemStack lvt_2_1_ = this.field_70467_a[0];
         this.field_70467_a[0] = null;
         return lvt_2_1_;
      } else {
         return null;
   ...
   public void func_174888_l() {
      for(int lvt_1_1_ = 0; lvt_1_1_ < this.field_70467_a.length; ++lvt_1_1_) {
         this.field_70467_a[lvt_1_1_] = null;
      }
