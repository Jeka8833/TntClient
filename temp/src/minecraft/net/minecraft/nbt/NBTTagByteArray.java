...
public class NBTTagByteArray extends NBTBase {
   ...
   void func_152446_a(DataInput p_152446_1_, int p_152446_2_, NBTSizeTracker p_152446_3_) throws IOException {
      ...
      p_152446_3_.func_152450_a((long)(8 * lvt_4_1_));
      this.field_74754_a = new byte[lvt_4_1_];
   ...
   public NBTBase func_74737_b() {
      byte[] lvt_1_1_ = new byte[this.field_74754_a.length];
      System.arraycopy(this.field_74754_a, 0, lvt_1_1_, 0, this.field_74754_a.length);
