...
public class NBTTagList extends NBTBase {
   ...
   void func_74734_a(DataOutput p_74734_1_) throws IOException {
      ...
      for(int lvt_2_1_ = 0; lvt_2_1_ < this.field_74747_a.size(); ++lvt_2_1_) {
         ((NBTBase)this.field_74747_a.get(lvt_2_1_)).func_74734_a(p_74734_1_);
      }
   ...
   void func_152446_a(DataInput p_152446_1_, int p_152446_2_, NBTSizeTracker p_152446_3_) throws IOException {
      ...
      if (p_152446_2_ > 512) {
         ...
         if (this.field_74746_b == 0 && lvt_4_1_ > 0) {
            throw new RuntimeException("Missing type on ListTag");
         } else {
            p_152446_3_.func_152450_a(32L * (long)lvt_4_1_);
            this.field_74747_a = Lists.newArrayListWithCapacity(lvt_4_1_);

            for(int lvt_5_1_ = 0; lvt_5_1_ < lvt_4_1_; ++lvt_5_1_) {
               NBTBase lvt_6_1_ = NBTBase.func_150284_a(this.field_74746_b);
               lvt_6_1_.func_152446_a(p_152446_1_, p_152446_2_ + 1, p_152446_3_);
               this.field_74747_a.add(lvt_6_1_);
            }
   ...
   public String toString() {
      ...
      for(int lvt_2_1_ = 0; lvt_2_1_ < this.field_74747_a.size(); ++lvt_2_1_) {
         ...
         lvt_1_1_.append(lvt_2_1_).append(':').append(this.field_74747_a.get(lvt_2_1_));
      }
   ...
   public NBTTagCompound func_150305_b(int p_150305_1_) {
      if (p_150305_1_ >= 0 && p_150305_1_ < this.field_74747_a.size()) {
         NBTBase lvt_2_1_ = (NBTBase)this.field_74747_a.get(p_150305_1_);
         return lvt_2_1_.func_74732_a() == 10 ? (NBTTagCompound)lvt_2_1_ : new NBTTagCompound();
      } else {
   ...
   public int[] func_150306_c(int p_150306_1_) {
      if (p_150306_1_ >= 0 && p_150306_1_ < this.field_74747_a.size()) {
         NBTBase lvt_2_1_ = (NBTBase)this.field_74747_a.get(p_150306_1_);
         return lvt_2_1_.func_74732_a() == 11 ? ((NBTTagIntArray)lvt_2_1_).func_150302_c() : new int[0];
      } else {
         return new int[0];
      }
   }
   ...
   public double func_150309_d(int p_150309_1_) {
      if (p_150309_1_ >= 0 && p_150309_1_ < this.field_74747_a.size()) {
         NBTBase lvt_2_1_ = (NBTBase)this.field_74747_a.get(p_150309_1_);
         return lvt_2_1_.func_74732_a() == 6 ? ((NBTTagDouble)lvt_2_1_).func_150286_g() : 0.0D;
      } else {
         return 0.0D;
      }
   }
   ...
   public float func_150308_e(int p_150308_1_) {
      if (p_150308_1_ >= 0 && p_150308_1_ < this.field_74747_a.size()) {
         NBTBase lvt_2_1_ = (NBTBase)this.field_74747_a.get(p_150308_1_);
         return lvt_2_1_.func_74732_a() == 5 ? ((NBTTagFloat)lvt_2_1_).func_150288_h() : 0.0F;
      } else {
         return 0.0F;
      }
   }
   ...
   public String func_150307_f(int p_150307_1_) {
      if (p_150307_1_ >= 0 && p_150307_1_ < this.field_74747_a.size()) {
         NBTBase lvt_2_1_ = (NBTBase)this.field_74747_a.get(p_150307_1_);
         return lvt_2_1_.func_74732_a() == 8 ? lvt_2_1_.func_150285_a_() : lvt_2_1_.toString();
      } else {
         return "";
      }
   }
   ...
   public NBTBase func_74737_b() {
      ...
      lvt_1_1_.field_74746_b = this.field_74746_b;
      Iterator lvt_2_1_ = this.field_74747_a.iterator();

      while(lvt_2_1_.hasNext()) {
         NBTBase lvt_3_1_ = (NBTBase)lvt_2_1_.next();
         NBTBase lvt_4_1_ = lvt_3_1_.func_74737_b();
         lvt_1_1_.field_74747_a.add(lvt_4_1_);
      }
   ...
   public boolean equals(Object p_equals_1_) {
      if (super.equals(p_equals_1_)) {
         ...
         if (this.field_74746_b == lvt_2_1_.field_74746_b) {
            return this.field_74747_a.equals(lvt_2_1_.field_74747_a);
         }
      }
