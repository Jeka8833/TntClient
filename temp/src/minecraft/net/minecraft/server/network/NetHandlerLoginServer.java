...
public class NetHandlerLoginServer implements INetHandlerLoginServer, ITickable {
   ...
   public void func_73660_a() {
      if (this.field_147328_g == NetHandlerLoginServer.LoginState.READY_TO_ACCEPT) {
         ...
         EntityPlayerMP lvt_1_1_ = this.field_147327_f.func_71203_ab().func_177451_a(this.field_147337_i.getId());
         if (lvt_1_1_ == null) {
   ...
   public void func_147322_a(String p_147322_1_) {
      try {
         ...
         ChatComponentText lvt_2_1_ = new ChatComponentText(p_147322_1_);
         this.field_147333_a.func_179290_a(new S00PacketDisconnect(lvt_2_1_));
         this.field_147333_a.func_150718_a(lvt_2_1_);
      } catch (Exception var3) {
         field_147332_c.error((String)"Error whilst disconnecting player", (Throwable)var3);
      }
   ...
   public void func_147326_c() {
      ...
      String lvt_1_1_ = this.field_147327_f.func_71203_ab().func_148542_a(this.field_147333_a.func_74430_c(), this.field_147337_i);
      if (lvt_1_1_ != null) {
         this.func_147322_a(lvt_1_1_);
      } else {
         ...
         EntityPlayerMP lvt_2_1_ = this.field_147327_f.func_71203_ab().func_177451_a(this.field_147337_i.getId());
         if (lvt_2_1_ != null) {
   ...
   public void func_147315_a(C01PacketEncryptionResponse p_147315_1_) {
      ...
      PrivateKey lvt_2_1_ = this.field_147327_f.func_71250_E().getPrivate();
      if (!Arrays.equals(this.field_147330_e, p_147315_1_.func_149299_b(lvt_2_1_))) {
         throw new IllegalStateException("Invalid nonce!");
      } else {
         this.field_147335_k = p_147315_1_.func_149300_a(lvt_2_1_);
         ...
         (new Thread("User Authenticator #" + field_147331_b.incrementAndGet()) {
            public void run() {
               GameProfile lvt_1_1_ = NetHandlerLoginServer.this.field_147337_i;

               try {
                  String lvt_2_1_ = (new BigInteger(CryptManager.func_75895_a(NetHandlerLoginServer.this.field_147334_j, NetHandlerLoginServer.this.field_147327_f.func_71250_E().getPublic(), NetHandlerLoginServer.this.field_147335_k))).toString(16);
                  NetHandlerLoginServer.this.field_147337_i = NetHandlerLoginServer.this.field_147327_f.func_147130_as().hasJoinedServer(new GameProfile((UUID)null, lvt_1_1_.getName()), lvt_2_1_);
                  if (NetHandlerLoginServer.this.field_147337_i != null) {
                     ...
                     NetHandlerLoginServer.this.field_147337_i = NetHandlerLoginServer.this.func_152506_a(lvt_1_1_);
                     NetHandlerLoginServer.this.field_147328_g = NetHandlerLoginServer.LoginState.READY_TO_ACCEPT;
                  } else {
   ...
   protected GameProfile func_152506_a(GameProfile p_152506_1_) {
      UUID lvt_2_1_ = UUID.nameUUIDFromBytes(("OfflinePlayer:" + p_152506_1_.getName()).getBytes(Charsets.UTF_8));
      return new GameProfile(lvt_2_1_, p_152506_1_.getName());
   }
