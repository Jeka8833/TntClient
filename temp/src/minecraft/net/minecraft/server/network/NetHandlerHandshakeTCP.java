...
public class NetHandlerHandshakeTCP implements INetHandlerHandshakeServer {
   ...
   public void func_147383_a(C00Handshake p_147383_1_) {
      ...
      case LOGIN:
         ...
         ChatComponentText lvt_2_2_;
         if (p_147383_1_.func_149595_d() > 47) {
            lvt_2_2_ = new ChatComponentText("Outdated server! I'm still on 1.8.9");
            this.field_147386_b.func_179290_a(new S00PacketDisconnect(lvt_2_2_));
            this.field_147386_b.func_150718_a(lvt_2_2_);
         } else if (p_147383_1_.func_149595_d() < 47) {
            lvt_2_2_ = new ChatComponentText("Outdated client! Please use 1.8.9");
            this.field_147386_b.func_179290_a(new S00PacketDisconnect(lvt_2_2_));
            this.field_147386_b.func_150718_a(lvt_2_2_);
         } else {
