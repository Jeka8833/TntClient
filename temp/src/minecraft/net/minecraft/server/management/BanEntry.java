...
public abstract class BanEntry<T> extends UserListEntry<T> {
   ...
   protected BanEntry(T p_i1174_1_, JsonObject p_i1174_2_) {
      ...
      Date lvt_3_2_;
      try {
         lvt_3_2_ = p_i1174_2_.has("created") ? field_73698_a.parse(p_i1174_2_.get("created").getAsString()) : new Date();
      } catch (ParseException var7) {
         lvt_3_2_ = new Date();
      }

      this.field_73694_d = lvt_3_2_;
      this.field_73695_e = p_i1174_2_.has("source") ? p_i1174_2_.get("source").getAsString() : "(Unknown)";

      Date lvt_4_3_;
      try {
         lvt_4_3_ = p_i1174_2_.has("expires") ? field_73698_a.parse(p_i1174_2_.get("expires").getAsString()) : null;
      } catch (ParseException var6) {
         lvt_4_3_ = null;
      }

      this.field_73692_f = lvt_4_3_;
