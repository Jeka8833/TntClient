...
public abstract class Enchantment {
   ...
   public String func_77316_c(int p_77316_1_) {
      String lvt_2_1_ = StatCollector.func_74838_a(this.func_77320_a());
      return lvt_2_1_ + " " + StatCollector.func_74838_a("enchantment.level." + p_77316_1_);
   }
   ...
   static {
      ...
      List<Enchantment> lvt_0_1_ = Lists.newArrayList();
      Enchantment[] lvt_1_1_ = field_180311_a;
      int lvt_2_1_ = lvt_1_1_.length;

      for(int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_) {
         Enchantment lvt_4_1_ = lvt_1_1_[lvt_3_1_];
         if (lvt_4_1_ != null) {
            lvt_0_1_.add(lvt_4_1_);
         }
      }

      field_77331_b = (Enchantment[])lvt_0_1_.toArray(new Enchantment[lvt_0_1_.size()]);
   }
}
