...
public class EnchantmentProtection extends Enchantment {
   ...
   public int func_77318_a(int p_77318_1_, DamageSource p_77318_2_) {
      if (p_77318_2_.func_76357_e()) {
         ...
         float lvt_3_1_ = (float)(6 + p_77318_1_ * p_77318_1_) / 3.0F;
         if (this.field_77356_a == 0) {
            return MathHelper.func_76141_d(lvt_3_1_ * 0.75F);
         } else if (this.field_77356_a == 1 && p_77318_2_.func_76347_k()) {
            return MathHelper.func_76141_d(lvt_3_1_ * 1.25F);
         } else if (this.field_77356_a == 2 && p_77318_2_ == DamageSource.field_76379_h) {
            return MathHelper.func_76141_d(lvt_3_1_ * 2.5F);
         } else if (this.field_77356_a == 3 && p_77318_2_.func_94541_c()) {
            return MathHelper.func_76141_d(lvt_3_1_ * 1.5F);
         } else {
            return this.field_77356_a == 4 && p_77318_2_.func_76352_a() ? MathHelper.func_76141_d(lvt_3_1_ * 1.5F) : 0;
         }
      }
   }
   ...
   public boolean func_77326_a(Enchantment p_77326_1_) {
      if (p_77326_1_ instanceof EnchantmentProtection) {
         EnchantmentProtection lvt_2_1_ = (EnchantmentProtection)p_77326_1_;
         if (lvt_2_1_.field_77356_a == this.field_77356_a) {
            return false;
         } else {
            return this.field_77356_a == 2 || lvt_2_1_.field_77356_a == 2;
         }
      } else {
   ...
   public static int func_92093_a(Entity p_92093_0_, int p_92093_1_) {
      int lvt_2_1_ = EnchantmentHelper.func_77511_a(Enchantment.field_77329_d.field_77352_x, p_92093_0_.func_70035_c());
      if (lvt_2_1_ > 0) {
         p_92093_1_ -= MathHelper.func_76141_d((float)p_92093_1_ * (float)lvt_2_1_ * 0.15F);
      }
   ...
   public static double func_92092_a(Entity p_92092_0_, double p_92092_1_) {
      int lvt_3_1_ = EnchantmentHelper.func_77511_a(Enchantment.field_77327_f.field_77352_x, p_92092_0_.func_70035_c());
      if (lvt_3_1_ > 0) {
         p_92092_1_ -= (double)MathHelper.func_76128_c(p_92092_1_ * (double)((float)lvt_3_1_ * 0.15F));
      }
