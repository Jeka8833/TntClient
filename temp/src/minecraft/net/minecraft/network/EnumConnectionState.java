...
public enum EnumConnectionState {
   ...
   protected EnumConnectionState func_179245_a(EnumPacketDirection p_179245_1_, Class<? extends Packet> p_179245_2_) {
      BiMap<Integer, Class<? extends Packet>> lvt_3_1_ = (BiMap)this.field_179247_h.get(p_179245_1_);
      if (lvt_3_1_ == null) {
         lvt_3_1_ = HashBiMap.create();
         this.field_179247_h.put(p_179245_1_, lvt_3_1_);
      }

      if (((BiMap)lvt_3_1_).containsValue(p_179245_2_)) {
         String lvt_4_1_ = p_179245_1_ + " packet " + p_179245_2_ + " is already known to ID " + ((BiMap)lvt_3_1_).inverse().get(p_179245_2_);
         LogManager.getLogger().fatal(lvt_4_1_);
         throw new IllegalArgumentException(lvt_4_1_);
      } else {
         ((BiMap)lvt_3_1_).put(((BiMap)lvt_3_1_).size(), p_179245_2_);
         return this;
      }
   }
   ...
   public Packet func_179244_a(EnumPacketDirection p_179244_1_, int p_179244_2_) throws InstantiationException, IllegalAccessException {
      Class<? extends Packet> lvt_3_1_ = (Class)((BiMap)this.field_179247_h.get(p_179244_1_)).get(p_179244_2_);
      return lvt_3_1_ == null ? null : (Packet)lvt_3_1_.newInstance();
   }
   ...
   static {
      EnumConnectionState[] lvt_0_1_ = values();
      int lvt_1_1_ = lvt_0_1_.length;

      for(int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_; ++lvt_2_1_) {
         EnumConnectionState lvt_3_1_ = lvt_0_1_[lvt_2_1_];
         int lvt_4_1_ = lvt_3_1_.func_150759_c();
         if (lvt_4_1_ < field_181136_e || lvt_4_1_ > field_181137_f) {
            throw new Error("Invalid protocol ID " + Integer.toString(lvt_4_1_));
         }

         field_150764_e[lvt_4_1_ - field_181136_e] = lvt_3_1_;
         Iterator lvt_5_1_ = lvt_3_1_.field_179247_h.keySet().iterator();

         while(lvt_5_1_.hasNext()) {
            EnumPacketDirection lvt_6_1_ = (EnumPacketDirection)lvt_5_1_.next();

            Class lvt_8_1_;
            for(Iterator lvt_7_1_ = ((BiMap)lvt_3_1_.field_179247_h.get(lvt_6_1_)).values().iterator(); lvt_7_1_.hasNext(); field_150761_f.put(lvt_8_1_, lvt_3_1_)) {
               lvt_8_1_ = (Class)lvt_7_1_.next();
               ...
               try {
                  lvt_8_1_.newInstance();
               } catch (Throwable var10) {
                  throw new Error("Packet " + lvt_8_1_ + " fails instantiation checks! " + lvt_8_1_);
               }
            }
         }
      }
