...
public class PacketBuffer extends ByteBuf {
   ...
   public byte[] func_179251_a() {
      byte[] lvt_1_1_ = new byte[this.func_150792_a()];
   ...
   public void func_150788_a(ItemStack p_150788_1_) {
      if (p_150788_1_ == null) {
         ...
         if (p_150788_1_.func_77973_b().func_77645_m() || p_150788_1_.func_77973_b().func_77651_p()) {
            lvt_2_1_ = p_150788_1_.func_77978_p();
         }

         this.func_150786_a(lvt_2_1_);
      }
   ...
   public ItemStack func_150791_c() throws IOException {
      ...
      if (lvt_2_1_ >= 0) {
         ...
         lvt_1_1_ = new ItemStack(Item.func_150899_d(lvt_2_1_), lvt_3_1_, lvt_4_1_);
         lvt_1_1_.func_77982_d(this.func_150793_b());
      }
   ...
   public String func_150789_c(int p_150789_1_) {
      int lvt_2_1_ = this.func_150792_a();
      if (lvt_2_1_ > p_150789_1_ * 4) {
         throw new DecoderException("The received encoded string buffer length is longer than maximum allowed (" + lvt_2_1_ + " > " + p_150789_1_ * 4 + ")");
      } else if (lvt_2_1_ < 0) {
         throw new DecoderException("The received encoded string buffer length is less than zero! Weird string!");
      } else {
         String lvt_3_1_ = new String(this.readBytes(lvt_2_1_).array(), Charsets.UTF_8);
         if (lvt_3_1_.length() > p_150789_1_) {
            throw new DecoderException("The received string length is longer than maximum allowed (" + lvt_2_1_ + " > " + p_150789_1_ + ")");
         } else {
            return lvt_3_1_;
         }
      }
