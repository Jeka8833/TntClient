...
public class S13PacketDestroyEntities implements Packet<INetHandlerPlayClient> {
   ...
   public void func_148837_a(PacketBuffer p_148837_1_) throws IOException {
      ...
      for(int lvt_2_1_ = 0; lvt_2_1_ < this.field_149100_a.length; ++lvt_2_1_) {
         this.field_149100_a[lvt_2_1_] = p_148837_1_.func_150792_a();
      }
   ...
   public void func_148840_b(PacketBuffer p_148840_1_) throws IOException {
      ...
      for(int lvt_2_1_ = 0; lvt_2_1_ < this.field_149100_a.length; ++lvt_2_1_) {
         p_148840_1_.func_150787_b(this.field_149100_a[lvt_2_1_]);
      }
