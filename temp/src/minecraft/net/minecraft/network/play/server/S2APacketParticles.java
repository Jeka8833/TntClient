...
public class S2APacketParticles implements Packet<INetHandlerPlayClient> {
   ...
   public void func_148837_a(PacketBuffer p_148837_1_) throws IOException {
      ...
      int lvt_2_1_ = this.field_179751_a.func_179345_d();
      this.field_179753_k = new int[lvt_2_1_];

      for(int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_) {
         this.field_179753_k[lvt_3_1_] = p_148837_1_.func_150792_a();
      }
   ...
   public void func_148840_b(PacketBuffer p_148840_1_) throws IOException {
      ...
      for(int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_) {
         p_148840_1_.func_150787_b(this.field_179753_k[lvt_3_1_]);
      }
