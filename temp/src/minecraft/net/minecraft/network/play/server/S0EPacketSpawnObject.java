...
public class S0EPacketSpawnObject implements Packet<INetHandlerPlayClient> {
   ...
   public S0EPacketSpawnObject(Entity p_i45166_1_, int p_i45166_2_, int p_i45166_3_) {
      ...
      if (p_i45166_3_ > 0) {
         double lvt_4_1_ = p_i45166_1_.field_70159_w;
         double lvt_6_1_ = p_i45166_1_.field_70181_x;
         double lvt_8_1_ = p_i45166_1_.field_70179_y;
         double lvt_10_1_ = 3.9D;
         if (lvt_4_1_ < -lvt_10_1_) {
            lvt_4_1_ = -lvt_10_1_;
         }

         if (lvt_6_1_ < -lvt_10_1_) {
            lvt_6_1_ = -lvt_10_1_;
         }
         ...
         this.field_149015_e = (int)(lvt_4_1_ * 8000.0D);
         this.field_149012_f = (int)(lvt_6_1_ * 8000.0D);
         this.field_149013_g = (int)(lvt_8_1_ * 8000.0D);
      }
