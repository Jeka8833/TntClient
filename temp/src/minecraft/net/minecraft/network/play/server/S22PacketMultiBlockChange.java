...
public class S22PacketMultiBlockChange implements Packet<INetHandlerPlayClient> {
   ...
   public S22PacketMultiBlockChange(int p_i45181_1_, short[] p_i45181_2_, Chunk p_i45181_3_) {
      ...
      for(int lvt_4_1_ = 0; lvt_4_1_ < this.field_179845_b.length; ++lvt_4_1_) {
         this.field_179845_b[lvt_4_1_] = new S22PacketMultiBlockChange.BlockUpdateData(p_i45181_2_[lvt_4_1_], p_i45181_3_);
      }
   ...
   public void func_148837_a(PacketBuffer p_148837_1_) throws IOException {
      ...
      for(int lvt_2_1_ = 0; lvt_2_1_ < this.field_179845_b.length; ++lvt_2_1_) {
         this.field_179845_b[lvt_2_1_] = new S22PacketMultiBlockChange.BlockUpdateData(p_148837_1_.readShort(), (IBlockState)Block.field_176229_d.func_148745_a(p_148837_1_.func_150792_a()));
      }
   ...
   public void func_148840_b(PacketBuffer p_148840_1_) throws IOException {
      ...
      S22PacketMultiBlockChange.BlockUpdateData[] lvt_2_1_ = this.field_179845_b;
      ...
      for(int lvt_4_1_ = 0; lvt_4_1_ < lvt_3_1_; ++lvt_4_1_) {
         ...
         p_148840_1_.writeShort(lvt_5_1_.func_180089_b());
         p_148840_1_.func_150787_b(Block.field_176229_d.func_148747_b(lvt_5_1_.func_180088_c()));
      }
