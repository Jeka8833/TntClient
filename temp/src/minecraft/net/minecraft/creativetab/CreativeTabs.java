...
public abstract class CreativeTabs {
   ...
   public boolean func_111226_a(EnumEnchantmentType p_111226_1_) {
      if (this.field_111230_s == null) {
         ...
         EnumEnchantmentType[] lvt_2_1_ = this.field_111230_s;
         int lvt_3_1_ = lvt_2_1_.length;

         for(int lvt_4_1_ = 0; lvt_4_1_ < lvt_3_1_; ++lvt_4_1_) {
            EnumEnchantmentType lvt_5_1_ = lvt_2_1_[lvt_4_1_];
            if (lvt_5_1_ == p_111226_1_) {
               return true;
            }
         }
   ...
   public void func_78018_a(List<ItemStack> p_78018_1_) {
      Iterator lvt_2_1_ = Item.field_150901_e.iterator();

      while(lvt_2_1_.hasNext()) {
         Item lvt_3_1_ = (Item)lvt_2_1_.next();
         if (lvt_3_1_ != null && lvt_3_1_.func_77640_w() == this) {
            lvt_3_1_.func_150895_a(lvt_3_1_, this, p_78018_1_);
         }
      }
   ...
   public void func_92116_a(List<ItemStack> p_92116_1_, EnumEnchantmentType... p_92116_2_) {
      Enchantment[] lvt_3_1_ = Enchantment.field_77331_b;
      int lvt_4_1_ = lvt_3_1_.length;

      for(int lvt_5_1_ = 0; lvt_5_1_ < lvt_4_1_; ++lvt_5_1_) {
         Enchantment lvt_6_1_ = lvt_3_1_[lvt_5_1_];
         if (lvt_6_1_ != null && lvt_6_1_.field_77351_y != null) {
            boolean lvt_7_1_ = false;

            for(int lvt_8_1_ = 0; lvt_8_1_ < p_92116_2_.length && !lvt_7_1_; ++lvt_8_1_) {
               if (lvt_6_1_.field_77351_y == p_92116_2_[lvt_8_1_]) {
                  lvt_7_1_ = true;
               }
            }

            if (lvt_7_1_) {
               p_92116_1_.add(Items.field_151134_bR.func_92111_a(new EnchantmentData(lvt_6_1_, lvt_6_1_.func_77325_b())));
            }
         }
      }
