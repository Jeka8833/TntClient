...
public class ServerCommandManager extends CommandHandler implements IAdminCommand {
   ...
   public void func_152372_a(ICommandSender p_152372_1_, ICommand p_152372_2_, int p_152372_3_, String p_152372_4_, Object... p_152372_5_) {
      ...
      MinecraftServer lvt_7_1_ = MinecraftServer.func_71276_C();
      if (!p_152372_1_.func_174792_t_()) {
         lvt_6_1_ = false;
      }

      IChatComponent lvt_8_1_ = new ChatComponentTranslation("chat.type.admin", new Object[]{p_152372_1_.func_70005_c_(), new ChatComponentTranslation(p_152372_4_, p_152372_5_)});
      lvt_8_1_.func_150256_b().func_150238_a(EnumChatFormatting.GRAY);
      lvt_8_1_.func_150256_b().func_150217_b(true);
      if (lvt_6_1_) {
         Iterator lvt_9_1_ = lvt_7_1_.func_71203_ab().func_181057_v().iterator();

         label85:
         while(true) {
            EntityPlayer lvt_10_1_;
            boolean lvt_11_1_;
            boolean lvt_12_1_;
            do {
               do {
                  do {
                     do {
                        ...
                        lvt_10_1_ = (EntityPlayer)lvt_9_1_.next();
                     } while(lvt_10_1_ == p_152372_1_);
                  } while(!lvt_7_1_.func_71203_ab().func_152596_g(lvt_10_1_.func_146103_bH()));
               } while(!p_152372_2_.func_71519_b(p_152372_1_));

               lvt_11_1_ = p_152372_1_ instanceof MinecraftServer && MinecraftServer.func_71276_C().func_183002_r();
               lvt_12_1_ = p_152372_1_ instanceof RConConsoleSource && MinecraftServer.func_71276_C().func_181034_q();
            } while(!lvt_11_1_ && !lvt_12_1_ && (p_152372_1_ instanceof RConConsoleSource || p_152372_1_ instanceof MinecraftServer));

            lvt_10_1_.func_145747_a(lvt_8_1_);
         }
      }

      if (p_152372_1_ != lvt_7_1_ && lvt_7_1_.field_71305_c[0].func_82736_K().func_82766_b("logAdminCommands")) {
         lvt_7_1_.func_145747_a(lvt_8_1_);
      }

      boolean lvt_9_2_ = lvt_7_1_.field_71305_c[0].func_82736_K().func_82766_b("sendCommandFeedback");
      if (p_152372_1_ instanceof CommandBlockLogic) {
         lvt_9_2_ = ((CommandBlockLogic)p_152372_1_).func_175571_m();
      }

      if ((p_152372_3_ & 1) != 1 && lvt_9_2_ || p_152372_1_ instanceof MinecraftServer) {
