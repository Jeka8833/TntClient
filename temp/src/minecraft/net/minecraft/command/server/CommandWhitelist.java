   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) throws CommandException {
      if (p_71515_2_.length < 1) {
         ...
         if (p_71515_2_[0].equals("on")) {
            lvt_3_1_.func_71203_ab().func_72371_a(true);
            func_152373_a(p_71515_1_, this, "commands.whitelist.enabled", new Object[0]);
         } else if (p_71515_2_[0].equals("off")) {
            lvt_3_1_.func_71203_ab().func_72371_a(false);
            func_152373_a(p_71515_1_, this, "commands.whitelist.disabled", new Object[0]);
         } else if (p_71515_2_[0].equals("list")) {
            p_71515_1_.func_145747_a(new ChatComponentTranslation("commands.whitelist.list", new Object[]{lvt_3_1_.func_71203_ab().func_152598_l().length, lvt_3_1_.func_71203_ab().func_72373_m().length}));
            String[] lvt_4_1_ = lvt_3_1_.func_71203_ab().func_152598_l();
            p_71515_1_.func_145747_a(new ChatComponentText(func_71527_a(lvt_4_1_)));
         } else {
            GameProfile lvt_4_3_;
            if (p_71515_2_[0].equals("add")) {
               if (p_71515_2_.length < 2) {
                  throw new WrongUsageException("commands.whitelist.add.usage", new Object[0]);
               }

               lvt_4_3_ = lvt_3_1_.func_152358_ax().func_152655_a(p_71515_2_[1]);
               if (lvt_4_3_ == null) {
                  throw new CommandException("commands.whitelist.add.failed", new Object[]{p_71515_2_[1]});
               }

               lvt_3_1_.func_71203_ab().func_152601_d(lvt_4_3_);
               ...
               lvt_4_3_ = lvt_3_1_.func_71203_ab().func_152599_k().func_152706_a(p_71515_2_[1]);
               if (lvt_4_3_ == null) {
                  throw new CommandException("commands.whitelist.remove.failed", new Object[]{p_71515_2_[1]});
               }

               lvt_3_1_.func_71203_ab().func_152597_c(lvt_4_3_);
               ...
               lvt_3_1_.func_71203_ab().func_72362_j();
