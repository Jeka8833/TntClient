...
public abstract class CommandBlockLogic implements ICommandSender {
   ...
   public void func_145755_a(World p_145755_1_) {
      ...
      if (lvt_2_1_ != null && lvt_2_1_.func_175578_N() && lvt_2_1_.func_82356_Z()) {
         ICommandManager lvt_3_1_ = lvt_2_1_.func_71187_D();

         try {
            this.field_145762_d = null;
            this.field_145764_b = lvt_3_1_.func_71556_a(this, this.field_145763_e);
         } catch (Throwable var7) {
            CrashReport lvt_5_1_ = CrashReport.func_85055_a(var7, "Executing command block");
            CrashReportCategory lvt_6_1_ = lvt_5_1_.func_85058_a("Command to be executed");
            lvt_6_1_.func_71500_a("Command", new Callable<String>() {
               public String call() throws Exception {
                  return CommandBlockLogic.this.func_145753_i();
               }
            });
            lvt_6_1_.func_71500_a("Name", new Callable<String>() {
               public String call() throws Exception {
   ...
   public boolean func_174792_t_() {
      ...
      return lvt_1_1_ == null || !lvt_1_1_.func_175578_N() || lvt_1_1_.field_71305_c[0].func_82736_K().func_82766_b("commandBlockOutput");
   }
