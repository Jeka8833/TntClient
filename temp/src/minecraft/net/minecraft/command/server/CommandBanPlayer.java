      ...
      if (p_71515_2_.length >= 1 && p_71515_2_[0].length() > 0) {
         ...
         if (lvt_4_1_ == null) {
            ...
            if (p_71515_2_.length >= 2) {
               lvt_5_1_ = func_147178_a(p_71515_1_, p_71515_2_, 1).func_150260_c();
            }

            UserListBansEntry lvt_6_1_ = new UserListBansEntry(lvt_4_1_, (Date)null, p_71515_1_.func_70005_c_(), (Date)null, lvt_5_1_);
            lvt_3_1_.func_71203_ab().func_152608_h().func_152687_a(lvt_6_1_);
            EntityPlayerMP lvt_7_1_ = lvt_3_1_.func_71203_ab().func_152612_a(p_71515_2_[0]);
            if (lvt_7_1_ != null) {
               lvt_7_1_.field_71135_a.func_147360_c("You are banned from this server.");
            }
