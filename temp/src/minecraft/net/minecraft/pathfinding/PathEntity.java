...
public class PathEntity {
   ...
   public Vec3 func_75881_a(Entity p_75881_1_, int p_75881_2_) {
      double lvt_3_1_ = (double)this.field_75884_a[p_75881_2_].field_75839_a + (double)((int)(p_75881_1_.field_70130_N + 1.0F)) * 0.5D;
      double lvt_5_1_ = (double)this.field_75884_a[p_75881_2_].field_75837_b;
      double lvt_7_1_ = (double)this.field_75884_a[p_75881_2_].field_75838_c + (double)((int)(p_75881_1_.field_70130_N + 1.0F)) * 0.5D;
   ...
   public boolean func_75876_a(PathEntity p_75876_1_) {
      if (p_75876_1_ == null) {
         ...
         for(int lvt_2_1_ = 0; lvt_2_1_ < this.field_75884_a.length; ++lvt_2_1_) {
            if (this.field_75884_a[lvt_2_1_].field_75839_a != p_75876_1_.field_75884_a[lvt_2_1_].field_75839_a || this.field_75884_a[lvt_2_1_].field_75837_b != p_75876_1_.field_75884_a[lvt_2_1_].field_75837_b || this.field_75884_a[lvt_2_1_].field_75838_c != p_75876_1_.field_75884_a[lvt_2_1_].field_75838_c) {
               return false;
            }
         }
   ...
   public boolean func_75880_b(Vec3 p_75880_1_) {
      PathPoint lvt_2_1_ = this.func_75870_c();
      if (lvt_2_1_ == null) {
         return false;
      } else {
         return lvt_2_1_.field_75839_a == (int)p_75880_1_.field_72450_a && lvt_2_1_.field_75838_c == (int)p_75880_1_.field_72449_c;
      }
   }
}
