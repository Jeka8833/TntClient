...
public class ConnectedProperties {
   ...
   public ConnectedProperties(Properties props, String path) {
      this.tintBlockState = Blocks.field_150350_a.func_176223_P();
      this.layer = null;
      ...
      this.tintBlockState = cp.parseBlockState(props.getProperty("tintBlock"), Blocks.field_150350_a.func_176223_P());
      this.layer = cp.parseBlockRenderLayer(props.getProperty("layer"), EnumWorldBlockLayer.CUTOUT_MIPPED);
   }
   ...
   public static IProperty getProperty(String key, Collection properties) {
      ...
      } while(!key.equals(prop.func_177701_a()));
   ...
   private static TextureAtlasSprite[] registerIcons(String[] tileNames, TextureMap textureMap, boolean skipTiles, boolean defaultTiles) {
      if (tileNames == null) {
         ...
         TextureAtlasSprite[] icons = (TextureAtlasSprite[])((TextureAtlasSprite[])iconList.toArray(new TextureAtlasSprite[iconList.size()]));
         return icons;
      }
   }
