...
public class CustomTextureLocation implements ICustomTexture {
   ...
   public ITextureObject getTexture() {
      if (this.texture == null) {
         ...
         this.texture = textureManager.func_110581_b(this.location);
         if (this.texture == null) {
            this.texture = new SimpleTexture(this.location);
            textureManager.func_110579_a(this.location, this.texture);
            this.texture = textureManager.func_110581_b(this.location);
         }
      }
   ...
   public int getTextureId() {
      ITextureObject tex = this.getTexture();
   ...
   public String toString() {
      return "textureUnit: " + this.textureUnit + ", location: " + this.location + ", glTextureId: " + (this.texture != null ? this.texture.func_110552_b() : "");
   }
}
