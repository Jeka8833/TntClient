...
public class TextureAnimations {
   ...
   public static void updateAnimations() {
      if (textureAnimations != null && Config.isAnimatedTextures()) {
         ...
         frameCount = Config.getMinecraft().field_71460_t.field_175084_ae;
      ...
      if (animPropNames.length <= 0) {
         ...
         for(int i = 0; i < animPropNames.length; ++i) {
            ...
            try {
               ...
               InputStream in = rp.func_110590_a(propLoc);
   ...
   private static TextureAnimation makeTextureAnimation(Properties props, ResourceLocation propLoc) {
      ...
      if (texFrom != null && texTo != null) {
         if (x >= 0 && y >= 0 && width >= 0 && height >= 0) {
            ...
            texTo = texTo.trim();
            String basePath = TextureUtils.getBasePath(propLoc.func_110623_a());
         ...
         if (in == null) {
            ...
            if (image == null) {
               ...
               for(int l = 0; l < ai.length; ++l) {
                  ...
                  int blue = ai[l] & 255;
                  if (options != null && options.field_74337_g) {
