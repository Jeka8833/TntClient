...
public class TextureAnimation {
   ...
   public TextureAnimation(String texFrom, byte[] srcData, String texTo, ResourceLocation locTexTo, int dstX, int dstY, int frameWidth, int frameHeight, Properties props) {
      ...
      if (this.interpolate) {
         this.interpolateData = GLAllocation.func_74524_c(frameLen);
      }
   ...
   public void updateTexture() {
      if (this.valid) {
         if (this.dstTextId < 0) {
            ...
            this.dstTextId = tex.func_110552_b();
         }

         if (this.imageData == null) {
            this.imageData = GLAllocation.func_74524_c(this.srcData.length);
   ...
   private void updateTextureInerpolate(TextureAnimationFrame frame1, TextureAnimationFrame frame2, double k) {
      ...
      if (offset1 + frameLen <= this.imageData.limit()) {
         ...
         if (offset2 + frameLen <= this.imageData.limit()) {
            ...
            GlStateManager.func_179144_i(this.dstTextId);
            GL11.glTexSubImage2D(3553, 0, this.dstX, this.dstY, this.frameWidth, this.frameHeight, 6408, 5121, (ByteBuffer)this.interpolateData);
         }
      }
   }
