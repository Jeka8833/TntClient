...
public class ModelAdapterHorse extends ModelAdapter {
   ...
   public ModelRenderer getModelRenderer(ModelBase model, String modelPart) {
      if (!(model instanceof ModelHorse)) {
         ...
         if (mapParts.containsKey(modelPart)) {
            ...
            return (ModelRenderer)Reflector.getFieldValue(modelHorse, Reflector.ModelHorse_ModelRenderers, index);
         } else {
            return null;
         }
      }
   ...
   public IEntityRenderer makeEntityRender(ModelBase modelBase, float shadowSize) {
      ...
      RenderHorse render = new RenderHorse(renderManager, (ModelHorse)modelBase, shadowSize);
      return render;
   }
}
