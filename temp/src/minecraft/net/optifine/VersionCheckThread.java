...
public class VersionCheckThread extends Thread {
   ...
   public void run() {
      ...
      try {
         ...
         if (Config.getGameSettings().field_74355_t) {
            conn.setRequestProperty("OF-MC-Version", "1.8.9");
            conn.setRequestProperty("OF-MC-Brand", "" + ClientBrandRetriever.getClientModName());
            conn.setRequestProperty("OF-Edition", "HD_U");
            conn.setRequestProperty("OF-Release", "L5");
         ...
         try {
            ...
            if (verLines.length >= 1) {
               ...
               if (Config.compareRelease(newVer, "L5") <= 0) {
                  return;
               }
