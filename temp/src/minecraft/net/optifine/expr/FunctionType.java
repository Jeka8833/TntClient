...
public enum FunctionType {
   ...
   public float evalFloat(IExpression[] args) {
      ...
      case SIN:
         return MathHelper.func_76126_a(evalFloat(args, 0));
      case COS:
         return MathHelper.func_76134_b(evalFloat(args, 0));
      case ASIN:
      ...
      case CLAMP:
         return MathHelper.func_76131_a(evalFloat(args, 0), evalFloat(args, 1), evalFloat(args, 2));
      case ABS:
         return MathHelper.func_76135_e(evalFloat(args, 0));
      case EXP:
         return (float)Math.exp((double)evalFloat(args, 0));
      case FLOOR:
         return (float)MathHelper.func_76141_d(evalFloat(args, 0));
      case CEIL:
         return (float)MathHelper.func_76123_f(evalFloat(args, 0));
      case FRAC:
      ...
      case SQRT:
         return MathHelper.func_76129_c(evalFloat(args, 0));
      case FMOD:
         float fmodX = evalFloat(args, 0);
         float fmodY = evalFloat(args, 1);
         return fmodX - fmodY * (float)MathHelper.func_76141_d(fmodX / fmodY);
      case TIME:
         ...
         return (float)(world.func_82737_E() % 24000L) + Config.renderPartialTicks;
      case IF:
